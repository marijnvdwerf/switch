...
_sub_43E27D:
    ...
    .global _sub_43E2A2
_sub_43E2A2:
    mov word ptr [__112C826], 0xc9                       # 0043E2A2
    ret                                                  # 0043E2AB
...
.L43F019:
    ...
    mov word ptr [__112C826], 0x7f7                      # 0043F024
...
.L43F0C2:
    ...
    mov word ptr [__112C826], 0x7f7                      # 0043F0CD
...
.L440E5F:
    bt word ptr [__508F10], 8                            # 00440E5F
    jb .L44101E                                          # 00440E68
    bt word ptr [__508F10], 9                            # 00440E6E
    jb .L44101E                                          # 00440E77
.L440E7D:
...
.L44106B:
    ...
    mov_offset edi, __50AC74                             # 00441076
    inc esi                                              # 0044107B
.L44107C:
    cmp_offset edi, __50ACB3                             # 0044107C
...
.L443ABA:
    ...
    mov word ptr [__112C826], 0x7f7                      # 00443AC5
...
.L443BF0:
    ...
    mov word ptr [__112C826], 0x7f7                      # 00443BFB
...
.L443DC3:
    ...
    mov word ptr [__112C826], 0x7f7                      # 00443DCE
...
.L443E4F:
    ...
    mov word ptr [__112C828], 0x7f7                      # 00443E63
...
.L44452D:
    ...
    .global _sub_44452F
_sub_44452F:
    mov dx, word ptr [__508F14]                          # 0044452F
    or dx, 1                                             # 00444536
    xchg word ptr [__508F14], dx                         # 0044453A
    push edx                                             # 00444541
...
.L4446BA:
    ...
    pop eax                                              # 00444766
    pop edx                                              # 00444767
    mov word ptr [__508F14], dx                          # 00444768
    ret                                                  # 0044476F
.L444770:
...
.L444B53:
    ...
    pop edx                                              # 00444B58
    mov word ptr [__508F14], dx                          # 00444B59
    ret                                                  # 00444B60
...
.L445E47:
    ...
    add dx, 6                                            # 00445E65
    push esi                                             # 00445E69
    mov word ptr [__112C826], 0x7f7                      # 00445E6A
...
.L445EF1:
    ...
    mov word ptr [__112C826], 0x7f7                      # 00445EF9
...
.L445FE2:
    ...
    mov word ptr [__112C826], 0x7f7                      # 00445FEC
...
.L446018:
    ...
    mov word ptr [__112C826], 0x7f7                      # 00446022
...
.L446250:
    ...
    mov dx, 1                                            # 00446262
    mov word ptr [__112C826], 0x7f7                      # 00446266
...
.L4462C6:
    ...
    mov dx, 1                                            # 004462D0
    mov word ptr [__112C826], 0x7f7                      # 004462D4
...
.L4463DA:
    ...
    mov word ptr [__112C826], 0x7f7                      # 004463E9
...
.L44642A:
    ...
    mov word ptr [__112C826], 0x7f7                      # 0044642E
...
.L446642:
    ...
    mov word ptr [__112C826], 0x7f7                      # 00446656
...
.L446704:
    ...
    mov word ptr [__112C826], 0x7f7                      # 00446718
...
.L4470C0:
    ...
    mov word ptr [__112C826], 0x7f7                      # 004470E1
    push esi                                             # 004470EA
