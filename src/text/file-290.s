...
.L4C1A05:
    ...
    mov ax, word ptr [ebx*2 + 0x5043d4]                  # 004C1A13
    ...
    mov eax, dword ptr [ebx*4 + 0x50435c]                # 004C1A55
    mov dword ptr [esi + 0x2c], eax                      # 004C1A5C
    mov eax, dword ptr [ebx*8 + 0x50438c]                # 004C1A5F
    mov dword ptr [esi + 0xc], eax                       # 004C1A66
    mov eax, dword ptr [ebx*8 + 0x504390]                # 004C1A69
    mov dword ptr [esi + 0x10], eax                      # 004C1A70
    mov eax, dword ptr [ebx*4 + 0x5043bc]                # 004C1A73
    mov dword ptr [esi + 0x24], eax                      # 004C1A7A
    mov eax, dword ptr [ebx*4 + 0x504374]                # 004C1A7D
...
_sub_4C1AA2:
    ...
    mov edx, 0x504474                                    # 004C1AAD
    call _sub_4C9C68                                     # 004C1AB2
    mov dword ptr [esi + 0x2c], 0x5230cc                 # 004C1AB7
    mov eax, dword ptr [0x50438c]                        # 004C1ABE
    mov dword ptr [esi + 0xc], eax                       # 004C1AC3
    mov eax, dword ptr [0x504390]                        # 004C1AC6
    ...
    mov ebp, dword ptr [0x50c3d0]                        # 004C1AE2
...
_sub_4C1AF7:
    ...
    movzx dx, byte ptr [0x525e3c]                        # 004C1AF9
...
.L4C1B8E:
    ...
    mov eax, dword ptr [0x5043e0]                        # 004C1BC4
    mov dword ptr [esi + 0x2c], eax                      # 004C1BC9
    mov eax, dword ptr [0x504410]                        # 004C1BCC
    mov dword ptr [esi + 0xc], eax                       # 004C1BD1
    mov eax, dword ptr [0x504414]                        # 004C1BD4
    mov dword ptr [esi + 0x10], eax                      # 004C1BD9
    mov eax, dword ptr [0x504440]                        # 004C1BDC
    mov dword ptr [esi + 0x24], eax                      # 004C1BE1
    mov eax, dword ptr [0x5043f8]                        # 004C1BE4
...
.L4C1C15:
    mov edi, dword ptr [0x11364e8]                       # 004C1C15
    cmp edi, -1                                          # 004C1C1B
    je .L4C1C63                                          # 004C1C1E
    movzx edi, di                                        # 004C1C20
    shl edi, 7                                           # 004C1C23
    add edi, 0x6db6dc                                    # 004C1C26
    ...
    mov al, byte ptr [0x525fc5]                          # 004C1C3B
.L4C1C40:
    msvc_xor ebp, ebp                                    # 004C1C40
.L4C1C42:
    cmp ebp, dword ptr [0x11364ec]                       # 004C1C42
    jae .L4C1C56                                         # 004C1C48
    inc ebp                                              # 004C1C4A
    cmp al, byte ptr [ebp + 0x11364ef]                   # 004C1C4B
...
_sub_4C1C64:
    ...
    mov edx, 0x5044e8                                    # 004C1C6F
    call _sub_4C9C68                                     # 004C1C74
    mov dword ptr [esi + 0x2c], 0x5231d0                 # 004C1C79
    pop eax                                              # 004C1C80
    mov word ptr [esi + 0x40], ax                        # 004C1C81
    mov eax, dword ptr [0x504410]                        # 004C1C85
    mov dword ptr [esi + 0xc], eax                       # 004C1C8A
    mov eax, dword ptr [0x504414]                        # 004C1C8D
    mov dword ptr [esi + 0x10], eax                      # 004C1C92
    mov al, byte ptr [0x525e3c]                          # 004C1C95
    mov byte ptr [esi + 0x884], al                       # 004C1C9A
    mov word ptr [esi + 0x872], 0                        # 004C1CA0
    mov ebp, dword ptr [0x50c3d0]                        # 004C1CA9
...
_sub_4C1CBE:
    ...
    je .L4C1D0F                                          # 004C1CD0
    mov al, byte ptr [0x525faa]                          # 004C1CD2
    mov ah, byte ptr [0x525fab]                          # 004C1CD7
    msvc_xor ebp, ebp                                    # 004C1CDD
.L4C1CDF:
    cmp ebp, dword ptr [0x11364ec]                       # 004C1CDF
    jae .L4C1CFA                                         # 004C1CE5
    cmp al, byte ptr [ebp + 0x11364f0]                   # 004C1CE7
    je .L4C1CFC                                          # 004C1CED
    cmp ah, byte ptr [ebp + 0x11364f0]                   # 004C1CEF
    je .L4C1CFC                                          # 004C1CF5
    inc ebp                                              # 004C1CF7
...
.L4C1CFC:
    ...
    mov cl, byte ptr [ebp + 0x11364f0]                   # 004C1D03
...
_sub_4C1D4F:
    ...
    mov bp, word ptr [0x525e42]                          # 004C1D63
.L4C1D6A:
    cmp bp, -1                                           # 004C1D6A
    je .L4C1D91                                          # 004C1D6E
    movzx ebp, bp                                        # 004C1D70
    shl ebp, 7                                           # 004C1D73
    add ebp, 0x6db6dc                                    # 004C1D76
...
_sub_4C1D92:
    ...
    mov bp, word ptr [0x525e42]                          # 004C1D9D
...
.L4C1DA9:
    ...
    call dword ptr [ebx*4 + 0x504464]                    # 004C1DDC
    pop esi                                              # 004C1DE3
    pop ebx                                              # 004C1DE4
    pop eax                                              # 004C1DE5
...
_sub_4C1E4F:
    ...
    push edi                                             # 004C1E56
    mov word ptr [0x112cc04], 0xffff                     # 004C1E57
    movzx edx, word ptr [ecx]                            # 004C1E60
    mov dword ptr [0x112cc06], edx                       # 004C1E63
    cmp ax, 4                                            # 004C1E69
    jb .L4C1E75                                          # 004C1E6D
    cmp ax, 0xa                                          # 004C1E6F
    jb .L4C1E7F                                          # 004C1E73
.L4C1E75:
    mov edi, 0x112cc04                                   # 004C1E75
    call _sub_4958C6                                     # 004C1E7A
.L4C1E7F:
    lea ecx, [ebp + 0x44]                                # 004C1E7F
    movzx eax, word ptr [ebp + 0x22]                     # 004C1E82
    mov word ptr [0x112ce04], 0xffff                     # 004C1E86
    movzx edx, word ptr [ecx]                            # 004C1E8F
    mov dword ptr [0x112ce06], edx                       # 004C1E92
    cmp ax, 4                                            # 004C1E98
    jb .L4C1EA4                                          # 004C1E9C
    cmp ax, 0xa                                          # 004C1E9E
    jb .L4C1EAE                                          # 004C1EA2
.L4C1EA4:
    mov edi, 0x112ce04                                   # 004C1EA4
    call _sub_4958C6                                     # 004C1EA9
.L4C1EAE:
    pop edi                                              # 004C1EAE
    mov esi, 0x112cc04                                   # 004C1EAF
    mov ebx, 0x112ce04                                   # 004C1EB4
.L4C1EB9:
...
_sub_4C1EC9:
    ...
    shl esi, 7                                           # 004C1ECD
    add esi, 0x6db6dc                                    # 004C1ED0
    movzx esi, word ptr [esi + 0x3a]                     # 004C1ED6
    shl esi, 7                                           # 004C1EDA
    add esi, 0x6db6dc                                    # 004C1EDD
    ...
    shl esi, 7                                           # 004C1EF3
    add esi, 0x6db6dc                                    # 004C1EF6
    movzx esi, word ptr [esi + 0x3a]                     # 004C1EFC
    shl esi, 7                                           # 004C1F00
    add esi, 0x6db6dc                                    # 004C1F03
...
_sub_4C1F88:
    ...
    mov eax, dword ptr [edx*4 + 0x50435c]                # 004C1F8F
...
.L4C1FA3:
    ...
    mov ax, word ptr [ebp + 0x531784]                    # 004C1FC6
    mov word ptr [0x112c826], ax                         # 004C1FCD
    movzx eax, word ptr [esi + 0x870]                    # 004C1FD3
    add eax, 0x462                                       # 004C1FDA
    mov dword ptr [0x5230e6], eax                        # 004C1FDF
    mov ax, word ptr [esi + 0x34]                        # 004C1FE4
    mov bx, word ptr [esi + 0x36]                        # 004C1FE8
    dec ax                                               # 004C1FEC
    dec bx                                               # 004C1FEE
    mov word ptr [0x5230d0], ax                          # 004C1FF0
    mov word ptr [0x5230d4], bx                          # 004C1FF6
    mov word ptr [0x523100], ax                          # 004C1FFD
    mov word ptr [0x523104], bx                          # 004C2003
    dec ax                                               # 004C200A
    mov word ptr [0x5230e0], ax                          # 004C200C
    sub ax, 0xd                                          # 004C2012
    mov word ptr [0x5230ee], ax                          # 004C2016
    add ax, 0xc                                          # 004C201C
    mov word ptr [0x5230f0], ax                          # 004C2020
    dec ax                                               # 004C2026
    sub bx, 0xd                                          # 004C2028
    mov word ptr [0x5231c0], ax                          # 004C202C
    mov word ptr [0x5231c4], bx                          # 004C2032
...
_sub_4C211C:
    ...
    movzx ebx, byte ptr [ebp + 0x53179c]                 # 004C2131
    mov ebx, dword ptr [ebx*4 + 0x50d0b8]                # 004C2138
    movzx eax, byte ptr [ebp + 0x53179d]                 # 004C213F
    mov ebx, dword ptr [ebx + eax*4 + 0x10]              # 004C2146
    movzx eax, byte ptr [ebp + 0x53179e]                 # 004C214A
    shl eax, 0x13                                        # 004C2151
    msvc_or ebx, eax                                     # 004C2154
    or ebx, 0x20000000                                   # 004C2156
    mov cx, word ptr [0x52316e]                          # 004C215C
    mov dx, word ptr [0x523172]                          # 004C2163
    inc cx                                               # 004C216A
    inc dx                                               # 004C216C
    ...
    mov word ptr [0x112c828], ax                         # 004C21A4
    cmp ax, 1                                            # 004C21AA
    je .L4C21B4                                          # 004C21AE
    add bx, 6                                            # 004C21B0
.L4C21B4:
    msvc_xor al, al                                      # 004C21B4
    mov word ptr [0x112c826], bx                         # 004C21B6
    mov esi, 0x112c826                                   # 004C21BD
...
_sub_4C21CD:
    ...
    movzx ebp, byte ptr [ebp*8 + 0x1136ba1]              # 004C21D5
...
.L4C21F8:
    ...
    movzx ebp, byte ptr [ebp*8 + 0x1136ba0]              # 004C2278
...
.L4C2289:
    ...
    mov word ptr [0x112c82a], bx                         # 004C22BF
    mov dword ptr [0x112c82c], eax                       # 004C22C6
    mov word ptr [0x112c830], cx                         # 004C22CB
    mov dword ptr [0x112c832], edx                       # 004C22D2
    pop edx                                              # 004C22D8
    pop ecx                                              # 004C22D9
    mov ax, word ptr [ebp + 0x44]                        # 004C22DA
    mov word ptr [0x112c828], ax                         # 004C22DE
    mov ax, word ptr [ebp + 0x22]                        # 004C22E4
    mov word ptr [0x112c826], ax                         # 004C22E8
    mov esi, dword ptr [esp]                             # 004C22EE
    mov cx, 1                                            # 004C22F1
    add dx, 2                                            # 004C22F5
    mov al, 0x20                                         # 004C22F9
    mov bx, 0x472                                        # 004C22FB
    cmp word ptr [0x112c830], -1                         # 004C22FF
    je .L4C230B                                          # 004C2307
    inc bx                                               # 004C2309
.L4C230B:
    mov esi, 0x112c826                                   # 004C230B
    ...
    shl esi, 7                                           # 004C2325
    add esi, 0x6db6dc                                    # 004C2328
    movzx esi, word ptr [esi + 0x3a]                     # 004C232E
    shl esi, 7                                           # 004C2332
    add esi, 0x6db6dc                                    # 004C2335
    ...
    neg eax                                              # 004C2354
.L4C2356:
    mov dword ptr [0x112c826], eax                       # 004C2356
    mov esi, 0x112c826                                   # 004C235B
    ...
    shl esi, 7                                           # 004C2377
    add esi, 0x6db6dc                                    # 004C237A
    mov eax, dword ptr [0x525e2c]                        # 004C2380
    ...
    inc bx                                               # 004C239D
.L4C239F:
    mov word ptr [0x112c826], ax                         # 004C239F
    mov esi, 0x112c826                                   # 004C23A5
    ...
    shl esi, 7                                           # 004C23C1
    add esi, 0x6db6dc                                    # 004C23C4
    movzx esi, word ptr [esi + 0x3a]                     # 004C23CA
    shl esi, 7                                           # 004C23CE
    add esi, 0x6db6dc                                    # 004C23D1
    movzx ax, byte ptr [esi + 0x72]                      # 004C23D7
    mov bx, 0x478                                        # 004C23DC
    mov word ptr [0x112c826], ax                         # 004C23E0
    mov esi, 0x112c826                                   # 004C23E6
...
.L4C2446:
    ...
    cmp word ptr [ebx + 0x531784], 0                     # 004C2479
    ...
    .global _sub_4C24CA
_sub_4C24CA:
    mov word ptr [0x112c826], 0xc7                       # 004C24CA
    ret                                                  # 004C24D3
...
.L4C2521:
    ...
    mov ax, word ptr [edx*2 + 0x5043d4]                  # 004C252F
    mov word ptr [esi + 0x83e], ax                       # 004C2537
    mov word ptr [esi + 0x872], 0                        # 004C253E
    mov ax, word ptr [esi + 0x40]                        # 004C2547
    cmp al, byte ptr [0x525e3c]                          # 004C254B
    jne .L4C256E                                         # 004C2551
    cmp dl, byte ptr [0x525faf]                          # 004C2553
    je .L4C256E                                          # 004C2559
    mov byte ptr [0x525faf], dl                          # 004C255B
    pushal                                               # 004C2561
    mov al, 1                                            # 004C2562
    mov bx, 0                                            # 004C2564
...
.L4C257C:
    mov eax, dword ptr [edx*8 + 0x50438c]                # 004C257C
    mov dword ptr [esi + 0xc], eax                       # 004C2583
    mov eax, dword ptr [edx*8 + 0x504390]                # 004C2586
    mov dword ptr [esi + 0x10], eax                      # 004C258D
    mov eax, dword ptr [edx*4 + 0x5043bc]                # 004C2590
    mov dword ptr [esi + 0x24], eax                      # 004C2597
    mov eax, dword ptr [edx*4 + 0x504374]                # 004C259A
    mov dword ptr [esi], eax                             # 004C25A1
    mov dword ptr [esi + 0x1c], 0                        # 004C25A3
    mov eax, dword ptr [edx*4 + 0x50435c]                # 004C25AA
...
_sub_4C266D:
    ...
    .global _sub_4C26A4
_sub_4C26A4:
    mov word ptr [0x52338a], 0x7d0                       # 004C26A4
...
.L4C26E9:
    cmp byte ptr [0x50ed4b], 0                           # 004C26E9
    je .L4C2708                                          # 004C26F0
    cmp ax, word ptr [0x5231ca]                          # 004C26F2
    jne .L4C2708                                         # 004C26F9
    cmp bx, word ptr [esi + 0x85c]                       # 004C26FB
    je _sub_4C2864                                       # 004C2702
.L4C2708:
    mov word ptr [0x5231ca], ax                          # 004C2708
    ...
    shl esi, 7                                           # 004C2728
    add esi, 0x6db6dc                                    # 004C272B
    mov edi, 0x50ed4b                                    # 004C2731
    push esi                                             # 004C2736
...
.L4C274C:
    mov dl, byte ptr [esi + 0x987c5c]                    # 004C274C
    and dl, 7                                            # 004C2752
    cmp dl, 0                                            # 004C2755
    je .L4C27BE                                          # 004C2758
    cmp dl, 1                                            # 004C275A
    ...
    inc eax                                              # 004C2768
.L4C2769:
    movzx ebx, byte ptr [esi + 0x987c5d]                 # 004C2769
    mov bh, byte ptr [esi + 0x987c5c]                    # 004C2770
    shr bh, 6                                            # 004C2776
    imul ebx, ebx, 0x3d2                                 # 004C2779
    mov dx, word ptr [ebx + 0x5e6f08]                    # 004C277F
    mov word ptr [0x112c828], dx                         # 004C2786
    mov dx, word ptr [ebx + 0x5e6edc]                    # 004C278D
    mov word ptr [0x112c826], dx                         # 004C2794
    push ecx                                             # 004C279B
    push esi                                             # 004C279C
    mov ecx, 0x112c826                                   # 004C279D
    call _sub_4958C6                                     # 004C27A2
    pop esi                                              # 004C27A7
    pop ecx                                              # 004C27A8
    or cl, 1                                             # 004C27A9
.L4C27AC:
    mov dl, byte ptr [esi + 0x987c5c]                    # 004C27AC
    and edx, 7                                           # 004C27B2
    add esi, dword ptr [edx*4 + 0x4fe070]                # 004C27B5
...
_sub_4C28D2:
    ...
    movzx ecx, word ptr [ecx + 0x5317d4]                 # 004C28DE
...
_sub_4C28F1:
    ...
    movzx ebp, byte ptr [ebp*8 + 0x1136ba7]              # 004C2913
    ...
    movzx ebp, byte ptr [ebp*8 + 0x1136ba7]              # 004C2945
    call _sub_4474BA                                     # 004C294D
    msvc_xor ebx, ebx                                    # 004C2952
.L4C2954:
    cmp ebx, dword ptr [0x11364ec]                       # 004C2954
    ...
    movzx ebp, byte ptr [ebp*8 + 0x1136ba5]              # 004C29A7
    call _sub_4474BA                                     # 004C29AF
    pop edx                                              # 004C29B4
    pop ecx                                              # 004C29B5
    pop ebx                                              # 004C29B6
.L4C29B7:
    movzx ebp, byte ptr [ebx + 0x11364f0]                # 004C29B7
    cmp ebp, 0xff                                        # 004C29BE
    je .L4C2A28                                          # 004C29C4
    btr ebp, 7                                           # 004C29C6
    jb .L4C29FA                                          # 004C29CA
    mov ebp, dword ptr [ebp*4 + 0x50c914]                # 004C29CC
...
.L4C29FA:
    mov ebp, dword ptr [ebp*4 + 0x50c984]                # 004C29FA
...
.L4C2A28:
    mov ebp, dword ptr [0x50c3d0]                        # 004C2A28
...
.L4C2A43:
    ...
    movzx ebp, byte ptr [0x525e3c]                       # 004C2A45
    movzx ebp, byte ptr [ebp + 0x9c645c]                 # 004C2A4C
...
.L4C2A87:
    ...
    mov ebp, dword ptr [0x50c3d0]                        # 004C2A8D
    add ebx, dword ptr [ebp + 2]                         # 004C2A93
    movzx ebp, word ptr [esi + 0x40]                     # 004C2A96
    movzx ebp, byte ptr [ebp + 0x9c645c]                 # 004C2A9A
...
.L4C2AC9:
    ...
    mov ebp, dword ptr [0x50c3d0]                        # 004C2ACF
    add ebx, dword ptr [ebp + 2]                         # 004C2AD5
    movzx ebp, word ptr [esi + 0x40]                     # 004C2AD8
    movzx ebp, byte ptr [ebp + 0x9c645c]                 # 004C2ADC
...
.L4C2B0B:
    ...
    mov ebp, dword ptr [0x50c3d0]                        # 004C2B11
    add ebx, dword ptr [ebp + 2]                         # 004C2B17
    movzx ebp, word ptr [esi + 0x40]                     # 004C2B1A
    movzx ebp, byte ptr [ebp + 0x9c645c]                 # 004C2B1E
...
.L4C2B4D:
    ...
    mov ebp, dword ptr [0x50c3d0]                        # 004C2B53
    add ebx, dword ptr [ebp + 2]                         # 004C2B59
    movzx ebp, word ptr [esi + 0x40]                     # 004C2B5C
    movzx ebp, byte ptr [ebp + 0x9c645c]                 # 004C2B60
...
.L4C2B90:
    ...
    mov ebp, dword ptr [0x50c3d0]                        # 004C2B96
    add ebx, dword ptr [ebp + 2]                         # 004C2B9C
    movzx ebp, word ptr [esi + 0x40]                     # 004C2B9F
    movzx ebp, byte ptr [ebp + 0x9c645c]                 # 004C2BA3
...
.L4C2BD3:
    ...
    mov ebp, dword ptr [0x50c3d0]                        # 004C2BD9
    add ebx, dword ptr [ebp + 2]                         # 004C2BDF
    movzx ebp, word ptr [esi + 0x40]                     # 004C2BE2
    movzx ebp, byte ptr [ebp + 0x9c645c]                 # 004C2BE6
...
.L4C2C16:
    ...
    mov ebp, dword ptr [0x50c3d0]                        # 004C2C1C
    add ebx, dword ptr [ebp + 2]                         # 004C2C22
    movzx ebp, word ptr [esi + 0x40]                     # 004C2C25
    movzx ebp, byte ptr [ebp + 0x9c645c]                 # 004C2C29
...
.L4C2C58:
    ...
    mov ebp, dword ptr [0x50c3d0]                        # 004C2C5E
    add ebx, dword ptr [ebp + 2]                         # 004C2C64
    movzx ebp, word ptr [esi + 0x40]                     # 004C2C67
    movzx ebp, byte ptr [ebp + 0x9c645c]                 # 004C2C6B
...
.L4C2C9A:
    ...
    mov ebp, dword ptr [0x50c3d0]                        # 004C2CA0
    add ebx, dword ptr [ebp + 2]                         # 004C2CA6
    movzx ebp, word ptr [esi + 0x40]                     # 004C2CA9
    movzx ebp, byte ptr [ebp + 0x9c645c]                 # 004C2CAD
...
.L4C2CDC:
    ...
    mov ebp, dword ptr [0x50c3d0]                        # 004C2CE2
    add ebx, dword ptr [ebp + 2]                         # 004C2CE8
    movzx ebp, word ptr [esi + 0x40]                     # 004C2CEB
    movzx ebp, byte ptr [ebp + 0x9c645c]                 # 004C2CEF
...
.L4C2D1E:
    ...
    mov ebp, dword ptr [0x50c3d0]                        # 004C2D24
    add ebx, dword ptr [ebp + 2]                         # 004C2D2A
    movzx ebp, word ptr [esi + 0x40]                     # 004C2D2D
    movzx ebp, byte ptr [ebp + 0x9c645c]                 # 004C2D31
...
.L4C2D60:
    ...
    mov ebp, dword ptr [0x50c3d0]                        # 004C2D66
    add ebx, dword ptr [ebp + 2]                         # 004C2D6C
    movzx ebp, word ptr [esi + 0x40]                     # 004C2D6F
    movzx ebp, byte ptr [ebp + 0x9c645c]                 # 004C2D73
...
.L4C2DA5:
    cmp bp, word ptr [0x1136268]                         # 004C2DA5
    jae .L4C2DE6                                         # 004C2DAC
    movzx edi, word ptr [ebp*2 + 0x113626a]              # 004C2DAE
    mov edi, dword ptr [edi*4 + 0x50c9e4]                # 004C2DB6
...
.L4C2DCA:
    ...
    mov al, byte ptr [0x525fc5]                          # 004C2DD2
.L4C2DD7:
...
.L4C2DE6:
    ...
    mov edi, 0x523270                                    # 004C2DE8
.L4C2DED:
    bsf eax, ecx                                         # 004C2DED
    je .L4C2E04                                          # 004C2DF0
    btr ecx, eax                                         # 004C2DF2
    mov byte ptr [ebp + 0x11364f0], al                   # 004C2DF5
...
.L4C2E04:
    ...
    or al, 0x80                                          # 004C2E0C
    mov byte ptr [ebp + 0x11364f0], al                   # 004C2E0E
    mov byte ptr [edi], 8                                # 004C2E14
    inc ebp                                              # 004C2E17
    add edi, 0x10                                        # 004C2E18
    jmp .L4C2E04                                         # 004C2E1B
.L4C2E1D:
    mov dword ptr [0x11364ec], ebp                       # 004C2E1D
.L4C2E23:
    cmp ebp, 8                                           # 004C2E23
...
.L4C2E32:
    ...
    mov edi, 0x523270                                    # 004C2E34
    mov byte ptr [ebp + 0x11364f0], 0xff                 # 004C2E39
    mov byte ptr [edi], 8                                # 004C2E40
    inc ebp                                              # 004C2E43
    add edi, 0x10                                        # 004C2E44
    mov dword ptr [0x11364ec], ebp                       # 004C2E47
.L4C2E4D:
    cmp ebp, 8                                           # 004C2E4D
...
_sub_4C2E5C:
    ...
    mov eax, dword ptr [edx*4 + 0x5043e0]                # 004C2E63
...
.L4C2E77:
    ...
    mov dword ptr [0x5231ea], eax                        # 004C2EAF
    mov ax, word ptr [esi + 0x34]                        # 004C2EB4
    mov bx, word ptr [esi + 0x36]                        # 004C2EB8
    dec ax                                               # 004C2EBC
    dec bx                                               # 004C2EBE
    mov word ptr [0x5231d4], ax                          # 004C2EC0
    mov word ptr [0x5231d8], bx                          # 004C2EC6
    mov word ptr [0x523204], ax                          # 004C2ECD
    mov word ptr [0x523208], bx                          # 004C2ED3
    dec ax                                               # 004C2EDA
    mov word ptr [0x5231e4], ax                          # 004C2EDC
    sub ax, 0xd                                          # 004C2EE2
    mov word ptr [0x5231f2], ax                          # 004C2EE6
    add ax, 0xc                                          # 004C2EEC
    mov word ptr [0x5231f4], ax                          # 004C2EF0
    dec ax                                               # 004C2EF6
    mov word ptr [0x523304], ax                          # 004C2EF8
    sub ax, 0xb4                                         # 004C2EFE
    mov word ptr [0x523302], ax                          # 004C2F02
    sub ax, 3                                            # 004C2F08
    sub bx, 0xd                                          # 004C2F0C
    mov word ptr [0x5232f4], ax                          # 004C2F10
    mov word ptr [0x5232f8], bx                          # 004C2F16
...
_sub_4C2F23:
    ...
    mov ebp, dword ptr [0x11364e8]                       # 004C2F4B
    cmp ebp, -1                                          # 004C2F51
    je .L4C2F7A                                          # 004C2F54
    movzx ebp, bp                                        # 004C2F56
    shl ebp, 7                                           # 004C2F59
    add ebp, 0x6db6dc                                    # 004C2F5C
    mov ax, word ptr [ebp + 0x44]                        # 004C2F62
    mov word ptr [0x112c828], ax                         # 004C2F66
    mov ax, word ptr [ebp + 0x22]                        # 004C2F6C
    mov word ptr [0x112c826], ax                         # 004C2F70
    mov bx, 0x4a3                                        # 004C2F76
.L4C2F7A:
    mov bp, word ptr [esi + 0x34]                        # 004C2F7A
    sub bp, 0xba                                         # 004C2F7E
    msvc_xor al, al                                      # 004C2F83
    mov esi, 0x112c826                                   # 004C2F85
    call _sub_494BBF                                     # 004C2F8A
    pop esi                                              # 004C2F8F
    movzx ebx, word ptr [esi + 0x840]                    # 004C2F90
    cmp bx, -1                                           # 004C2F97
    je .L4C3306                                          # 004C2F9B
    mov ebx, dword ptr [ebx*4 + 0x50c9e4]                # 004C2FA1
    push edi                                             # 004C2FA8
    push esi                                             # 004C2FA9
    mov edi, 0x512813                                    # 004C2FAA
    push ebx                                             # 004C2FAF
    movzx ecx, byte ptr [ebx + 7]                        # 004C2FB0
    movsx eax, word ptr [ebx + 8]                        # 004C2FB4
    imul eax, dword ptr [ecx*4 + 0x525e5e]               # 004C2FB8
    sar eax, 6                                           # 004C2FC0
    mov dword ptr [0x112c826], eax                       # 004C2FC3
    mov ecx, 0x112c826                                   # 004C2FC8
    ...
    imul eax, dword ptr [ecx*4 + 0x525e5e]               # 004C2FE1
    sar eax, 0xa                                         # 004C2FE9
    mov dword ptr [0x112c826], eax                       # 004C2FEC
    mov ecx, 0x112c826                                   # 004C2FF1
...
.L4C301D:
    ...
    mov ebx, dword ptr [ebx*4 + 0x50c914]                # 004C3048
...
.L4C3054:
    ...
    je .L4C306C                                          # 004C3060
    mov ebx, dword ptr [ebx*4 + 0x50c984]                # 004C3062
...
.L4C3074:
    ...
    mov ebx, dword ptr [ebx*4 + 0x50c8f4]                # 004C308F
...
.L4C30A3:
    ...
    mov ebx, dword ptr [ebx*4 + 0x50c974]                # 004C30A8
...
.L4C30BC:
    ...
    mov eax, dword ptr [eax*4 + 0x50c8f4]                # 004C30CF
    mov ax, word ptr [eax]                               # 004C30D6
    mov word ptr [0x112c826], ax                         # 004C30D9
    mov eax, 0x4eb                                       # 004C30DF
    mov ecx, 0x112c826                                   # 004C30E4
...
.L4C3117:
    ...
    mov ecx, dword ptr [ecx*4 + 0x50c8f4]                # 004C314E
    mov ax, word ptr [ecx]                               # 004C3155
    mov word ptr [0x112c828], ax                         # 004C3158
    mov ax, word ptr [ebx + 0xdc]                        # 004C315E
    mov word ptr [0x112c826], ax                         # 004C3165
    mov ecx, 0x112c826                                   # 004C316B
...
.L4C317B:
    ...
    mov dword ptr [0x112c828], eax                       # 004C3190
    mov esi, dword ptr [ebx + 0xe4]                      # 004C3195
    bsf ebx, esi                                         # 004C319B
    je .L4C321A                                          # 004C319E
    btr esi, ebx                                         # 004C31A0
    push esi                                             # 004C31A3
    mov ebx, dword ptr [ebx*4 + 0x50c700]                # 004C31A4
    mov dx, word ptr [ebx + 8]                           # 004C31AB
    cmp eax, 1                                           # 004C31AF
    je .L4C31B8                                          # 004C31B2
    mov dx, word ptr [ebx + 0xa]                         # 004C31B4
.L4C31B8:
    mov word ptr [0x112c826], dx                         # 004C31B8
    mov ecx, 0x112c826                                   # 004C31BF
...
.L4C31E9:
    push esi                                             # 004C31E9
    mov ebx, dword ptr [ebx*4 + 0x50c700]                # 004C31EA
    mov dx, word ptr [ebx]                               # 004C31F1
    mov word ptr [0x112c826], dx                         # 004C31F4
    mov ecx, 0x112c826                                   # 004C31FB
...
.L4C3230:
    ...
    mov dword ptr [0x112c828], eax                       # 004C3245
    mov esi, dword ptr [ebx + 0xe8]                      # 004C324A
    bsf ebx, esi                                         # 004C3250
    je .L4C32D4                                          # 004C3253
    btr esi, ebx                                         # 004C3255
    push esi                                             # 004C3258
    mov ebx, dword ptr [ebx*4 + 0x50c700]                # 004C3259
    mov dx, word ptr [ebx + 8]                           # 004C3260
    cmp eax, 1                                           # 004C3264
    je .L4C326D                                          # 004C3267
    mov dx, word ptr [ebx + 0xa]                         # 004C3269
.L4C326D:
    mov word ptr [0x112c826], dx                         # 004C326D
    mov ecx, 0x112c826                                   # 004C3274
...
.L4C32A3:
    push esi                                             # 004C32A3
    mov ebx, dword ptr [ebx*4 + 0x50c700]                # 004C32A4
    mov dx, word ptr [ebx]                               # 004C32AB
    mov word ptr [0x112c826], dx                         # 004C32AE
    mov ecx, 0x112c826                                   # 004C32B5
...
.L4C32D5:
    ...
    pop edi                                              # 004C32D6
    push esi                                             # 004C32D7
    mov cx, word ptr [0x5232f4]                          # 004C32D8
    mov dx, word ptr [0x523308]                          # 004C32DF
...
_sub_4C3307:
    ...
    movzx ebp, byte ptr [ebp*8 + 0x1136ba4]              # 004C3318
...
.L4C33C8:
    ...
    movzx ebx, byte ptr [0x525e3c]                       # 004C33E3
    ...
    push ebp                                             # 004C33F6
    push esi                                             # 004C33F7
    mov ebp, dword ptr [ebp*4 + 0x50c9e4]                # 004C33F8
    mov ax, word ptr [ebp]                               # 004C33FF
    mov word ptr [0x112c826], ax                         # 004C3403
...
.L4C343D:
    ...
    movzx ebp, byte ptr [ebp*8 + 0x1136ba0]              # 004C3444
    ...
    movzx ebx, byte ptr [0x525e3c]                       # 004C3471
    movzx eax, word ptr [0x52622e]                       # 004C3478
    ...
    mov ebp, dword ptr [ebp*4 + 0x50c9e4]                # 004C349D
    push edi                                             # 004C34A4
    movzx eax, word ptr [ebp]                            # 004C34A5
    mov edi, 0x512813                                    # 004C34A9
    push ebp                                             # 004C34AE
...
.L4C34C1:
    ...
    mov ebx, dword ptr [ebx*4 + 0x50c700]                # 004C34C9
...
.L4C350F:
    ret                                                  # 004C350F
.L4C3510:
    mov ebp, dword ptr [0x11364e8]                       # 004C3510
    mov bx, 0x4e0                                        # 004C3516
    cmp ebp, -1                                          # 004C351A
    je .L4C3541                                          # 004C351D
    movzx ebp, bp                                        # 004C351F
    shl ebp, 7                                           # 004C3522
    add ebp, 0x6db6dc                                    # 004C3525
    inc bx                                               # 004C352B
    mov ax, word ptr [ebp + 0x44]                        # 004C352D
    mov word ptr [0x112c828], ax                         # 004C3531
    mov ax, word ptr [ebp + 0x22]                        # 004C3537
    mov word ptr [0x112c826], ax                         # 004C353B
.L4C3541:
    mov esi, 0x112c826                                   # 004C3541
    mov cx, 3                                            # 004C3546
    mov bp, word ptr [0x5232f4]                          # 004C354A
    mov dx, word ptr [esi + 0x83e]                       # 004C3551
    sub dx, 0xa                                          # 004C3558
    shr dx, 1                                            # 004C355C
    sub bp, word ptr [0x5232f2]                          # 004C355F
...
.L4C35C8:
    ...
    mov ax, word ptr [edx*2 + 0x504458]                  # 004C35D6
    mov word ptr [esi + 0x83e], ax                       # 004C35DE
    mov word ptr [esi + 0x872], 0                        # 004C35E5
    cmp dl, byte ptr [0x52622c]                          # 004C35EE
    je .L4C3609                                          # 004C35F4
    mov byte ptr [0x52622c], dl                          # 004C35F6
    pushal                                               # 004C35FC
    mov al, 1                                            # 004C35FD
    mov bx, 0                                            # 004C35FF
...
_sub_4C36A7:
    ...
    mov cl, byte ptr [edx + 0x11364f0]                   # 004C36C2
    call _sub_4A3A06                                     # 004C36C8
    mov dword ptr [0x11364e8], 0xffffffff                # 004C36CD
...
_sub_4C370C:
    ...
    jb .L4C3722                                          # 004C3716
.L4C3718:
    mov word ptr [0x112c826], 0xc8                       # 004C3718
    ret                                                  # 004C3721
.L4C3722:
    movzx edx, ax                                        # 004C3722
    sub edx, 0xa                                         # 004C3725
    movzx edx, byte ptr [edx + 0x11364f0]                # 004C3728
    cmp dl, 0xff                                         # 004C372F
    je .L4C375E                                          # 004C3732
    btr edx, 7                                           # 004C3734
    jb .L4C374C                                          # 004C3738
    mov edx, dword ptr [edx*4 + 0x50c914]                # 004C373A
    mov dx, word ptr [edx]                               # 004C3741
    mov word ptr [0x112c826], dx                         # 004C3744
    ret                                                  # 004C374B
.L4C374C:
    mov edx, dword ptr [edx*4 + 0x50c984]                # 004C374C
    mov dx, word ptr [edx]                               # 004C3753
    mov word ptr [0x112c826], dx                         # 004C3756
    ret                                                  # 004C375D
.L4C375E:
    mov word ptr [0x112c826], 0x612                      # 004C375E
    cmp word ptr [esi + 0x870], 4                        # 004C3767
    je .L4C377A                                          # 004C376F
    mov word ptr [0x112c826], 0x613                      # 004C3771
.L4C377A:
    ret                                                  # 004C377A
...
_sub_4C384B:
    ...
    push esi                                             # 004C3894
    mov edi, dword ptr [edx*4 + 0x50c9e4]                # 004C3895
    mov di, word ptr [edi]                               # 004C389C
    mov word ptr [0x112c830], di                         # 004C389F
    mov word ptr [0x9c68e8], 0x4a1                       # 004C38A6
    mov edi, dword ptr [0x11364e8]                       # 004C38AF
    cmp di, -1                                           # 004C38B5
    je .L4C38E4                                          # 004C38B9
    movzx eax, di                                        # 004C38BB
    shl eax, 7                                           # 004C38BE
    add eax, 0x6db6dc                                    # 004C38C1
    mov cx, word ptr [eax + 0x44]                        # 004C38C6
    mov ax, word ptr [eax + 0x22]                        # 004C38CA
    mov word ptr [0x112c832], ax                         # 004C38CE
    mov word ptr [0x112c834], cx                         # 004C38D4
    mov word ptr [0x9c68e8], 0x4a0                       # 004C38DB
.L4C38E4:
    mov bl, 1                                            # 004C38E4
    mov esi, 5                                           # 004C38E6
    ...
    cmp dword ptr [0x11364e8], -1                        # 004C38FD
    jne .L4C391D                                         # 004C3904
    push esi                                             # 004C3906
    movzx edx, word ptr [0x113642a]                      # 004C3907
    shl edx, 7                                           # 004C390E
    add edx, 0x6db6dc                                    # 004C3911
...
_sub_4C3929:
    ...
    mov eax, dword ptr [0x11364ec]                       # 004C392E
...
.L4C39D8:
    ...
    mov ebp, dword ptr [edx*4 + 0x50c9e4]                # 004C39E9
    cmp ebp, -1                                          # 004C39F0
    je .L4C39FE                                          # 004C39F3
...
.L4C3A0E:
    ...
    sub eax, 0x531784                                    # 004C3A1E
    msvc_xor edx, edx                                    # 004C3A23
    mov ebx, 0x8fa8                                      # 004C3A25
    div ebx                                              # 004C3A2A
    msvc_mov ebp, eax                                    # 004C3A2C
    mov ax, word ptr [0x525e32]                          # 004C3A2E
    msvc_xor edx, edx                                    # 004C3A34
.L4C3A36:
    mov edi, dword ptr [edx*4 + 0x50c9e4]                # 004C3A36
    cmp edi, -1                                          # 004C3A3D
    je .L4C3A8F                                          # 004C3A40
    ...
    mov cx, word ptr [0x526248]                          # 004C3A54
    msvc_mov bx, bp                                      # 004C3A5B
    cmp bl, byte ptr [0x525e3c]                          # 004C3A5E
    je .L4C3A75                                          # 004C3A64
    cmp bl, byte ptr [0x525e3d]                          # 004C3A66
    je .L4C3A75                                          # 004C3A6C
    mov cx, word ptr [0x52624a]                          # 004C3A6E
.L4C3A75:
...
.L4C3AA0:
    mov edi, dword ptr [edx*4 + 0x50c9e4]                # 004C3AA0
    cmp edi, -1                                          # 004C3AA7
    je .L4C3B8E                                          # 004C3AAA
    mov ax, word ptr [edi + 0x114]                       # 004C3AB0
    cmp ax, word ptr [0x525e32]                          # 004C3AB7
    jne .L4C3B55                                         # 004C3ABE
    mov esi, 0x531784                                    # 004C3AC4
    msvc_xor bl, bl                                      # 004C3AC9
.L4C3ACB:
    cmp word ptr [esi], 0                                # 004C3ACB
    je .L4C3B44                                          # 004C3ACF
    mov ax, word ptr [0x526248]                          # 004C3AD1
    cmp bl, byte ptr [0x525e3c]                          # 004C3AD7
    je .L4C3AED                                          # 004C3ADD
    cmp bl, byte ptr [0x525e3d]                          # 004C3ADF
    je .L4C3AED                                          # 004C3AE5
    mov ax, word ptr [0x52624a]                          # 004C3AE7
.L4C3AED:
    ...
    pop edx                                              # 004C3B12
    pop ebx                                              # 004C3B13
    cmp bl, byte ptr [0x525e3c]                          # 004C3B14
    jne .L4C3B44                                         # 004C3B1A
    pushal                                               # 004C3B1C
    mov ebx, dword ptr [edx*4 + 0x50c9e4]                # 004C3B1D
...
.L4C3B55:
    ...
    cmp ax, word ptr [0x525e32]                          # 004C3B5C
    jne .L4C3B8E                                         # 004C3B63
    mov esi, 0x531784                                    # 004C3B65
...
.L4C3C52:
    ...
    .global _sub_4C3C54
_sub_4C3C54:
    mov si, word ptr [0x525e42]                          # 004C3C54
.L4C3C5B:
    cmp si, -1                                           # 004C3C5B
    je .L4C3D7A                                          # 004C3C5F
    movzx esi, si                                        # 004C3C65
    shl esi, 7                                           # 004C3C68
    add esi, 0x6db6dc                                    # 004C3C6B
...
.L4C3CDA:
    ...
    shl ebp, 7                                           # 004C3CDE
    add ebp, 0x6db6dc                                    # 004C3CE1
    movzx ebp, word ptr [ebp + 0x3a]                     # 004C3CE7
    shl ebp, 7                                           # 004C3CEB
    add ebp, 0x6db6dc                                    # 004C3CEE
    movzx ebp, word ptr [ebp + 0x3a]                     # 004C3CF4
    shl ebp, 7                                           # 004C3CF8
    add ebp, 0x6db6dc                                    # 004C3CFB
