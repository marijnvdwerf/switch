...
.text
    ...
    .global _sub_426790
_sub_426790:
    mov eax, dword ptr [eax*4 + _vehicleObjects]         # 00426790
...
_sub_4267BE:
    ...
    mov ax, word ptr [esi + _stations+948]               # 004267CE
    mov cx, word ptr [esi + _stations+950]               # 004267D5
    mov word ptr [__9C68E0], ax                          # 004267DC
    mov word ptr [__9C68E2], cx                          # 004267E2
    mov ax, word ptr [esi + _stations+952]               # 004267E9
    mov word ptr [__9C68E4], ax                          # 004267F0
    movzx esi, di                                        # 004267F6
    shl esi, 7                                           # 004267F9
    add_offset esi, _things                              # 004267FC
    push eax                                             # 00426802
    push esi                                             # 00426803
    ...
    shl esi, 7                                           # 00426831
    add_offset esi, _things                              # 00426834
    movzx esi, word ptr [esi + 0x3a]                     # 0042683A
    shl esi, 7                                           # 0042683E
    add_offset esi, _things                              # 00426841
    movzx esi, word ptr [esi + 0x3a]                     # 00426847
    shl esi, 7                                           # 0042684B
    add_offset esi, _things                              # 0042684E
    cmp byte ptr [esi + 1], 6                            # 00426854
    pop esi                                              # 00426858
    je .L426B0F                                          # 00426859
.L42685F:
    mov byte ptr [__113623A], bl                         # 0042685F
    shr ebx, 0x10                                        # 00426865
    mov word ptr [__525BDC], bp                          # 00426868
    mov byte ptr [__525BDE], dl                          # 0042686F
    cmp bx, -1                                           # 00426875
    je .L426AB1                                          # 00426879
    movzx ebp, word ptr [__525BDC]                       # 0042687F
    imul ebp, ebp, 0x3d2                                 # 00426886
    mov ax, word ptr [ebp + _stations+948]               # 0042688C
    mov cx, word ptr [ebp + _stations+950]               # 00426893
    mov dx, word ptr [ebp + _stations+952]               # 0042689A
    shr dx, 2                                            # 004268A1
    movzx edi, cx                                        # 004268A5
    shl edi, 9                                           # 004268A8
    msvc_or di, ax                                       # 004268AB
    shr edi, 3                                           # 004268AE
    mov edi, dword ptr [edi + __E40134]                  # 004268B1
.L4268B7:
...
.L4268C9:
    ...
    mov byte ptr [__525BDF], al                          # 004268D8
    movzx edi, al                                        # 004268DD
    mov edi, dword ptr [edi*4 + _airportObjects]         # 004268E0
    mov edi, dword ptr [edi + 0xb2]                      # 004268E7
    movzx edx, byte ptr [__525BDE]                       # 004268ED
...
.L426901:
    ...
    test dword ptr [ebp + _stations+954], eax            # 00426904
    jne .L426B1A                                         # 0042690A
    push edi                                             # 00426910
    movzx edi, byte ptr [__525BDF]                       # 00426911
    mov edi, dword ptr [edi*4 + _airportObjects]         # 00426918
    mov eax, dword ptr [edi + 0xb6]                      # 0042691F
    pop edi                                              # 00426925
    test dword ptr [ebp + _stations+954], eax            # 00426926
    jne .L426B1A                                         # 0042692C
    mov byte ptr [__525BE0], bl                          # 00426932
    mov al, byte ptr [edi + 1]                           # 00426938
    mov byte ptr [__525BE1], al                          # 0042693B
    push esi                                             # 00426940
    mov al, byte ptr [ebp + _stations+40]                # 00426941
    ...
    shl esi, 7                                           # 0042695D
    add_offset esi, _things                              # 00426960
    movzx esi, word ptr [esi + 0x3a]                     # 00426966
    shl esi, 7                                           # 0042696A
    add_offset esi, _things                              # 0042696D
    movzx esi, word ptr [esi + 0x3a]                     # 00426973
    shl esi, 7                                           # 00426977
    add_offset esi, _things                              # 0042697A
    movzx eax, word ptr [esi + 0x40]                     # 00426980
    call _sub_426790                                     # 00426984
    movzx esi, byte ptr [__525BDF]                       # 00426989
    mov esi, dword ptr [esi*4 + _airportObjects]         # 00426990
    test word ptr [esi + 0x10], ax                       # 00426997
    pop esi                                              # 0042699B
    je .L426B04                                          # 0042699C
    test byte ptr [__113623A], 1                         # 004269A2
    je .L426B01                                          # 004269A9
    movzx eax, word ptr [__525BDC]                       # 004269AF
    movzx ebx, byte ptr [__525BDE]                       # 004269B6
    call _sub_426D52                                     # 004269BD
    push eax                                             # 004269C2
    push ecx                                             # 004269C3
    push edx                                             # 004269C4
    movzx eax, word ptr [__525BDC]                       # 004269C5
    movzx ebx, byte ptr [__525BE1]                       # 004269CC
    ...
    shl edi, 7                                           # 004269F5
    add_offset edi, _things                              # 004269F8
    movzx edi, word ptr [edi + 0x3a]                     # 004269FE
    shl edi, 7                                           # 00426A02
    add_offset edi, _things                              # 00426A05
    movzx edi, word ptr [edi + 0x3a]                     # 00426A0B
    shl edi, 7                                           # 00426A0F
    add_offset edi, _things                              # 00426A12
    movzx edi, word ptr [edi + 0x40]                     # 00426A18
    mov edi, dword ptr [edi*4 + _vehicleObjects]         # 00426A1C
...
.L426A98:
    ...
    shl edi, 7                                           # 00426AA6
    add_offset edi, _things                              # 00426AA9
...
.L426AB3:
    ...
    shl edi, 7                                           # 00426ACA
    add_offset edi, _things                              # 00426ACD
    jmp .L426AB3                                         # 00426AD3
.L426AD5:
    test byte ptr [__113623A], 1                         # 00426AD5
    je .L426B01                                          # 00426ADC
    test byte ptr [__113623A], 0x40                      # 00426ADE
    jne .L426B01                                         # 00426AE5
    mov cx, word ptr [__9C68E0]                          # 00426AE7
    mov dx, word ptr [__9C68E2]                          # 00426AEE
    mov bp, word ptr [__9C68E4]                          # 00426AF5
    call _sub_48B11D                                     # 00426AFC
.L426B01:
    msvc_xor ebx, ebx                                    # 00426B01
    ret                                                  # 00426B03
.L426B04:
    mov word ptr [__9C68E6], 0x702                       # 00426B04
    jmp .L426B23                                         # 00426B0D
.L426B0F:
    mov word ptr [__9C68E6], 0                           # 00426B0F
    jmp .L426B23                                         # 00426B18
.L426B1A:
    mov word ptr [__9C68E6], 0x48a                       # 00426B1A
.L426B23:
    ...
    .global _sub_426B29
_sub_426B29:
    mov byte ptr [__9C68EA], 0x24                        # 00426B29
    movzx esi, di                                        # 00426B30
    shl esi, 7                                           # 00426B33
    add_offset esi, _things                              # 00426B36
    movzx edi, word ptr [esi + 0x3a]                     # 00426B3C
    shl edi, 7                                           # 00426B40
    add_offset edi, _things                              # 00426B43
    movzx edi, word ptr [edi + 0x3a]                     # 00426B49
    shl edi, 7                                           # 00426B4D
    add_offset edi, _things                              # 00426B50
    mov ax, word ptr [edi + 0xe]                         # 00426B56
    mov word ptr [__9C68E0], ax                          # 00426B5A
    mov ax, word ptr [edi + 0x10]                        # 00426B60
    mov word ptr [__9C68E2], ax                          # 00426B64
    mov ax, word ptr [edi + 0x12]                        # 00426B6A
    mov word ptr [__9C68E4], ax                          # 00426B6E
    ...
    pushal                                               # 00426BA9
    mov cx, word ptr [__9C68E0]                          # 00426BAA
    mov dx, word ptr [__9C68E2]                          # 00426BB1
    mov bp, word ptr [__9C68E4]                          # 00426BB8
...
.L426BC6:
    ...
    shl esi, 7                                           # 00426BED
    add_offset esi, _things                              # 00426BF0
...
.L426BF8:
    ...
    btr dword ptr [edi + _stations+954], eax             # 00426C0D
.L426C14:
...
.L426C20:
    ...
    shl edi, 7                                           # 00426C2E
    add_offset edi, _things                              # 00426C31
...
.L426C39:
    ...
    shl esi, 7                                           # 00426C43
    add_offset esi, _things                              # 00426C46
    movzx esi, word ptr [esi + 0x3a]                     # 00426C4C
    shl esi, 7                                           # 00426C50
    add_offset esi, _things                              # 00426C53
    movzx esi, word ptr [esi + 0x3a]                     # 00426C59
    shl esi, 7                                           # 00426C5D
    add_offset esi, _things                              # 00426C60
.L426C66:
    ...
    shl esi, 7                                           # 00426C75
    add_offset esi, _things                              # 00426C78
    movzx esi, word ptr [esi + 0x3a]                     # 00426C7E
    shl esi, 7                                           # 00426C82
    add_offset esi, _things                              # 00426C85
    movzx esi, word ptr [esi + 0x3a]                     # 00426C8B
    shl esi, 7                                           # 00426C8F
    add_offset esi, _things                              # 00426C92
...
.L426D03:
    ...
    shl esi, 7                                           # 00426D1F
    add_offset esi, _things                              # 00426D22
    movzx esi, word ptr [esi + 0x3a]                     # 00426D28
    shl esi, 7                                           # 00426D2C
    add_offset esi, _things                              # 00426D2F
...
_sub_426D52:
    ...
    mov bp, word ptr [eax + _stations+948]               # 00426D5A
    mov cx, word ptr [eax + _stations+950]               # 00426D61
    mov dx, word ptr [eax + _stations+952]               # 00426D68
    shr dx, 2                                            # 00426D6F
    movzx edi, cx                                        # 00426D73
    shl edi, 9                                           # 00426D76
    msvc_or di, bp                                       # 00426D79
    shr edi, 3                                           # 00426D7C
    mov edi, dword ptr [edi + __E40134]                  # 00426D7F
...
.L426D99:
    ...
    and edx, 3                                           # 00426DA1
    mov edi, dword ptr [eax*4 + _airportObjects]         # 00426DA4
    ...
    jmp dword ptr [edx*4 + __4F8AA8]                     # 00426DC3
    .global _loc_426DCA
_loc_426DCA:
    xchg ax, cx                                          # 00426DCA
    neg cx                                               # 00426DCC
    jmp _loc_426DDE                                      # 00426DCF
    .global _loc_426DD1
_loc_426DD1:
    neg ax                                               # 00426DD1
    neg cx                                               # 00426DD4
    jmp _loc_426DDE                                      # 00426DD7
    .global _loc_426DD9
_loc_426DD9:
    xchg ax, cx                                          # 00426DD9
    neg ax                                               # 00426DDB
...
_loc_426DDE:
    ...
    add ax, word ptr [ebp + _stations+948]               # 00426DE6
    add cx, word ptr [ebp + _stations+950]               # 00426DED
    mov dx, word ptr [ebp + _stations+952]               # 00426DF4
    add dx, word ptr [ebx + 4]                           # 00426DFB
    movzx ebx, word ptr [ebx + 6]                        # 00426DFF
    test ebx, 8                                          # 00426E03
    jne .L426E23                                         # 00426E09
    mov dx, word ptr [ebp + _stations+952]               # 00426E0B
...
_sub_426E26:
    ...
    mov bp, word ptr [eax + _stations+948]               # 00426E2E
    mov cx, word ptr [eax + _stations+950]               # 00426E35
    mov dx, word ptr [eax + _stations+952]               # 00426E3C
    shr dx, 2                                            # 00426E43
    movzx edi, cx                                        # 00426E47
    shl edi, 9                                           # 00426E4A
    msvc_or di, bp                                       # 00426E4D
    shr edi, 3                                           # 00426E50
    mov edi, dword ptr [edi + __E40134]                  # 00426E53
...
.L426E6D:
    ...
    and edx, 3                                           # 00426E75
    mov edi, dword ptr [eax*4 + _airportObjects]         # 00426E78
    ...
    jmp dword ptr [edx*4 + __4F8AB8]                     # 00426EA6
    .global _loc_426EAD
_loc_426EAD:
    xchg ax, cx                                          # 00426EAD
    neg cx                                               # 00426EAF
    jmp _loc_426EC1                                      # 00426EB2
    .global _loc_426EB4
_loc_426EB4:
    neg ax                                               # 00426EB4
    neg cx                                               # 00426EB7
    jmp _loc_426EC1                                      # 00426EBA
    .global _loc_426EBC
_loc_426EBC:
    xchg ax, cx                                          # 00426EBC
    neg ax                                               # 00426EBE
...
_loc_426EC1:
    ...
    add ax, word ptr [ebp + _stations+948]               # 00426EC9
    add cx, word ptr [ebp + _stations+950]               # 00426ED0
    mov dx, word ptr [ebp + _stations+952]               # 00426ED7
    add dx, word ptr [ebx + 4]                           # 00426EDE
    movzx ebx, word ptr [ebx + 6]                        # 00426EE2
    test ebx, 8                                          # 00426EE6
    jne .L426F06                                         # 00426EEC
    mov dx, word ptr [ebp + _stations+952]               # 00426EEE
...
.L426F06:
    ...
    .global _sub_426F0B
_sub_426F0B:
    mov word ptr [__113600C], ax                         # 00426F0B
    mov word ptr [__113600E], bx                         # 00426F11
    push esi                                             # 00426F18
    mov edx, 0xfffff7ff                                  # 00426F19
    call _sub_459E54                                     # 00426F1E
    cmp bl, 9                                            # 00426F23
    je .L426FFA                                          # 00426F26
    mov ax, word ptr [__113600C]                         # 00426F2C
    mov bx, word ptr [__113600E]                         # 00426F32
    mov edx, 0xfffffff6                                  # 00426F39
    call _sub_459E54                                     # 00426F3E
    cmp bl, 0                                            # 00426F43
    je .L42711F                                          # 00426F46
    msvc_xor ebp, ebp                                    # 00426F4C
    mov_offset esi, _stations                            # 00426F4E
.L426F53:
...
.L426FA9:
    ...
    shr edx, 3                                           # 00426FC2
    mov edx, dword ptr [edx + __E40134]                  # 00426FC5
...
.L427033:
    ...
    test ebx, 1                                          # 00427043
    je .L427103                                          # 00427049
    mov ebx, dword ptr [__E3F0B8]                        # 0042704F
    jmp dword ptr [ebx*4 + __4F8AC8]                     # 00427055
    .global _loc_42705C
_loc_42705C:
...
.L4270AA:
    ...
    mov edi, dword ptr [__1135F52]                       # 004270AD
    ...
    sub ax, word ptr [__113600C]                         # 004270CC
    jns .L4270D8                                         # 004270D3
    neg ax                                               # 004270D5
.L4270D8:
    sub bx, word ptr [__113600E]                         # 004270D8
    jns .L4270E4                                         # 004270DF
    neg bx                                               # 004270E1
.L4270E4:
    msvc_add ax, bx                                      # 004270E4
    pop ebx                                              # 004270E7
    cmp ax, word ptr [__1135FC6]                         # 004270E8
    jae .L4270FE                                         # 004270EF
    mov word ptr [__1135FC6], ax                         # 004270F1
    mov word ptr [__1135FC8], bx                         # 004270F7
.L4270FE:
    msvc_jmp .L427033                                    # 004270FE
.L427103:
    pop ebx                                              # 00427103
    msvc_jmp .L427033                                    # 00427104
.L427109:
    pop ebp                                              # 00427109
    cmp word ptr [__1135FC6], -1                         # 0042710A
    je .L42711F                                          # 00427112
    mov dx, word ptr [__1135FC8]                         # 00427114
    pop esi                                              # 0042711B
...
.L42711F:
    ...
    .global _sub_427122
_sub_427122:
    mov dword ptr [__525BB0], 0                          # 00427122
    ...
    mov bl, byte ptr [ebp + __987C5C]                    # 0042713E
    and ebx, 7                                           # 00427144
    cmp bl, 3                                            # 00427147
    je .L4271A0                                          # 0042714A
    test byte ptr [ebx + __4FE088], 8                    # 0042714C
    jne .L427157                                         # 00427153
    jmp .L4271A0                                         # 00427155
.L427157:
    movzx ebx, byte ptr [ebp + __987C5C+1]               # 00427157
    mov bh, byte ptr [ebp + __987C5C]                    # 0042715E
    shr bh, 6                                            # 00427164
.L427167:
    imul ebx, ebx, 0x3d2                                 # 00427167
    mov ax, word ptr [ebx + _stations+2]                 # 0042716D
    mov cx, word ptr [ebx + _stations+4]                 # 00427174
    test word ptr [ebx + _stations+42], 0x40             # 0042717B
    je .L427194                                          # 00427184
    mov ax, word ptr [ebx + _stations+948]               # 00427186
    mov cx, word ptr [ebx + _stations+950]               # 0042718D
.L427194:
...
.L4271B8:
    ...
    test word ptr [ebp + _stations+42], 0x40             # 004271CA
    je .L4271A0                                          # 004271D3
    movzx ebx, byte ptr [esi + 0x68]                     # 004271D5
    call _sub_426E26                                     # 004271D9
    mov dword ptr [__525BB0], ebx                        # 004271DE
.L4271E4:
    push eax                                             # 004271E4
    push ecx                                             # 004271E5
...
_sub_427214:
    ...
    mov ax, word ptr [ebp + _stations+948]               # 00427221
    mov cx, word ptr [ebp + _stations+950]               # 00427228
    mov dx, word ptr [ebp + _stations+952]               # 0042722F
    shr dx, 2                                            # 00427236
    movzx edi, cx                                        # 0042723A
    shl edi, 9                                           # 0042723D
    msvc_or di, ax                                       # 00427240
    shr edi, 3                                           # 00427243
    mov edi, dword ptr [edi + __E40134]                  # 00427246
.L42724C:
...
.L42725E:
    ...
    mov edi, dword ptr [eax*4 + _airportObjects]         # 00427264
    pop eax                                              # 0042726B
    cmp eax, -1                                          # 0042726C
    je .L42738D                                          # 0042726F
...
.L4272A5:
    ...
    shl ebx, 7                                           # 004272A9
    add_offset ebx, _things                              # 004272AC
    movzx ebx, word ptr [ebx + 0x3a]                     # 004272B2
    shl ebx, 7                                           # 004272B6
    add_offset ebx, _things                              # 004272B9
    movzx ebx, word ptr [ebx + 0x3a]                     # 004272BF
    shl ebx, 7                                           # 004272C3
    add_offset ebx, _things                              # 004272C6
    movzx ebx, word ptr [ebx + 0x40]                     # 004272CC
    mov ebx, dword ptr [ebx*4 + _vehicleObjects]         # 004272D0
...
.L4272EA:
    ...
    test dword ptr [ebp + _stations+954], edx            # 00427307
    jne .L427321                                         # 0042730D
    mov edx, dword ptr [ebx + 8]                         # 0042730F
    msvc_or edx, edx                                     # 00427312
    je .L427389                                          # 00427314
    and edx, dword ptr [ebp + _stations+954]             # 00427316
...
.L42733F:
    ...
    test dword ptr [ebp + _stations+954], edx            # 0042735C
    jne .L427376                                         # 00427362
    mov edx, dword ptr [ebx + 8]                         # 00427364
    msvc_or edx, edx                                     # 00427367
    je .L427389                                          # 00427369
    and edx, dword ptr [ebp + _stations+954]             # 0042736B
...
.L427395:
    ...
    test dword ptr [ebp + _stations+954], edx            # 004273AD
    jne .L4273C7                                         # 004273B3
    mov edx, dword ptr [ebx + 8]                         # 004273B5
    msvc_or edx, edx                                     # 004273B8
    je .L4273DA                                          # 004273BA
    and edx, dword ptr [ebp + _stations+954]             # 004273BC
...
_sub_4273DF:
    ...
    mov ax, word ptr [ebp + _stations+948]               # 00427400
    mov cx, word ptr [ebp + _stations+950]               # 00427407
    mov dx, word ptr [ebp + _stations+952]               # 0042740E
    shr dx, 2                                            # 00427415
    movzx edi, cx                                        # 00427419
    shl edi, 9                                           # 0042741C
    msvc_or di, ax                                       # 0042741F
    shr edi, 3                                           # 00427422
    mov edi, dword ptr [edi + __E40134]                  # 00427425
.L42742B:
...
.L42743D:
    ...
    mov edi, dword ptr [eax*4 + _airportObjects]         # 00427443
    ...
    shl edx, 7                                           # 0042745D
    add_offset edx, _things                              # 00427460
    movzx edx, word ptr [edx + 0x3a]                     # 00427466
    shl edx, 7                                           # 0042746A
    add_offset edx, _things                              # 0042746D
...
.L4274E0:
    ...
    shl edx, 7                                           # 004274E4
    add_offset edx, _things                              # 004274E7
    movzx edx, word ptr [edx + 0x3a]                     # 004274ED
    shl edx, 7                                           # 004274F1
    add_offset edx, _things                              # 004274F4
    mov eax, 2                                           # 004274FA
...
.L42750D:
    ...
    .global _sub_42750E
_sub_42750E:
    mov edi, dword ptr [__1136120]                       # 0042750E
    movzx edi, word ptr [edi + 0x3a]                     # 00427514
    shl edi, 7                                           # 00427518
    add_offset edi, _things                              # 0042751B
    movzx ebp, word ptr [edi + 0x40]                     # 00427521
    mov ebp, dword ptr [ebp*4 + _vehicleObjects]         # 00427525
    cmp byte ptr [ebp + 0x15a], 0                        # 0042752C
    je .L427594                                          # 00427533
    mov eax, dword ptr [_scenarioChunk3]                 # 00427535
    mov ebx, dword ptr [_scenarioChunk3+4]               # 0042753A
    ror eax, 3                                           # 00427540
    xor ebx, 0x1234567f                                  # 00427543
    mov dword ptr [_scenarioChunk3+4], eax               # 00427549
    ror ebx, 7                                           # 0042754E
    add dword ptr [_scenarioChunk3], ebx                 # 00427551
    ...
    mov edi, dword ptr [__1136120]                       # 00427572
...
.L427594:
    ...
    .global _sub_427595
_sub_427595:
    mov word ptr [__113600C], ax                         # 00427595
    mov word ptr [__113600E], bx                         # 0042759B
    push esi                                             # 004275A2
    call _sub_460781                                     # 004275A3
    cmp ax, 0x8000                                       # 004275A8
    je .L427739                                          # 004275AC
    msvc_mov cx, bx                                      # 004275B2
    mov word ptr [__525BB4], ax                          # 004275B5
    mov word ptr [__525BB6], cx                          # 004275BB
    add word ptr [__525BB4], 0x10                        # 004275C2
    add word ptr [__525BB6], 0x10                        # 004275CA
    sub ax, 0x80                                         # 004275D2
    sub cx, 0x80                                         # 004275D6
    mov bx, 0x909                                        # 004275DB
    mov word ptr [__525BB8], 0xffff                      # 004275DF
.L4275E8:
...
.L427612:
    ...
    jmp dword ptr [edx*4 + __4F8AD8]                     # 0042767E
    .global _loc_427685
_loc_427685:
    msvc_xchg di, bx                                     # 00427685
    neg di                                               # 00427688
    jmp _loc_42769B                                      # 0042768B
    .global _loc_42768D
_loc_42768D:
    neg bx                                               # 0042768D
    neg di                                               # 00427690
    jmp _loc_42769B                                      # 00427693
    .global _loc_427695
_loc_427695:
...
_loc_42769B:
    ...
    sub ax, word ptr [__525BB4]                          # 004276A1
    jae .L4276AD                                         # 004276A8
    neg ax                                               # 004276AA
.L4276AD:
    sub cx, word ptr [__525BB6]                          # 004276AD
...
.L4276B9:
    ...
    pop edi                                              # 004276BC
    pop ebx                                              # 004276BD
    cmp ax, word ptr [__525BB8]                          # 004276BE
    jae .L4276EA                                         # 004276C5
    mov word ptr [__525BB8], ax                          # 004276C7
    mov ax, word ptr [esp + 4]                           # 004276CD
    mov cx, word ptr [esp]                               # 004276D2
    mov word ptr [__525BBA], ax                          # 004276D6
    mov word ptr [__525BBC], cx                          # 004276DC
    mov word ptr [__525BBE], di                          # 004276E3
.L4276EA:
    pop ecx                                              # 004276EA
    pop eax                                              # 004276EB
.L4276EC:
...
.L4276F9:
    ...
    dec bl                                               # 004276FD
    jne .L4275E8                                         # 004276FF
    sub ax, 0x120                                        # 00427705
    mov bl, 9                                            # 00427709
    add cx, 0x20                                         # 0042770B
    dec bh                                               # 0042770F
    jne .L4275E8                                         # 00427711
    cmp word ptr [__525BB8], -1                          # 00427717
    je .L427739                                          # 0042771F
    mov ax, word ptr [__525BBA]                          # 00427721
    mov cx, word ptr [__525BBC]                          # 00427727
    mov di, word ptr [__525BBE]                          # 0042772E
    pop esi                                              # 00427735
...
_sub_42773C:
    ...
    mov word ptr [__9C68E4], dx                          # 00427750
    add word ptr [__9C68E0], 0x20                        # 00427757
    add word ptr [__9C68E2], 0x20                        # 0042775F
    movzx esi, di                                        # 00427767
    shl esi, 7                                           # 0042776A
    add_offset esi, _things                              # 0042776D
    push eax                                             # 00427773
    push esi                                             # 00427774
    ...
    jne .L4279B2                                         # 00427797
    push esi                                             # 0042779D
    movzx esi, word ptr [esi + 0x3a]                     # 0042779E
    shl esi, 7                                           # 004277A2
    add_offset esi, _things                              # 004277A5
    movzx esi, word ptr [esi + 0x3a]                     # 004277AB
    shl esi, 7                                           # 004277AF
    add_offset esi, _things                              # 004277B2
    movzx esi, word ptr [esi + 0x3a]                     # 004277B8
    shl esi, 7                                           # 004277BC
    add_offset esi, _things                              # 004277BF
    cmp byte ptr [esi + 1], 6                            # 004277C5
    pop esi                                              # 004277C9
    je .L4279B2                                          # 004277CA
.L4277D0:
    mov byte ptr [__113623A], bl                         # 004277D0
    shr ebx, 0x10                                        # 004277D6
    mov word ptr [__525BC0], ax                          # 004277D9
    mov word ptr [__525BC2], cx                          # 004277DF
    mov word ptr [__525BC4], dx                          # 004277E6
    shr dx, 2                                            # 004277ED
    movzx edi, cx                                        # 004277F1
    shl edi, 9                                           # 004277F4
    msvc_or di, ax                                       # 004277F7
    shr edi, 3                                           # 004277FA
    mov edi, dword ptr [edi + __E40134]                  # 004277FD
.L427803:
...
_loc_427889:
    ...
    .global _loc_42788E
_loc_42788E:
    add ax, word ptr [__525BC0]                          # 0042788E
    add cx, word ptr [__525BC2]                          # 00427895
    ...
    je .L4279A7                                          # 004278B4
    test byte ptr [__113623A], 1                         # 004278BA
    je .L4279A4                                          # 004278C1
    ...
    mov ax, word ptr [__525BC0]                          # 004278FD
    mov cx, word ptr [__525BC2]                          # 00427903
    mov word ptr [esi + 0x30], ax                        # 0042790A
    mov word ptr [esi + 0x32], cx                        # 0042790E
    mov ax, word ptr [__525BC4]                          # 00427912
    shr ax, 2                                            # 00427918
    mov byte ptr [esi + 0x34], al                        # 0042791C
    movzx edi, word ptr [esi + 0x3a]                     # 0042791F
    shl edi, 7                                           # 00427923
    add_offset edi, _things                              # 00427926
    or byte ptr [edi + 0x48], 4                          # 0042792C
    test byte ptr [__113623A], 0x40                      # 00427930
    je .L427978                                          # 00427937
...
.L42793B:
    ...
    shl edi, 7                                           # 00427949
    add_offset edi, _things                              # 0042794C
...
.L427956:
    ...
    shl edi, 7                                           # 0042796D
    add_offset edi, _things                              # 00427970
    jmp .L427956                                         # 00427976
.L427978:
    test byte ptr [__113623A], 1                         # 00427978
    je .L4279A4                                          # 0042797F
    test byte ptr [__113623A], 0x40                      # 00427981
    jne .L4279A4                                         # 00427988
    mov cx, word ptr [__9C68E0]                          # 0042798A
    mov dx, word ptr [__9C68E2]                          # 00427991
    mov bp, word ptr [__9C68E4]                          # 00427998
    call _sub_48B199                                     # 0042799F
.L4279A4:
    msvc_xor ebx, ebx                                    # 004279A4
    ret                                                  # 004279A6
.L4279A7:
    mov word ptr [__9C68E6], 0x5f9                       # 004279A7
    jmp .L4279C6                                         # 004279B0
.L4279B2:
    mov word ptr [__9C68E6], 0                           # 004279B2
    jmp .L4279C6                                         # 004279BB
.L4279BD:
    mov word ptr [__9C68E6], 0x48a                       # 004279BD
.L4279C6:
    ...
    .global _sub_4279CC
_sub_4279CC:
    mov byte ptr [__9C68EA], 0x2c                        # 004279CC
    movzx esi, di                                        # 004279D3
    shl esi, 7                                           # 004279D6
    add_offset esi, _things                              # 004279D9
    movzx edi, word ptr [esi + 0x3a]                     # 004279DF
    shl edi, 7                                           # 004279E3
    add_offset edi, _things                              # 004279E6
    movzx edi, word ptr [edi + 0x3a]                     # 004279EC
    shl edi, 7                                           # 004279F0
    add_offset edi, _things                              # 004279F3
    mov ax, word ptr [edi + 0xe]                         # 004279F9
    mov word ptr [__9C68E0], ax                          # 004279FD
    mov ax, word ptr [edi + 0x10]                        # 00427A03
    mov word ptr [__9C68E2], ax                          # 00427A07
    mov ax, word ptr [edi + 0x12]                        # 00427A0D
    mov word ptr [__9C68E4], ax                          # 00427A11
    ...
    pushal                                               # 00427A50
    mov cx, word ptr [__9C68E0]                          # 00427A51
    mov dx, word ptr [__9C68E2]                          # 00427A58
    mov bp, word ptr [__9C68E4]                          # 00427A5F
...
.L427A6C:
    ...
    shr edi, 3                                           # 00427A87
    mov edi, dword ptr [edi + __E40134]                  # 00427A8A
.L427A90:
...
.L427AB3:
    ...
    shl esi, 7                                           # 00427ADA
    add_offset esi, _things                              # 00427ADD
...
.L427AEC:
    ...
    shl edi, 7                                           # 00427AFA
    add_offset edi, _things                              # 00427AFD
...
.L427B05:
    ...
    shl esi, 7                                           # 00427B0F
    add_offset esi, _things                              # 00427B12
    movzx esi, word ptr [esi + 0x3a]                     # 00427B18
    shl esi, 7                                           # 00427B1C
    add_offset esi, _things                              # 00427B1F
    movzx esi, word ptr [esi + 0x3a]                     # 00427B25
    shl esi, 7                                           # 00427B29
    add_offset esi, _things                              # 00427B2C
.L427B32:
    ...
    shl esi, 7                                           # 00427B41
    add_offset esi, _things                              # 00427B44
    movzx esi, word ptr [esi + 0x3a]                     # 00427B4A
    shl esi, 7                                           # 00427B4E
    add_offset esi, _things                              # 00427B51
    movzx esi, word ptr [esi + 0x3a]                     # 00427B57
    shl esi, 7                                           # 00427B5B
    add_offset esi, _things                              # 00427B5E
...
_sub_427C05:
    push eax                                             # 00427C05
    mov edi, dword ptr [__1136120]                       # 00427C06
    ...
    shr edi, 3                                           # 00427C25
    mov edi, dword ptr [edi + __E40134]                  # 00427C28
...
.L427CCD:
    mov edi, dword ptr [__1136120]                       # 00427CCD
...
.L427D3E:
    ...
    mov bl, byte ptr [ebp + __987C5C]                    # 00427D52
    and ebx, 7                                           # 00427D58
    cmp bl, 3                                            # 00427D5B
    ...
    shl cl, 7                                            # 00427D77
    or al, 3                                             # 00427D7A
    cmp ax, word ptr [ebp + __987C5C]                    # 00427D7C
    jne .L427DC6                                         # 00427D83
    mov bp, word ptr [ebp + __987C5C+2]                  # 00427D85
    ...
    mov al, byte ptr [ecx + ebp + __987C5C]              # 00427D9C
    and eax, 7                                           # 00427DA3
    add ecx, dword ptr [eax*4 + __4FE070]                # 00427DA6
    cmp byte ptr [ecx + ebp + __987C5C], 0               # 00427DAD
...
.L427DDA:
    ...
    shr ebp, 3                                           # 00427DF5
    mov ebp, dword ptr [ebp + __E40134]                  # 00427DF8
.L427DFE:
...
.L427E21:
    ...
    shr ebp, 3                                           # 00427E54
    mov ebp, dword ptr [ebp + __E40134]                  # 00427E57
.L427E5D:
...
.L427E7A:
    mov edi, dword ptr [__1136120]                       # 00427E7A
...
.L427EB4:
    mov ebp, dword ptr [__1136120]                       # 00427EB4
    mov edi, dword ptr [__113611C]                       # 00427EBA
    ...
    movsx edx, word ptr [ebx*4 + __503B6A]               # 00427EDA
    movsx ebx, word ptr [ebx*4 + __503B6C]               # 00427EE2
    ...
    mov ebp, dword ptr [__1136120]                       # 00427F08
...
.L427F44:
    mov word ptr [__525BE8], ax                          # 00427F44
    mov word ptr [__525BEA], cx                          # 00427F4A
    msvc_xor bx, bx                                      # 00427F51
    msvc_xor ebp, ebp                                    # 00427F54
.L427F56:
    mov byte ptr [ebp + __525BEC], 0                     # 00427F56
    ...
    mov di, word ptr [edi*2 + __1025A8C]                 # 00427F72
.L427F7A:
    cmp di, -1                                           # 00427F7A
    je .L427FAA                                          # 00427F7E
    movzx edi, di                                        # 00427F80
    shl edi, 7                                           # 00427F83
    add_offset edi, _things                              # 00427F86
    ...
    mov byte ptr [ebp + __525BEC], 1                     # 00427F9D
.L427FA4:
...
_sub_427FC9:
    ...
    pop esi                                              # 00427FDF
    mov word ptr [__525BD6], 0xffff                      # 00427FE0
    movzx ebp, word ptr [esi + 0x4a]                     # 00427FE9
    add ebp, dword ptr [esi + 0x46]                      # 00427FED
    mov bl, byte ptr [ebp + __987C5C]                    # 00427FF0
    and ebx, 7                                           # 00427FF6
    cmp bl, 3                                            # 00427FF9
    je .L4280B6                                          # 00427FFC
    test byte ptr [ebx + __4FE088], 8                    # 00428002
    jne .L428010                                         # 00428009
    msvc_jmp .L428097                                    # 0042800B
.L428010:
    movzx ebx, byte ptr [ebp + __987C5C+1]               # 00428010
    mov bh, byte ptr [ebp + __987C5C]                    # 00428017
    shr bh, 6                                            # 0042801D
    push ebx                                             # 00428020
    ...
    cmp ax, -1                                           # 00428027
    je .L42806C                                          # 0042802B
    mov word ptr [__525BDA], bx                          # 0042802D
    mov word ptr [__525BD6], bp                          # 00428034
    mov word ptr [__525BD8], di                          # 0042803B
    mov byte ptr [__525BE4], dl                          # 00428042
    mov word ptr [__525BCA], ax                          # 00428048
    mov word ptr [__525BCC], cx                          # 0042804E
    and ax, 0xffe0                                       # 00428055
    and cx, 0xffe0                                       # 00428059
    mov word ptr [__525BC6], ax                          # 0042805D
    mov word ptr [__525BC8], cx                          # 00428063
    jmp .L4280E9                                         # 0042806A
.L42806C:
    imul ebx, ebx, 0x3d2                                 # 0042806C
    mov ax, word ptr [ebx + _stations+2]                 # 00428072
    mov cx, word ptr [ebx + _stations+4]                 # 00428079
    and ax, 0xffe0                                       # 00428080
    and cx, 0xffe0                                       # 00428084
    mov word ptr [__525BC6], ax                          # 00428088
    mov word ptr [__525BC8], cx                          # 0042808E
...
.L428097:
    ...
    mov word ptr [__525BC6], ax                          # 004280A7
    mov word ptr [__525BC8], cx                          # 004280AD
    jmp .L4280E9                                         # 004280B4
.L4280B6:
    mov al, byte ptr [ebp + __987C5C+1]                  # 004280B6
    mov cl, byte ptr [ebp + __987C5C+3]                  # 004280BC
    mov ah, byte ptr [ebp + __987C5C]                    # 004280C2
    mov ch, byte ptr [ebp + __987C5C+2]                  # 004280C8
    shr ah, 7                                            # 004280CE
    shr ch, 7                                            # 004280D1
    shl ax, 5                                            # 004280D4
    shl cx, 5                                            # 004280D8
    mov word ptr [__525BC6], ax                          # 004280DC
    mov word ptr [__525BC8], cx                          # 004280E2
.L4280E9:
    mov edi, dword ptr [__1136120]                       # 004280E9
    mov bl, byte ptr [edi + 0x1e]                        # 004280EF
    add bl, 7                                            # 004280F2
    shr bl, 4                                            # 004280F5
    and bl, 3                                            # 004280F8
    mov byte ptr [__525BE3], bl                          # 004280FB
    ...
    shr dx, 4                                            # 00428115
    mov byte ptr [__525BE2], 0xff                        # 00428119
    mov word ptr [__525BD2], 0xffff                      # 00428120
    mov word ptr [__525BD4], 0xffff                      # 00428129
    msvc_xor ebx, ebx                                    # 00428132
.L428134:
    push eax                                             # 00428134
    push ecx                                             # 00428135
    push esi                                             # 00428136
    add ax, word ptr [ebx*4 + __503C6C]                  # 00428137
    add cx, word ptr [ebx*4 + __503C6E]                  # 0042813F
    mov word ptr [__525BCE], 0xffff                      # 00428147
    msvc_xor ebp, ebp                                    # 00428150
    call _sub_428237                                     # 00428152
    mov ax, word ptr [__525BCE]                          # 00428157
    cmp ax, word ptr [__525BD2]                          # 0042815D
    ja .L4281A5                                          # 00428164
    jb .L428187                                          # 00428166
    cmp ax, -1                                           # 00428168
    je .L4281A5                                          # 0042816C
    mov ax, word ptr [__525BD0]                          # 0042816E
    cmp ax, word ptr [__525BD4]                          # 00428174
    ja .L4281A5                                          # 0042817B
    jb .L428187                                          # 0042817D
    cmp bl, byte ptr [__525BE3]                          # 0042817F
    jne .L4281A5                                         # 00428185
.L428187:
    mov byte ptr [__525BE2], bl                          # 00428187
    mov ax, word ptr [__525BCE]                          # 0042818D
    mov word ptr [__525BD2], ax                          # 00428193
    mov ax, word ptr [__525BD0]                          # 00428199
    mov word ptr [__525BD4], ax                          # 0042819F
.L4281A5:
    pop esi                                              # 004281A5
    pop ecx                                              # 004281A6
    pop eax                                              # 004281A7
    ...
    cmp ebx, 4                                           # 004281A9
    jb .L428134                                          # 004281AC
    cmp byte ptr [__525BE2], 0xff                        # 004281AE
    je .L428229                                          # 004281B5
    movzx ebx, byte ptr [__525BE2]                       # 004281B7
    cmp word ptr [__525BD2], 0                           # 004281BE
    jne .L42820B                                         # 004281C6
    cmp word ptr [__525BD4], 0                           # 004281C8
    jne .L42820B                                         # 004281D0
    cmp word ptr [__525BD6], -1                          # 004281D2
    je .L42820B                                          # 004281DA
    mov ax, word ptr [__525BCA]                          # 004281DC
    mov cx, word ptr [__525BCC]                          # 004281E2
    mov di, word ptr [__525BD6]                          # 004281E9
    mov bp, word ptr [__525BD8]                          # 004281F0
    movzx dx, byte ptr [__525BE4]                        # 004281F7
    shl dx, 2                                            # 004281FF
    movzx ebx, word ptr [__525BDA]                       # 00428203
    ret                                                  # 0042820A
.L42820B:
    add ax, word ptr [ebx*4 + __503C6C]                  # 0042820B
    add cx, word ptr [ebx*4 + __503C6E]                  # 00428213
...
_sub_428237:
    ...
    shr edi, 3                                           # 00428258
    mov edi, dword ptr [edi + __E40134]                  # 0042825B
...
.L428299:
    push eax                                             # 00428299
    push ecx                                             # 0042829A
    sub ax, word ptr [__525BE8]                          # 0042829B
    sub cx, word ptr [__525BEA]                          # 004282A2
    shr ax, 5                                            # 004282A9
    shr cx, 5                                            # 004282AD
    imul ax, ax, 0xf                                     # 004282B1
    msvc_add cx, ax                                      # 004282B5
    and ecx, 0xffff                                      # 004282B8
    cmp byte ptr [ecx + __525BEC], 0                     # 004282BE
    pop ecx                                              # 004282C5
    pop eax                                              # 004282C6
    jne .L428378                                         # 004282C7
    mov di, word ptr [__525BC6]                          # 004282CD
    mov si, word ptr [__525BC8]                          # 004282D4
...
.L4282F3:
    ...
    je .L428320                                          # 004282FA
    cmp di, word ptr [__525BCE]                          # 004282FC
    ja .L42834E                                          # 00428303
    jne .L428310                                         # 00428305
    cmp bp, word ptr [__525BD0]                          # 00428307
    jae .L42834E                                         # 0042830E
.L428310:
    mov word ptr [__525BCE], di                          # 00428310
    mov word ptr [__525BD0], bp                          # 00428317
    jmp .L42834E                                         # 0042831E
.L428320:
    cmp word ptr [__525BCE], 0                           # 00428320
    ja .L42833C                                          # 00428328
    cmp bp, word ptr [__525BD0]                          # 0042832A
    jae .L428378                                         # 00428331
    mov word ptr [__525BD0], bp                          # 00428333
    jmp .L428378                                         # 0042833A
.L42833C:
    mov word ptr [__525BCE], 0                           # 0042833C
    mov word ptr [__525BD0], bp                          # 00428345
...
.L428357:
    push eax                                             # 00428357
    push ecx                                             # 00428358
    add ax, word ptr [ebx*4 + __503C6C]                  # 00428359
    add cx, word ptr [ebx*4 + __503C6E]                  # 00428361
...
_sub_428379:
    ...
    lea ebp, [ebx + _stations+464]                       # 00428380
    msvc_xor edi, edi                                    # 00428386
.L428388:
    cmp di, word ptr [ebx + _stations+462]               # 00428388
    ...
    shr esi, 3                                           # 004283AD
    mov esi, dword ptr [esi + __E40134]                  # 004283B0
.L4283B6:
...
.L4283F3:
    ...
    mov ebx, dword ptr [ebx*4 + _dockObjects]            # 004283FF
    mov ax, word ptr [ebx + 0x24]                        # 00428406
    mov cx, word ptr [ebx + 0x26]                        # 0042840A
    mov bl, byte ptr [esi]                               # 0042840E
    and ebx, 3                                           # 00428410
    jmp dword ptr [ebx*4 + __4F8AF8]                     # 00428413
    .global _loc_42841A
_loc_42841A:
    xchg ax, cx                                          # 0042841A
    neg cx                                               # 0042841C
    jmp _loc_42842E                                      # 0042841F
    .global _loc_428421
_loc_428421:
    neg ax                                               # 00428421
    neg cx                                               # 00428424
    jmp _loc_42842E                                      # 00428427
    .global _loc_428429
_loc_428429:
    xchg ax, cx                                          # 00428429
    neg ax                                               # 0042842B
...
_loc_42842E:
    ...
    .global _sub_42843E
_sub_42843E:
    mov edi, dword ptr [__1136120]                       # 0042843E
    movzx edi, word ptr [edi + 0x3a]                     # 00428444
    shl edi, 7                                           # 00428448
    add_offset edi, _things                              # 0042844B
    movzx ebp, word ptr [edi + 0x40]                     # 00428451
    mov ebp, dword ptr [ebp*4 + _vehicleObjects]         # 00428455
    cmp byte ptr [ebp + 0x15a], 0                        # 0042845C
    je .L4284C4                                          # 00428463
    mov eax, dword ptr [_scenarioChunk3]                 # 00428465
    mov ebx, dword ptr [_scenarioChunk3+4]               # 0042846A
    ror eax, 3                                           # 00428470
    xor ebx, 0x1234567f                                  # 00428473
    mov dword ptr [_scenarioChunk3+4], eax               # 00428479
    ror ebx, 7                                           # 0042847E
    add dword ptr [_scenarioChunk3], ebx                 # 00428481
    ...
    mov edi, dword ptr [__1136120]                       # 004284A2
