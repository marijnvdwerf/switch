...
.text
    ...
    .global _sub_4284C8
_sub_4284C8:
    mov word ptr [0x5271ce], 0                           # 004284C8
    mov word ptr [0x5271d0], 0xffff                      # 004284D1
    ret                                                  # 004284DA

    .global _sub_4284DB
_sub_4284DB:
    mov esi, 0x5271d2                                    # 004284DB
    movzx ebp, word ptr [0x5271ce]                       # 004284E0
    msvc_or ebp, ebp                                     # 004284E7
    je .L42851B                                          # 004284E9
.L4284EB:
    movzx ebx, byte ptr [esi]                            # 004284EB
    movzx eax, word ptr [ebx*2 + 0x4f8b84]               # 004284EE
    add eax, dword ptr [esi + 0xd0]                      # 004284F6
    cmp eax, dword ptr [0x525e2c]                        # 004284FC
    ja .L428512                                          # 00428502
    push esi                                             # 00428504
    push ebp                                             # 00428505
...
.L428527:
    ...
    inc ah                                               # 00428554
.L428556:
    cmp al, byte ptr [ebx*4 + 0x4f8b09]                  # 00428556
    ...
    inc ah                                               # 00428571
.L428573:
    cmp al, byte ptr [ebx*4 + 0x4f8b0a]                  # 00428573
...
.L428590:
    ...
    je .L4285A9                                          # 00428592
    cmp bp, word ptr [0x5271d0]                          # 00428594
...
_sub_4285BA:
    ...
    push esi                                             # 004285BB
    push ebp                                             # 004285BC
    mov byte ptr [0x525ce2], ah                          # 004285BD
    movzx eax, al                                        # 004285C3
    movzx ebx, bx                                        # 004285C6
    movzx ecx, cx                                        # 004285C9
    movzx edx, dx                                        # 004285CC
    test word ptr [eax*2 + 0x4f8be4], 1                  # 004285CF
    je .L428617                                          # 004285D9
    mov esi, 0x5271d2                                    # 004285DB
    movzx ebp, word ptr [0x5271ce]                       # 004285E0
...
.L4285EB:
    ...
    je _sub_428DA7                                       # 00428608
.L42860E:
    add esi, 0xd4                                        # 0042860E
    dec ebp                                              # 00428614
    jne .L4285EB                                         # 00428615
.L428617:
    cmp word ptr [0x5271ce], 0xc8                        # 00428617
    jb .L4286AF                                          # 00428620
    push eax                                             # 00428626
    push ebx                                             # 00428627
    push ecx                                             # 00428628
    push edx                                             # 00428629
    mov esi, 0x5271d2                                    # 0042862A
    movzx ebp, word ptr [0x5271ce]                       # 0042862F
    mov ecx, 0xffffffff                                  # 00428636
.L42863B:
    cmp word ptr [esi + 0xc8], 0                         # 0042863B
    je .L428664                                          # 00428643
    movzx edx, byte ptr [esi]                            # 00428645
    movzx eax, word ptr [edx*2 + 0x4f8b84]               # 00428648
    add eax, dword ptr [esi + 0xd0]                      # 00428650
    sub eax, dword ptr [0x525e2c]                        # 00428656
...
.L428664:
    ...
    mov esi, 0x5271d2                                    # 00428672
    movzx ebp, word ptr [0x5271ce]                       # 00428677
.L42867E:
    movzx edx, byte ptr [esi]                            # 0042867E
    movzx eax, word ptr [edx*2 + 0x4f8b84]               # 00428681
    add eax, dword ptr [esi + 0xd0]                      # 00428689
    sub eax, dword ptr [0x525e2c]                        # 0042868F
...
.L4286A6:
    ...
    pop eax                                              # 004286AE
.L4286AF:
    movzx esi, word ptr [0x5271ce]                       # 004286AF
    imul esi, esi, 0xd4                                  # 004286B6
    add esi, 0x5271d2                                    # 004286BC
    inc word ptr [0x5271ce]                              # 004286C2
    ...
    mov ah, byte ptr [0x525ce2]                          # 004286E9
    mov byte ptr [esi + 0xc7], ah                        # 004286EF
    mov eax, dword ptr [0x525e2c]                        # 004286F5
    mov dword ptr [esi + 0xd0], eax                      # 004286FA
    movzx ebx, byte ptr [esi]                            # 00428700
    mov edi, 0x112cc04                                   # 00428703
    jmp dword ptr [ebx*4 + 0x4f8c88]                     # 00428708
...
_sub_42870F:
    ...
    shl ebx, 7                                           # 00428717
    add ebx, 0x6db6dc                                    # 0042871A
    mov ax, word ptr [ebx + 0x44]                        # 00428720
    mov word ptr [0x112c828], ax                         # 00428724
    mov ax, word ptr [ebx + 0x22]                        # 0042872A
    mov word ptr [0x112c826], ax                         # 0042872E
    movzx ebx, word ptr [esi + 0xcc]                     # 00428734
    imul ebx, ebx, 0x3d2                                 # 0042873B
    mov ax, word ptr [ebx + 0x5e6edc]                    # 00428741
    mov word ptr [0x112c82a], ax                         # 00428748
    mov ax, word ptr [ebx + 0x5e6f08]                    # 0042874E
    mov word ptr [0x112c82c], ax                         # 00428755
    mov eax, 0x18f                                       # 0042875B
    mov ecx, 0x112c826                                   # 00428760
    call _sub_4958C6                                     # 00428765
    pop esi                                              # 0042876A
    msvc_jmp _sub_428D59                                 # 0042876B
...
_sub_428770:
    ...
    mov ax, word ptr [ebx + 0x5c4631]                    # 0042877E
    mov word ptr [0x112c828], ax                         # 00428785
    mov ax, word ptr [ebx + 0x5c455c]                    # 0042878B
    mov word ptr [0x112c826], ax                         # 00428792
    movzx ebp, byte ptr [ebx + 0x5c456c]                 # 00428798
    mov ebp, dword ptr [ebp*4 + 0x50d074]                # 0042879F
    movzx eax, word ptr [ebp + 4]                        # 004287A6
    mov ecx, 0x112c826                                   # 004287AA
    call _sub_4958C6                                     # 004287AF
    pop esi                                              # 004287B4
    msvc_jmp _sub_428D59                                 # 004287B5
...
_sub_4287BA:
    ...
    shl ebx, 7                                           # 004287C2
    add ebx, 0x6db6dc                                    # 004287C5
    mov ax, word ptr [ebx + 0x44]                        # 004287CB
    mov word ptr [0x112c828], ax                         # 004287CF
    mov ax, word ptr [ebx + 0x22]                        # 004287D5
    mov word ptr [0x112c826], ax                         # 004287D9
    mov eax, 0x190                                       # 004287DF
    mov ecx, 0x112c826                                   # 004287E4
    call _sub_4958C6                                     # 004287E9
    pop esi                                              # 004287EE
    msvc_jmp _sub_428D59                                 # 004287EF

    .global _sub_4287F4
_sub_4287F4:
    push esi                                             # 004287F4
    pop esi                                              # 004287F5
    msvc_jmp _sub_428D59                                 # 004287F6
...
_sub_4287FB:
    ...
    mov ax, word ptr [edx + 0x5e6edc]                    # 00428809
    mov word ptr [0x112c826], ax                         # 00428810
    mov ax, word ptr [edx + 0x5e6f08]                    # 00428816
    mov word ptr [0x112c828], ax                         # 0042881D
    movzx edx, word ptr [esi + 0xcc]                     # 00428823
    mov edx, dword ptr [edx*4 + 0x50c700]                # 0042882A
    mov ax, word ptr [edx]                               # 00428831
    mov word ptr [0x112c82a], ax                         # 00428834
    mov eax, 0x191                                       # 0042883A
    mov ecx, 0x112c826                                   # 0042883F
    call _sub_4958C6                                     # 00428844
    pop esi                                              # 00428849
    msvc_jmp _sub_428D59                                 # 0042884A
...
_sub_42884F:
    ...
    mov ax, word ptr [edx + 0x5e6edc]                    # 0042885D
    mov word ptr [0x112c826], ax                         # 00428864
    mov ax, word ptr [edx + 0x5e6f08]                    # 0042886A
    mov word ptr [0x112c828], ax                         # 00428871
    movzx edx, word ptr [esi + 0xcc]                     # 00428877
    mov edx, dword ptr [edx*4 + 0x50c700]                # 0042887E
    mov ax, word ptr [edx]                               # 00428885
    mov word ptr [0x112c82a], ax                         # 00428888
    mov eax, 0x192                                       # 0042888E
    mov ecx, 0x112c826                                   # 00428893
    call _sub_4958C6                                     # 00428898
    pop esi                                              # 0042889D
    msvc_jmp _sub_428D59                                 # 0042889E
...
_sub_4288A3:
    ...
    mov ax, word ptr [ebx + 0x531784]                    # 004288B1
    mov word ptr [0x112c826], ax                         # 004288B8
    movzx ebx, word ptr [esi + 0xcc]                     # 004288BE
    imul ebx, ebx, 0x270                                 # 004288C5
    mov ax, word ptr [ebx + 0x5b825c]                    # 004288CB
    mov word ptr [0x112c82a], ax                         # 004288D2
    mov eax, 0x193                                       # 004288D8
    mov ecx, 0x112c826                                   # 004288DD
    call _sub_4958C6                                     # 004288E2
    pop esi                                              # 004288E7
    msvc_jmp _sub_428D59                                 # 004288E8
...
_sub_4288ED:
    ...
    shl ebx, 7                                           # 004288F5
    add ebx, 0x6db6dc                                    # 004288F8
    mov ax, word ptr [ebx + 0x44]                        # 004288FE
    mov word ptr [0x112c828], ax                         # 00428902
    mov ax, word ptr [ebx + 0x22]                        # 00428908
    mov word ptr [0x112c826], ax                         # 0042890C
    movzx edx, word ptr [esi + 0xcc]                     # 00428912
    imul edx, edx, 0x3d2                                 # 00428919
    mov ax, word ptr [edx + 0x5e6edc]                    # 0042891F
    mov word ptr [0x112c82a], ax                         # 00428926
    mov ax, word ptr [edx + 0x5e6f08]                    # 0042892C
    mov word ptr [0x112c82c], ax                         # 00428933
    mov eax, 0x194                                       # 00428939
    mov ecx, 0x112c826                                   # 0042893E
    call _sub_4958C6                                     # 00428943
    pop esi                                              # 00428948
    msvc_jmp _sub_428D59                                 # 00428949
...
_sub_42894E:
    ...
    mov ax, word ptr [ebx + 0x5b825c]                    # 0042895C
    mov word ptr [0x112c828], ax                         # 00428963
    movzx ebx, byte ptr [esi + 0xcf]                     # 00428969
    mov ebx, dword ptr [ebx*4 + 0x50c700]                # 00428970
    mov ax, word ptr [ebx]                               # 00428977
    mov word ptr [0x112c826], ax                         # 0042897A
    mov eax, 0x195                                       # 00428980
    test byte ptr [ebx + 0x12], 4                        # 00428985
    je .L42898C                                          # 00428989
    inc eax                                              # 0042898B
.L42898C:
    mov ecx, 0x112c826                                   # 0042898C
    call _sub_4958C6                                     # 00428991
    pop esi                                              # 00428996
    msvc_jmp _sub_428D59                                 # 00428997
...
_sub_42899C:
    ...
    mov ax, word ptr [ebx + 0x5c4631]                    # 004289AA
    mov word ptr [0x112c82a], ax                         # 004289B1
    mov ax, word ptr [ebx + 0x5c455c]                    # 004289B7
    mov word ptr [0x112c828], ax                         # 004289BE
    movzx ebx, byte ptr [esi + 0xcf]                     # 004289C4
    mov ebx, dword ptr [ebx*4 + 0x50c700]                # 004289CB
    mov ax, word ptr [ebx]                               # 004289D2
    mov word ptr [0x112c826], ax                         # 004289D5
    mov eax, 0x197                                       # 004289DB
    mov ecx, 0x112c826                                   # 004289E0
    call _sub_4958C6                                     # 004289E5
    pop esi                                              # 004289EA
    msvc_jmp _sub_428D59                                 # 004289EB

    .global _sub_4289F0
_sub_4289F0:
    push esi                                             # 004289F0
    movzx ebx, word ptr [esi + 0xca]                     # 004289F1
    mov ebx, dword ptr [ebx*4 + 0x50c9e4]                # 004289F8
    mov ax, word ptr [ebx]                               # 004289FF
    mov word ptr [0x112c826], ax                         # 00428A02
    mov eax, 0x198                                       # 00428A08
    mov ecx, 0x112c826                                   # 00428A0D
    call _sub_4958C6                                     # 00428A12
    pop esi                                              # 00428A17
    msvc_jmp _sub_428D59                                 # 00428A18
...
_sub_428A1D:
    ...
    mov ax, word ptr [ebx + 0x531786]                    # 00428A2B
    mov word ptr [0x112c826], ax                         # 00428A32
    mov ax, word ptr [esi + 0xcc]                        # 00428A38
    add ax, 0x6ec                                        # 00428A3F
    mov word ptr [0x112c82c], ax                         # 00428A43
    dec ax                                               # 00428A49
    mov word ptr [0x112c82a], ax                         # 00428A4B
    mov eax, 0x199                                       # 00428A51
    mov ecx, 0x112c826                                   # 00428A56
    call _sub_4958C6                                     # 00428A5B
    pop esi                                              # 00428A60
    msvc_jmp _sub_428D59                                 # 00428A61
...
_sub_428A66:
    ...
    movzx eax, word ptr [ebx + 0x5c4631]                 # 00428A74
    imul eax, eax, 0x270                                 # 00428A7B
    mov ax, word ptr [eax + 0x5b825c]                    # 00428A81
    mov word ptr [0x112c828], ax                         # 00428A88
    movzx ebp, byte ptr [ebx + 0x5c456c]                 # 00428A8E
    mov ebp, dword ptr [ebp*4 + 0x50d074]                # 00428A95
    mov ax, word ptr [ebp]                               # 00428A9C
    mov word ptr [0x112c826], ax                         # 00428AA0
    mov eax, 0x19a                                       # 00428AA6
    mov ecx, 0x112c826                                   # 00428AAB
    call _sub_4958C6                                     # 00428AB0
    pop esi                                              # 00428AB5
    msvc_jmp _sub_428D59                                 # 00428AB6
...
_sub_428ABB:
    ...
    mov ax, word ptr [ebx + 0x5c4631]                    # 00428AC9
    mov word ptr [0x112c828], ax                         # 00428AD0
    mov ax, word ptr [ebx + 0x5c455c]                    # 00428AD6
    mov word ptr [0x112c826], ax                         # 00428ADD
    movzx ebp, byte ptr [ebx + 0x5c456c]                 # 00428AE3
    mov ebp, dword ptr [ebp*4 + 0x50d074]                # 00428AEA
    movzx eax, word ptr [ebp + 6]                        # 00428AF1
    mov ecx, 0x112c826                                   # 00428AF5
    call _sub_4958C6                                     # 00428AFA
    pop esi                                              # 00428AFF
    msvc_jmp _sub_428D59                                 # 00428B00
...
_sub_428B05:
    ...
    mov ax, word ptr [ebx + 0x5c4631]                    # 00428B13
    mov word ptr [0x112c828], ax                         # 00428B1A
    mov ax, word ptr [ebx + 0x5c455c]                    # 00428B20
    mov word ptr [0x112c826], ax                         # 00428B27
    movzx ebp, byte ptr [ebx + 0x5c456c]                 # 00428B2D
    mov ebp, dword ptr [ebp*4 + 0x50d074]                # 00428B34
    movzx eax, word ptr [ebp + 8]                        # 00428B3B
    mov ecx, 0x112c826                                   # 00428B3F
    call _sub_4958C6                                     # 00428B44
    pop esi                                              # 00428B49
    msvc_jmp _sub_428D59                                 # 00428B4A
...
_sub_428B4F:
    ...
    mov ax, word ptr [ebx + 0x531786]                    # 00428B5D
    mov word ptr [0x112c826], ax                         # 00428B64
    mov eax, 0x19b                                       # 00428B6A
    mov ecx, 0x112c826                                   # 00428B6F
    call _sub_4958C6                                     # 00428B74
    pop esi                                              # 00428B79
    msvc_jmp _sub_428D59                                 # 00428B7A
...
_sub_428B7F:
    ...
    mov ax, word ptr [ebx + 0x531786]                    # 00428B8D
    mov word ptr [0x112c826], ax                         # 00428B94
    mov eax, 0x19c                                       # 00428B9A
    mov ecx, 0x112c826                                   # 00428B9F
    call _sub_4958C6                                     # 00428BA4
    pop esi                                              # 00428BA9
    msvc_jmp _sub_428D59                                 # 00428BAA
...
_sub_428BAF:
    ...
    mov ax, word ptr [ebx + 0x531786]                    # 00428BBD
    mov word ptr [0x112c826], ax                         # 00428BC4
    mov eax, 0x19d                                       # 00428BCA
    mov ecx, 0x112c826                                   # 00428BCF
    call _sub_4958C6                                     # 00428BD4
    pop esi                                              # 00428BD9
    msvc_jmp _sub_428D59                                 # 00428BDA
...
_sub_428BDF:
    ...
    mov ax, word ptr [ebx + 0x531784]                    # 00428BED
    mov word ptr [0x112c826], ax                         # 00428BF4
    mov eax, 0x19e                                       # 00428BFA
    mov ecx, 0x112c826                                   # 00428BFF
    call _sub_4958C6                                     # 00428C04
    pop esi                                              # 00428C09
    msvc_jmp _sub_428D59                                 # 00428C0A
...
_sub_428C0F:
    ...
    mov ax, word ptr [ebx + 0x531784]                    # 00428C1D
    mov word ptr [0x112c826], ax                         # 00428C24
    mov eax, 0x19f                                       # 00428C2A
    mov ecx, 0x112c826                                   # 00428C2F
    call _sub_4958C6                                     # 00428C34
    pop esi                                              # 00428C39
    msvc_jmp _sub_428D59                                 # 00428C3A
...
_sub_428C3F:
    ...
    mov ax, word ptr [ebx + 0x531784]                    # 00428C4D
    mov word ptr [0x112c826], ax                         # 00428C54
    mov eax, 0x1a0                                       # 00428C5A
    mov ecx, 0x112c826                                   # 00428C5F
    call _sub_4958C6                                     # 00428C64
    pop esi                                              # 00428C69
    msvc_jmp _sub_428D59                                 # 00428C6A
...
_sub_428C6F:
    ...
    mov ax, word ptr [ebx + 0x531784]                    # 00428C7D
    mov word ptr [0x112c826], ax                         # 00428C84
    mov eax, 0x1a1                                       # 00428C8A
    mov ecx, 0x112c826                                   # 00428C8F
    call _sub_4958C6                                     # 00428C94
    pop esi                                              # 00428C99
    msvc_jmp _sub_428D59                                 # 00428C9A
...
_sub_428C9F:
    ...
    shl ebx, 7                                           # 00428CA7
    add ebx, 0x6db6dc                                    # 00428CAA
    mov ax, word ptr [ebx + 0x44]                        # 00428CB0
    mov word ptr [0x112c828], ax                         # 00428CB4
    mov ax, word ptr [ebx + 0x22]                        # 00428CBA
    mov word ptr [0x112c826], ax                         # 00428CBE
    mov eax, 0x1a2                                       # 00428CC4
    mov ecx, 0x112c826                                   # 00428CC9
    call _sub_4958C6                                     # 00428CCE
    pop esi                                              # 00428CD3
    msvc_jmp _sub_428D59                                 # 00428CD4
...
_sub_428CD9:
    ...
    mov ax, word ptr [ebx + 0x531786]                    # 00428CE7
    mov word ptr [0x112c826], ax                         # 00428CEE
    mov eax, 0x1a3                                       # 00428CF4
    mov ecx, 0x112c826                                   # 00428CF9
    call _sub_4958C6                                     # 00428CFE
    pop esi                                              # 00428D03
    jmp _sub_428D59                                      # 00428D04

    .global _sub_428D06
_sub_428D06:
    push esi                                             # 00428D06
    movzx ebx, word ptr [esi + 0xce]                     # 00428D07
    mov ax, word ptr [ebx*2 + 0x52624e]                  # 00428D0E
    mov word ptr [0x112c82a], ax                         # 00428D16
    add bx, 0x7c2                                        # 00428D1C
    mov word ptr [0x112c826], bx                         # 00428D21
    movzx ebx, word ptr [esi + 0xca]                     # 00428D28
    shl ebx, 7                                           # 00428D2F
    add ebx, 0x6db6dc                                    # 00428D32
    movzx ax, byte ptr [ebx + 0x5e]                      # 00428D38
    add ax, 0x7c5                                        # 00428D3D
    mov word ptr [0x112c828], ax                         # 00428D41
    mov eax, 0x1a4                                       # 00428D47
    mov ecx, 0x112c826                                   # 00428D4C
    call _sub_4958C6                                     # 00428D51
    pop esi                                              # 00428D56
    jmp _sub_428D59                                      # 00428D57

    .global _sub_428D59
_sub_428D59:
    mov ebp, 0x112cc04                                   # 00428D59
...
_sub_428DA7:
    ...
    .global _sub_428DAB
_sub_428DAB:
    cmp word ptr [0x5271d0], -1                          # 00428DAB
    je .L428DDE                                          # 00428DB3
    msvc_mov eax, esi                                    # 00428DB5
    msvc_xor edx, edx                                    # 00428DB7
    sub eax, 0x5271d2                                    # 00428DB9
    mov ecx, 0xd4                                        # 00428DBE
    div ecx                                              # 00428DC3
    cmp ax, word ptr [0x5271d0]                          # 00428DC5
    je .L428DD9                                          # 00428DCC
    ja .L428DDE                                          # 00428DCE
    dec word ptr [0x5271d0]                              # 00428DD0
    jmp .L428DDE                                         # 00428DD7
.L428DD9:
    call _sub_428E0F                                     # 00428DD9
.L428DDE:
    dec word ptr [0x5271ce]                              # 00428DDE
.L428DE5:
    cmp esi, 0x53169e                                    # 00428DE5
...
_sub_428E0F:
    pushal                                               # 00428E0F
    movzx edi, word ptr [0x5271d0]                       # 00428E10
    cmp di, -1                                           # 00428E17
    je .L428E32                                          # 00428E1B
    imul edi, edi, 0xd4                                  # 00428E1D
    add edi, 0x5271d2                                    # 00428E23
    mov word ptr [edi + 0xc8], 0xffff                    # 00428E29
.L428E32:
    mov cl, 0x24                                         # 00428E32
    msvc_xor dx, dx                                      # 00428E34
    call _sub_4CC692                                     # 00428E37
    mov word ptr [0x5271d0], 0xffff                      # 00428E3C
    popal                                                # 00428E45
    ret                                                  # 00428E46

    .global _sub_428E47
_sub_428E47:
    test word ptr [0x508f14], 1                          # 00428E47
...
.L428E72:
    ret                                                  # 00428E72
.L428E73:
    movzx edi, word ptr [0x5271d0]                       # 00428E73
    cmp di, -1                                           # 00428E7A
    je .L428F32                                          # 00428E7E
    ...
    mov word ptr [0x5271d0], 0xffff                      # 00428E9F
    pop eax                                              # 00428EA8
    call _sub_428F8B                                     # 00428EA9
    ret                                                  # 00428EAE
.L428EAF:
    imul edi, edi, 0xd4                                  # 00428EAF
    add edi, 0x5271d2                                    # 00428EB5
    inc word ptr [edi + 0xc8]                            # 00428EBB
    mov dx, 0x1e0                                        # 00428EC2
    mov ax, word ptr [0x5271ce]                          # 00428EC6
    sub ax, word ptr [0x5271d0]                          # 00428ECC
    je .L428EED                                          # 00428ED3
...
.L428EED:
    ...
    cmp byte ptr [0x508f1a], 0                           # 00428EF1
    je .L428F19                                          # 00428EF8
    ...
    cmp byte ptr [ebx + 0x50af2a], 2                     # 00428F0C
    je .L428F19                                          # 00428F13
...
_sub_428F38:
    ...
    mov edi, 0x5271d2                                    # 00428F42
    msvc_xor dx, dx                                      # 00428F47
.L428F4A:
    cmp dx, word ptr [0x5271ce]                          # 00428F4A
    ...
    mov ch, byte ptr [ebx + 0x4f8bc4]                    # 00428F6D
.L428F73:
    cmp ch, cl                                           # 00428F73
...
_sub_428F8B:
    ...
    add edi, 0x5271d2                                    # 00428F96
    cmp word ptr [edi + 0xc8], 0                         # 00428F9C
    je .L428FB2                                          # 00428FA4
    cmp word ptr [0x508f12], 0xa                         # 00428FA6
    jb .L428FB2                                          # 00428FAE
    inc dl                                               # 00428FB0
.L428FB2:
    mov word ptr [0x5271d0], ax                          # 00428FB2
    movzx ebx, byte ptr [edi]                            # 00428FB8
    msvc_or dl, dl                                       # 00428FBB
    jne .L428FF7                                         # 00428FBD
    movzx ecx, byte ptr [ebx + 0x4f8c22]                 # 00428FBF
    cmp cl, 0                                            # 00428FC6
    je .L428FD0                                          # 00428FC9
    cmp cl, 2                                            # 00428FCB
...
.L428FD0:
    ...
    cmp al, byte ptr [0x525e3c]                          # 00428FD6
    je .L428FDF                                          # 00428FDC
    inc ecx                                              # 00428FDE
.L428FDF:
    mov cl, byte ptr [ecx + 0x50af2a]                    # 00428FDF
    cmp cl, 0                                            # 00428FE5
    je .L4291FF                                          # 00428FE8
    cmp cl, 1                                            # 00428FEE
    je .L42919E                                          # 00428FF1
.L428FF7:
    ...
    je .L429016                                          # 0042900C
    cmp dl, byte ptr [0x525e3c]                          # 0042900E
    jne .L42901D                                         # 00429014
.L429016:
    movzx eax, byte ptr [ebx + 0x4f8c41]                 # 00429016
.L42901D:
    cmp al, 0xff                                         # 0042901D
    je .L429039                                          # 0042901F
    mov bp, word ptr [0x50b894]                          # 00429021
    shr bp, 1                                            # 00429028
...
.L429039:
    ...
    pop eax                                              # 0042903B
.L42903C:
    test word ptr [ebx*2 + 0x4f8be4], 2                  # 0042903C
    jne .L4290F5                                         # 00429046
    mov word ptr [0x525ce0], 5                           # 0042904C
    push edi                                             # 00429055
    mov ax, word ptr [0x50b896]                          # 00429056
    sub ax, word ptr [0x525ce0]                          # 0042905C
    cmp byte ptr [0x508f1a], 0                           # 00429063
    jne .L429070                                         # 0042906A
    msvc_or dl, dl                                       # 0042906C
    je .L429083                                          # 0042906E
.L429070:
    mov ax, word ptr [0x50b896]                          # 00429070
    sub ax, 0x75                                         # 00429076
    mov word ptr [0x525ce0], 0x75                        # 0042907A
.L429083:
    shl eax, 0x10                                        # 00429083
    mov ax, word ptr [0x50b894]                          # 00429086
    shr ax, 1                                            # 0042908C
    sub ax, 0xb4                                         # 0042908F
    mov ebx, 0x750168                                    # 00429093
    mov ecx, 0x1624                                      # 00429098
    mov edx, 0x4f8d64                                    # 0042909D
    call _sub_4C9F5D                                     # 004290A2
    mov dword ptr [esi + 0x2c], 0x508cf0                 # 004290A7
    ...
    pop edi                                              # 004290C6
    mov dword ptr [0x525cd0], 0xffffffff                 # 004290C7
    mov dword ptr [0x525cd8], 0xffffffff                 # 004290D1
    mov dword ptr [0x525cd4], 0xffffffff                 # 004290DB
    mov dword ptr [0x525cdc], 0xffffffff                 # 004290E5
    call _sub_429209                                     # 004290EF
    ret                                                  # 004290F4
.L4290F5:
    mov word ptr [0x525ce0], 5                           # 004290F5
    push edi                                             # 004290FE
    mov ax, word ptr [0x50b896]                          # 004290FF
    sub ax, word ptr [0x525ce0]                          # 00429105
    cmp byte ptr [0x508f1a], 0                           # 0042910C
    jne .L429119                                         # 00429113
    msvc_or dl, dl                                       # 00429115
    je .L42912C                                          # 00429117
.L429119:
    mov ax, word ptr [0x50b896]                          # 00429119
    sub ax, 0x9f                                         # 0042911F
    mov word ptr [0x525ce0], 0x9f                        # 00429123
.L42912C:
    shl eax, 0x10                                        # 0042912C
    mov ax, word ptr [0x50b894]                          # 0042912F
    shr ax, 1                                            # 00429135
    sub ax, 0xb4                                         # 00429138
    mov ebx, 0x9f0168                                    # 0042913C
    mov ecx, 0x3624                                      # 00429141
    mov edx, 0x4f8d64                                    # 00429146
    call _sub_4C9F5D                                     # 0042914B
    mov dword ptr [esi + 0x2c], 0x508c8c                 # 00429150
    ...
    pop edi                                              # 0042916F
    mov dword ptr [0x525cd0], 0xffffffff                 # 00429170
    mov dword ptr [0x525cd8], 0xffffffff                 # 0042917A
    mov dword ptr [0x525cd4], 0xffffffff                 # 00429184
    mov dword ptr [0x525cdc], 0xffffffff                 # 0042918E
    call _sub_429209                                     # 00429198
    ret                                                  # 0042919D
.L42919E:
    mov word ptr [0x525ce0], 0                           # 0042919E
    push edi                                             # 004291A7
    mov ax, word ptr [0x50b896]                          # 004291A8
    sub ax, 0x19                                         # 004291AE
    shl eax, 0x10                                        # 004291B2
    mov ax, word ptr [0x50b894]                          # 004291B5
    sub ax, 0x8a                                         # 004291BB
    mov ebx, 0x19006f                                    # 004291BF
    mov ecx, 0x9624                                      # 004291C4
    mov edx, 0x4f8dd8                                    # 004291C9
    call _sub_4C9F5D                                     # 004291CE
    mov dword ptr [esi + 0x2c], 0x508d54                 # 004291D3
    or dword ptr [esi + 0xc], 1                          # 004291DA
    call _sub_4CA17F                                     # 004291DE
    mov ebp, dword ptr [0x50c3d0]                        # 004291E3
...
_sub_429209:
    ...
    movzx ebp, word ptr [0x5271d0]                       # 00429213
    cmp bp, -1                                           # 0042921A
    je _sub_4293BE                                       # 0042921E
    imul ebp, ebp, 0xd4                                  # 00429224
    add ebp, 0x5271d2                                    # 0042922A
    movzx ebx, byte ptr [ebp]                            # 00429230
    test word ptr [ebx*2 + 0x4f8be4], 4                  # 00429234
    je _sub_4293BE                                       # 0042923E
    movzx edi, byte ptr [ebx*4 + 0x4f8b08]               # 00429244
    movzx eax, word ptr [ebp + 0xca]                     # 0042924C
    cmp ax, -1                                           # 00429253
    je _sub_4293BE                                       # 00429257
    jmp dword ptr [edi*4 + 0x4f8d04]                     # 0042925D
...
_sub_429264:
    ...
    mov cl, 1                                            # 00429289
    mov ch, byte ptr [0xe3f0b8]                          # 0042928B
...
_sub_42929C:
    ...
    mov dx, word ptr [eax + 0x5e6ee0]                    # 004292A2
    shl edx, 0x10                                        # 004292A9
    mov dx, word ptr [eax + 0x5e6ede]                    # 004292AC
    mov cx, word ptr [eax + 0x5e6ee2]                    # 004292B3
    shl ecx, 0x10                                        # 004292BA
    msvc_xor cl, cl                                      # 004292BD
    mov ch, byte ptr [0xe3f0b8]                          # 004292BF
...
_sub_4292D0:
    ...
    mov cl, 1                                            # 004292F5
    mov ch, byte ptr [0xe3f0b8]                          # 004292F7
...
.L42936B:
    ...
    mov ch, byte ptr [0xe3f0b8]                          # 00429378
...
_sub_429398:
    ...
    mov ch, byte ptr [0xe3f0b8]                          # 004293B2
...
.L4293DB:
    cmp ecx, dword ptr [0x525cd0]                        # 004293DB
    jne .L4293EF                                         # 004293E1
    cmp edx, dword ptr [0x525cd4]                        # 004293E3
    je .L4294B2                                          # 004293E9
.L4293EF:
    mov dword ptr [0x525cd0], ecx                        # 004293EF
    mov dword ptr [0x525cd4], edx                        # 004293F5
...
.L42940E:
    ...
    test word ptr [ebx*2 + 0x4f8be4], 8                  # 00429429
    je .L42944D                                          # 00429433
...
.L42944D:
    cmp edx, -1                                          # 0042944D
    je .L4294B2                                          # 00429450
    test word ptr [ebx*2 + 0x4f8be4], 2                  # 00429452
...
.L4294B2:
    ...
    movzx ebp, word ptr [0x5271d0]                       # 004294BC
    cmp bp, -1                                           # 004294C3
    je _sub_429667                                       # 004294C7
    imul ebp, ebp, 0xd4                                  # 004294CD
    add ebp, 0x5271d2                                    # 004294D3
    movzx ebx, byte ptr [ebp]                            # 004294D9
    test word ptr [ebx*2 + 0x4f8be4], 8                  # 004294DD
    je _sub_429667                                       # 004294E7
    movzx edi, byte ptr [ebx*4 + 0x4f8b09]               # 004294ED
    movzx eax, word ptr [ebp + 0xcc]                     # 004294F5
    cmp ax, -1                                           # 004294FC
    je _sub_429667                                       # 00429500
    jmp dword ptr [edi*4 + 0x4f8d24]                     # 00429506
...
_sub_42950D:
    ...
    mov cl, 1                                            # 00429532
    mov ch, byte ptr [0xe3f0b8]                          # 00429534
    or edx, 0x40000000                                   # 0042953A
    msvc_jmp _sub_429667                                 # 00429540

    .global _sub_429545
_sub_429545:
    imul eax, eax, 0x3d2                                 # 00429545
    mov dx, word ptr [eax + 0x5e6ee0]                    # 0042954B
    shl edx, 0x10                                        # 00429552
    mov dx, word ptr [eax + 0x5e6ede]                    # 00429555
    mov cx, word ptr [eax + 0x5e6ee2]                    # 0042955C
    shl ecx, 0x10                                        # 00429563
    msvc_xor cl, cl                                      # 00429566
    mov ch, byte ptr [0xe3f0b8]                          # 00429568
    or edx, 0x40000000                                   # 0042956E
    msvc_jmp _sub_429667                                 # 00429574
...
.L429614:
    ...
    mov ch, byte ptr [0xe3f0b8]                          # 00429621
    jmp _sub_429667                                      # 00429627

    .global _sub_429629
_sub_429629:
    mov ecx, 0xfffffffe                                  # 00429629
    call _sub_4CA4BD                                     # 0042962E
    jmp _sub_429667                                      # 00429633

    .global _sub_429635
_sub_429635:
    mov ecx, 0xfffffffd                                  # 00429635
    call _sub_4CA4BD                                     # 0042963A
    jmp _sub_429667                                      # 0042963F
...
_sub_429641:
    ...
    mov ch, byte ptr [0xe3f0b8]                          # 0042965B
...
.L429684:
    cmp ecx, dword ptr [0x525cd8]                        # 00429684
    jne .L429698                                         # 0042968A
    cmp edx, dword ptr [0x525cdc]                        # 0042968C
    je .L429737                                          # 00429692
.L429698:
    mov dword ptr [0x525cd8], ecx                        # 00429698
    mov dword ptr [0x525cdc], edx                        # 0042969E
...
.L4296B7:
    ...
    cmp edx, -1                                          # 004296D2
    je .L429737                                          # 004296D5
    test word ptr [ebx*2 + 0x4f8be4], 2                  # 004296D7
...
_sub_429738:
    ...
    .global _sub_429739
_sub_429739:
    movzx ebp, word ptr [0x5271d0]                       # 00429739
    imul ebp, ebp, 0xd4                                  # 00429740
    add ebp, 0x5271d2                                    # 00429746
    movzx ebx, byte ptr [ebp]                            # 0042974C
    test word ptr [ebx*2 + 0x4f8be4], 2                  # 00429750
...
.L429775:
    ...
    test word ptr [ebx*2 + 0x4f8be4], 4                  # 004297B3
    je .L429806                                          # 004297BD
    test word ptr [ebx*2 + 0x4f8be4], 2                  # 004297BF
    je .L429806                                          # 004297C9
...
.L429806:
    ...
    test word ptr [ebx*2 + 0x4f8be4], 8                  # 0042980A
    je .L42985D                                          # 00429814
    test word ptr [ebx*2 + 0x4f8be4], 2                  # 00429816
    je .L42985D                                          # 00429820
...
.L429862:
    ...
    push ebp                                             # 004298A7
    push esi                                             # 004298A8
    mov ebx, 0x5177fa                                    # 004298A9
    lea edx, [ebp + 1]                                   # 004298AE
    movzx eax, byte ptr [ebp]                            # 004298B1
    test word ptr [eax*2 + 0x4f8be4], 0x20               # 004298B5
...
.L4298C9:
    ...
    test word ptr [ebx*2 + 0x4f8be4], 4                  # 00429938
    je .L42998B                                          # 00429942
    test word ptr [ebx*2 + 0x4f8be4], 2                  # 00429944
    je .L42998B                                          # 0042994E
...
.L42998B:
    ...
    test word ptr [ebx*2 + 0x4f8be4], 8                  # 0042998F
    je .L4299E2                                          # 00429999
    test word ptr [ebx*2 + 0x4f8be4], 2                  # 0042999B
    je .L4299E2                                          # 004299A5
...
.L4299E7:
    ...
    push ebp                                             # 00429A1C
    push esi                                             # 00429A1D
    mov ebx, 0x5177fa                                    # 00429A1E
    lea edx, [ebp + 1]                                   # 00429A23
    movzx eax, byte ptr [ebp]                            # 00429A26
    test word ptr [eax*2 + 0x4f8be4], 0x20               # 00429A2A
...
.L429B00:
    ...
    test word ptr [ebx*2 + 0x4f8be4], 4                  # 00429B04
    je .L429B5B                                          # 00429B0E
    ...
    movzx ebx, byte ptr [ebx*4 + 0x4f8b08]               # 00429B22
...
.L429B5B:
    ...
    test word ptr [ebx*2 + 0x4f8be4], 8                  # 00429B5F
    je .L429BB6                                          # 00429B69
    ...
    movzx ebx, byte ptr [ebx*4 + 0x4f8b09]               # 00429B7D
...
_sub_429BB7:
    ...
    ret                                                  # 00429BCD
.L429BCE:
    movzx ebp, word ptr [0x5271d0]                       # 00429BCE
    cmp bp, -1                                           # 00429BD5
    je _sub_429DA8                                       # 00429BD9
    imul ebp, ebp, 0xd4                                  # 00429BDF
    add ebp, 0x5271d2                                    # 00429BE5
    movzx ebx, byte ptr [ebp]                            # 00429BEB
    test word ptr [ebx*2 + 0x4f8be4], 4                  # 00429BEF
    je _sub_429DA8                                       # 00429BF9
    movzx ebx, byte ptr [ebx*4 + 0x4f8b08]               # 00429BFF
    movzx edx, word ptr [ebp + 0xca]                     # 00429C07
    jmp .L429C50                                         # 00429C0E
.L429C10:
    movzx ebp, word ptr [0x5271d0]                       # 00429C10
    cmp bp, -1                                           # 00429C17
    je _sub_429DA8                                       # 00429C1B
    imul ebp, ebp, 0xd4                                  # 00429C21
    add ebp, 0x5271d2                                    # 00429C27
    movzx ebx, byte ptr [ebp]                            # 00429C2D
    test word ptr [ebx*2 + 0x4f8be4], 8                  # 00429C31
    je _sub_429DA8                                       # 00429C3B
    movzx ebx, byte ptr [ebx*4 + 0x4f8b09]               # 00429C41
    movzx edx, word ptr [ebp + 0xcc]                     # 00429C49
.L429C50:
    jmp dword ptr [ebx*4 + 0x4f8d44]                     # 00429C50
...
_sub_429C8D:
    push esi                                             # 00429C8D
    push edx                                             # 00429C8E
    mov eax, dword ptr [edx*4 + 0x50c9e4]                # 00429C8F
    ...
    mov edx, dword ptr [edx*4 + 0x50c9e4]                # 00429CAF
...
.L429CCB:
    cmp ebp, dword ptr [0x11364ec]                       # 00429CCB
    jae .L429CE5                                         # 00429CD1
    cmp al, byte ptr [ebp + 0x11364f0]                   # 00429CD3
    je .L429CDE                                          # 00429CD9
    inc ebp                                              # 00429CDB
...
.L429CE5:
    ...
    .global _sub_429CFC
_sub_429CFC:
    movzx edi, word ptr [0x5271d0]                       # 00429CFC
    cmp di, -1                                           # 00429D03
    je .L429D27                                          # 00429D07
    imul edi, edi, 0xd4                                  # 00429D09
    add edi, 0x5271d2                                    # 00429D0F
    mov word ptr [edi + 0xc8], 0xffff                    # 00429D15
    mov word ptr [0x5271d0], 0xffff                      # 00429D1E
.L429D27:
    msvc_jmp _sub_4CC6EA                                 # 00429D27

    .global _sub_429D2C
_sub_429D2C:
    mov ax, word ptr [0x525ce0]                          # 00429D2C
    add ax, 4                                            # 00429D32
    cmp ax, word ptr [esi + 0x36]                        # 00429D36
    jbe .L429D40                                         # 00429D3A
    mov ax, word ptr [esi + 0x36]                        # 00429D3C
.L429D40:
    mov word ptr [0x525ce0], ax                          # 00429D40
    mov ax, word ptr [0x50b896]                          # 00429D46
    sub ax, word ptr [0x525ce0]                          # 00429D4C
    mov bx, word ptr [0x50b894]                          # 00429D53
    shr bx, 1                                            # 00429D5A
...
_sub_429DAA:
    ...
    test byte ptr [0x508f17], 4                          # 00429DB8
    jne _sub_42A035                                      # 00429DBF
    movzx ebp, word ptr [0x5271d0]                       # 00429DC5
    imul ebp, ebp, 0xd4                                  # 00429DCC
    add ebp, 0x5271d2                                    # 00429DD2
    push edi                                             # 00429DD8
    ...
    test word ptr [eax*2 + 0x4f8be4], 2                  # 00429E00
    jne .L429E19                                         # 00429E0A
    movzx ebp, byte ptr [0x1136c6d]                      # 00429E0C
...
_sub_429EA2:
    ...
    ret                                                  # 00429EA8
.L429EA9:
    movzx ebp, word ptr [0x5271d0]                       # 00429EA9
    cmp bp, -1                                           # 00429EB0
    je _sub_42A035                                       # 00429EB4
    imul ebp, ebp, 0xd4                                  # 00429EBA
    add ebp, 0x5271d2                                    # 00429EC0
    mov word ptr [ebp + 0xc8], 1                         # 00429EC6
    mov ax, word ptr [0x5271d0]                          # 00429ECF
    push esi                                             # 00429ED5
    mov word ptr [0x5271d0], 0xffff                      # 00429ED6
...
_sub_429EEB:
    push esi                                             # 00429EEB
    mov eax, dword ptr [0x523338]                        # 00429EEC
    mov ebx, dword ptr [0x52333c]                        # 00429EF1
...
.L429F0C:
    ...
    je .L429F26                                          # 00429F14
    cmp byte ptr [0x508f17], 0                           # 00429F16
...
.L429F26:
    ...
    cmp byte ptr [0x508f17], 0                           # 00429F39
    jne .L429FBF                                         # 00429F40
    add word ptr [0x525ce0], 2                           # 00429F42
    test word ptr [0x525ce0], 0x8007                     # 00429F4A
    jne .L429FBF                                         # 00429F53
    movzx ebp, word ptr [0x5271d0]                       # 00429F55
    cmp bp, -1                                           # 00429F5C
    je .L429FBF                                          # 00429F60
    imul ebp, ebp, 0xd4                                  # 00429F62
    add ebp, 0x5271d2                                    # 00429F68
    lea edx, [ebp + 1]                                   # 00429F6E
    mov cx, word ptr [0x525ce0]                          # 00429F71
    shr cx, 2                                            # 00429F78
.L429F7C:
...
.L429F9E:
    ...
    je .L429FBF                                          # 00429FA4
    push esi                                             # 00429FA6
    movsx ebp, word ptr [0x50b894]                       # 00429FA7
    push eax                                             # 00429FAE
    push ebx                                             # 00429FAF
    ...
    pop esi                                              # 00429FBE
.L429FBF:
    movzx ebp, word ptr [0x5271d0]                       # 00429FBF
    cmp bp, -1                                           # 00429FC6
    je .L429FD6                                          # 00429FCA
    ret                                                  # 00429FCC
.L429FCD:
...
.L429FD6:
    ...
    .global _sub_429FE4
_sub_429FE4:
    mov ax, word ptr [0x50b896]                          # 00429FE4
    sub ax, 0x19                                         # 00429FEA
    mov cx, word ptr [0x50b894]                          # 00429FEE
...
_sub_42A035:
    ...
    .global _sub_42A036
_sub_42A036:
    jmp dword ptr [ebx*4 + 0x4f8e4c]                     # 0042A036

    .global _sub_42A03D
_sub_42A03D:
    imul eax, eax, 0x453                                 # 0042A03D
    mov bx, word ptr [eax + 0x5c4631]                    # 0042A043
    mov word ptr [0x112c828], bx                         # 0042A04A
    mov bx, word ptr [eax + 0x5c455c]                    # 0042A051
    mov word ptr [0x112c826], bx                         # 0042A058
    msvc_jmp _sub_42A125                                 # 0042A05F

    .global _sub_42A064
_sub_42A064:
    imul eax, eax, 0x3d2                                 # 0042A064
    mov bx, word ptr [eax + 0x5e6edc]                    # 0042A06A
    mov word ptr [0x112c826], bx                         # 0042A071
    mov bx, word ptr [eax + 0x5e6f08]                    # 0042A078
    mov word ptr [0x112c828], bx                         # 0042A07F
    msvc_jmp _sub_42A125                                 # 0042A086

    .global _sub_42A08B
_sub_42A08B:
    imul eax, eax, 0x270                                 # 0042A08B
    mov bx, word ptr [eax + 0x5b825c]                    # 0042A091
    mov word ptr [0x112c826], bx                         # 0042A098
    msvc_jmp _sub_42A125                                 # 0042A09F

    .global _sub_42A0A4
_sub_42A0A4:
    movzx eax, ax                                        # 0042A0A4
    shl eax, 7                                           # 0042A0A7
    add eax, 0x6db6dc                                    # 0042A0AA
    movzx esi, byte ptr [eax + 0x21]                     # 0042A0AF
    imul esi, esi, 0x8fa8                                # 0042A0B3
    mov bx, word ptr [esi + 0x531784]                    # 0042A0B9
    mov word ptr [0x112c828], bx                         # 0042A0C0
    mov bx, word ptr [eax + 0x44]                        # 0042A0C7
    mov word ptr [0x112c82e], bx                         # 0042A0CB
    mov bx, word ptr [eax + 0x22]                        # 0042A0D2
    mov word ptr [0x112c82c], bx                         # 0042A0D6
    mov word ptr [0x112c826], 0x1db                      # 0042A0DD
    mov bl, byte ptr [eax + 0x21]                        # 0042A0E6
    cmp bl, byte ptr [0x525e3c]                          # 0042A0E9
    jne .L42A0FA                                         # 0042A0EF
    mov word ptr [0x112c826], 0x1dc                      # 0042A0F1
.L42A0FA:
    jmp _sub_42A125                                      # 0042A0FA

    .global _sub_42A0FC
_sub_42A0FC:
    imul eax, eax, 0x8fa8                                # 0042A0FC
    mov bx, word ptr [eax + 0x531784]                    # 0042A102
    mov word ptr [0x112c826], bx                         # 0042A109
    jmp _sub_42A125                                      # 0042A110

    .global _sub_42A112
_sub_42A112:
    mov eax, dword ptr [eax*4 + 0x50c9e4]                # 0042A112
    mov bx, word ptr [eax]                               # 0042A119
    mov word ptr [0x112c826], bx                         # 0042A11C
    jmp _sub_42A125                                      # 0042A123

    .global _sub_42A125
_sub_42A125:
    mov bx, 0x1c5                                        # 0042A125
    mov esi, 0x112c826                                   # 0042A129
...
_sub_42A135:
    ...
    .global _sub_42A136
_sub_42A136:
    cmp dword ptr [0x525cd0], -2                         # 0042A136
    ...
    movzx ebx, byte ptr [ebp + 0x53179c]                 # 0042A160
    mov ebx, dword ptr [ebx*4 + 0x50d0b8]                # 0042A167
    movzx eax, byte ptr [ebp + 0x53179d]                 # 0042A16E
    mov ebx, dword ptr [ebx + eax*4 + 0x10]              # 0042A175
    movzx eax, byte ptr [ebp + 0x53179e]                 # 0042A179
    ...
    cmp word ptr [ebp + 0x53a5b8], 0                     # 0042A1CA
    je .L42A207                                          # 0042A1D2
...
.L42A207:
    ...
    pop esi                                              # 0042A208
.L42A209:
    cmp dword ptr [0x525cd0], -3                         # 0042A209
    ...
    movzx ebx, byte ptr [0x525e3c]                       # 0042A274
    movzx eax, word ptr [0x52622e]                       # 0042A27B
...
.L42A297:
    ...
    pop esi                                              # 0042A299
.L42A29A:
    cmp dword ptr [0x525cd8], -2                         # 0042A29A
    ...
    movzx ebx, byte ptr [ebp + 0x53179c]                 # 0042A2C4
    mov ebx, dword ptr [ebx*4 + 0x50d0b8]                # 0042A2CB
    movzx eax, byte ptr [ebp + 0x53179d]                 # 0042A2D2
    mov ebx, dword ptr [ebx + eax*4 + 0x10]              # 0042A2D9
    movzx eax, byte ptr [ebp + 0x53179e]                 # 0042A2DD
    ...
    cmp word ptr [ebp + 0x53a5b8], 0                     # 0042A32E
    je .L42A36B                                          # 0042A336
...
.L42A36B:
    ...
    pop esi                                              # 0042A36C
.L42A36D:
    cmp dword ptr [0x525cd8], -3                         # 0042A36D
    ...
    movzx ebx, byte ptr [0x525e3c]                       # 0042A3D8
    movzx eax, word ptr [0x52622e]                       # 0042A3DF
...
.L42A452:
    ...
    mov eax, dword ptr [0x4f8c60]                        # 0042A460
    mov dword ptr [esi + 0x2c], eax                      # 0042A465
    mov eax, dword ptr [0x4f8c70]                        # 0042A468
    mov dword ptr [esi + 0xc], eax                       # 0042A46D
    mov eax, dword ptr [0x4f8c74]                        # 0042A470
    mov dword ptr [esi + 0x10], eax                      # 0042A475
    mov eax, dword ptr [0x4f8c80]                        # 0042A478
    mov dword ptr [esi + 0x24], eax                      # 0042A47D
    mov eax, dword ptr [0x4f8c68]                        # 0042A480
...
_sub_42A4A8:
    ...
    mov ax, word ptr [0x50b894]                          # 0042A4AD
    sub ax, 0x16e                                        # 0042A4B3
    mov ebx, 0xd9016e                                    # 0042A4B7
    mov ecx, 0x80025                                     # 0042A4BC
    mov edx, 0x4f8e74                                    # 0042A4C1
    call _sub_4C9F5D                                     # 0042A4C6
    mov dword ptr [esi + 0x2c], 0x508d68                 # 0042A4CB
    mov eax, dword ptr [0x4f8c70]                        # 0042A4D2
    mov dword ptr [esi + 0xc], eax                       # 0042A4D7
    mov eax, dword ptr [0x4f8c74]                        # 0042A4DA
    ...
    mov al, byte ptr [0x525e3c]                          # 0042A52A
    mov byte ptr [esi + 0x884], al                       # 0042A52F
    mov ebp, dword ptr [0x50c3d0]                        # 0042A535
...
_sub_42A545:
    ...
    mov eax, dword ptr [edx*4 + 0x4f8c60]                # 0042A54C
...
.L42A560:
    ...
    dec ax                                               # 0042A57E
    dec bx                                               # 0042A580
    mov word ptr [0x508d6c], ax                          # 0042A582
    mov word ptr [0x508d70], bx                          # 0042A588
    mov word ptr [0x508d9c], ax                          # 0042A58F
    mov word ptr [0x508da0], bx                          # 0042A595
    dec ax                                               # 0042A59C
    mov word ptr [0x508d7c], ax                          # 0042A59E
    sub ax, 0xd                                          # 0042A5A4
    mov word ptr [0x508d8a], ax                          # 0042A5A8
    add ax, 0xc                                          # 0042A5AE
    mov word ptr [0x508d8c], ax                          # 0042A5B2
    dec ax                                               # 0042A5B8
    sub bx, 0xd                                          # 0042A5BA
    mov word ptr [0x508dcc], ax                          # 0042A5BE
    mov word ptr [0x508dd0], bx                          # 0042A5C4
    ret                                                  # 0042A5CB
...
_sub_42A5D7:
    ...
    movzx ebp, byte ptr [ebp*8 + 0x1136ba4]              # 0042A5DF
...
.L42A602:
    cmp ax, word ptr [0x5271ce]                          # 0042A602
    ...
    add ebp, 0x5271d2                                    # 0042A63A
    push ebp                                             # 0042A640
    lea ebp, [ebp + 1]                                   # 0042A641
    mov ebx, 0x5177fa                                    # 0042A644
.L42A649:
...
.L42A686:
    ...
    mov dword ptr [0x112c828], eax                       # 0042A691
    msvc_xor cx, cx                                      # 0042A696
    mov word ptr [0x112c826], 0x595                      # 0042A699
    mov esi, 0x112c826                                   # 0042A6A2
    ...
    push ebp                                             # 0042A6B5
    push esi                                             # 0042A6B6
    mov word ptr [0x112c826], 0x7f7                      # 0042A6B7
    msvc_xor cx, cx                                      # 0042A6C0
    add dx, 6                                            # 0042A6C3
    mov esi, 0x112c826                                   # 0042A6C7
    msvc_xor al, al                                      # 0042A6CC
    mov bp, word ptr [0x508dcc]                          # 0042A6CE
    sub bp, word ptr [0x508dca]                          # 0042A6D5
    sub bp, 0xd                                          # 0042A6DC
...
.L42A70B:
    ...
    .global _sub_42A70C
_sub_42A70C:
    mov word ptr [0x112c826], 0xd4                       # 0042A70C
    ret                                                  # 0042A715

    .global _sub_42A716
_sub_42A716:
    bt dword ptr [0x523368], 3                           # 0042A716
    jae .L42A740                                         # 0042A71E
    mov cl, byte ptr [esi + 0x882]                       # 0042A720
    cmp cl, byte ptr [0x523392]                          # 0042A726
    jne .L42A740                                         # 0042A72C
    mov cx, word ptr [esi + 0x40]                        # 0042A72E
    cmp cx, word ptr [0x523390]                          # 0042A732
...
.L42A769:
    mov eax, dword ptr [edx*8 + 0x4f8c70]                # 0042A769
    mov dword ptr [esi + 0xc], eax                       # 0042A770
    mov eax, dword ptr [edx*8 + 0x4f8c74]                # 0042A773
    mov dword ptr [esi + 0x10], eax                      # 0042A77A
    mov eax, dword ptr [edx*4 + 0x4f8c80]                # 0042A77D
    mov dword ptr [esi + 0x24], eax                      # 0042A784
    mov eax, dword ptr [edx*4 + 0x4f8c68]                # 0042A787
    mov dword ptr [esi], eax                             # 0042A78E
    mov dword ptr [esi + 0x1c], 0                        # 0042A790
    mov eax, dword ptr [edx*4 + 0x4f8c60]                # 0042A797
    ...
    jmp dword ptr [eax*4 + 0x4f8e6c]                     # 0042A7B2
...
.L42A870:
    ...
    .global _sub_42A871
_sub_42A871:
    movzx edx, word ptr [0x5271ce]                       # 0042A871
...
_sub_42A87C:
    ...
    cmp ax, word ptr [0x5271ce]                          # 0042A893
...
_sub_42A8B9:
    ...
    div ecx                                              # 0042A8C3
    cmp ax, word ptr [0x5271ce]                          # 0042A8C5
    jae _sub_42A98D                                      # 0042A8CC
    push esi                                             # 0042A8D2
    movzx edi, word ptr [0x5271d0]                       # 0042A8D3
    cmp di, -1                                           # 0042A8DA
    je .L42A90A                                          # 0042A8DE
    imul edi, edi, 0xd4                                  # 0042A8E0
    add edi, 0x5271d2                                    # 0042A8E6
...
_sub_42A98E:
    ...
    mov eax, dword ptr [edx*4 + 0x4f8c60]                # 0042A995
...
.L42A9A9:
    ...
    dec ax                                               # 0042A9C7
    dec bx                                               # 0042A9C9
    mov word ptr [0x508de0], ax                          # 0042A9CB
    mov word ptr [0x508de4], bx                          # 0042A9D1
    mov word ptr [0x508e10], ax                          # 0042A9D8
    mov word ptr [0x508e14], bx                          # 0042A9DE
    dec ax                                               # 0042A9E5
    mov word ptr [0x508df0], ax                          # 0042A9E7
    sub ax, 0xd                                          # 0042A9ED
    mov word ptr [0x508dfe], ax                          # 0042A9F1
    add ax, 0xc                                          # 0042A9F7
    mov word ptr [0x508e00], ax                          # 0042A9FB
    ret                                                  # 0042AA01
...
_sub_42AA02:
    ...
    mov dx, word ptr [0x508e42]                          # 0042AA0C
...
.L42AA19:
    ...
    mov word ptr [0x112c826], bx                         # 0042AA29
    mov bx, 0x1c9                                        # 0042AA30
    mov esi, 0x112c826                                   # 0042AA34
    ...
    push edx                                             # 0042AA44
    push esi                                             # 0042AA45
    movzx ebx, byte ptr [ebx + 0x50af2a]                 # 0042AA46
    add bx, 0x5e9                                        # 0042AA4D
    mov cx, word ptr [0x508e3e]                          # 0042AA52
    add cx, word ptr [esi + 0x30]                        # 0042AA59
    inc cx                                               # 0042AA5D
    mov word ptr [0x112c826], bx                         # 0042AA5F
    mov bx, 0x1c7                                        # 0042AA66
    mov esi, 0x112c826                                   # 0042AA6A
...
_sub_42AABD:
    ...
    mov word ptr [0x113d850], 0x1a5                      # 0042AAFC
    mov word ptr [0x113d8a0], 0x5e9                      # 0042AB05
    mov word ptr [0x113d852], 0x1a5                      # 0042AB0E
    mov word ptr [0x113d8a8], 0x5ea                      # 0042AB17
    mov word ptr [0x113d854], 0x1a5                      # 0042AB20
    mov word ptr [0x113d8b0], 0x5eb                      # 0042AB29
    pop ebp                                              # 0042AB32
    pop esi                                              # 0042AB33
    movzx ecx, byte ptr [ebp + 0x50af2a]                 # 0042AB34
    bts dword ptr [0x113dc64], ecx                       # 0042AB3B
    ret                                                  # 0042AB42
...
_sub_42AB43:
    ...
    sub ebp, 7                                           # 0042AB4C
    shr ebp, 1                                           # 0042AB4F
    cmp al, byte ptr [ebp + 0x50af2a]                    # 0042AB51
    je _sub_42AB8B                                       # 0042AB57
    mov byte ptr [ebp + 0x50af2a], al                    # 0042AB59
...
.L42ABAC:
    ...
    mov ebp, dword ptr [0x50c3d0]                        # 0042ABB2
...
.L42ABDF:
    ...
    mov ebp, dword ptr [0x50c3d0]                        # 0042ABE5
...
.L42AC1C:
    ...
    .global _sub_42AC27
_sub_42AC27:
    movzx edi, word ptr [0x5271d0]                       # 0042AC27
    cmp di, -1                                           # 0042AC2E
    je .L42AC5E                                          # 0042AC32
    imul edi, edi, 0xd4                                  # 0042AC34
    add edi, 0x5271d2                                    # 0042AC3A
