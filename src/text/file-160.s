...
.L4536FD:
    ...
    push   ebp
.L453714:
    movzx  edi,BYTE PTR [ebp+0xde]
    imul   edi,edi,0xd
    movzx  ebp,cx
    imul   ebp,ebp,0x3d2
    add    ebp,0x5e9cbc
    mul    BYTE PTR [ebx+esi*1+0x171]
    or     ah,ah
    je     .L453749
    push   eax
...
.L4537EB:
    ...
    push eax
    push ebp
    movzx  edi,BYTE PTR [ebp+0xdf]
    imul   edi,edi,0xd
    movzx  ebp,cx
    imul   ebp,ebp,0x3d2
    add    ebp,0x5e9cbc
    mul    BYTE PTR [ebx+esi*1+0x175]
    or     ah,ah
    je     .L453837
.L453802:
    push eax
...
.L459306:
    ...
    ja .L459326                                          # 0045930D
    cmp word ptr [esi + 0xd6], 0x190                      # 0045930F
    ja .L459326                                          # 00459317
    cmp word ptr [esi + 0xda], 0x190                      # 00459319
    ja .L459326                                          # 00459321
