...
.L49B50E:
    mov byte ptr [edi + 0x525f72], 0xff                  # 0049B50E
    mov byte ptr [edi + 0x525f7a], 0xff                  # 0049B515
    mov byte ptr [edi + 0x525f82], 0xff                  # 0049B51C
    mov byte ptr [edi + 0x525f8a], 0xff                  # 0049B523
    inc edi                                              # 0049B52A
    cmp edi, 8                                           # 0049B52B
    jb .L49B50E                                          # 0049B52E
    mov byte ptr [0x525fac], 0xff                        # 0049B530
    mov byte ptr [0x525fad], 0xff                        # 0049B537
    mov byte ptr [0x525fb0], 0                           # 0049B53E
    ret                                                  # 0049B545
...
.L49B549:
    mov esi, dword ptr [ebp*4 + 0x50c914]                # 0049B549
    cmp esi, -1                                          # 0049B550
    je .L49B5F8                                          # 0049B553
    msvc_xor edi, edi                                    # 0049B559
    mov edx, 0xffffffff                                  # 0049B55B
.L49B560:
    mov ebx, dword ptr [edi*4 + 0x50c9e4]                # 0049B560
    cmp ebx, -1                                          # 0049B567
    je .L49B5C0                                          # 0049B56A
...
.L49B5C0:
    ...
    jb .L49B560                                          # 0049B5C7
    mov byte ptr [ebp + 0x525f8a], 0xff                  # 0049B5C9
    cmp edx, -1                                          # 0049B5D0
    je .L49B5F8                                          # 0049B5D3
...
.L49B5F2:
    mov byte ptr [ebp + 0x525f8a], bl                    # 0049B5F2
.L49B5F8:
    inc ebp                                              # 0049B5F8
    cmp ebp, 8                                           # 0049B5F9
    jb .L49B549                                          # 0049B5FC
...
.L49B604:
    mov esi, dword ptr [ebp*4 + 0x50c984]                # 0049B604
    cmp esi, -1                                          # 0049B60B
    je .L49B6B3                                          # 0049B60E
    msvc_xor edi, edi                                    # 0049B614
    mov edx, 0xffffffff                                  # 0049B616
.L49B61B:
    mov ebx, dword ptr [edi*4 + 0x50c9e4]                # 0049B61B
    cmp ebx, -1                                          # 0049B622
    je .L49B67B                                          # 0049B625
...
.L49B67B:
    ...
    jb .L49B61B                                          # 0049B682
    mov byte ptr [ebp + 0x525fa2], 0xff                  # 0049B684
    cmp edx, -1                                          # 0049B68B
    je .L49B6B3                                          # 0049B68E
...
.L49B6AD:
    mov byte ptr [ebp + 0x525fa2], bl                    # 0049B6AD
.L49B6B3:
    inc ebp                                              # 0049B6B3
    cmp ebp, 8                                           # 0049B6B4
    jb .L49B604                                          # 0049B6B7
...
_sub_49B6BF:
    ...
    je .L49B6E9                                          # 0049B6CD
    cmp byte ptr [0x525e3d], 0xff                        # 0049B6CF
    je .L49B6E9                                          # 0049B6D6
    mov al, byte ptr [esi + 7]                           # 0049B6D8
    and al, 0xf                                          # 0049B6DB
    cmp al, byte ptr [0x525e3d]                          # 0049B6DD
    je _sub_49BB97                                       # 0049B6E3
.L49B6E9:
    test word ptr [0xe3f0bc], 8                          # 0049B6E9
    je .L49B791                                          # 0049B6F2
    mov edi, dword ptr [0xe0c3e0]                        # 0049B6F8
    cmp word ptr [edi + 0xe], 0                          # 0049B6FE
    jne .L49B791                                         # 0049B703
    push ecx                                             # 0049B709
    push edx                                             # 0049B70A
    push esi                                             # 0049B70B
    mov byte ptr [0xe3f0ac], 0                           # 0049B70C
    ...
    inc ebp                                              # 0049B72A
.L49B72B:
    movsx ax, byte ptr [ebp + edi*2 + 0x4f86b4]          # 0049B72B
    msvc_add dx, ax                                      # 0049B734
    movzx ebx, dx                                        # 0049B737
    add ebx, 8                                           # 0049B73A
    shr ebx, 4                                           # 0049B73D
    add ebx, 0x20380a26                                  # 0049B740
    add bx, word ptr [0x50af28]                          # 0049B746
    sub bx, word ptr [0x525fb2]                          # 0049B74D
    add dx, 8                                            # 0049B754
    ...
    mov si, 1                                            # 0049B760
    mov ah, 0                                            # 0049B764
    mov word ptr [0xe3f0a0], 0x3e8                       # 0049B766
    mov word ptr [0xe3f0a2], 0x3e8                       # 0049B76F
    mov word ptr [0xe3f0a4], 0x43f                       # 0049B778
    mov ebp, dword ptr [0xe3f0b8]                        # 0049B781
    call dword ptr [ebp*4 + 0x4fd140]                    # 0049B787
.L49B78E:
    pop esi                                              # 0049B78E
    pop edx                                              # 0049B78F
    pop ecx                                              # 0049B790
.L49B791:
    ...
    mov byte ptr [0xe3f0ac], 4                           # 0049B795
    shr ebx, 4                                           # 0049B79C
    mov ebx, dword ptr [ebx*4 + 0x50c914]                # 0049B79F
    mov eax, dword ptr [ebx + 0x1e]                      # 0049B7A6
    mov dword ptr [0x1135f1e], ebx                       # 0049B7A9
    mov dword ptr [0x1135f26], eax                       # 0049B7AF
    mov al, byte ptr [ebx + 0x1b]                        # 0049B7B4
    mov byte ptr [0x113605e], al                         # 0049B7B7
    mov dword ptr [0x1135f2a], ecx                       # 0049B7BC
    mov al, byte ptr [esi + 7]                           # 0049B7C2
    and eax, 0xf                                         # 0049B7C5
    mov al, byte ptr [eax + 0x9c645c]                    # 0049B7C8
    shl eax, 0x13                                        # 0049B7CE
    or eax, 0x20000000                                   # 0049B7D1
    mov dword ptr [0x1135f32], eax                       # 0049B7D6
    mov dword ptr [0x1135f36], eax                       # 0049B7DB
    test byte ptr [esi + 1], 0x10                        # 0049B7E0
    je .L49B805                                          # 0049B7E4
    mov byte ptr [0xe3f0ac], 0                           # 0049B7E6
    movzx eax, byte ptr [0x50aed8]                       # 0049B7ED
    mov eax, dword ptr [eax*4 + 0x4ffae8]                # 0049B7F4
    mov dword ptr [0x1135f32], eax                       # 0049B7FB
    mov dword ptr [0x1135f36], eax                       # 0049B800
.L49B805:
    or dword ptr [0x1135f26], eax                        # 0049B805
    test byte ptr [0x522095], 1                          # 0049B80B
    jne _sub_49B836                                      # 0049B812
    movzx eax, byte ptr [ebx + 6]                        # 0049B814
    mov ebx, dword ptr [eax*4 + 0x4ffb7c]                # 0049B818
...
_sub_49B835:
    ...
    .global _sub_49B836
_sub_49B836:
    mov edi, dword ptr [0xe0c3e0]                        # 0049B836
    cmp word ptr [edi + 0xe], 0                          # 0049B83C
    jne _sub_49BB97                                      # 0049B841
    test byte ptr [esi + 7], 0xf0                        # 0049B847
    je .L49B9C9                                          # 0049B84B
    mov bl, 5                                            # 0049B851
    xchg byte ptr [0xe3f0ac], bl                         # 0049B853
    push ebx                                             # 0049B859
    test byte ptr [esi + 7], 0x10                        # 0049B85A
    je .L49B8B4                                          # 0049B85E
    mov ebx, dword ptr [0x1135f1e]                       # 0049B860
    push esi                                             # 0049B866
    movzx ebx, byte ptr [ebx + 0xa]                      # 0049B867
    mov byte ptr [0xe3f0ad], 0                           # 0049B86B
    mov ebx, dword ptr [ebx*4 + 0x50c8f4]                # 0049B872
    mov dword ptr [0x1135f22], ebx                       # 0049B879
    mov eax, dword ptr [ebx + 0xa]                       # 0049B87F
    add eax, dword ptr [0x1135f32]                       # 0049B882
    mov dword ptr [0x1135f2e], eax                       # 0049B888
    movzx eax, byte ptr [ebx + 4]                        # 0049B88D
    mov ebx, dword ptr [eax*4 + 0x4ffb80]                # 0049B891
    ...
    mov ecx, dword ptr [0x1135f2a]                       # 0049B8A7
...
.L49B8B4:
    ...
    je .L49B90E                                          # 0049B8B8
    mov ebx, dword ptr [0x1135f1e]                       # 0049B8BA
    push esi                                             # 0049B8C0
    movzx ebx, byte ptr [ebx + 0xb]                      # 0049B8C1
    mov byte ptr [0xe3f0ad], 1                           # 0049B8C5
    mov ebx, dword ptr [ebx*4 + 0x50c8f4]                # 0049B8CC
    mov dword ptr [0x1135f22], ebx                       # 0049B8D3
    mov eax, dword ptr [ebx + 0xa]                       # 0049B8D9
    add eax, dword ptr [0x1135f32]                       # 0049B8DC
    mov dword ptr [0x1135f2e], eax                       # 0049B8E2
    movzx eax, byte ptr [ebx + 4]                        # 0049B8E7
    mov ebx, dword ptr [eax*4 + 0x4ffb80]                # 0049B8EB
    ...
    mov ecx, dword ptr [0x1135f2a]                       # 0049B901
...
.L49B90E:
    ...
    je .L49B968                                          # 0049B912
    mov ebx, dword ptr [0x1135f1e]                       # 0049B914
    push esi                                             # 0049B91A
    movzx ebx, byte ptr [ebx + 0xc]                      # 0049B91B
    mov byte ptr [0xe3f0ad], 2                           # 0049B91F
    mov ebx, dword ptr [ebx*4 + 0x50c8f4]                # 0049B926
    mov dword ptr [0x1135f22], ebx                       # 0049B92D
    mov eax, dword ptr [ebx + 0xa]                       # 0049B933
    add eax, dword ptr [0x1135f32]                       # 0049B936
    mov dword ptr [0x1135f2e], eax                       # 0049B93C
    movzx eax, byte ptr [ebx + 4]                        # 0049B941
    mov ebx, dword ptr [eax*4 + 0x4ffb80]                # 0049B945
    ...
    mov ecx, dword ptr [0x1135f2a]                       # 0049B95B
...
.L49B968:
    ...
    je .L49B9C2                                          # 0049B96C
    mov ebx, dword ptr [0x1135f1e]                       # 0049B96E
    push esi                                             # 0049B974
    movzx ebx, byte ptr [ebx + 0xd]                      # 0049B975
    mov byte ptr [0xe3f0ad], 3                           # 0049B979
    mov ebx, dword ptr [ebx*4 + 0x50c8f4]                # 0049B980
    mov dword ptr [0x1135f22], ebx                       # 0049B987
    mov eax, dword ptr [ebx + 0xa]                       # 0049B98D
    add eax, dword ptr [0x1135f32]                       # 0049B990
    mov dword ptr [0x1135f2e], eax                       # 0049B996
    movzx eax, byte ptr [ebx + 4]                        # 0049B99B
    mov ebx, dword ptr [eax*4 + 0x4ffb80]                # 0049B99F
    ...
    mov ecx, dword ptr [0x1135f2a]                       # 0049B9B5
    and ebp, 0xf                                         # 0049B9BB
    call dword ptr [ebx + ecx*4]                         # 0049B9BE
    pop esi                                              # 0049B9C1
.L49B9C2:
    pop ebx                                              # 0049B9C2
    mov byte ptr [0xe3f0ac], bl                          # 0049B9C3
.L49B9C9:
    test byte ptr [esi + 4], 0x40                        # 0049B9C9
    je _sub_49BB97                                       # 0049B9CD
    mov bl, 5                                            # 0049B9D3
    xchg byte ptr [0xe3f0ac], bl                         # 0049B9D5
    push ebx                                             # 0049B9DB
    test word ptr [0x1135fe4], 1                         # 0049B9DC
    je .L49BA49                                          # 0049B9E5
    test byte ptr [esi + 7], 0x10                        # 0049B9E7
    jne .L49BA49                                         # 0049B9EB
    mov ebx, dword ptr [0x1135f1e]                       # 0049B9ED
    push esi                                             # 0049B9F3
    movzx ebx, byte ptr [ebx + 0xa]                      # 0049B9F4
    mov byte ptr [0xe3f0ad], 0                           # 0049B9F8
    mov ebx, dword ptr [ebx*4 + 0x50c8f4]                # 0049B9FF
    mov dword ptr [0x1135f22], ebx                       # 0049BA06
    movzx eax, byte ptr [0x50aed8]                       # 0049BA0C
    mov eax, dword ptr [eax*4 + 0x4ffae8]                # 0049BA13
    add eax, dword ptr [ebx + 0xa]                       # 0049BA1A
    mov dword ptr [0x1135f2e], eax                       # 0049BA1D
    movzx eax, byte ptr [ebx + 4]                        # 0049BA22
    mov ebx, dword ptr [eax*4 + 0x4ffb80]                # 0049BA26
    ...
    mov ecx, dword ptr [0x1135f2a]                       # 0049BA3C
    and ebp, 0xf                                         # 0049BA42
    call dword ptr [ebx + ecx*4]                         # 0049BA45
    pop esi                                              # 0049BA48
.L49BA49:
    test word ptr [0x1135fe4], 2                         # 0049BA49
    je .L49BAB6                                          # 0049BA52
    test byte ptr [esi + 7], 0x20                        # 0049BA54
    jne .L49BAB6                                         # 0049BA58
    mov ebx, dword ptr [0x1135f1e]                       # 0049BA5A
    push esi                                             # 0049BA60
    movzx ebx, byte ptr [ebx + 0xb]                      # 0049BA61
    mov byte ptr [0xe3f0ad], 1                           # 0049BA65
    mov ebx, dword ptr [ebx*4 + 0x50c8f4]                # 0049BA6C
    mov dword ptr [0x1135f22], ebx                       # 0049BA73
    movzx eax, byte ptr [0x50aed8]                       # 0049BA79
    mov eax, dword ptr [eax*4 + 0x4ffae8]                # 0049BA80
    add eax, dword ptr [ebx + 0xa]                       # 0049BA87
    mov dword ptr [0x1135f2e], eax                       # 0049BA8A
    movzx eax, byte ptr [ebx + 4]                        # 0049BA8F
    mov ebx, dword ptr [eax*4 + 0x4ffb80]                # 0049BA93
    ...
    mov ecx, dword ptr [0x1135f2a]                       # 0049BAA9
    and ebp, 0xf                                         # 0049BAAF
    call dword ptr [ebx + ecx*4]                         # 0049BAB2
    pop esi                                              # 0049BAB5
.L49BAB6:
    test word ptr [0x1135fe4], 4                         # 0049BAB6
    je .L49BB23                                          # 0049BABF
    test byte ptr [esi + 7], 0x40                        # 0049BAC1
    jne .L49BB23                                         # 0049BAC5
    mov ebx, dword ptr [0x1135f1e]                       # 0049BAC7
    push esi                                             # 0049BACD
    movzx ebx, byte ptr [ebx + 0xc]                      # 0049BACE
    mov byte ptr [0xe3f0ad], 2                           # 0049BAD2
    mov ebx, dword ptr [ebx*4 + 0x50c8f4]                # 0049BAD9
    mov dword ptr [0x1135f22], ebx                       # 0049BAE0
    movzx eax, byte ptr [0x50aed8]                       # 0049BAE6
    mov eax, dword ptr [eax*4 + 0x4ffae8]                # 0049BAED
    add eax, dword ptr [ebx + 0xa]                       # 0049BAF4
    mov dword ptr [0x1135f2e], eax                       # 0049BAF7
    movzx eax, byte ptr [ebx + 4]                        # 0049BAFC
    mov ebx, dword ptr [eax*4 + 0x4ffb80]                # 0049BB00
    ...
    mov ecx, dword ptr [0x1135f2a]                       # 0049BB16
    and ebp, 0xf                                         # 0049BB1C
    call dword ptr [ebx + ecx*4]                         # 0049BB1F
    pop esi                                              # 0049BB22
.L49BB23:
    test word ptr [0x1135fe4], 8                         # 0049BB23
    je .L49BB90                                          # 0049BB2C
    test byte ptr [esi + 7], 0x80                        # 0049BB2E
    jne .L49BB90                                         # 0049BB32
    mov ebx, dword ptr [0x1135f1e]                       # 0049BB34
    push esi                                             # 0049BB3A
    movzx ebx, byte ptr [ebx + 0xd]                      # 0049BB3B
    mov byte ptr [0xe3f0ad], 3                           # 0049BB3F
    mov ebx, dword ptr [ebx*4 + 0x50c8f4]                # 0049BB46
    mov dword ptr [0x1135f22], ebx                       # 0049BB4D
    movzx eax, byte ptr [0x50aed8]                       # 0049BB53
    mov eax, dword ptr [eax*4 + 0x4ffae8]                # 0049BB5A
    add eax, dword ptr [ebx + 0xa]                       # 0049BB61
    mov dword ptr [0x1135f2e], eax                       # 0049BB64
    movzx eax, byte ptr [ebx + 4]                        # 0049BB69
    mov ebx, dword ptr [eax*4 + 0x4ffb80]                # 0049BB6D
    ...
    mov ecx, dword ptr [0x1135f2a]                       # 0049BB83
    and ebp, 0xf                                         # 0049BB89
    call dword ptr [ebx + ecx*4]                         # 0049BB8C
    pop esi                                              # 0049BB8F
.L49BB90:
    pop ebx                                              # 0049BB90
    mov byte ptr [0xe3f0ac], bl                          # 0049BB91
...
_sub_49BB97:
    ...
    .global _sub_49BB98
_sub_49BB98:
    mov byte ptr [0x9c68ea], 0x30                        # 0049BB98
    mov word ptr [0x9c68e0], ax                          # 0049BB9F
    mov word ptr [0x9c68e2], cx                          # 0049BBA5
    add word ptr [0x9c68e0], 0x10                        # 0049BBAC
    add word ptr [0x9c68e2], 0x10                        # 0049BBB4
    mov word ptr [0x9c68e4], di                          # 0049BBBC
    and bh, 3                                            # 0049BBC3
    mov byte ptr [0x1136072], 0                          # 0049BBC6
    mov byte ptr [0x1136073], 0                          # 0049BBCD
    mov byte ptr [0x1136075], 0xff                       # 0049BBD4
    mov byte ptr [0x1136074], 0                          # 0049BBDB
    mov dword ptr [0x1135c78], edi                       # 0049BBE2
    ror edi, 0x10                                        # 0049BBE8
    mov word ptr [0x1135f84], di                         # 0049BBEB
    ror edi, 0x10                                        # 0049BBF2
    mov dword ptr [0x1135c68], edx                       # 0049BBF5
    test bl, 1                                           # 0049BBFB
    je .L49BC24                                          # 0049BBFE
    ...
    mov bh, byte ptr [0x9c68eb]                          # 0049BC16
    mov bl, 1                                            # 0049BC1C
...
.L49BC24:
    ...
    jb _sub_49C268                                       # 0049BC31
    movzx ebp, byte ptr [esp + 0xc]                      # 0049BC37
    mov ebp, dword ptr [ebp*4 + 0x50c914]                # 0049BC3C
    msvc_xor esi, esi                                    # 0049BC43
.L49BC45:
    bt word ptr [0x1135f84], si                          # 0049BC45
    jae .L49BC82                                         # 0049BC4D
    push eax                                             # 0049BC4F
    push edx                                             # 0049BC50
    push ebp                                             # 0049BC51
    movzx ebp, byte ptr [esi + ebp + 0xa]                # 0049BC52
    mov ebp, dword ptr [ebp*4 + 0x50c8f4]                # 0049BC57
    movzx edx, dh                                        # 0049BC5E
    mov ax, word ptr [edx*2 + 0x4f891c]                  # 0049BC61
    and ax, word ptr [ebp + 2]                           # 0049BC69
    cmp ax, word ptr [edx*2 + 0x4f891c]                  # 0049BC6D
    je .L49BC7F                                          # 0049BC75
    btr word ptr [0x1135f84], si                         # 0049BC77
.L49BC7F:
    pop ebp                                              # 0049BC7F
    pop edx                                              # 0049BC80
    pop eax                                              # 0049BC81
...
_sub_49BDF6:
    ...
    and dl, 0xf                                          # 0049BE13
    jmp dword ptr [edi*4 + 0x4ffb88]                     # 0049BE16
...
_sub_49BE89:
    ...
    jl _sub_49C228                                       # 0049BEA2
    shr dx, 2                                            # 0049BEA8
    mov dh, byte ptr [ebp + 7]                           # 0049BEAC
    shr dh, 2                                            # 0049BEAF
    msvc_add dh, dl                                      # 0049BEB2
    add dh, 8                                            # 0049BEB4
    and byte ptr [0x1136073], 0xfd                       # 0049BEB7
    ...
    shr esi, 3                                           # 0049BEDF
    mov esi, dword ptr [esi + 0xe40134]                  # 0049BEE2
...
.L49BEF5:
    test byte ptr [esi + 5], 0x1f                        # 0049BEF5
    je .L49BF02                                          # 0049BEF9
    or byte ptr [0x1136073], 0x80                        # 0049BEFB
.L49BF02:
    ...
    je .L49BF7C                                          # 0049BF1C
.L49BF1E:
    or byte ptr [0x1136073], 3                           # 0049BF1E
    push edx                                             # 0049BF25
    sub dl, byte ptr [esi + 2]                           # 0049BF26
    shr dl, 2                                            # 0049BF29
    movsx edi, byte ptr [esp + 0x13]                     # 0049BF2C
    cmp edi, -1                                          # 0049BF31
    je _sub_49C1F9                                       # 0049BF34
    mov edi, dword ptr [edi*4 + 0x50c894]                # 0049BF3A
    cmp dl, byte ptr [edi + 0xc]                         # 0049BF41
    ja _sub_49C211                                       # 0049BF44
    cmp dl, byte ptr [0x1136074]                         # 0049BF4A
    jb .L49BF58                                          # 0049BF50
    mov byte ptr [0x1136074], dl                         # 0049BF52
.L49BF58:
    movzx edx, byte ptr [esp + 0x11]                     # 0049BF58
    mov dx, word ptr [edx*2 + 0x4f8764]                  # 0049BF5D
    test word ptr [edi + 0x14], dx                       # 0049BF65
    jne _sub_49C205                                      # 0049BF69
    pop edx                                              # 0049BF6F
    push eax                                             # 0049BF70
...
.L49BF7C:
    ...
    ja _sub_49C233                                       # 0049BF7F
    mov byte ptr [0x113601c], dl                         # 0049BF85
    mov word ptr [0x1135fe0], ax                         # 0049BF8B
    mov word ptr [0x1135fe2], cx                         # 0049BF91
    mov dword ptr [0x1135f5a], esp                       # 0049BF98
    mov dword ptr [0x1135f5e], ebp                       # 0049BF9E
    mov byte ptr [0x113607c], 0                          # 0049BFA4
    push ebp                                             # 0049BFAB
    mov ebp, 0x49c275                                    # 0049BFAC
    call _sub_462917                                     # 0049BFB1
    pop ebp                                              # 0049BFB6
    jb _sub_49C268                                       # 0049BFB7
    test byte ptr [0x113607c], 1                         # 0049BFBD
    je .L49BFEF                                          # 0049BFC4
    push eax                                             # 0049BFC6
    push ecx                                             # 0049BFC7
    movzx edi, byte ptr [0x525fc4]                       # 0049BFC8
    mov edi, dword ptr [edi*4 + 0x50c840]                # 0049BFCF
    movsx eax, word ptr [edi + 2]                        # 0049BFD6
    movzx ecx, byte ptr [edi + 6]                        # 0049BFDA
    imul eax, dword ptr [ecx*4 + 0x525e5e]               # 0049BFDE
...
.L49C009:
    ...
    pop edx                                              # 0049C00E
    jb _sub_49C268                                       # 0049C00F
    mov bh, byte ptr [0xf00166]                          # 0049C015
    and bh, 3                                            # 0049C01B
    cmp byte ptr [0x1136072], 0                          # 0049C01E
    je .L49C033                                          # 0049C025
    test byte ptr [0x1136072], bh                        # 0049C027
    je _sub_49C25F                                       # 0049C02D
.L49C033:
    mov byte ptr [0x1136072], bh                         # 0049C033
    test byte ptr [0xf00166], 4                          # 0049C039
    jne _sub_49C249                                      # 0049C040
    test byte ptr [0xf00166], 8                          # 0049C046
    jne _sub_49C254                                      # 0049C04D
    test byte ptr [esp + 0x14], 1                        # 0049C053
    je .L49C12F                                          # 0049C058
    mov bh, byte ptr [0x9c68eb]                          # 0049C05E
    cmp bh, byte ptr [0x525e3c]                          # 0049C064
    je .L49C074                                          # 0049C06A
    cmp bh, byte ptr [0x525e3d]                          # 0049C06C
    jne .L49C083                                         # 0049C072
.L49C074:
    push eax                                             # 0049C074
    mov al, 3                                            # 0049C075
    mov ah, byte ptr [0x9c68eb]                          # 0049C077
...
.L49C12F:
    ...
    msvc_jmp _sub_49BDF6                                 # 0049C132

    .global _sub_49C137
_sub_49C137:
    pop ebx                                              # 0049C137
    test byte ptr [0x1136073], 1                         # 0049C138
    je .L49C190                                          # 0049C13F
    movzx edi, byte ptr [esp + 0xb]                      # 0049C141
    mov edi, dword ptr [edi*4 + 0x50c894]                # 0049C146
    movzx ecx, byte ptr [0x1136074]                      # 0049C14D
    ...
    imul eax, dword ptr [ecx*4 + 0x525e5e]               # 0049C165
    sar eax, 0xa                                         # 0049C16D
    movzx ecx, byte ptr [esp + 9]                        # 0049C170
    movzx ecx, word ptr [ecx*2 + 0x4f870c]               # 0049C175
    imul eax, ecx                                        # 0049C17D
    sar eax, 8                                           # 0049C180
    test byte ptr [0x1136073], 0x80                      # 0049C183
    je .L49C18E                                          # 0049C18A
    shl eax, 1                                           # 0049C18C
.L49C18E:
    msvc_add ebx, eax                                    # 0049C18E
.L49C190:
    test byte ptr [0x1136072], 2                         # 0049C190
    je .L49C1C8                                          # 0049C197
    movzx edi, byte ptr [esp + 8]                        # 0049C199
    mov edi, dword ptr [edi*4 + 0x50c914]                # 0049C19E
    movsx eax, word ptr [edi + 0x18]                     # 0049C1A5
    imul eax, dword ptr [0x525e66]                       # 0049C1A9
    sar eax, 8                                           # 0049C1B0
    movzx ecx, byte ptr [esp + 9]                        # 0049C1B3
    movzx ecx, word ptr [ecx*2 + 0x4f870c]               # 0049C1B8
...
.L49C1C8:
    ...
    pushal                                               # 0049C1D6
    mov cx, word ptr [0x9c68e0]                          # 0049C1D7
    mov dx, word ptr [0x9c68e2]                          # 0049C1DE
    mov bp, word ptr [0x9c68e4]                          # 0049C1E5
...
_sub_49C1F9:
    pop edx                                              # 0049C1F9
    mov word ptr [0x9c68e6], 0x17a                       # 0049C1FA
    jmp _sub_49C268                                      # 0049C203

    .global _sub_49C205
_sub_49C205:
    pop edx                                              # 0049C205
    mov word ptr [0x9c68e6], 0x17e                       # 0049C206
    jmp _sub_49C268                                      # 0049C20F

    .global _sub_49C211
_sub_49C211:
    pop edx                                              # 0049C211
    mov word ptr [0x9c68e6], 0x17b                       # 0049C212
    jmp _sub_49C268                                      # 0049C21B
# 0x49C21D
    .byte 0x66, 0xC7, 0x05, 0xE6, 0x68, 0x9C, 0x00, 0x64 #        0 f...h..d
    .byte 0x01, 0xEB, 0x40                               #        8 ..@


    .global _sub_49C228
_sub_49C228:
    mov word ptr [0x9c68e6], 0x62                        # 0049C228
    jmp _sub_49C268                                      # 0049C231

    .global _sub_49C233
_sub_49C233:
    mov word ptr [0x9c68e6], 0x63                        # 0049C233
    jmp _sub_49C268                                      # 0049C23C
# 0x49C23E
    .byte 0x66, 0xC7, 0x05, 0xE6, 0x68, 0x9C, 0x00, 0x68 #        0 f...h..h
    .byte 0x01, 0xEB, 0x1F                               #        8 ...


    .global _sub_49C249
_sub_49C249:
    mov word ptr [0x9c68e6], 0x167                       # 0049C249
    jmp _sub_49C268                                      # 0049C252

    .global _sub_49C254
_sub_49C254:
    mov word ptr [0x9c68e6], 0x166                       # 0049C254
    jmp _sub_49C268                                      # 0049C25D

    .global _sub_49C25F
_sub_49C25F:
    mov word ptr [0x9c68e6], 0x70                        # 0049C25F
...
_sub_49C268:
    ...
    ret                                                  # 0049C274
# 0x49C275
    .byte 0x60, 0x8A, 0x06, 0x24, 0x3C, 0x3C, 0x04, 0x0F #        0 `..$<<..
    .byte 0x84, 0x7D, 0x02, 0x00, 0x00, 0x3C, 0x1C, 0x0F #        8 .}...<..
    .byte 0x84, 0x77, 0x01, 0x00, 0x00, 0x3C, 0x0C, 0x0F #       10 .w...<..
    .byte 0x84, 0x4C, 0x04, 0x00, 0x00, 0x3C, 0x08, 0x75 #       18 .L...<.u
    .byte 0x0F, 0x8A, 0x66, 0x05, 0xC0, 0xEC, 0x05, 0x80 #       20 ..f.....
    .byte 0xFC, 0x00, 0x0F, 0x84, 0x39, 0x04, 0x00, 0x00 #       28 ....9...
    .byte 0x3C, 0x14, 0x0F, 0x84, 0xEF, 0x00, 0x00, 0x00 #       30 <.......
    .byte 0x3C, 0x10, 0x74, 0x03, 0x61, 0xF9, 0xC3, 0x80 #       38 <.t.a...
    .byte 0x0D, 0x73, 0x60, 0x13, 0x01, 0x10, 0x0F, 0xB6 #       40 .s`.....
    .byte 0x5E, 0x04, 0x8B, 0x1C, 0x9D, 0x70, 0xCE, 0x50 #       48 ^....p.P
    .byte 0x00, 0xF6, 0x83, 0x98, 0x00, 0x00, 0x00, 0x08 #       50 ........
    .byte 0x75, 0xE2, 0x66, 0xA1, 0xE0, 0x5F, 0x13, 0x01 #       58 u.f.._..
    .byte 0x66, 0x8B, 0x0D, 0xE2, 0x5F, 0x13, 0x01, 0x8A #       60 f..._...
    .byte 0x5E, 0x05, 0x83, 0xE3, 0x03, 0x66, 0x2B, 0x04 #       68 ^....f+.
    .byte 0x9D, 0x96, 0x92, 0x4F, 0x00, 0x66, 0x2B, 0x0C #       70 ...O.f+.
    .byte 0x9D, 0x98, 0x92, 0x4F, 0x00, 0x8A, 0x56, 0x02 #       78 ...O..V.
    .byte 0xBD, 0x7C, 0x5C, 0x13, 0x01, 0x66, 0x83, 0x7D #       80 .|...f.}
    .byte 0x00, 0xFF, 0x74, 0x1A, 0x66, 0x3B, 0x45, 0x00 #       88 ..t.f;E.
    .byte 0x75, 0x0F, 0x66, 0x3B, 0x4D, 0x02, 0x75, 0x09 #       90 u.f;M.u.
    .byte 0x3A, 0x55, 0x04, 0x0F, 0x84, 0xC8, 0x03, 0x00 #       98 :U......
    .byte 0x00, 0x83, 0xC5, 0x06, 0xEB, 0xDF, 0x66, 0x89 #       A0 ......f.
    .byte 0x45, 0x00, 0x66, 0x89, 0x4D, 0x02, 0x88, 0x55 #       A8 E.f.M..U
    .byte 0x04, 0x66, 0xC7, 0x45, 0x06, 0xFF, 0xFF, 0x89 #       B0 .f.E....
    .byte 0x35, 0x58, 0x01, 0xF0, 0x00, 0x8B, 0x2D, 0x5A #       B8 5X....-Z
    .byte 0x5F, 0x13, 0x01, 0x66, 0x0F, 0xB6, 0x7E, 0x02 #       C0 _..f..~.
    .byte 0x66, 0xC1, 0xE7, 0x02, 0x8A, 0x5D, 0x14, 0xF6 #       C8 f....]..
    .byte 0xC3, 0x01, 0x75, 0x0A, 0x66, 0x83, 0x3D, 0x82 #       D0 ..u.f.=.
    .byte 0x5C, 0x13, 0x01, 0xFF, 0x74, 0x03, 0x80, 0xCB #       D8 ....t...
    .byte 0x80, 0xF6, 0xC3, 0x50, 0x74, 0x03, 0x80, 0xE3 #       E0 ...Pt...
    .byte 0xAE, 0xE8, 0xEB, 0x13, 0xF9, 0xFF, 0x81, 0xFB #       E8 ........
    .byte 0x00, 0x00, 0x00, 0x80, 0x0F, 0x84, 0x42, 0xFF #       F0 ......B.
    .byte 0xFF, 0xFF, 0x8B, 0x2D, 0x5A, 0x5F, 0x13, 0x01 #       F8 ...-Z_..
    .byte 0x01, 0x5D, 0x00, 0xF6, 0x45, 0x14, 0x01, 0x0F #      100 .]..E...
    .byte 0x84, 0x5C, 0x03, 0x00, 0x00, 0xF6, 0x45, 0x14 #      108 ......E.
    .byte 0x50, 0x0F, 0x85, 0x52, 0x03, 0x00, 0x00, 0x8B #      110 P..R....
    .byte 0x35, 0x58, 0x01, 0xF0, 0x00, 0x89, 0x35, 0x5C #      118 5X....5.
    .byte 0x01, 0xF0, 0x00, 0x61, 0x23, 0xC0, 0xC3, 0x8B #      120 ...a#...
    .byte 0x2D, 0x5A, 0x5F, 0x13, 0x01, 0x0F, 0xB6, 0x5E #      128 -Z_....^
    .byte 0x04, 0x8B, 0x1C, 0x9D, 0x64, 0xCD, 0x50, 0x00 #      130 ....d.P.
    .byte 0x0F, 0xBF, 0x4B, 0x42, 0x0F, 0xB6, 0x5B, 0x3F #      138 ..KB..[?
    .byte 0x0F, 0xAF, 0x0C, 0x9D, 0x5E, 0x5E, 0x52, 0x00 #      140 ....^^R.
    .byte 0xC1, 0xF9, 0x0C, 0x01, 0x4D, 0x00, 0xF6, 0x45 #      148 ....M..E
    .byte 0x14, 0x50, 0x0F, 0x85, 0x11, 0x03, 0x00, 0x00 #      150 .P......
    .byte 0xF6, 0x45, 0x14, 0x01, 0x0F, 0x84, 0x07, 0x03 #      158 .E......
    .byte 0x00, 0x00, 0x89, 0x35, 0x58, 0x01, 0xF0, 0x00 #      160 ...5X...
    .byte 0x66, 0xA1, 0xE0, 0x5F, 0x13, 0x01, 0x66, 0x8B #      168 f.._..f.
    .byte 0x0D, 0xE2, 0x5F, 0x13, 0x01, 0xB3, 0x01, 0xE8 #      170 .._.....
    .byte 0x41, 0xF0, 0x01, 0x00, 0x8B, 0x35, 0x58, 0x01 #      178 A....5X.
    .byte 0xF0, 0x00, 0x89, 0x35, 0x5C, 0x01, 0xF0, 0x00 #      180 ...5....
    .byte 0x61, 0x23, 0xC0, 0xC3, 0x8B, 0x2D, 0x5A, 0x5F #      188 a#...-Z_
    .byte 0x13, 0x01, 0xF6, 0x46, 0x04, 0x80, 0x74, 0x1F #      190 ...F..t.
    .byte 0x0F, 0xB6, 0x46, 0x06, 0xC0, 0xE8, 0x05, 0xA2 #      198 ..F.....
    .byte 0x75, 0x60, 0x13, 0x01, 0x8B, 0x04, 0x85, 0x94 #      1A0 u`......
    .byte 0xC8, 0x50, 0x00, 0x66, 0xF7, 0x40, 0x14, 0x00 #      1A8 .P.f.@..
    .byte 0x08, 0x0F, 0x85, 0xE8, 0x02, 0x00, 0x00, 0x0F #      1B0 ........
    .byte 0xB6, 0x46, 0x05, 0xC0, 0xE8, 0x04, 0x8B, 0x1C #      1B8 .F......
    .byte 0x85, 0x84, 0xC9, 0x50, 0x00, 0x0F, 0xB6, 0x45 #      1C0 ...P...E
    .byte 0x0C, 0x66, 0x0F, 0xA3, 0x43, 0x2C, 0x72, 0x19 #      1C8 .f..C,r.
    .byte 0x8B, 0x1C, 0x85, 0x14, 0xC9, 0x50, 0x00, 0x0F #      1D0 .....P..
    .byte 0xB6, 0x46, 0x05, 0xC0, 0xE8, 0x04, 0x66, 0x0F #      1D8 .F....f.
    .byte 0xA3, 0x43, 0x12, 0x0F, 0x83, 0x5B, 0x03, 0x00 #      1E0 .C...[..
    .byte 0x00, 0xF6, 0x06, 0x40, 0x0F, 0x85, 0xCF, 0x02 #      1E8 ...@....
    .byte 0x00, 0x00, 0xF6, 0x06, 0x80, 0x0F, 0x85, 0xB5 #      1F0 ........
    .byte 0x02, 0x00, 0x00, 0xF6, 0x46, 0x04, 0x80, 0x74 #      1F8 ....F..t
    .byte 0x0F, 0x8A, 0x46, 0x06, 0xC0, 0xE8, 0x05, 0x3A #      200 ..F....:
    .byte 0x45, 0x0F, 0x0F, 0x85, 0x7E, 0x02, 0x00, 0x00 #      208 E...~...
    .byte 0x8A, 0x5E, 0x04, 0x80, 0xE3, 0x0F, 0x80, 0xFB #      210 .^......
    .byte 0x00, 0x0F, 0x85, 0x4D, 0x02, 0x00, 0x00, 0x8A #      218 ...M....
    .byte 0x5D, 0x0D, 0x80, 0xFB, 0x00, 0x0F, 0x85, 0x41 #      220 ]......A
    .byte 0x02, 0x00, 0x00, 0x8A, 0x16, 0x2A, 0x55, 0x15 #      228 .....*U.
    .byte 0xF6, 0xC2, 0x01, 0x0F, 0x84, 0x33, 0x02, 0x00 #      230 .....3..
    .byte 0x00, 0x8A, 0x46, 0x02, 0x3A, 0x05, 0x1C, 0x60 #      238 ..F.:..`
    .byte 0x13, 0x01, 0x0F, 0x85, 0x24, 0x02, 0x00, 0x00 #      240 ....$...
    .byte 0x80, 0x0D, 0x7C, 0x60, 0x13, 0x01, 0x01, 0x80 #      248 ..|`....
    .byte 0x0D, 0x73, 0x60, 0x13, 0x01, 0x04, 0xF6, 0x45 #      250 .s`....E
    .byte 0x14, 0x50, 0x0F, 0x85, 0x09, 0x02, 0x00, 0x00 #      258 .P......
    .byte 0xF6, 0x45, 0x14, 0x01, 0x0F, 0x84, 0xFF, 0x01 #      260 .E......
    .byte 0x00, 0x00, 0x80, 0x4E, 0x07, 0x20, 0x80, 0x66 #      268 ...N. .f
    .byte 0x05, 0xF3, 0xA0, 0xC4, 0x5F, 0x52, 0x00, 0xC0 #      270 ...._R..
    .byte 0xE0, 0x02, 0x08, 0x46, 0x05, 0x80, 0x66, 0x07 #      278 ...F..f.
    .byte 0xEF, 0x80, 0x66, 0x06, 0xF0, 0xE9, 0xDF, 0x01 #      280 ..f.....
    .byte 0x00, 0x00, 0x8B, 0x2D, 0x5A, 0x5F, 0x13, 0x01 #      288 ...-Z_..
    .byte 0xF6, 0x46, 0x04, 0x80, 0x74, 0x0B, 0x8A, 0x46 #      290 .F..t..F
    .byte 0x06, 0xC0, 0xE8, 0x05, 0xA2, 0x75, 0x60, 0x13 #      298 .....u`.
    .byte 0x01, 0x8A, 0x5E, 0x04, 0x83, 0xE3, 0x3F, 0x8B #      2A0 ..^...?.
    .byte 0x1C, 0x9D, 0xF8, 0x78, 0x4F, 0x00, 0x8A, 0x4E #      2A8 ...xO..N
    .byte 0x05, 0x83, 0xE1, 0x0F, 0xC1, 0xE1, 0x02, 0x8A #      2B0 ........
    .byte 0x16, 0x80, 0xE2, 0x03, 0x0A, 0xCA, 0x8A, 0x34 #      2B8 .......4
    .byte 0x19, 0x0F, 0xB6, 0x5D, 0x0D, 0x8B, 0x1C, 0x9D #      2C0 ...]....
    .byte 0xF8, 0x78, 0x4F, 0x00, 0x8B, 0x0D, 0x5E, 0x5F #      2C8 .xO...^_
    .byte 0x13, 0x01, 0x0F, 0xB6, 0x09, 0xC1, 0xE1, 0x02 #      2D0 ........
    .byte 0x8A, 0x55, 0x15, 0x80, 0xE2, 0x03, 0x0A, 0xCA #      2D8 .U......
    .byte 0x84, 0x34, 0x19, 0x0F, 0x84, 0x80, 0x01, 0x00 #      2E0 .4......
    .byte 0x00, 0xF7, 0x05, 0x68, 0x5C, 0x13, 0x01, 0x00 #      2E8 ...h....
    .byte 0x00, 0x40, 0x00, 0x0F, 0x85, 0x73, 0x02, 0x00 #      2F0 .@...s..
    .byte 0x00, 0x8A, 0x46, 0x07, 0x24, 0x0F, 0xE8, 0xF2 #      2F8 ..F.$...
    .byte 0x58, 0xF9, 0xFF, 0x0F, 0x82, 0x6C, 0x02, 0x00 #      300 X....l..
    .byte 0x00, 0x8A, 0x46, 0x04, 0x83, 0xE0, 0x3F, 0x66 #      308 ..F...?f
    .byte 0xF7, 0x04, 0x45, 0x64, 0x87, 0x4F, 0x00, 0x03 #      310 ..Ed.O..
    .byte 0x00, 0x0F, 0x85, 0xDB, 0x01, 0x00, 0x00, 0x0F #      318 ........
    .byte 0xB6, 0x45, 0x0D, 0x66, 0xF7, 0x04, 0x45, 0x64 #      320 .E.f..Ed
    .byte 0x87, 0x4F, 0x00, 0x03, 0x00, 0x0F, 0x85, 0xC7 #      328 .O......
    .byte 0x01, 0x00, 0x00, 0x8A, 0x46, 0x02, 0x3A, 0x05 #      330 ....F.:.
    .byte 0x1C, 0x60, 0x13, 0x01, 0x0F, 0x85, 0x90, 0x01 #      338 .`......
    .byte 0x00, 0x00, 0xF6, 0x06, 0x40, 0x0F, 0x85, 0x76 #      340 ....@..v
    .byte 0x01, 0x00, 0x00, 0xF6, 0x06, 0x80, 0x0F, 0x85 #      348 ........
    .byte 0x5C, 0x01, 0x00, 0x00, 0x8A, 0x45, 0x15, 0x32 #      350 .....E.2
    .byte 0x06, 0xA8, 0x01, 0x75, 0x24, 0x8A, 0x5E, 0x04 #      358 ...u$.^.
    .byte 0x0F, 0xB6, 0x4D, 0x0D, 0x83, 0xE3, 0x3F, 0x66 #      360 ..M...?f
    .byte 0x8B, 0x04, 0x4D, 0x64, 0x87, 0x4F, 0x00, 0x66 #      368 ..Md.O.f
    .byte 0x33, 0x04, 0x5D, 0x64, 0x87, 0x4F, 0x00, 0x66 #      370 3.]d.O.f
    .byte 0xA9, 0x00, 0x02, 0x0F, 0x85, 0xFC, 0x00, 0x00 #      378 ........
    .byte 0x00, 0xF6, 0x46, 0x04, 0x80, 0x74, 0x23, 0x0F #      380 ..F..t#.
    .byte 0xB6, 0x46, 0x06, 0xC0, 0xE8, 0x05, 0x3A, 0x45 #      388 .F....:E
    .byte 0x0F, 0x0F, 0x85, 0xF7, 0x00, 0x00, 0x00, 0x8B #      390 ........
    .byte 0x04, 0x85, 0x94, 0xC8, 0x50, 0x00, 0x66, 0xF7 #      398 ....P.f.
    .byte 0x40, 0x14, 0x00, 0x08, 0x0F, 0x85, 0xF5, 0x00 #      3A0 @.......
    .byte 0x00, 0x00, 0x8A, 0x46, 0x05, 0xC0, 0xE8, 0x04 #      3A8 ...F....
    .byte 0x3A, 0x45, 0x0C, 0x75, 0x68, 0x8A, 0x46, 0x04 #      3B0 :E.uh.F.
    .byte 0x24, 0x3F, 0x3A, 0x45, 0x0D, 0x75, 0x21, 0x8A #      3B8 $?:E.u!.
    .byte 0x06, 0x24, 0x03, 0x8A, 0x65, 0x15, 0x80, 0xE4 #      3C0 .$..e...
    .byte 0x03, 0x38, 0xE0, 0x75, 0x13, 0x8A, 0x46, 0x05 #      3C8 .8.u..F.
    .byte 0x24, 0x0F, 0x8B, 0x1D, 0x5E, 0x5F, 0x13, 0x01 #      3D0 $...^_..
    .byte 0x3A, 0x03, 0x0F, 0x84, 0x2B, 0x01, 0x00, 0x00 #      3D8 :...+...
    .byte 0x8A, 0x4E, 0x04, 0x83, 0xE1, 0x3F, 0x8A, 0x04 #      3E0 .N...?..
    .byte 0xCD, 0xBC, 0x87, 0x4F, 0x00, 0x3A, 0x45, 0x0D #      3E8 ...O.:E.
    .byte 0x75, 0x2B, 0x8A, 0x06, 0x02, 0x04, 0xCD, 0xBD #      3F0 u+......
    .byte 0x87, 0x4F, 0x00, 0x24, 0x03, 0x8A, 0x65, 0x15 #      3F8 .O.$..e.
    .byte 0x80, 0xE4, 0x03, 0x38, 0xE0, 0x75, 0x16, 0x8B #      400 ...8.u..
    .byte 0x1D, 0x5E, 0x5F, 0x13, 0x01, 0x80, 0x7B, 0x0A #      408 .^_...{.
    .byte 0xFF, 0x75, 0x0A, 0xF6, 0x46, 0x05, 0x0F, 0x0F #      410 .u..F...
    .byte 0x84, 0xEE, 0x00, 0x00, 0x00, 0x0F, 0xB6, 0x46 #      418 .......F
    .byte 0x05, 0xC0, 0xE8, 0x04, 0x8B, 0x1C, 0x85, 0x14 #      420 ........
    .byte 0xC9, 0x50, 0x00, 0x3A, 0x45, 0x0C, 0x74, 0x26 #      428 .P.:E.t&
    .byte 0x0F, 0xB6, 0x45, 0x0C, 0x66, 0x0F, 0xA3, 0x43 #      430 ..E.f..C
    .byte 0x10, 0x72, 0x27, 0x8B, 0x1C, 0x85, 0x14, 0xC9 #      438 .r'.....
    .byte 0x50, 0x00, 0x0F, 0xB6, 0x46, 0x05, 0xC0, 0xE8 #      440 P...F...
    .byte 0x04, 0x66, 0x0F, 0xA3, 0x43, 0x10, 0x0F, 0x83 #      448 .f..C...
    .byte 0xC8, 0x00, 0x00, 0x00, 0xEB, 0x0C, 0x66, 0xF7 #      450 ......f.
    .byte 0x43, 0x02, 0x00, 0x04, 0x0F, 0x84, 0x0A, 0x01 #      458 C.......
    .byte 0x00, 0x00, 0x80, 0x0D, 0x73, 0x60, 0x13, 0x01 #      460 ....s`..
    .byte 0x08, 0x61, 0xF8, 0xC3, 0x66, 0xC7, 0x05, 0xE6 #      468 .a..f...
    .byte 0x68, 0x9C, 0x00, 0x97, 0x00, 0x61, 0xBE, 0xFF #      470 h....a..
    .byte 0xFF, 0xFF, 0xFF, 0xF9, 0xC3, 0x66, 0xC7, 0x05 #      478 .....f..
    .byte 0xE6, 0x68, 0x9C, 0x00, 0xAA, 0x00, 0x61, 0xBE #      480 .h....a.
    .byte 0xFF, 0xFF, 0xFF, 0xFF, 0xF9, 0xC3, 0x66, 0xC7 #      488 ......f.
    .byte 0x05, 0xE6, 0x68, 0x9C, 0x00, 0xA8, 0x00, 0x61 #      490 ..h....a
    .byte 0xBE, 0xFF, 0xFF, 0xFF, 0xFF, 0xF9, 0xC3, 0x66 #      498 .......f
    .byte 0xC7, 0x05, 0xE6, 0x68, 0x9C, 0x00, 0xA9, 0x00 #      4A0 ...h....
    .byte 0x61, 0xBE, 0xFF, 0xFF, 0xFF, 0xFF, 0xF9, 0xC3 #      4A8 a.......
    .byte 0x66, 0xC7, 0x05, 0xE6, 0x68, 0x9C, 0x00, 0xA2 #      4B0 f...h...
    .byte 0x00, 0x61, 0xBE, 0xFF, 0xFF, 0xFF, 0xFF, 0xF9 #      4B8 .a......
    .byte 0xC3, 0x66, 0xC7, 0x05, 0xE6, 0x68, 0x9C, 0x00 #      4C0 .f...h..
    .byte 0xA3, 0x00, 0x61, 0xBE, 0xFF, 0xFF, 0xFF, 0xFF #      4C8 ..a.....
    .byte 0xF9, 0xC3, 0x0F, 0xB6, 0x46, 0x05, 0xC1, 0xE8 #      4D0 ....F...
    .byte 0x04, 0x8B, 0x04, 0x85, 0x14, 0xC9, 0x50, 0x00 #      4D8 ......P.
    .byte 0x66, 0x8B, 0x00, 0x66, 0xA3, 0x26, 0xC8, 0x12 #      4E0 f..f.&..
    .byte 0x01, 0x66, 0xC7, 0x05, 0xE6, 0x68, 0x9C, 0x00 #      4E8 .f...h..
    .byte 0x9A, 0x00, 0x61, 0xBE, 0xFF, 0xFF, 0xFF, 0xFF #      4F0 ..a.....
    .byte 0xF9, 0xC3, 0x66, 0xC7, 0x05, 0xE6, 0x68, 0x9C #      4F8 ..f...h.
    .byte 0x00, 0x99, 0x00, 0x61, 0xBE, 0xFF, 0xFF, 0xFF #      500 ...a....
    .byte 0xFF, 0xF9, 0xC3, 0x66, 0xC7, 0x05, 0xE6, 0x68 #      508 ...f...h
    .byte 0x9C, 0x00, 0x9B, 0x00, 0x61, 0xBE, 0xFF, 0xFF #      510 ....a...
    .byte 0xFF, 0xFF, 0xF9, 0xC3, 0x0F, 0xB6, 0x46, 0x05 #      518 ......F.
    .byte 0xC1, 0xE8, 0x04, 0x8B, 0x04, 0x85, 0x14, 0xC9 #      520 ........
    .byte 0x50, 0x00, 0x66, 0x8B, 0x00, 0x66, 0xA3, 0x26 #      528 P.f..f.&
    .byte 0xC8, 0x12, 0x01, 0x66, 0xC7, 0x05, 0xE6, 0x68 #      530 ...f...h
    .byte 0x9C, 0x00, 0x9C, 0x00, 0x61, 0xBE, 0xFF, 0xFF #      538 ....a...
    .byte 0xFF, 0xFF, 0xF9, 0xC3, 0x0F, 0xB6, 0x46, 0x05 #      540 ......F.
    .byte 0xC1, 0xE8, 0x04, 0x8B, 0x04, 0x85, 0x84, 0xC9 #      548 ........
    .byte 0x50, 0x00, 0x66, 0x8B, 0x00, 0x66, 0xA3, 0x26 #      550 P.f..f.&
    .byte 0xC8, 0x12, 0x01, 0x66, 0xC7, 0x05, 0xE6, 0x68 #      558 ...f...h
    .byte 0x9C, 0x00, 0x9C, 0x00, 0x61, 0xBE, 0xFF, 0xFF #      560 ....a...
    .byte 0xFF, 0xFF, 0xF9, 0xC3, 0x66, 0xC7, 0x05, 0xE6 #      568 ....f...
    .byte 0x68, 0x9C, 0x00, 0x9D, 0x00, 0x61, 0xBE, 0xFF #      570 h....a..
    .byte 0xFF, 0xFF, 0xFF, 0xF9, 0xC3                   #      578 .....


    .global _sub_49C7F2
_sub_49C7F2:
    mov byte ptr [0x9c68ea], 0x30                        # 0049C7F2
    mov word ptr [0x9c68e0], ax                          # 0049C7F9
    mov word ptr [0x9c68e2], cx                          # 0049C7FF
    add word ptr [0x9c68e0], 0x10                        # 0049C806
    add word ptr [0x9c68e2], 0x10                        # 0049C80E
    mov word ptr [0x9c68e4], di                          # 0049C816
    mov dword ptr [0x1135f16], 0                         # 0049C81D
    mov byte ptr [0x113605b], 0                          # 0049C827
    mov byte ptr [0x113607b], dh                         # 0049C82E
    mov byte ptr [0x113607a], dl                         # 0049C834
    mov word ptr [0x1135fda], bp                         # 0049C83A
    mov byte ptr [0x1136083], 0                          # 0049C841
    test bl, 0x40                                        # 0049C848
    je .L49C854                                          # 0049C84B
    or byte ptr [0x1136083], 0x10                        # 0049C84D
.L49C854:
    test bl, 0x10                                        # 0049C854
    je .L49C860                                          # 0049C857
    or byte ptr [0x1136083], 0x20                        # 0049C859
.L49C860:
    push eax                                             # 0049C860
    push ebx                                             # 0049C861
    push ecx                                             # 0049C862
    ...
    shr esi, 3                                           # 0049C86F
    mov esi, dword ptr [esi + 0xe40134]                  # 0049C872
.L49C878:
    ...
    and dh, 0xf                                          # 0049C89C
    cmp dh, byte ptr [0x113607b]                         # 0049C89F
    jne .L49C8BF                                         # 0049C8A5
    mov dh, byte ptr [esi + 5]                           # 0049C8A7
    shr dh, 4                                            # 0049C8AA
    cmp dh, byte ptr [0x1135fda]                         # 0049C8AD
...
.L49C8C4:
    ...
    cmp dh, byte ptr [0x1136083]                         # 0049C8CA
    jne .L49C8BF                                         # 0049C8D0
    test byte ptr [0x1136083], 0x10                      # 0049C8D2
    je .L49C8E9                                          # 0049C8D9
    mov dh, byte ptr [esi + 7]                           # 0049C8DB
    and dh, 0xf                                          # 0049C8DE
    cmp dh, byte ptr [0x9c68eb]                          # 0049C8E1
    jne .L49C8BF                                         # 0049C8E7
.L49C8E9:
    test byte ptr [0x1136083], 0x10                      # 0049C8E9
    jne .L49C902                                         # 0049C8F0
    mov al, byte ptr [esi + 7]                           # 0049C8F2
    and al, 0xf                                          # 0049C8F5
    call _sub_431E6A                                     # 0049C8F7
    jb _sub_49CE2A                                       # 0049C8FC
.L49C902:
    pop ecx                                              # 0049C902
    pop ebx                                              # 0049C903
    pop eax                                              # 0049C904
    ...
    push edi                                             # 0049C90E
    push ebp                                             # 0049C90F
    mov dh, byte ptr [0x113607b]                         # 0049C910
    mov dl, byte ptr [0x113607a]                         # 0049C916
    mov bp, word ptr [0x1135fda]                         # 0049C91C
...
.L49C93D:
    ...
    ret                                                  # 0049C95A
.L49C95B:
    add dword ptr [0x1135f16], ebx                       # 0049C95B
    pop ebp                                              # 0049C961
    pop edi                                              # 0049C962
    pop edx                                              # 0049C963
    pop ecx                                              # 0049C964
...
.L49C967:
    ...
    shr esi, 3                                           # 0049C976
    mov esi, dword ptr [esi + 0xe40134]                  # 0049C979
.L49C97F:
    ...
    and dh, 0xf                                          # 0049C9A3
    cmp dh, byte ptr [0x113607b]                         # 0049C9A6
    jne .L49C9C6                                         # 0049C9AC
    mov dh, byte ptr [esi + 5]                           # 0049C9AE
    shr dh, 4                                            # 0049C9B1
    cmp dh, byte ptr [0x1135fda]                         # 0049C9B4
...
.L49C9CB:
    ...
    cmp dh, byte ptr [0x1136083]                         # 0049C9D1
    jne .L49C9C6                                         # 0049C9D7
    test byte ptr [0x1136083], 0x10                      # 0049C9D9
    je .L49C9F0                                          # 0049C9E0
    mov dh, byte ptr [esi + 7]                           # 0049C9E2
    and dh, 0xf                                          # 0049C9E5
    cmp dh, byte ptr [0x9c68eb]                          # 0049C9E8
...
.L49C9F0:
    ...
    push edi                                             # 0049C9FC
    push ebp                                             # 0049C9FD
    mov dh, byte ptr [0x113607b]                         # 0049C9FE
    mov dl, byte ptr [0x113607a]                         # 0049CA04
    mov bp, word ptr [0x1135fda]                         # 0049CA0A
    ...
    ret                                                  # 0049CA2E
.L49CA2F:
    add dword ptr [0x1135f16], ebx                       # 0049CA2F
    pop ebp                                              # 0049CA35
    pop edi                                              # 0049CA36
    pop edx                                              # 0049CA37
    pop ecx                                              # 0049CA38
...
.L49CA3B:
    ...
    shr esi, 3                                           # 0049CA4A
    mov esi, dword ptr [esi + 0xe40134]                  # 0049CA4D
.L49CA53:
    ...
    and dh, 0xf                                          # 0049CA77
    cmp dh, byte ptr [0x113607b]                         # 0049CA7A
    jne .L49CA9A                                         # 0049CA80
    mov dh, byte ptr [esi + 5]                           # 0049CA82
    shr dh, 4                                            # 0049CA85
    cmp dh, byte ptr [0x1135fda]                         # 0049CA88
...
.L49CA9F:
    ...
    cmp dh, byte ptr [0x1136083]                         # 0049CAA5
    jne .L49CA9A                                         # 0049CAAB
    test byte ptr [0x1136083], 0x10                      # 0049CAAD
    je .L49CAC4                                          # 0049CAB4
    mov dh, byte ptr [esi + 7]                           # 0049CAB6
    and dh, 0xf                                          # 0049CAB9
    cmp dh, byte ptr [0x9c68eb]                          # 0049CABC
...
_sub_49CB6B:
    ...
    shr dx, 2                                            # 0049CB70
    test byte ptr [0x1136083], 0x20                      # 0049CB74
    je .L49CB7F                                          # 0049CB7B
    jmp .L49CB84                                         # 0049CB7D
.L49CB7F:
    call _sub_4CBE5F                                     # 0049CB7F
.L49CB84:
    mov word ptr [0x1135fdc], ax                         # 0049CB84
    mov word ptr [0x1135fde], cx                         # 0049CB8A
    movzx esi, cx                                        # 0049CB91
    shl esi, 9                                           # 0049CB94
    msvc_or si, ax                                       # 0049CB97
    shr esi, 3                                           # 0049CB9A
    mov esi, dword ptr [esi + 0xe40134]                  # 0049CB9D
.L49CBA3:
    ...
    shr al, 4                                            # 0049CBC6
    cmp al, byte ptr [0x1135fda]                         # 0049CBC9
...
.L49CD84:
    ...
    je .L49CDA7                                          # 0049CD89
    mov ax, word ptr [0x1135fdc]                         # 0049CD8B
    mov cx, word ptr [0x1135fde]                         # 0049CD91
...
.L49CDA7:
    ...
    msvc_jmp _sub_49CB27                                 # 0049CDAE

    .global _sub_49CDB3
_sub_49CDB3:
    pop ebp                                              # 0049CDB3
    add ebp, dword ptr [0x1135f16]                       # 0049CDB4
    test byte ptr [0x113605b], 1                         # 0049CDBA
    je .L49CDFB                                          # 0049CDC1
    movzx edi, byte ptr [0x113605c]                      # 0049CDC3
    mov edi, dword ptr [edi*4 + 0x50c894]                # 0049CDCA
    movsx eax, word ptr [edi + 0x12]                     # 0049CDD1
    movzx ecx, byte ptr [edi + 0xd]                      # 0049CDD5
    imul eax, dword ptr [ecx*4 + 0x525e5e]               # 0049CDD9
    sar eax, 0xa                                         # 0049CDE1
    movzx ecx, byte ptr [0x113607a]                      # 0049CDE4
    movzx ecx, word ptr [ecx*2 + 0x4f870c]               # 0049CDEB
...
.L49CDFB:
    ...
    pushal                                               # 0049CE0B
    mov cx, word ptr [0x9c68e0]                          # 0049CE0C
    mov dx, word ptr [0x9c68e2]                          # 0049CE13
    mov bp, word ptr [0x9c68e4]                          # 0049CE1A
...
_sub_49CE33:
    ...
    test word ptr [0x508f14], 2                          # 0049CE35
    je .L49CE43                                          # 0049CE3E
    or eax, 0x20                                         # 0049CE40
.L49CE43:
    test byte ptr [0x1136063], 0xc0                      # 0049CE43
    je .L49CE4F                                          # 0049CE4A
    or eax, 0x10                                         # 0049CE4C
.L49CE4F:
    cmp byte ptr [0x113602e], 0xff                       # 0049CE4F
    jne .L49CE5B                                         # 0049CE56
    or eax, 0x40                                         # 0049CE58
.L49CE5B:
    cmp dword ptr [0x1136054], -1                        # 0049CE5B
    jne .L49CE69                                         # 0049CE62
    or eax, 0x80                                         # 0049CE64
.L49CE69:
    cmp byte ptr [0x113604c], 0xff                       # 0049CE69
...
_sub_49CE79:
    ...
    mov eax, dword ptr [edx*4 + 0x4ffab8]                # 0049CE80
...
.L49CE94:
    ...
    movzx ebx, byte ptr [0x1136062]                      # 0049CEAD
    test bl, 0x80                                        # 0049CEB4
    jne .L49CF1E                                         # 0049CEB7
    mov ebx, dword ptr [ebx*4 + 0x50c914]                # 0049CEB9
    mov ax, word ptr [ebx]                               # 0049CEC0
    mov word ptr [0x112c826], ax                         # 0049CEC3
.L49CEC9:
    movsx ebp, byte ptr [0x1136039]                      # 0049CEC9
    cmp ebp, -1                                          # 0049CED0
    je .L49CF18                                          # 0049CED3
    mov ebp, dword ptr [ebp*4 + 0x50c894]                # 0049CED5
    cmp ebp, -1                                          # 0049CEDC
    je .L49CF18                                          # 0049CEDF
    movzx eax, word ptr [ebp]                            # 0049CEE1
    mov word ptr [0x112c828], ax                         # 0049CEE5
    mov ax, word ptr [ebp + 0xa]                         # 0049CEEB
    mov word ptr [0x112c82c], ax                         # 0049CEEF
    mov word ptr [0x112c82a], 0x107                      # 0049CEF5
    cmp ax, -1                                           # 0049CEFE
    jne .L49CF0D                                         # 0049CF02
    mov word ptr [0x112c82a], 0x108                      # 0049CF04
.L49CF0D:
    movzx ax, byte ptr [ebp + 0xc]                       # 0049CF0D
    mov word ptr [0x112c82e], ax                         # 0049CF12
.L49CF18:
    call _sub_4A09DE                                     # 0049CF18
    ret                                                  # 0049CF1D
.L49CF1E:
    and ebx, 0xffffff7f                                  # 0049CF1E
    mov ebx, dword ptr [ebx*4 + 0x50c984]                # 0049CF24
    mov ax, word ptr [ebx]                               # 0049CF2B
    mov word ptr [0x112c826], ax                         # 0049CF2E
...
_sub_49CF36:
    ...
    cmp byte ptr [0x521db8], 0                           # 0049CF40
    je .L49CF9E                                          # 0049CF47
    movsx ebp, byte ptr [0x1136039]                      # 0049CF49
    cmp ebp, -1                                          # 0049CF50
    je .L49CF9E                                          # 0049CF53
    mov ebp, dword ptr [ebp*4 + 0x50c894]                # 0049CF55
    cmp ebp, -1                                          # 0049CF5C
    je .L49CF9E                                          # 0049CF5F
    movzx ebx, byte ptr [0x525e3c]                       # 0049CF61
    movzx ebx, byte ptr [ebx + 0x9c645c]                 # 0049CF68
    ...
    add cx, word ptr [0x521dba]                          # 0049CF84
    add dx, word ptr [0x521dbe]                          # 0049CF8B
    add cx, 2                                            # 0049CF92
    inc dx                                               # 0049CF96
    call _sub_448C79                                     # 0049CF98
    pop esi                                              # 0049CF9D
.L49CF9E:
    cmp byte ptr [0x521dd8], 0                           # 0049CF9E
    je _sub_49D1D6                                       # 0049CFA5
    test byte ptr [0x1136062], 0x80                      # 0049CFAB
    jne _sub_49D1D7                                      # 0049CFB2
    push edi                                             # 0049CFB8
    call _sub_4A04F8                                     # 0049CFB9
    shr edi, 0x10                                        # 0049CFBE
    mov word ptr [0x1135fd8], di                         # 0049CFC1
    pop edi                                              # 0049CFC8
    jb _sub_49D1D6                                       # 0049CFC9
    mov byte ptr [0x1136077], dl                         # 0049CFCF
    mov byte ptr [0x1136078], bh                         # 0049CFD5
    mov byte ptr [0x1136079], dh                         # 0049CFDB
    shr edx, 0x10                                        # 0049CFE1
    and dx, 0x1f                                         # 0049CFE4
    mov word ptr [0x1135fd6], dx                         # 0049CFE8
    push edi                                             # 0049CFEF
    push esi                                             # 0049CFF0
    mov ax, word ptr [esi + 0x30]                        # 0049CFF1
    mov cx, word ptr [esi + 0x32]                        # 0049CFF5
    add ax, word ptr [0x521dda]                          # 0049CFF9
    add cx, word ptr [0x521dde]                          # 0049D000
    inc ax                                               # 0049D007
    inc cx                                               # 0049D009
    mov bx, word ptr [0x521ddc]                          # 0049D00B
    mov dx, word ptr [0x521de0]                          # 0049D012
    sub bx, word ptr [0x521dda]                          # 0049D019
    sub dx, word ptr [0x521dde]                          # 0049D020
    dec bx                                               # 0049D027
    dec dx                                               # 0049D029
    push ebx                                             # 0049D02B
    push edx                                             # 0049D02C
    ...
    pop edx                                              # 0049D034
    pop ebx                                              # 0049D035
    je _sub_49D16B                                       # 0049D036
    msvc_mov bp, bx                                      # 0049D03C
    msvc_mov si, dx                                      # 0049D03F
    movzx ecx, byte ptr [0x1136079]                      # 0049D042
    mov ecx, dword ptr [ecx*4 + 0x4f73d8]                # 0049D049
.L49D050:
...
.L49D073:
    mov bl, byte ptr [0x1136078]                         # 0049D073
    and ebx, 3                                           # 0049D079
    jmp dword ptr [ebx*4 + 0x4ffbb8]                     # 0049D07C

    .global _sub_49D083
_sub_49D083:
    xchg ax, cx                                          # 0049D083
    neg cx                                               # 0049D085
    jmp _sub_49D097                                      # 0049D088

    .global _sub_49D08A
_sub_49D08A:
    neg ax                                               # 0049D08A
    neg cx                                               # 0049D08D
    jmp _sub_49D097                                      # 0049D090
...
_sub_49D097:
    ...
    mov ebx, dword ptr [0xe3f0b8]                        # 0049D0AB
    jmp dword ptr [ebx*4 + 0x4ffbc8]                     # 0049D0B1
...
_sub_49D106:
    ...
    mov dword ptr [0xe0c3e0], edi                        # 0049D11E
    push edi                                             # 0049D124
    mov ax, 0x2000                                       # 0049D125
    mov cx, 0x2000                                       # 0049D129
    mov di, word ptr [0x1135fd8]                         # 0049D12D
    shl edi, 0x10                                        # 0049D134
    mov di, 0x1e0                                        # 0049D137
    mov dx, word ptr [0x1135fd6]                         # 0049D13B
    shl edx, 0x10                                        # 0049D142
    mov dl, byte ptr [0x1136077]                         # 0049D145
    mov bh, byte ptr [0x1136078]                         # 0049D14B
    mov dh, byte ptr [0x1136079]                         # 0049D151
    or byte ptr [0x522095], 2                            # 0049D157
    call _sub_4A0AE5                                     # 0049D15E
    and byte ptr [0x522095], 0xfd                        # 0049D163
    pop edi                                              # 0049D16A
...
_sub_49D16B:
    ...
    pop edi                                              # 0049D16C
    push esi                                             # 0049D16D
    mov cx, word ptr [0x521dda]                          # 0049D16E
    add cx, word ptr [0x521ddc]                          # 0049D175
    sar cx, 1                                            # 0049D17C
    mov dx, word ptr [0x521de0]                          # 0049D17F
    add cx, word ptr [esi + 0x30]                        # 0049D186
    add dx, word ptr [esi + 0x32]                        # 0049D18A
    sub dx, 0x17                                         # 0049D18E
    cmp byte ptr [0x1136061], 1                          # 0049D192
    je .L49D1AC                                          # 0049D199
    push ecx                                             # 0049D19B
    push edx                                             # 0049D19C
    push esi                                             # 0049D19D
...
.L49D1AC:
    add dx, 0xb                                          # 0049D1AC
    cmp dword ptr [0x1135f3e], 0x80000000                # 0049D1B0
    je .L49D1D5                                          # 0049D1BA
    cmp dword ptr [0x1135f3e], 0                         # 0049D1BC
    je .L49D1D5                                          # 0049D1C3
    mov bx, 0x8a                                         # 0049D1C5
    msvc_xor al, al                                      # 0049D1C9
    mov esi, 0x1135f3e                                   # 0049D1CB
...
_sub_49D1D7:
    ...
    mov word ptr [0x1135fd8], di                         # 0049D1E0
    pop edi                                              # 0049D1E7
    jb _sub_49D3F5                                       # 0049D1E8
    mov byte ptr [0x1136077], dl                         # 0049D1EE
    mov byte ptr [0x1136078], bh                         # 0049D1F4
    mov byte ptr [0x1136079], dh                         # 0049D1FA
    shr edx, 0x10                                        # 0049D200
    and dx, 0x1f                                         # 0049D203
    mov word ptr [0x1135fd6], dx                         # 0049D207
    push edi                                             # 0049D20E
    push esi                                             # 0049D20F
    mov ax, word ptr [esi + 0x30]                        # 0049D210
    mov cx, word ptr [esi + 0x32]                        # 0049D214
    add ax, word ptr [0x521dda]                          # 0049D218
    add cx, word ptr [0x521dde]                          # 0049D21F
    inc ax                                               # 0049D226
    inc cx                                               # 0049D228
    mov bx, word ptr [0x521ddc]                          # 0049D22A
    mov dx, word ptr [0x521de0]                          # 0049D231
    sub bx, word ptr [0x521dda]                          # 0049D238
    sub dx, word ptr [0x521dde]                          # 0049D23F
    dec bx                                               # 0049D246
    dec dx                                               # 0049D248
    push ebx                                             # 0049D24A
    push edx                                             # 0049D24B
    ...
    pop edx                                              # 0049D253
    pop ebx                                              # 0049D254
    je _sub_49D38A                                       # 0049D255
    msvc_mov bp, bx                                      # 0049D25B
    msvc_mov si, dx                                      # 0049D25E
    movzx ecx, byte ptr [0x1136079]                      # 0049D261
    mov ecx, dword ptr [ecx*4 + 0x4f6d1c]                # 0049D268
.L49D26F:
...
.L49D292:
    mov bl, byte ptr [0x1136078]                         # 0049D292
    and ebx, 3                                           # 0049D298
    jmp dword ptr [ebx*4 + 0x4ffbd8]                     # 0049D29B

    .global _sub_49D2A2
_sub_49D2A2:
    xchg ax, cx                                          # 0049D2A2
    neg cx                                               # 0049D2A4
    jmp _sub_49D2B6                                      # 0049D2A7

    .global _sub_49D2A9
_sub_49D2A9:
    neg ax                                               # 0049D2A9
    neg cx                                               # 0049D2AC
    jmp _sub_49D2B6                                      # 0049D2AF
...
_sub_49D2B6:
    ...
    mov ebx, dword ptr [0xe3f0b8]                        # 0049D2CA
    jmp dword ptr [ebx*4 + 0x4ffbe8]                     # 0049D2D0
...
_sub_49D325:
    ...
    mov dword ptr [0xe0c3e0], edi                        # 0049D33D
    push edi                                             # 0049D343
    mov ax, 0x2000                                       # 0049D344
    mov cx, 0x2000                                       # 0049D348
    mov di, word ptr [0x1135fd8]                         # 0049D34C
    shl edi, 0x10                                        # 0049D353
    mov di, 0x1e0                                        # 0049D356
    mov dx, word ptr [0x1135fd6]                         # 0049D35A
    shl edx, 0x10                                        # 0049D361
    mov dl, byte ptr [0x1136077]                         # 0049D364
    mov bh, byte ptr [0x1136078]                         # 0049D36A
    mov dh, byte ptr [0x1136079]                         # 0049D370
    or byte ptr [0x522095], 2                            # 0049D376
    call _sub_478F1F                                     # 0049D37D
    and byte ptr [0x522095], 0xfd                        # 0049D382
    pop edi                                              # 0049D389
...
_sub_49D38A:
    ...
    pop edi                                              # 0049D38B
    push esi                                             # 0049D38C
    mov cx, word ptr [0x521dda]                          # 0049D38D
    add cx, word ptr [0x521ddc]                          # 0049D394
    sar cx, 1                                            # 0049D39B
    mov dx, word ptr [0x521de0]                          # 0049D39E
    add cx, word ptr [esi + 0x30]                        # 0049D3A5
    add dx, word ptr [esi + 0x32]                        # 0049D3A9
    sub dx, 0x17                                         # 0049D3AD
    cmp byte ptr [0x1136061], 1                          # 0049D3B1
    je .L49D3CB                                          # 0049D3B8
    push ecx                                             # 0049D3BA
    push edx                                             # 0049D3BB
    push esi                                             # 0049D3BC
...
.L49D3CB:
    add dx, 0xb                                          # 0049D3CB
    cmp dword ptr [0x1135f3e], 0x80000000                # 0049D3CF
    je .L49D3F4                                          # 0049D3D9
    cmp dword ptr [0x1135f3e], 0                         # 0049D3DB
    je .L49D3F4                                          # 0049D3E2
    mov bx, 0x8a                                         # 0049D3E4
    msvc_xor al, al                                      # 0049D3E8
    mov esi, 0x1135f3e                                   # 0049D3EA
...
_sub_49D4F5:
    ...
    ret                                                  # 0049D501
.L49D502:
    mov word ptr [0x52338a], 0x7d0                       # 0049D502
    ret                                                  # 0049D50B

    .global _sub_49D50C
_sub_49D50C:
    mov byte ptr [0x113603a], 0xff                       # 0049D50C
    call _sub_49FEC7                                     # 0049D513
    mov dword ptr [0x1135f3e], 0x80000000                # 0049D518
    mov byte ptr [0x1136067], 0xb                        # 0049D522
    cmp dword ptr [0x521d22], 0x933                      # 0049D529
    je _sub_49F1B5                                       # 0049D533
    mov byte ptr [0x1136067], 0xd                        # 0049D539
    cmp dword ptr [0x521d22], 0x937                      # 0049D540
    je _sub_49F1B5                                       # 0049D54A
    cmp dword ptr [0x521d22], 0x938                      # 0049D550
    je _sub_49F1B5                                       # 0049D55A
    mov byte ptr [0x1136067], 0xc                        # 0049D560
    msvc_jmp _sub_49F1B5                                 # 0049D567

    .global _sub_49D56C
_sub_49D56C:
    mov byte ptr [0x113603a], 0xff                       # 0049D56C
    call _sub_49FEC7                                     # 0049D573
    mov dword ptr [0x1135f3e], 0x80000000                # 0049D578
    mov byte ptr [0x1136067], 0xc                        # 0049D582
    cmp dword ptr [0x521d62], 0x934                      # 0049D589
    je _sub_49F1B5                                       # 0049D593
    mov byte ptr [0x1136067], 0xd                        # 0049D599
    cmp dword ptr [0x521d62], 0x938                      # 0049D5A0
    je _sub_49F1B5                                       # 0049D5AA
    mov byte ptr [0x1136067], 0xb                        # 0049D5B0
    msvc_jmp _sub_49F1B5                                 # 0049D5B7

    .global _sub_49D5BC
_sub_49D5BC:
    mov byte ptr [0x113603a], 0xff                       # 0049D5BC
    call _sub_49FEC7                                     # 0049D5C3
    mov byte ptr [0x1136067], 9                          # 0049D5C8
    mov dword ptr [0x1135f3e], 0x80000000                # 0049D5CF
    msvc_jmp _sub_49F1B5                                 # 0049D5D9

    .global _sub_49D5DE
_sub_49D5DE:
    mov byte ptr [0x113603a], 0xff                       # 0049D5DE
    call _sub_49FEC7                                     # 0049D5E5
    mov byte ptr [0x1136067], 0xa                        # 0049D5EA
    mov dword ptr [0x1135f3e], 0x80000000                # 0049D5F1
    msvc_jmp _sub_49F1B5                                 # 0049D5FB

    .global _sub_49D600
_sub_49D600:
    mov byte ptr [0x113603a], 0xff                       # 0049D600
    call _sub_49FEC7                                     # 0049D607
    mov byte ptr [0x1136067], 5                          # 0049D60C
    mov dword ptr [0x1135f3e], 0x80000000                # 0049D613
    msvc_jmp _sub_49F1B5                                 # 0049D61D

    .global _sub_49D622
_sub_49D622:
    mov byte ptr [0x113603a], 0xff                       # 0049D622
    call _sub_49FEC7                                     # 0049D629
    mov byte ptr [0x1136067], 6                          # 0049D62E
    mov dword ptr [0x1135f3e], 0x80000000                # 0049D635
    msvc_jmp _sub_49F1B5                                 # 0049D63F

    .global _sub_49D644
_sub_49D644:
    mov byte ptr [0x113603a], 0xff                       # 0049D644
    call _sub_49FEC7                                     # 0049D64B
    mov byte ptr [0x1136067], 3                          # 0049D650
    mov dword ptr [0x1135f3e], 0x80000000                # 0049D657
    msvc_jmp _sub_49F1B5                                 # 0049D661

    .global _sub_49D666
_sub_49D666:
    mov byte ptr [0x113603a], 0xff                       # 0049D666
    call _sub_49FEC7                                     # 0049D66D
    mov byte ptr [0x1136067], 4                          # 0049D672
    mov dword ptr [0x1135f3e], 0x80000000                # 0049D679
    msvc_jmp _sub_49F1B5                                 # 0049D683

    .global _sub_49D688
_sub_49D688:
    mov byte ptr [0x113603a], 0xff                       # 0049D688
    call _sub_49FEC7                                     # 0049D68F
    mov byte ptr [0x1136067], 1                          # 0049D694
    mov dword ptr [0x1135f3e], 0x80000000                # 0049D69B
    msvc_jmp _sub_49F1B5                                 # 0049D6A5

    .global _sub_49D6AA
_sub_49D6AA:
    mov byte ptr [0x113603a], 0xff                       # 0049D6AA
    call _sub_49FEC7                                     # 0049D6B1
    mov byte ptr [0x1136067], 2                          # 0049D6B6
    mov dword ptr [0x1135f3e], 0x80000000                # 0049D6BD
    msvc_jmp _sub_49F1B5                                 # 0049D6C7

    .global _sub_49D6CC
_sub_49D6CC:
    mov byte ptr [0x113603a], 0xff                       # 0049D6CC
    call _sub_49FEC7                                     # 0049D6D3
    mov byte ptr [0x1136067], 7                          # 0049D6D8
    mov dword ptr [0x1135f3e], 0x80000000                # 0049D6DF
    msvc_jmp _sub_49F1B5                                 # 0049D6E9

    .global _sub_49D6EE
_sub_49D6EE:
    mov byte ptr [0x113603a], 0xff                       # 0049D6EE
    call _sub_49FEC7                                     # 0049D6F5
    mov byte ptr [0x1136067], 8                          # 0049D6FA
    mov dword ptr [0x1135f3e], 0x80000000                # 0049D701
    msvc_jmp _sub_49F1B5                                 # 0049D70B

    .global _sub_49D710
_sub_49D710:
    mov byte ptr [0x113603a], 0xff                       # 0049D710
    call _sub_49FEC7                                     # 0049D717
    mov byte ptr [0x1136067], 0                          # 0049D71C
    mov dword ptr [0x1135f3e], 0x80000000                # 0049D723
    msvc_jmp _sub_49F1B5                                 # 0049D72D

    .global _sub_49D732
_sub_49D732:
    mov byte ptr [0x113603a], 0xff                       # 0049D732
    call _sub_49FEC7                                     # 0049D739
    mov byte ptr [0x1136068], 8                          # 0049D73E
    mov dword ptr [0x1135f3e], 0x80000000                # 0049D745
    msvc_jmp _sub_49F1B5                                 # 0049D74F

    .global _sub_49D754
_sub_49D754:
    mov byte ptr [0x113603a], 0xff                       # 0049D754
    call _sub_49FEC7                                     # 0049D75B
    mov byte ptr [0x1136068], 6                          # 0049D760
    mov dword ptr [0x1135f3e], 0x80000000                # 0049D767
    msvc_jmp _sub_49F1B5                                 # 0049D771

    .global _sub_49D776
_sub_49D776:
    mov byte ptr [0x113603a], 0xff                       # 0049D776
    call _sub_49FEC7                                     # 0049D77D
    mov byte ptr [0x1136068], 0                          # 0049D782
    mov dword ptr [0x1135f3e], 0x80000000                # 0049D789
    msvc_jmp _sub_49F1B5                                 # 0049D793

    .global _sub_49D798
_sub_49D798:
    mov byte ptr [0x113603a], 0xff                       # 0049D798
    call _sub_49FEC7                                     # 0049D79F
    mov byte ptr [0x1136068], 2                          # 0049D7A4
    mov dword ptr [0x1135f3e], 0x80000000                # 0049D7AB
    msvc_jmp _sub_49F1B5                                 # 0049D7B5

    .global _sub_49D7BA
_sub_49D7BA:
    mov byte ptr [0x113603a], 0xff                       # 0049D7BA
    call _sub_49FEC7                                     # 0049D7C1
    mov byte ptr [0x1136068], 4                          # 0049D7C6
    mov dword ptr [0x1135f3e], 0x80000000                # 0049D7CD
    msvc_jmp _sub_49F1B5                                 # 0049D7D7

    .global _sub_49D7DC
_sub_49D7DC:
    cmp byte ptr [0x1136061], 1                          # 0049D7DC
    jne .L49D801                                         # 0049D7E3
    inc byte ptr [0x1136064]                             # 0049D7E5
    and byte ptr [0x1136064], 3                          # 0049D7EB
    mov dword ptr [0x1135f3e], 0x80000000                # 0049D7F2
...
.L49D801:
    ...
    bts dword ptr [0x523368], 6                          # 0049D818
    mov byte ptr [0x1136061], 1                          # 0049D820
    mov byte ptr [0x113607e], 0                          # 0049D827
    and byte ptr [0x1136064], 3                          # 0049D82E
...
.L49D847:
    inc ebx                                              # 0049D847
    cmp byte ptr [ebx + 0x1136030], 0xff                 # 0049D848
...
.L49D87B:
    movzx ecx, byte ptr [ebx + 0x1136030]                # 0049D87B
    cmp cl, 0xff                                         # 0049D882
    je .L49D900                                          # 0049D885
    cmp cl, byte ptr [0x1136039]                         # 0049D887
    jne .L49D896                                         # 0049D88D
    mov word ptr [0x113d84e], bx                         # 0049D88F
.L49D896:
    mov ecx, dword ptr [ecx*4 + 0x50c894]                # 0049D896
    movzx eax, byte ptr [0x525e3c]                       # 0049D89D
    movzx eax, byte ptr [eax + 0x9c645c]                 # 0049D8A4
    shl eax, 0x13                                        # 0049D8AB
    add eax, dword ptr [ecx + 0x16]                      # 0049D8AE
    add eax, 0x20000000                                  # 0049D8B1
    mov word ptr [ebx*2 + 0x113d850], 0x7e4              # 0049D8B6
    mov dword ptr [ebx*8 + 0x113d8a0], eax               # 0049D8C0
    mov word ptr [ebx*8 + 0x113d8a4], 0x108              # 0049D8C7
    mov ax, word ptr [ecx + 0xa]                         # 0049D8D1
    cmp ax, -1                                           # 0049D8D5
    je .L49D8ED                                          # 0049D8D9
    mov word ptr [ebx*8 + 0x113d8a4], 0x107              # 0049D8DB
    mov word ptr [ebx*8 + 0x113d8a6], ax                 # 0049D8E5
.L49D8ED:
    movzx ax, byte ptr [ecx + 0xc]                       # 0049D8ED
    mov word ptr [ebx*8 + 0x113d9e0], ax                 # 0049D8F2
    inc ebx                                              # 0049D8FA
...
_sub_49D901:
    ...
    mov al, byte ptr [ebx + 0x1136030]                   # 0049D90E
    mov byte ptr [0x1136039], al                         # 0049D914
    movzx ebx, byte ptr [0x1136062]                      # 0049D919
    mov byte ptr [ebx + 0x525f7a], al                    # 0049D920
    call _sub_49FEC7                                     # 0049D926
    mov dword ptr [0x1135f3e], 0x80000000                # 0049D92B
...
.L49D95E:
    ...
    and word ptr [0xf24484], 0xfffd                      # 0049D96A
    mov dword ptr [0x1135f3e], 0x80000000                # 0049D972
    mov dword ptr [0x1135f4e], 0x80000000                # 0049D97C
    mov dword ptr [0x1135f6c], 0x80000000                # 0049D986
    mov dword ptr [0x1135f46], 0x80000000                # 0049D990
    mov byte ptr [0x1136076], 0                          # 0049D99A
    bt dword ptr [0x523368], 3                           # 0049D9A1
    jae .L49D9CB                                         # 0049D9A9
    mov cl, byte ptr [esi + 0x882]                       # 0049D9AB
    cmp cl, byte ptr [0x523392]                          # 0049D9B1
    jne .L49D9CB                                         # 0049D9B7
    mov cx, word ptr [esi + 0x40]                        # 0049D9B9
    cmp cx, word ptr [0x523390]                          # 0049D9BD
...
.L49D9CB:
    ...
    mov eax, dword ptr [edx*4 + 0x4ffad8]                # 0049D9E2
    mov dword ptr [esi + 0xc], eax                       # 0049D9E9
    mov eax, dword ptr [edx*4 + 0x4ffac8]                # 0049D9EC
    mov dword ptr [esi], eax                             # 0049D9F3
    mov dword ptr [esi + 0x1c], 0                        # 0049D9F5
    mov eax, dword ptr [edx*4 + 0x4ffab8]                # 0049D9FC
    ...
    cmp byte ptr [0x1136061], 0                          # 0049DA45
    je .L49DA66                                          # 0049DA4C
    mov byte ptr [0x1136061], 0                          # 0049DA4E
    mov byte ptr [0x113607e], 1                          # 0049DA55
...
_sub_49DAA5:
    ...
    cmp byte ptr [0x1136061], 1                          # 0049DAAA
    je .L49DAB8                                          # 0049DAB1
    bts dword ptr [esi + 0xc], 0x1c                      # 0049DAB3
.L49DAB8:
    mov eax, dword ptr [esi + 0x14]                      # 0049DAB8
    and eax, 0xf0                                        # 0049DABB
    movzx ecx, byte ptr [0x1136067]                      # 0049DAC0
    movzx edi, byte ptr [0x1136062]                      # 0049DAC7
    test di, 0x80                                        # 0049DACE
    jne _sub_49DBCF                                      # 0049DAD3
    mov edi, dword ptr [edi*4 + 0x50c914]                # 0049DAD9
    cmp cl, 0xff                                         # 0049DAE0
    je _sub_49DB1F                                       # 0049DAE3
    jmp dword ptr [ecx*4 + 0x4ffbf8]                     # 0049DAE5

    .global _sub_49DAEC
_sub_49DAEC:
    or eax, 0x3600000                                    # 0049DAEC
    jmp _sub_49DB1F                                      # 0049DAF1
...
.L49DB1D:
    jmp _sub_49DB1F                                      # 0049DB1D

    .global _sub_49DB1F
_sub_49DB1F:
    cmp byte ptr [0x1136068], 2                          # 0049DB1F
    je .L49DB31                                          # 0049DB26
    cmp byte ptr [0x1136068], 6                          # 0049DB28
...
.L49DB48:
    cmp byte ptr [0x1136068], 4                          # 0049DB48
    je .L49DB5A                                          # 0049DB4F
    cmp byte ptr [0x1136068], 8                          # 0049DB51
...
.L49DB71:
    cmp byte ptr [0x1136064], 0xc                        # 0049DB71
    jae .L49DBA4                                         # 0049DB78
    cmp byte ptr [0x1136064], 8                          # 0049DB7A
    jae .L49DB98                                         # 0049DB81
    cmp byte ptr [0x1136064], 4                          # 0049DB83
    jb .L49DBAE                                          # 0049DB8A
...
.L49DBAE:
    cmp byte ptr [0x1136061], 0                          # 0049DBAE
...
_sub_49DBCF:
    ...
    mov edi, dword ptr [edi*4 + 0x50c984]                # 0049DBD4
    cmp cl, 0xff                                         # 0049DBDB
    je _sub_49DBEC                                       # 0049DBDE
    jmp dword ptr [ecx*4 + 0x4ffc30]                     # 0049DBE0
...
_sub_49DBE7:
    ...
    .global _sub_49DBEC
_sub_49DBEC:
    cmp byte ptr [0x1136068], 2                          # 0049DBEC
    je .L49DBFE                                          # 0049DBF3
    cmp byte ptr [0x1136068], 6                          # 0049DBF5
...
.L49DC0D:
    cmp byte ptr [0x1136068], 4                          # 0049DC0D
    je .L49DC1F                                          # 0049DC14
    cmp byte ptr [0x1136068], 8                          # 0049DC16
...
.L49DC2E:
    cmp byte ptr [0x1136064], 0xc                        # 0049DC2E
    jae .L49DC61                                         # 0049DC35
    cmp byte ptr [0x1136064], 8                          # 0049DC37
    jae .L49DC55                                         # 0049DC3E
    cmp byte ptr [0x1136064], 4                          # 0049DC40
    jb .L49DC6B                                          # 0049DC47
...
.L49DC6B:
    cmp byte ptr [0x1136061], 0                          # 0049DC6B
...
_sub_49DCA2:
    ...
    cmp byte ptr [0x1136061], 1                          # 0049DCBB
    jne .L49DCED                                         # 0049DCC2
    bt dword ptr [0x523368], 3                           # 0049DCC4
    jae _sub_4CC6EA                                      # 0049DCCC
    cmp byte ptr [0x523392], 0xd                         # 0049DCD2
    jne _sub_4CC6EA                                      # 0049DCD9
    cmp word ptr [0x523394], 0x1c                        # 0049DCDF
    jne _sub_4CC6EA                                      # 0049DCE7
.L49DCED:
    cmp byte ptr [0x1136061], 0                          # 0049DCED
    jne .L49DD0E                                         # 0049DCF4
    bt dword ptr [0x523368], 3                           # 0049DCF6
    jae .L49DD0E                                         # 0049DCFE
    cmp byte ptr [0x523392], 0xd                         # 0049DD00
...
_sub_49DD14:
    ...
    and word ptr [0xf24484], 0xfffd                      # 0049DD25
...
_sub_49DD39:
    ...
    mov eax, dword ptr [edx*4 + 0x4ffab8]                # 0049DD40
...
.L49DD54:
    ...
    mov byte ptr [0x521ebc], 0                           # 0049DD6D
    test byte ptr [0x1136063], 0x80                      # 0049DD74
    jne .L49DDF5                                         # 0049DD7B
    test byte ptr [0x1136063], 0x40                      # 0049DD7D
    jne .L49DE1E                                         # 0049DD84
    movzx ebx, byte ptr [0x1136062]                      # 0049DD8A
    test ebx, 0x80                                       # 0049DD91
    jne .L49DDC6                                         # 0049DD97
    mov ebx, dword ptr [ebx*4 + 0x50c914]                # 0049DD99
    mov ax, word ptr [ebx]                               # 0049DDA0
    mov word ptr [0x112c826], ax                         # 0049DDA3
    movzx ebp, byte ptr [0x113604c]                      # 0049DDA9
    mov ebp, dword ptr [ebp*4 + 0x50c8b4]                # 0049DDB0
    movzx eax, word ptr [ebp]                            # 0049DDB7
    mov dword ptr [0x521e96], eax                        # 0049DDBB
.L49DDC0:
    call _sub_4A09DE                                     # 0049DDC0
    ret                                                  # 0049DDC5
.L49DDC6:
    and ebx, 0xffffff7f                                  # 0049DDC6
    mov ebx, dword ptr [ebx*4 + 0x50c984]                # 0049DDCC
    mov ax, word ptr [ebx]                               # 0049DDD3
    mov word ptr [0x112c826], ax                         # 0049DDD6
    movzx ebp, byte ptr [0x113604c]                      # 0049DDDC
    mov ebp, dword ptr [ebp*4 + 0x50c934]                # 0049DDE3
    movzx eax, word ptr [ebp]                            # 0049DDEA
    mov dword ptr [0x521e96], eax                        # 0049DDEE
    jmp .L49DDC0                                         # 0049DDF3
.L49DDF5:
    mov byte ptr [0x521ebc], 9                           # 0049DDF5
    movzx ebp, byte ptr [0x113604c]                      # 0049DDFC
    mov ebp, dword ptr [ebp*4 + 0x50c9a4]                # 0049DE03
    movzx eax, word ptr [ebp]                            # 0049DE0A
    mov dword ptr [0x521e96], eax                        # 0049DE0E
    mov word ptr [0x112c826], 0x5f4                      # 0049DE13
    jmp .L49DDC0                                         # 0049DE1C
.L49DE1E:
    movzx ebp, byte ptr [0x113604c]                      # 0049DE1E
    mov ebp, dword ptr [ebp*4 + 0x50c9c4]                # 0049DE25
    movzx eax, word ptr [ebp]                            # 0049DE2C
    mov dword ptr [0x521e96], eax                        # 0049DE30
    mov word ptr [0x112c826], 0x5f5                      # 0049DE35
...
_sub_49DE40:
    ...
    test byte ptr [0x1136063], 0x80                      # 0049DE4A
    jne .L49E157                                         # 0049DE51
    test byte ptr [0x1136063], 0x40                      # 0049DE57
    jne .L49E1A4                                         # 0049DE5E
    test byte ptr [0x1136062], 0x80                      # 0049DE64
    jne .L49E0D0                                         # 0049DE6B
    push esi                                             # 0049DE71
    movzx ebp, byte ptr [0x113604c]                      # 0049DE72
    mov ebp, dword ptr [ebp*4 + 0x50c8b4]                # 0049DE79
    movzx ebx, byte ptr [0x525e3c]                       # 0049DE80
    movzx ebx, byte ptr [ebx + 0x9c645c]                 # 0049DE87
    shl ebx, 0x13                                        # 0049DE8E
    or ebx, 0x20000000                                   # 0049DE91
    add ebx, dword ptr [ebp + 0xe]                       # 0049DE97
    add ebx, 0                                           # 0049DE9A
    mov cx, word ptr [0x521eae]                          # 0049DE9D
    mov dx, word ptr [0x521eb2]                          # 0049DEA4
    ...
    pop edx                                              # 0049DEBC
    pop ecx                                              # 0049DEBD
    movzx ebx, byte ptr [0x525e3c]                       # 0049DEBE
    movzx ebx, byte ptr [ebx + 0x9c645c]                 # 0049DEC5
    movzx ebx, byte ptr [ebx + 0x5045fa]                 # 0049DECC
...
.L49DEF3:
    ...
    mov dx, word ptr [0x521eb4]                          # 0049DEF8
    add cx, 0x45                                         # 0049DEFF
    add dx, word ptr [esi + 0x32]                        # 0049DF03
    add dx, 4                                            # 0049DF07
    cmp dword ptr [0x1135f6c], 0x80000000                # 0049DF0B
    je .L49DF30                                          # 0049DF15
    cmp dword ptr [0x1135f6c], 0                         # 0049DF17
    je .L49DF30                                          # 0049DF1E
    mov bx, 0x8a                                         # 0049DF20
    msvc_xor al, al                                      # 0049DF24
    mov esi, 0x1135f6c                                   # 0049DF26
    call _sub_494DE8                                     # 0049DF2B
.L49DF30:
    pop esi                                              # 0049DF30
    push esi                                             # 0049DF31
    mov ax, word ptr [esi + 0x30]                        # 0049DF32
    mov cx, word ptr [0x521eb4]                          # 0049DF36
    ...
    mov dx, word ptr [0x521eb4]                          # 0049DF6F
    add cx, 0x45                                         # 0049DF76
    add dx, word ptr [esi + 0x32]                        # 0049DF7A
    add dx, 0x12                                         # 0049DF7E
    test byte ptr [0x522096], 8                          # 0049DF82
    je .L49E0CE                                          # 0049DF89
    mov bx, 0x520                                        # 0049DF8F
    mov ebp, dword ptr [0x1135f70]                       # 0049DF93
    cmp ebp, -1                                          # 0049DF99
    je .L49DFB9                                          # 0049DF9C
    imul ebp, ebp, 0x3d2                                 # 0049DF9E
    mov bx, word ptr [ebp + 0x5e6f08]                    # 0049DFA4
    mov word ptr [0x112c828], bx                         # 0049DFAB
    mov bx, word ptr [ebp + 0x5e6edc]                    # 0049DFB2
.L49DFB9:
    mov word ptr [0x112c826], bx                         # 0049DFB9
    mov bx, 0x521                                        # 0049DFC0
    mov bp, word ptr [esi + 0x34]                        # 0049DFC4
    sub bp, 4                                            # 0049DFC8
    mov esi, 0x112c826                                   # 0049DFCC
    msvc_xor al, al                                      # 0049DFD1
    call _sub_494C36                                     # 0049DFD3
    mov esi, dword ptr [esp]                             # 0049DFD8
    mov cx, word ptr [esi + 0x30]                        # 0049DFDB
    mov dx, word ptr [0x521eb4]                          # 0049DFDF
    add cx, 2                                            # 0049DFE6
    ...
    cmp dword ptr [0x1135f74], 0                         # 0049DFFD
...
.L49E015:
    bt dword ptr [0x1135f74], ebx                        # 0049E015
    ...
    ja .L49E04D                                          # 0049E02D
    mov ebp, dword ptr [ebx*4 + 0x50c700]                # 0049E02F
    push ebx                                             # 0049E036
    push ecx                                             # 0049E037
    push edx                                             # 0049E038
    dec dx                                               # 0049E039
...
.L49E053:
    ...
    mov dx, word ptr [0x521eb4]                          # 0049E05A
    add cx, 2                                            # 0049E061
    ...
    cmp dword ptr [0x1135f78], 0                         # 0049E078
...
.L49E090:
    bt dword ptr [0x1135f78], ebx                        # 0049E090
    ...
    ja .L49E0C8                                          # 0049E0A8
    mov ebp, dword ptr [ebx*4 + 0x50c700]                # 0049E0AA
    push ebx                                             # 0049E0B1
    push ecx                                             # 0049E0B2
    push edx                                             # 0049E0B3
    dec dx                                               # 0049E0B4
...
.L49E0D0:
    push esi                                             # 0049E0D0
    movzx ebp, byte ptr [0x113604c]                      # 0049E0D1
    mov ebp, dword ptr [ebp*4 + 0x50c934]                # 0049E0D8
    movzx ebx, byte ptr [0x525e3c]                       # 0049E0DF
    movzx ebx, byte ptr [ebx + 0x9c645c]                 # 0049E0E6
    shl ebx, 0x13                                        # 0049E0ED
    or ebx, 0x20000000                                   # 0049E0F0
    add ebx, dword ptr [ebp + 0xc]                       # 0049E0F6
    add ebx, 0                                           # 0049E0F9
    mov cx, word ptr [0x521eae]                          # 0049E0FC
    mov dx, word ptr [0x521eb2]                          # 0049E103
    ...
    pop edx                                              # 0049E11B
    pop ecx                                              # 0049E11C
    movzx ebx, byte ptr [0x525e3c]                       # 0049E11D
    movzx ebx, byte ptr [ebx + 0x9c645c]                 # 0049E124
    movzx ebx, byte ptr [ebx + 0x5045fa]                 # 0049E12B
...
.L49E157:
    push esi                                             # 0049E157
    movzx ebp, byte ptr [0x113604c]                      # 0049E158
    mov ebp, dword ptr [ebp*4 + 0x50c9a4]                # 0049E15F
    movzx ebx, byte ptr [0x525e3c]                       # 0049E166
    movzx ebx, byte ptr [ebx + 0x9c645c]                 # 0049E16D
    shl ebx, 0x13                                        # 0049E174
    or ebx, 0x20000000                                   # 0049E177
    add ebx, dword ptr [ebp + 8]                         # 0049E17D
    add ebx, 0                                           # 0049E180
    mov cx, word ptr [0x521eae]                          # 0049E183
    mov dx, word ptr [0x521eb2]                          # 0049E18A
...
.L49E1A4:
    push esi                                             # 0049E1A4
    movzx ebp, byte ptr [0x113604c]                      # 0049E1A5
    mov ebp, dword ptr [ebp*4 + 0x50c9c4]                # 0049E1AC
    movzx ebx, byte ptr [0x525e3c]                       # 0049E1B3
    movzx ebx, byte ptr [ebx + 0x9c645c]                 # 0049E1BA
    shl ebx, 0x13                                        # 0049E1C1
    or ebx, 0x20000000                                   # 0049E1C4
    add ebx, dword ptr [ebp + 8]                         # 0049E1CA
    add ebx, 0                                           # 0049E1CD
    mov cx, word ptr [0x521eae]                          # 0049E1D0
    mov dx, word ptr [0x521eb2]                          # 0049E1D7
...
_sub_49E1F1:
    mov cl, 0xd                                          # 0049E1F1
    msvc_xor dx, dx                                      # 0049E1F3
    call _sub_4C9B56                                     # 0049E1F6
    je .L49E227                                          # 0049E1FB
    cmp word ptr [esi + 0x870], 1                        # 0049E1FD
    jne .L49E227                                         # 0049E205
    test byte ptr [0x522096], 8                          # 0049E207
    je .L49E227                                          # 0049E20E
    cmp ebx, dword ptr [0x1135f70]                       # 0049E210
    jne .L49E227                                         # 0049E216
    mov dword ptr [0x1135f70], 0xffffffff                # 0049E218
    call _sub_4CA4BD                                     # 0049E222
.L49E227:
    ret                                                  # 0049E227
...
_sub_49E261:
    ...
    .global _sub_49E26E
_sub_49E26E:
    inc byte ptr [0x1136064]                             # 0049E26E
    and byte ptr [0x1136064], 3                          # 0049E274
    mov dword ptr [0x1135f6c], 0x80000000                # 0049E27B
...
.L49E29D:
    inc ebx                                              # 0049E29D
    cmp byte ptr [ebx + 0x113603b], 0xff                 # 0049E29E
    ...
    test byte ptr [0x1136063], 0x80                      # 0049E2CF
    jne .L49E356                                         # 0049E2D6
    test byte ptr [0x1136063], 0x40                      # 0049E2D8
    jne .L49E386                                         # 0049E2DF
    test byte ptr [0x1136062], 0x80                      # 0049E2E5
    jne .L49E322                                         # 0049E2EC
.L49E2EE:
    movzx ecx, byte ptr [ebx + 0x113603b]                # 0049E2EE
    cmp cl, 0xff                                         # 0049E2F5
    je .L49E3B6                                          # 0049E2F8
    cmp cl, byte ptr [0x113604c]                         # 0049E2FE
    jne .L49E30D                                         # 0049E304
    mov word ptr [0x113d84e], bx                         # 0049E306
.L49E30D:
    mov ecx, dword ptr [ecx*4 + 0x50c8b4]                # 0049E30D
    mov ax, word ptr [ecx]                               # 0049E314
    mov word ptr [ebx*2 + 0x113d850], ax                 # 0049E317
    inc ebx                                              # 0049E31F
    jmp .L49E2EE                                         # 0049E320
.L49E322:
    movzx ecx, byte ptr [ebx + 0x113603b]                # 0049E322
    cmp cl, 0xff                                         # 0049E329
    je .L49E3B6                                          # 0049E32C
    cmp cl, byte ptr [0x113604c]                         # 0049E332
    jne .L49E341                                         # 0049E338
    mov word ptr [0x113d84e], bx                         # 0049E33A
.L49E341:
    mov ecx, dword ptr [ecx*4 + 0x50c934]                # 0049E341
    mov ax, word ptr [ecx]                               # 0049E348
    mov word ptr [ebx*2 + 0x113d850], ax                 # 0049E34B
    inc ebx                                              # 0049E353
    jmp .L49E322                                         # 0049E354
.L49E356:
    movzx ecx, byte ptr [ebx + 0x113603b]                # 0049E356
    cmp cl, 0xff                                         # 0049E35D
    je .L49E3B6                                          # 0049E360
    cmp cl, byte ptr [0x113604c]                         # 0049E362
    jne .L49E371                                         # 0049E368
    mov word ptr [0x113d84e], bx                         # 0049E36A
.L49E371:
    mov ecx, dword ptr [ecx*4 + 0x50c9a4]                # 0049E371
    mov ax, word ptr [ecx]                               # 0049E378
    mov word ptr [ebx*2 + 0x113d850], ax                 # 0049E37B
    inc ebx                                              # 0049E383
    jmp .L49E356                                         # 0049E384
.L49E386:
    movzx ecx, byte ptr [ebx + 0x113603b]                # 0049E386
    cmp cl, 0xff                                         # 0049E38D
    je .L49E3B6                                          # 0049E390
    cmp cl, byte ptr [0x113604c]                         # 0049E392
    jne .L49E3A1                                         # 0049E398
    mov word ptr [0x113d84e], bx                         # 0049E39A
.L49E3A1:
    mov ecx, dword ptr [ecx*4 + 0x50c9c4]                # 0049E3A1
    mov ax, word ptr [ecx]                               # 0049E3A8
    mov word ptr [ebx*2 + 0x113d850], ax                 # 0049E3AB
    inc ebx                                              # 0049E3B3
...
_sub_49E3B7:
    ...
    mov al, byte ptr [ebx + 0x113603b]                   # 0049E3C4
    mov byte ptr [0x113604c], al                         # 0049E3CA
    test byte ptr [0x1136063], 0x80                      # 0049E3CF
    je .L49E3E2                                          # 0049E3D6
    mov byte ptr [0x525fac], al                          # 0049E3D8
    msvc_jmp _sub_4CA4BD                                 # 0049E3DD
.L49E3E2:
    test byte ptr [0x1136063], 0x40                      # 0049E3E2
    je .L49E3F5                                          # 0049E3E9
    mov byte ptr [0x525fad], al                          # 0049E3EB
    msvc_jmp _sub_4CA4BD                                 # 0049E3F0
.L49E3F5:
    movzx ebx, byte ptr [0x1136062]                      # 0049E3F5
    test ebx, 0x80                                       # 0049E3FC
    jne .L49E40F                                         # 0049E402
    mov byte ptr [ebx + 0x525f82], al                    # 0049E404
    msvc_jmp _sub_4CA4BD                                 # 0049E40A
.L49E40F:
    and ebx, 0xffffff7f                                  # 0049E40F
    mov byte ptr [ebx + 0x525f9a], al                    # 0049E415
...
_sub_49E437:
    ...
    bt dword ptr [0x523368], 3                           # 0049E450
    jae .L49E463                                         # 0049E458
    cmp byte ptr [0x523392], 0xd                         # 0049E45A
    je .L49E473                                          # 0049E461
.L49E463:
    test byte ptr [0x522096], 8                          # 0049E463
    je .L49E473                                          # 0049E46A
    push esi                                             # 0049E46C
...
_sub_49E474:
    ...
    and word ptr [0xf24484], 0xfffd                      # 0049E485
...
_sub_49E499:
    ...
    mov eax, dword ptr [edx*4 + 0x4ffab8]                # 0049E4A0
...
.L49E4B4:
    ...
    movzx ebx, byte ptr [0x1136062]                      # 0049E4CD
    mov ebx, dword ptr [ebx*4 + 0x50c914]                # 0049E4D4
    mov ax, word ptr [ebx]                               # 0049E4DB
    mov word ptr [0x112c826], ax                         # 0049E4DE
    movzx ebp, byte ptr [0x113602e]                      # 0049E4E4
    mov ebp, dword ptr [ebp*4 + 0x50c800]                # 0049E4EB
    movzx eax, word ptr [ebp]                            # 0049E4F2
    mov dword ptr [0x521f5a], eax                        # 0049E4F6
...
_sub_49E501:
    ...
    push esi                                             # 0049E50B
    movzx ebp, byte ptr [0x113602e]                      # 0049E50C
    mov ebp, dword ptr [ebp*4 + 0x50c800]                # 0049E513
    ...
    mov word ptr [0x112c826], bx                         # 0049E532
    msvc_xor al, al                                      # 0049E539
    mov esi, 0x112c826                                   # 0049E53B
    mov bx, 0x10e                                        # 0049E540
    call _sub_495224                                     # 0049E544
    pop esi                                              # 0049E549
    push esi                                             # 0049E54A
    mov cx, word ptr [0x521f72]                          # 0049E54B
    mov dx, word ptr [0x521f78]                          # 0049E552
    add cx, word ptr [0x521f74]                          # 0049E559
    sar cx, 1                                            # 0049E560
    add cx, word ptr [esi + 0x30]                        # 0049E563
    add dx, word ptr [esi + 0x32]                        # 0049E567
    sub cx, 8                                            # 0049E56B
    sub dx, 4                                            # 0049E56F
    movzx ebp, byte ptr [0x113602e]                      # 0049E573
    mov ebp, dword ptr [ebp*4 + 0x50c800]                # 0049E57A
    mov ebx, dword ptr [ebp + 0xe]                       # 0049E581
    add ebx, 0                                           # 0049E584
    call _sub_448C79                                     # 0049E587
    pop esi                                              # 0049E58C
    push esi                                             # 0049E58D
    mov cx, word ptr [0x521f72]                          # 0049E58E
    mov dx, word ptr [0x521f78]                          # 0049E595
    add cx, word ptr [0x521f74]                          # 0049E59C
    sar cx, 1                                            # 0049E5A3
    add cx, word ptr [esi + 0x30]                        # 0049E5A6
    add dx, word ptr [esi + 0x32]                        # 0049E5AA
    add cx, 8                                            # 0049E5AE
    sub dx, 4                                            # 0049E5B2
    movzx ebp, byte ptr [0x113602e]                      # 0049E5B6
    mov ebp, dword ptr [ebp*4 + 0x50c800]                # 0049E5BD
    mov ebx, dword ptr [ebp + 0xe]                       # 0049E5C4
    add ebx, 4                                           # 0049E5C7
    call _sub_448C79                                     # 0049E5CA
    pop esi                                              # 0049E5CF
    push esi                                             # 0049E5D0
    mov cx, word ptr [0x521f82]                          # 0049E5D1
    mov dx, word ptr [0x521f88]                          # 0049E5D8
    add cx, word ptr [0x521f84]                          # 0049E5DF
    sar cx, 1                                            # 0049E5E6
    add cx, word ptr [esi + 0x30]                        # 0049E5E9
    add dx, word ptr [esi + 0x32]                        # 0049E5ED
    sub dx, 4                                            # 0049E5F1
    movzx ebp, byte ptr [0x113602e]                      # 0049E5F5
    mov ebp, dword ptr [ebp*4 + 0x50c800]                # 0049E5FC
    ...
    mov dx, word ptr [0x521f88]                          # 0049E614
    add cx, 0x45                                         # 0049E61B
    add dx, word ptr [esi + 0x32]                        # 0049E61F
    add dx, 5                                            # 0049E623
    cmp dword ptr [0x1135f4e], 0x80000000                # 0049E627
    je .L49E64C                                          # 0049E631
    cmp dword ptr [0x1135f4e], 0                         # 0049E633
    je .L49E64C                                          # 0049E63A
    mov bx, 0x8a                                         # 0049E63C
    msvc_xor al, al                                      # 0049E640
    mov esi, 0x1135f4e                                   # 0049E642
...
_sub_49E67C:
    ...
    .global _sub_49E687
_sub_49E687:
    mov byte ptr [0x113602f], 1                          # 0049E687
    jmp _sub_49E697                                      # 0049E68E

    .global _sub_49E690
_sub_49E690:
    mov byte ptr [0x113602f], 0                          # 0049E690
...
.L49E6B7:
    inc ebx                                              # 0049E6B7
    cmp byte ptr [ebx + 0x113601d], 0xff                 # 0049E6B8
...
.L49E6E9:
    movzx ecx, byte ptr [ebx + 0x113601d]                # 0049E6E9
    cmp cl, 0xff                                         # 0049E6F0
    je .L49E719                                          # 0049E6F3
    cmp cl, byte ptr [0x113602e]                         # 0049E6F5
    jne .L49E704                                         # 0049E6FB
    mov word ptr [0x113d84e], bx                         # 0049E6FD
.L49E704:
    mov ecx, dword ptr [ecx*4 + 0x50c800]                # 0049E704
    mov ax, word ptr [ecx]                               # 0049E70B
    mov word ptr [ebx*2 + 0x113d850], ax                 # 0049E70E
    inc ebx                                              # 0049E716
...
_sub_49E71A:
    ...
    mov al, byte ptr [ebx + 0x113601d]                   # 0049E727
    mov byte ptr [0x113602e], al                         # 0049E72D
    movzx ebx, byte ptr [0x1136062]                      # 0049E732
    mov byte ptr [ebx + 0x525f72], al                    # 0049E739
...
_sub_49E76F:
    ...
    bt dword ptr [0x523368], 3                           # 0049E788
    jae .L49E79B                                         # 0049E790
    cmp byte ptr [0x523392], 0xd                         # 0049E792
    je .L49E7AB                                          # 0049E799
.L49E79B:
    test byte ptr [0x522096], 4                          # 0049E79B
    je .L49E7AB                                          # 0049E7A2
    push esi                                             # 0049E7A4
...
_sub_49E7AC:
    ...
    and word ptr [0xf24484], 0xfffd                      # 0049E7BF
...
_sub_49E7D3:
    ...
    mov eax, dword ptr [edx*4 + 0x4ffab8]                # 0049E7DA
...
.L49E7EE:
    ...
    movzx ebx, byte ptr [0x1136062]                      # 0049E807
    test bl, 0x80                                        # 0049E80E
    jne .L49E995                                         # 0049E811
    mov ebx, dword ptr [ebx*4 + 0x50c914]                # 0049E817
    mov ax, word ptr [ebx]                               # 0049E81E
    mov word ptr [0x112c826], ax                         # 0049E821
    mov edx, dword ptr [esi + 0x1c]                      # 0049E827
    and edx, 0xfffff0ff                                  # 0049E82A
    mov byte ptr [0x522014], 0                           # 0049E830
    mov byte ptr [0x522024], 0                           # 0049E837
    mov byte ptr [0x522034], 0                           # 0049E83E
    mov byte ptr [0x522044], 0                           # 0049E845
    movzx ecx, byte ptr [0x1136054]                      # 0049E84C
    cmp cl, 0xff                                         # 0049E853
    je .L49E87F                                          # 0049E856
    mov ecx, dword ptr [ecx*4 + 0x50c8f4]                # 0049E858
    movzx eax, word ptr [ecx]                            # 0049E85F
    mov byte ptr [0x522014], 0x1b                        # 0049E862
    mov dword ptr [0x52201e], eax                        # 0049E869
    test word ptr [0x1135fe4], 1                         # 0049E86E
    je .L49E87F                                          # 0049E877
    or edx, 0x100                                        # 0049E879
.L49E87F:
    movzx ecx, byte ptr [0x1136055]                      # 0049E87F
    cmp cl, 0xff                                         # 0049E886
    je .L49E8B2                                          # 0049E889
    mov ecx, dword ptr [ecx*4 + 0x50c8f4]                # 0049E88B
    movzx eax, word ptr [ecx]                            # 0049E892
    mov byte ptr [0x522024], 0x1b                        # 0049E895
    mov dword ptr [0x52202e], eax                        # 0049E89C
    test word ptr [0x1135fe4], 2                         # 0049E8A1
    je .L49E8B2                                          # 0049E8AA
    or edx, 0x200                                        # 0049E8AC
.L49E8B2:
    movzx ecx, byte ptr [0x1136056]                      # 0049E8B2
    cmp cl, 0xff                                         # 0049E8B9
    je .L49E8E5                                          # 0049E8BC
    mov ecx, dword ptr [ecx*4 + 0x50c8f4]                # 0049E8BE
    movzx eax, word ptr [ecx]                            # 0049E8C5
    mov byte ptr [0x522034], 0x1b                        # 0049E8C8
    mov dword ptr [0x52203e], eax                        # 0049E8CF
    test word ptr [0x1135fe4], 4                         # 0049E8D4
    je .L49E8E5                                          # 0049E8DD
    or edx, 0x400                                        # 0049E8DF
.L49E8E5:
    movzx ecx, byte ptr [0x1136057]                      # 0049E8E5
    cmp cl, 0xff                                         # 0049E8EC
    je .L49E918                                          # 0049E8EF
    mov ecx, dword ptr [ecx*4 + 0x50c8f4]                # 0049E8F1
    movzx eax, word ptr [ecx]                            # 0049E8F8
    mov byte ptr [0x522044], 0x1b                        # 0049E8FB
    mov dword ptr [0x52204e], eax                        # 0049E902
    test word ptr [0x1135fe4], 8                         # 0049E907
    je .L49E918                                          # 0049E910
    or edx, 0x800                                        # 0049E912
.L49E918:
    mov dword ptr [esi + 0x1c], edx                      # 0049E918
.L49E91B:
    mov byte ptr [0x522054], 0                           # 0049E91B
    mov byte ptr [0x522064], 0                           # 0049E922
    mov byte ptr [0x522074], 0                           # 0049E929
    mov word ptr [0x522062], 0xffff                      # 0049E930
    test word ptr [0x1135fe4], 0xf                       # 0049E939
    je .L49E97E                                          # 0049E942
    mov byte ptr [0x522054], 3                           # 0049E944
    mov byte ptr [0x522064], 0x12                        # 0049E94B
    mov byte ptr [0x522074], 0xb                         # 0049E952
    mov word ptr [0x522062], 0x160                       # 0049E959
    bt dword ptr [0x523368], 3                           # 0049E962
    jae .L49E97E                                         # 0049E96A
    cmp byte ptr [0x523392], 0xd                         # 0049E96C
    jne .L49E97E                                         # 0049E973
    mov word ptr [0x522062], 0x161                       # 0049E975
.L49E97E:
    movzx eax, byte ptr [0x113606e]                      # 0049E97E
    add eax, 0x15c                                       # 0049E985
    mov dword ptr [0x52206e], eax                        # 0049E98A
    call _sub_4A09DE                                     # 0049E98F
    ret                                                  # 0049E994
.L49E995:
    and ebx, 0xffffff7f                                  # 0049E995
    mov ebx, dword ptr [ebx*4 + 0x50c984]                # 0049E99B
    mov ax, word ptr [ebx]                               # 0049E9A2
    mov word ptr [0x112c826], ax                         # 0049E9A5
    mov edx, dword ptr [esi + 0x1c]                      # 0049E9AB
    and edx, 0xfffff0ff                                  # 0049E9AE
    mov byte ptr [0x522014], 0                           # 0049E9B4
    mov byte ptr [0x522024], 0                           # 0049E9BB
    mov byte ptr [0x522034], 0                           # 0049E9C2
    mov byte ptr [0x522044], 0                           # 0049E9C9
    movzx ecx, byte ptr [0x1136054]                      # 0049E9D0
    cmp cl, 0xff                                         # 0049E9D7
    je .L49EA03                                          # 0049E9DA
    mov ecx, dword ptr [ecx*4 + 0x50c974]                # 0049E9DC
    movzx eax, word ptr [ecx]                            # 0049E9E3
    mov byte ptr [0x522014], 0x1b                        # 0049E9E6
    mov dword ptr [0x52201e], eax                        # 0049E9ED
    test word ptr [0x1135fe4], 1                         # 0049E9F2
    je .L49EA03                                          # 0049E9FB
    or edx, 0x100                                        # 0049E9FD
.L49EA03:
    movzx ecx, byte ptr [0x1136055]                      # 0049EA03
    cmp cl, 0xff                                         # 0049EA0A
    je .L49EA36                                          # 0049EA0D
    mov ecx, dword ptr [ecx*4 + 0x50c974]                # 0049EA0F
    movzx eax, word ptr [ecx]                            # 0049EA16
    mov byte ptr [0x522024], 0x1b                        # 0049EA19
    mov dword ptr [0x52202e], eax                        # 0049EA20
    test word ptr [0x1135fe4], 2                         # 0049EA25
    je .L49EA36                                          # 0049EA2E
...
_sub_49EA3E:
    ...
    push edi                                             # 0049EA48
    push esi                                             # 0049EA49
    test word ptr [0x1135fe4], 0xf                       # 0049EA4A
    je _sub_49EB90                                       # 0049EA53
    mov ax, word ptr [esi + 0x30]                        # 0049EA59
    mov cx, word ptr [esi + 0x32]                        # 0049EA5D
    add ax, word ptr [0x522056]                          # 0049EA61
    add cx, word ptr [0x52205a]                          # 0049EA68
    inc ax                                               # 0049EA6F
    inc cx                                               # 0049EA71
    mov bx, word ptr [0x522058]                          # 0049EA73
    mov dx, word ptr [0x52205c]                          # 0049EA7A
    sub bx, word ptr [0x522056]                          # 0049EA81
    sub dx, word ptr [0x52205a]                          # 0049EA88
    dec bx                                               # 0049EA8F
    dec dx                                               # 0049EA91
    push ebx                                             # 0049EA93
    push edx                                             # 0049EA94
    ...
    mov ebx, dword ptr [0xe3f0b8]                        # 0049EAB6
    jmp dword ptr [ebx*4 + 0x4ffdc4]                     # 0049EABC
...
_sub_49EB11:
    ...
    mov dword ptr [0xe0c3e0], edi                        # 0049EB29
    push edi                                             # 0049EB2F
    mov ax, 0x2000                                       # 0049EB30
    mov cx, 0x2000                                       # 0049EB34
    mov di, word ptr [0x1135fe4]                         # 0049EB38
    shl edi, 0x10                                        # 0049EB3F
    mov di, 0x1d0                                        # 0049EB42
    movzx edx, byte ptr [0x525e3c]                       # 0049EB46
    imul edx, edx, 0x8fa8                                # 0049EB4D
    movzx edx, byte ptr [edx + 0x53179e]                 # 0049EB53
    shl edx, 0x10                                        # 0049EB5A
    mov dl, byte ptr [0x1136062]                         # 0049EB5D
    mov bh, byte ptr [0xe3f0b8]                          # 0049EB63
    or byte ptr [0x522095], 1                            # 0049EB69
...
.L49EB88:
    and byte ptr [0x522095], 0xfe                        # 0049EB88
    pop edi                                              # 0049EB8F
...
_sub_49EB90:
    ...
    mov dx, word ptr [0x52205c]                          # 0049EB97
    add cx, 0x45                                         # 0049EB9E
    add dx, word ptr [esi + 0x32]                        # 0049EBA2
    add dx, 4                                            # 0049EBA6
    cmp dword ptr [0x1135f46], 0x80000000                # 0049EBAA
    je .L49EBCF                                          # 0049EBB4
    cmp dword ptr [0x1135f46], 0                         # 0049EBB6
    je .L49EBCF                                          # 0049EBBD
    mov bx, 0x8a                                         # 0049EBBF
    msvc_xor al, al                                      # 0049EBC3
    mov esi, 0x1135f46                                   # 0049EBC5
...
_sub_49EC38:
    ...
    pop esi                                              # 0049EC6D
    mov word ptr [0x113d850], 0x15c                      # 0049EC6E
    mov word ptr [0x113d852], 0x15d                      # 0049EC77
    mov word ptr [0x113d854], 0x15e                      # 0049EC80
    movzx ecx, byte ptr [0x113606e]                      # 0049EC89
    mov word ptr [0x113d84e], cx                         # 0049EC90
    ret                                                  # 0049EC97
...
_sub_49EC98:
    ...
    mov byte ptr [0x113606e], al                         # 0049ECA2
...
_sub_49ECAD:
    sub dx, 8                                            # 0049ECAD
    btc word ptr [0x1135fe4], dx                         # 0049ECB1
    mov ax, word ptr [0x1135fe4]                         # 0049ECB9
    movzx ebx, byte ptr [0x1136062]                      # 0049ECBF
    mov byte ptr [ebx + 0x525f8a], al                    # 0049ECC6
...
_sub_49ECD1:
    ...
    bt dword ptr [0x523368], 3                           # 0049ECEA
    jae .L49ECFD                                         # 0049ECF2
    cmp byte ptr [0x523392], 0xd                         # 0049ECF4
    je .L49ED0D                                          # 0049ECFB
.L49ECFD:
    test byte ptr [0x522096], 0x10                       # 0049ECFD
    je .L49ED0D                                          # 0049ED04
    push esi                                             # 0049ED06
...
_sub_49ED0E:
    ...
    and word ptr [0xf24484], 0xfffd                      # 0049ED1F
...
_sub_49ED32:
    ...
    .global _sub_49ED33
_sub_49ED33:
    test byte ptr [0x1136062], 0x80                      # 0049ED33
...
.L49ED5A:
    movzx ebp, byte ptr [0x1136062]                      # 0049ED5A
    mov ebp, dword ptr [ebp*4 + 0x50c914]                # 0049ED61
    mov ebp, dword ptr [ebp + 0x1e]                      # 0049ED68
    add ebp, 0x20000000                                  # 0049ED6B
    msvc_add ebx, ebp                                    # 0049ED71
    movzx ebp, byte ptr [0x525e3c]                       # 0049ED73
    movzx ebp, byte ptr [ebp + 0x9c645c]                 # 0049ED7A
    shl ebp, 0x13                                        # 0049ED81
    msvc_or ebx, ebp                                     # 0049ED84
    mov eax, 4                                           # 0049ED86
    call _sub_4CF194                                     # 0049ED8B
    test byte ptr [0x1136063], 0x80                      # 0049ED90
    jne .L49EE90                                         # 0049ED97
    test byte ptr [0x1136063], 0x40                      # 0049ED9D
...
.L49EDE2:
    ...
    movzx ebp, byte ptr [0x113604c]                      # 0049EE13
    mov ebp, dword ptr [ebp*4 + 0x50c8b4]                # 0049EE1A
    movzx ebx, byte ptr [0x525e3c]                       # 0049EE21
    movzx ebx, byte ptr [ebx + 0x9c645c]                 # 0049EE28
    ...
    pop edx                                              # 0049EE47
    pop ecx                                              # 0049EE48
    movzx ebx, byte ptr [0x525e3c]                       # 0049EE49
    movzx ebx, byte ptr [ebx + 0x9c645c]                 # 0049EE50
    movzx ebx, byte ptr [ebx + 0x5045fa]                 # 0049EE57
...
.L49EE90:
    mov ebx, dword ptr [0x50c3d0]                        # 0049EE90
...
.L49EEA8:
    mov ebx, dword ptr [0x50c3d0]                        # 0049EEA8
...
.L49EEF9:
    ...
    movzx ebp, byte ptr [0x113602e]                      # 0049EF0A
    mov ebp, dword ptr [ebp*4 + 0x50c800]                # 0049EF11
    ...
    mov ebp, dword ptr [ebp*2 + 0x4ffaf0]                # 0049EF30
...
.L49EFA1:
    ...
    movzx esi, byte ptr [0x1136062]                      # 0049EFA3
    mov esi, dword ptr [esi*4 + 0x50c914]                # 0049EFAA
.L49EFB1:
    movzx eax, byte ptr [ebp + 0x1136054]                # 0049EFB1
    ...
    push ebp                                             # 0049EFBF
    push esi                                             # 0049EFC0
    mov eax, dword ptr [eax*4 + 0x50c8f4]                # 0049EFC1
...
.L49F009:
    movzx ebp, byte ptr [0x1136062]                      # 0049F009
    and ebp, 0xffffff7f                                  # 0049F010
    mov ebp, dword ptr [ebp*4 + 0x50c984]                # 0049F016
    mov ebp, dword ptr [ebp + 0xe]                       # 0049F01D
    add ebp, 0x20000000                                  # 0049F020
    msvc_add ebx, ebp                                    # 0049F026
    movzx ebp, byte ptr [0x525e3c]                       # 0049F028
    movzx ebp, byte ptr [ebp + 0x9c645c]                 # 0049F02F
...
.L49F07D:
    ...
    movzx ebp, byte ptr [0x113604c]                      # 0049F0AE
    mov ebp, dword ptr [ebp*4 + 0x50c934]                # 0049F0B5
    movzx ebx, byte ptr [0x525e3c]                       # 0049F0BC
    movzx ebx, byte ptr [ebx + 0x9c645c]                 # 0049F0C3
    ...
    pop edx                                              # 0049F0E2
    pop ecx                                              # 0049F0E3
    movzx ebx, byte ptr [0x525e3c]                       # 0049F0E4
    movzx ebx, byte ptr [ebx + 0x9c645c]                 # 0049F0EB
    movzx ebx, byte ptr [ebx + 0x5045fa]                 # 0049F0F2
...
.L49F161:
    ...
    movzx esi, byte ptr [0x1136062]                      # 0049F163
    and esi, 0xffffff7f                                  # 0049F16A
    mov esi, dword ptr [esi*4 + 0x50c984]                # 0049F170
.L49F177:
    movzx eax, byte ptr [ebp + 0x1136054]                # 0049F177
    ...
    push ebp                                             # 0049F185
    push esi                                             # 0049F186
    mov eax, dword ptr [eax*4 + 0x50c974]                # 0049F187
...
_sub_49F1B5:
    ...
    test byte ptr [0x1136062], 0x80                      # 0049F1C3
    jne _sub_49F5E0                                      # 0049F1CA
    push esi                                             # 0049F1D0
    call _sub_46112C                                     # 0049F1D1
    or word ptr [0xf24484], 0xa                          # 0049F1D6
...
.L49F1EC:
    mov bl, byte ptr [0x1136064]                         # 0049F1EC
    mov edi, 0                                           # 0049F1F2
    mov ax, word ptr [0x1135fb4]                         # 0049F1F7
    mov cx, word ptr [0x1135fb6]                         # 0049F1FD
.L49F204:
    msvc_xor edx, edx                                    # 0049F204
    mov edi, dword ptr [edi*4 + 0x4f73d8]                # 0049F206
    and ebx, 3                                           # 0049F20D
...
_sub_49F210:
    ...
    jmp dword ptr [ebx*4 + 0x4ffe48]                     # 0049F223
...
_sub_49F240:
    ...
    mov word ptr [edx*4 + 0xf24490], bp                  # 0049F246
    mov word ptr [edx*4 + 0xf24492], si                  # 0049F24E
    inc edx                                              # 0049F256
...
_sub_49F257:
    ...
    .global _sub_49F25C
_sub_49F25C:
    mov word ptr [edx*4 + 0xf24490], 0xffff              # 0049F25C
    call _sub_46112C                                     # 0049F266
    pop esi                                              # 0049F26B
    mov dword ptr [esi + 0x24], 0                        # 0049F26C
    movzx edi, byte ptr [0x1136062]                      # 0049F273
    mov edi, dword ptr [edi*4 + 0x50c914]                # 0049F27A
    mov byte ptr [0x521d28], 9                           # 0049F281
    mov byte ptr [0x521d48], 9                           # 0049F288
    mov byte ptr [0x521cc8], 0                           # 0049F28F
    mov byte ptr [0x521cd8], 0                           # 0049F296
    mov byte ptr [0x521cb8], 0                           # 0049F29D
    mov byte ptr [0x521ce8], 0                           # 0049F2A4
    mov byte ptr [0x521ca8], 0                           # 0049F2AB
    mov byte ptr [0x521cf8], 0                           # 0049F2B2
    mov byte ptr [0x521c98], 0                           # 0049F2B9
    mov byte ptr [0x521d08], 0                           # 0049F2C0
    mov word ptr [0x521caa], 3                           # 0049F2C7
    mov word ptr [0x521cac], 0x18                        # 0049F2D0
    mov word ptr [0x521cfa], 0x71                        # 0049F2D9
    mov word ptr [0x521cfc], 0x86                        # 0049F2E2
    mov word ptr [0x521cba], 0x19                        # 0049F2EB
    mov word ptr [0x521cbc], 0x2e                        # 0049F2F4
    mov word ptr [0x521cea], 0x5b                        # 0049F2FD
    mov word ptr [0x521cec], 0x70                        # 0049F306
    bt word ptr [edi + 2], 4                             # 0049F30F
    jae .L49F36D                                         # 0049F315
    mov word ptr [0x521caa], 0x19                        # 0049F317
    mov word ptr [0x521cac], 0x2e                        # 0049F320
    mov word ptr [0x521cfa], 0x5b                        # 0049F329
    mov word ptr [0x521cfc], 0x70                        # 0049F332
    mov word ptr [0x521cba], 0x2f                        # 0049F33B
    mov word ptr [0x521cbc], 0x44                        # 0049F344
    mov word ptr [0x521cea], 0x45                        # 0049F34D
    mov word ptr [0x521cec], 0x5a                        # 0049F356
    mov byte ptr [0x521c98], 9                           # 0049F35F
    mov byte ptr [0x521d08], 9                           # 0049F366
.L49F36D:
    bt word ptr [edi + 2], 1                             # 0049F36D
    jae .L49F383                                         # 0049F373
    mov byte ptr [0x521cc8], 9                           # 0049F375
    mov byte ptr [0x521cd8], 9                           # 0049F37C
.L49F383:
    bt word ptr [edi + 2], 2                             # 0049F383
    jae .L49F399                                         # 0049F389
    mov byte ptr [0x521cb8], 9                           # 0049F38B
    mov byte ptr [0x521ce8], 9                           # 0049F392
.L49F399:
    bt word ptr [edi + 2], 3                             # 0049F399
    jae .L49F3AF                                         # 0049F39F
    mov byte ptr [0x521ca8], 9                           # 0049F3A1
    mov byte ptr [0x521cf8], 9                           # 0049F3A8
.L49F3AF:
    mov byte ptr [0x521d18], 0                           # 0049F3AF
    mov byte ptr [0x521d58], 0                           # 0049F3B6
    bt word ptr [edi + 2], 7                             # 0049F3BD
    jae .L49F48E                                         # 0049F3C3
    mov byte ptr [0x521d18], 9                           # 0049F3C9
    mov byte ptr [0x521d58], 9                           # 0049F3D0
    mov dword ptr [0x521d22], 0x933                      # 0049F3D7
    mov dword ptr [0x521d62], 0x934                      # 0049F3E1
    mov word ptr [0x521d26], 0x7d                        # 0049F3EB
    mov word ptr [0x521d66], 0x7e                        # 0049F3F4
    mov byte ptr [0x522090], 0x10                        # 0049F3FD
    mov byte ptr [0x522091], 0x14                        # 0049F404
    cmp byte ptr [0x1136064], 4                          # 0049F40B
    jb .L49F48E                                          # 0049F412
    cmp byte ptr [0x1136064], 0xc                        # 0049F414
    jae .L49F48E                                         # 0049F41B
    mov dword ptr [0x521d22], 0x937                      # 0049F41D
    mov dword ptr [0x521d62], 0x935                      # 0049F427
    mov word ptr [0x521d26], 0x80                        # 0049F431
    mov word ptr [0x521d66], 0x7f                        # 0049F43A
    mov byte ptr [0x522090], 0x14                        # 0049F443
    mov byte ptr [0x522092], 0x10                        # 0049F44A
    cmp byte ptr [0x1136064], 8                          # 0049F451
    jb .L49F48E                                          # 0049F458
    mov dword ptr [0x521d22], 0x936                      # 0049F45A
    mov dword ptr [0x521d62], 0x938                      # 0049F464
    mov word ptr [0x521d26], 0x7f                        # 0049F46E
    mov word ptr [0x521d66], 0x80                        # 0049F477
    mov byte ptr [0x522091], 0x10                        # 0049F480
    mov byte ptr [0x522092], 0x14                        # 0049F487
.L49F48E:
    mov byte ptr [0x521d68], 0                           # 0049F48E
    mov byte ptr [0x521d78], 0                           # 0049F495
    mov byte ptr [0x521d98], 0                           # 0049F49C
    mov byte ptr [0x521da8], 0                           # 0049F4A3
    bt word ptr [edi + 2], 5                             # 0049F4AA
    jae .L49F4C0                                         # 0049F4B0
    mov byte ptr [0x521d78], 9                           # 0049F4B2
    mov byte ptr [0x521d98], 9                           # 0049F4B9
.L49F4C0:
    bt word ptr [edi + 2], 6                             # 0049F4C0
    jae .L49F4D6                                         # 0049F4C6
    mov byte ptr [0x521d68], 9                           # 0049F4C8
    mov byte ptr [0x521da8], 9                           # 0049F4CF
.L49F4D6:
    mov byte ptr [0x521db8], 0x12                        # 0049F4D6
    mov byte ptr [0x521dc8], 0xb                         # 0049F4DD
    cmp byte ptr [0x1136039], 0xff                       # 0049F4E4
    je .L49F4FF                                          # 0049F4EB
    cmp byte ptr [0x1136061], 1                          # 0049F4ED
    je .L49F50D                                          # 0049F4F4
    test byte ptr [0x1136076], 1                         # 0049F4F6
    jne .L49F50D                                         # 0049F4FD
.L49F4FF:
    mov byte ptr [0x521db8], 0                           # 0049F4FF
    mov byte ptr [0x521dc8], 0                           # 0049F506
.L49F50D:
    mov edx, dword ptr [esi + 0x1c]                      # 0049F50D
    and edx, 0xfc0000ff                                  # 0049F510
    mov byte ptr [0x521dd8], 0                           # 0049F516
    mov byte ptr [0x521de8], 9                           # 0049F51D
    mov byte ptr [0x521df8], 0                           # 0049F524
    cmp byte ptr [0x1136061], 1                          # 0049F52B
    je .L49F542                                          # 0049F532
    cmp byte ptr [0x1136061], 0                          # 0049F534
    je .L49F575                                          # 0049F53B
    msvc_jmp .L49F5D6                                    # 0049F53D
.L49F542:
    mov byte ptr [0x521dd8], 5                           # 0049F542
    mov word ptr [0x521de6], 0x81                        # 0049F549
    mov byte ptr [0x521de8], 0                           # 0049F552
    mov byte ptr [0x521df8], 9                           # 0049F559
    mov dword ptr [0x521e02], 0x93d                      # 0049F560
    mov word ptr [0x521e06], 0x244                       # 0049F56A
    jmp .L49F59F                                         # 0049F573
.L49F575:
    mov byte ptr [0x521dd8], 3                           # 0049F575
    mov word ptr [0x521de6], 0x82                        # 0049F57C
    mov byte ptr [0x521df8], 9                           # 0049F585
    mov dword ptr [0x521e02], 0x93a                      # 0049F58C
    mov word ptr [0x521e06], 0x243                       # 0049F596
.L49F59F:
    movzx eax, byte ptr [0x1136067]                      # 0049F59F
    cmp al, 0xff                                         # 0049F5A6
    je .L49F5B4                                          # 0049F5A8
    movzx ecx, byte ptr [eax + 0x522085]                 # 0049F5AA
    bts edx, ecx                                         # 0049F5B1
.L49F5B4:
    mov al, byte ptr [0x1136068]                         # 0049F5B4
...
_sub_49F5E0:
    ...
    or word ptr [0xf24484], 0xa                          # 0049F5E6
...
.L49F5FC:
    mov bl, byte ptr [0x1136064]                         # 0049F5FC
    mov edi, 0                                           # 0049F602
    mov ax, word ptr [0x1135fb4]                         # 0049F607
    mov cx, word ptr [0x1135fb6]                         # 0049F60D
.L49F614:
    msvc_xor edx, edx                                    # 0049F614
    mov edi, dword ptr [edi*4 + 0x4f6d1c]                # 0049F616
    and ebx, 3                                           # 0049F61D
...
_sub_49F620:
    ...
    jmp dword ptr [ebx*4 + 0x4ffe58]                     # 0049F633
...
_sub_49F650:
    ...
    mov word ptr [edx*4 + 0xf24490], bp                  # 0049F656
    mov word ptr [edx*4 + 0xf24492], si                  # 0049F65E
    inc edx                                              # 0049F666
...
_sub_49F667:
    ...
    .global _sub_49F66C
_sub_49F66C:
    mov word ptr [edx*4 + 0xf24490], 0xffff              # 0049F66C
    call _sub_46112C                                     # 0049F676
    pop esi                                              # 0049F67B
    mov dword ptr [esi + 0x24], 0                        # 0049F67C
    movzx edi, byte ptr [0x1136062]                      # 0049F683
    and di, 0xff7f                                       # 0049F68A
    mov edi, dword ptr [edi*4 + 0x50c984]                # 0049F68F
    mov byte ptr [0x521d28], 0                           # 0049F696
    mov byte ptr [0x521d48], 0                           # 0049F69D
    mov byte ptr [0x521cc8], 0                           # 0049F6A4
    mov byte ptr [0x521cd8], 0                           # 0049F6AB
    mov byte ptr [0x521cb8], 0                           # 0049F6B2
    mov byte ptr [0x521ce8], 0                           # 0049F6B9
    mov byte ptr [0x521ca8], 0                           # 0049F6C0
    mov byte ptr [0x521cf8], 0                           # 0049F6C7
    mov byte ptr [0x521c98], 0                           # 0049F6CE
    mov byte ptr [0x521d08], 0                           # 0049F6D5
    mov word ptr [0x521caa], 3                           # 0049F6DC
    mov word ptr [0x521cac], 0x18                        # 0049F6E5
    mov word ptr [0x521cfa], 0x71                        # 0049F6EE
    mov word ptr [0x521cfc], 0x86                        # 0049F6F7
    mov word ptr [0x521cba], 0x19                        # 0049F700
    mov word ptr [0x521cbc], 0x2e                        # 0049F709
    mov word ptr [0x521cea], 0x5b                        # 0049F712
    mov word ptr [0x521cec], 0x70                        # 0049F71B
    bt word ptr [edi + 2], 1                             # 0049F724
    jae .L49F782                                         # 0049F72A
    mov word ptr [0x521caa], 0x19                        # 0049F72C
    mov word ptr [0x521cac], 0x2e                        # 0049F735
    mov word ptr [0x521cfa], 0x5b                        # 0049F73E
    mov word ptr [0x521cfc], 0x70                        # 0049F747
    mov word ptr [0x521cba], 0x2f                        # 0049F750
    mov word ptr [0x521cbc], 0x44                        # 0049F759
    mov word ptr [0x521cea], 0x45                        # 0049F762
    mov word ptr [0x521cec], 0x5a                        # 0049F76B
    mov byte ptr [0x521c98], 9                           # 0049F774
    mov byte ptr [0x521d08], 9                           # 0049F77B
.L49F782:
    bt word ptr [edi + 2], 0                             # 0049F782
    jae .L49F798                                         # 0049F788
    mov byte ptr [0x521ca8], 9                           # 0049F78A
    mov byte ptr [0x521cf8], 9                           # 0049F791
.L49F798:
    mov byte ptr [0x521d18], 0                           # 0049F798
    mov byte ptr [0x521d58], 0                           # 0049F79F
    bt word ptr [edi + 2], 5                             # 0049F7A6
    jae .L49F7DB                                         # 0049F7AC
    mov byte ptr [0x521d18], 9                           # 0049F7AE
    mov dword ptr [0x521d22], 0x937                      # 0049F7B5
    mov word ptr [0x521d26], 0x80                        # 0049F7BF
    cmp byte ptr [0x525fae], 0                           # 0049F7C8
    jne .L49F7DB                                         # 0049F7CF
    mov dword ptr [0x521d22], 0x938                      # 0049F7D1
.L49F7DB:
    mov byte ptr [0x521d68], 0                           # 0049F7DB
    mov byte ptr [0x521d78], 0                           # 0049F7E2
    mov byte ptr [0x521d98], 0                           # 0049F7E9
    mov byte ptr [0x521da8], 0                           # 0049F7F0
    bt word ptr [edi + 2], 2                             # 0049F7F7
    jae .L49F80D                                         # 0049F7FD
    mov byte ptr [0x521d78], 9                           # 0049F7FF
    mov byte ptr [0x521d98], 9                           # 0049F806
.L49F80D:
    bt word ptr [edi + 2], 3                             # 0049F80D
    jae .L49F823                                         # 0049F813
    mov byte ptr [0x521d68], 9                           # 0049F815
    mov byte ptr [0x521da8], 9                           # 0049F81C
.L49F823:
    mov byte ptr [0x521db8], 0x12                        # 0049F823
    mov byte ptr [0x521dc8], 0xb                         # 0049F82A
    cmp byte ptr [0x1136039], 0xff                       # 0049F831
    je .L49F84C                                          # 0049F838
    cmp byte ptr [0x1136061], 1                          # 0049F83A
    je .L49F85A                                          # 0049F841
    test byte ptr [0x1136076], 1                         # 0049F843
    jne .L49F85A                                         # 0049F84A
.L49F84C:
    mov byte ptr [0x521db8], 0                           # 0049F84C
    mov byte ptr [0x521dc8], 0                           # 0049F853
.L49F85A:
    mov edx, dword ptr [esi + 0x1c]                      # 0049F85A
    and edx, 0xfc0000ff                                  # 0049F85D
    mov byte ptr [0x521dd8], 0                           # 0049F863
    mov byte ptr [0x521de8], 9                           # 0049F86A
    mov byte ptr [0x521df8], 0                           # 0049F871
    cmp byte ptr [0x1136061], 1                          # 0049F878
    je .L49F88F                                          # 0049F87F
    cmp byte ptr [0x1136061], 0                          # 0049F881
    je .L49F8C2                                          # 0049F888
    msvc_jmp .L49F923                                    # 0049F88A
.L49F88F:
    mov byte ptr [0x521dd8], 5                           # 0049F88F
    mov word ptr [0x521de6], 0x81                        # 0049F896
    mov byte ptr [0x521de8], 0                           # 0049F89F
    mov byte ptr [0x521df8], 9                           # 0049F8A6
    mov dword ptr [0x521e02], 0x93d                      # 0049F8AD
    mov word ptr [0x521e06], 0x244                       # 0049F8B7
    jmp .L49F8EC                                         # 0049F8C0
.L49F8C2:
    mov byte ptr [0x521dd8], 3                           # 0049F8C2
    mov word ptr [0x521de6], 0x82                        # 0049F8C9
    mov byte ptr [0x521df8], 9                           # 0049F8D2
    mov dword ptr [0x521e02], 0x93a                      # 0049F8D9
    mov word ptr [0x521e06], 0x243                       # 0049F8E3
.L49F8EC:
    movzx eax, byte ptr [0x1136067]                      # 0049F8EC
    cmp al, 0xff                                         # 0049F8F3
    je .L49F901                                          # 0049F8F5
    movzx ecx, byte ptr [eax + 0x522085]                 # 0049F8F7
    bts edx, ecx                                         # 0049F8FE
.L49F901:
    mov al, byte ptr [0x1136068]                         # 0049F901
...
.L49F923:
    ...
    .global _sub_49F92D
_sub_49F92D:
    test byte ptr [0x1136062], 0x80                      # 0049F92D
    jne .L49FA10                                         # 0049F934
    push esi                                             # 0049F93A
    mov dword ptr [0x1135f3e], 0x80000000                # 0049F93B
    mov byte ptr [0x1136076], 0                          # 0049F945
    mov dword ptr [0x1135f42], 0x80000000                # 0049F94C
    ...
    mov esi, dword ptr [esi*4 + 0x50c914]                # 0049F96E
    mov si, word ptr [esi]                               # 0049F975
    mov word ptr [0x112c82c], si                         # 0049F978
    mov word ptr [0x9c68e8], 0x8f                        # 0049F97F
    mov bl, 1                                            # 0049F988
    mov esi, 7                                           # 0049F98A
    call _sub_431315                                     # 0049F98F
    mov dword ptr [0x1135f42], ebx                       # 0049F994
    ...
    add ax, word ptr [edx*8 + 0x4f7b5e]                  # 0049F9B2
    add cx, word ptr [edx*8 + 0x4f7b60]                  # 0049F9BA
    add di, word ptr [edx*8 + 0x4f7b62]                  # 0049F9C2
    mov bl, byte ptr [edx*8 + 0x4f7b5d]                  # 0049F9CA
    mov byte ptr [0x1136064], bl                         # 0049F9D1
    mov word ptr [0x1135fb4], ax                         # 0049F9D7
    mov word ptr [0x1135fb6], cx                         # 0049F9DD
    mov word ptr [0x1135fb8], di                         # 0049F9E4
    mov byte ptr [0x522096], 0                           # 0049F9EB
    mov byte ptr [0x1136066], 0                          # 0049F9F2
    cmp byte ptr [0x1136067], 9                          # 0049F9F9
    jb .L49FA09                                          # 0049FA00
    mov byte ptr [0x1136067], 0                          # 0049FA02
.L49FA09:
...
.L49FA10:
    push esi                                             # 0049FA10
    mov dword ptr [0x1135f3e], 0x80000000                # 0049FA11
    mov byte ptr [0x1136076], 0                          # 0049FA1B
    mov dword ptr [0x1135f42], 0x80000000                # 0049FA22
    ...
    mov esi, dword ptr [esi*4 + 0x50c984]                # 0049FA44
    mov si, word ptr [esi]                               # 0049FA4B
    mov word ptr [0x112c82c], si                         # 0049FA4E
    mov word ptr [0x9c68e8], 0x8f                        # 0049FA55
    mov bl, 1                                            # 0049FA5E
    mov esi, 0x26                                        # 0049FA60
    call _sub_431315                                     # 0049FA65
    mov dword ptr [0x1135f42], ebx                       # 0049FA6A
    ...
    cmp word ptr [0x9c68e6], 0x9c                        # 0049FA7D
    jne .L49FB5C                                         # 0049FA86
    cmp byte ptr [0x112c2e9], 0xff                       # 0049FA8C
    je .L49FB5C                                          # 0049FA93
    push ebx                                             # 0049FA99
    ...
    mov esi, dword ptr [esi*4 + 0x50c984]                # 0049FAC1
    mov si, word ptr [esi]                               # 0049FAC8
    mov word ptr [0x112c82c], si                         # 0049FACB
    mov word ptr [0x9c68e8], 0x8f                        # 0049FAD2
    mov bl, 1                                            # 0049FADB
    mov esi, 0x26                                        # 0049FADD
    call _sub_431315                                     # 0049FAE2
    mov dword ptr [0x1135f42], ebx                       # 0049FAE7
...
.L49FAFA:
    ...
    add ax, word ptr [edx*8 + 0x4f6f8e]                  # 0049FB05
    add cx, word ptr [edx*8 + 0x4f6f90]                  # 0049FB0D
    add di, word ptr [edx*8 + 0x4f6f92]                  # 0049FB15
    mov bl, byte ptr [edx*8 + 0x4f6f8d]                  # 0049FB1D
    mov byte ptr [0x1136064], bl                         # 0049FB24
    mov word ptr [0x1135fb4], ax                         # 0049FB2A
    mov word ptr [0x1135fb6], cx                         # 0049FB30
    mov word ptr [0x1135fb8], di                         # 0049FB37
    mov byte ptr [0x522096], 0                           # 0049FB3E
    mov byte ptr [0x1136066], 0                          # 0049FB45
    cmp byte ptr [0x1136067], 9                          # 0049FB4C
    jb .L49FB5C                                          # 0049FB53
    mov byte ptr [0x1136067], 0                          # 0049FB55
.L49FB5C:
...
_sub_49FB63:
    ...
    je .L49FBE3                                          # 0049FB88
    mov word ptr [0x1135fc0], ax                         # 0049FB8A
    mov word ptr [0x1135fc2], cx                         # 0049FB90
    mov byte ptr [0x113606a], dh                         # 0049FB97
    mov word ptr [0x1135fc4], di                         # 0049FB9D
    mov byte ptr [0x1136069], bh                         # 0049FBA4
    mov byte ptr [0x522093], dl                          # 0049FBAA
    or byte ptr [0x522096], 2                            # 0049FBB0
    mov al, 3                                            # 0049FBB7
    test byte ptr [0x1136072], 2                         # 0049FBB9
    je .L49FBC4                                          # 0049FBC0
    mov al, 1                                            # 0049FBC2
.L49FBC4:
    call _sub_4A0A18                                     # 0049FBC4
    cmp byte ptr [0x1136068], 0                          # 0049FBC9
    je .L49FBD9                                          # 0049FBD0
    mov al, 2                                            # 0049FBD2
    call _sub_4A0A18                                     # 0049FBD4
.L49FBD9:
    mov byte ptr [0x113603a], 0                          # 0049FBD9
    msvc_mov ebx, esi                                    # 0049FBE0
    ret                                                  # 0049FBE2
.L49FBE3:
    cmp byte ptr [0x113603a], 0                          # 0049FBE3
    je .L49FC53                                          # 0049FBEA
    cmp word ptr [0x9c68e6], 0x17e                       # 0049FBEC
    jne .L49FC53                                         # 0049FBF5
    mov byte ptr [0x113603a], 0                          # 0049FBF7
    push eax                                             # 0049FBFE
    push ebx                                             # 0049FBFF
    mov ebp, 0x1136030                                   # 0049FC00
    movzx edi, dh                                        # 0049FC05
.L49FC08:
    movzx ebx, byte ptr [ebp]                            # 0049FC08
    cmp bl, 0xff                                         # 0049FC0C
    je .L49FC51                                          # 0049FC0F
    mov esi, dword ptr [ebx*4 + 0x50c894]                # 0049FC11
    mov ax, word ptr [edi*2 + 0x4f8764]                  # 0049FC18
    test word ptr [esi + 0x14], ax                       # 0049FC20
    je .L49FC29                                          # 0049FC24
    inc ebp                                              # 0049FC26
    jmp .L49FC08                                         # 0049FC27
.L49FC29:
    cmp bl, byte ptr [0x1136039]                         # 0049FC29
    je .L49FC51                                          # 0049FC2F
    ror edx, 0x18                                        # 0049FC31
    msvc_mov dl, bl                                      # 0049FC34
    rol edx, 0x18                                        # 0049FC36
    mov byte ptr [0x1136039], bl                         # 0049FC39
    mov al, 0xd                                          # 0049FC3F
    mov bx, 0                                            # 0049FC41
...
.L49FC51:
    ...
    pop eax                                              # 0049FC52
.L49FC53:
    mov byte ptr [0x113603a], 0                          # 0049FC53
...
_sub_49FC60:
    ...
    je .L49FCE9                                          # 0049FC85
    mov word ptr [0x1135fc0], ax                         # 0049FC87
    mov word ptr [0x1135fc2], cx                         # 0049FC8D
    mov byte ptr [0x113606a], dh                         # 0049FC94
    mov word ptr [0x1135fc4], di                         # 0049FC9A
    mov byte ptr [0x1136069], bh                         # 0049FCA1
    mov byte ptr [0x522093], dl                          # 0049FCA7
    or word ptr [0x522093], 0x80                         # 0049FCAD
    or byte ptr [0x522096], 2                            # 0049FCB6
    mov al, 3                                            # 0049FCBD
    test byte ptr [0x1136072], 2                         # 0049FCBF
    je .L49FCCA                                          # 0049FCC6
    mov al, 1                                            # 0049FCC8
.L49FCCA:
    call _sub_4A0A18                                     # 0049FCCA
    cmp byte ptr [0x1136068], 0                          # 0049FCCF
    je .L49FCDF                                          # 0049FCD6
    mov al, 2                                            # 0049FCD8
    call _sub_4A0A18                                     # 0049FCDA
.L49FCDF:
    mov byte ptr [0x113603a], 0                          # 0049FCDF
    msvc_mov ebx, esi                                    # 0049FCE6
    ret                                                  # 0049FCE8
.L49FCE9:
    cmp byte ptr [0x113603a], 0                          # 0049FCE9
    je .L49FD59                                          # 0049FCF0
    cmp word ptr [0x9c68e6], 0x17e                       # 0049FCF2
    jne .L49FD59                                         # 0049FCFB
    mov byte ptr [0x113603a], 0                          # 0049FCFD
    push eax                                             # 0049FD04
    push ebx                                             # 0049FD05
    mov ebp, 0x1136030                                   # 0049FD06
    movzx edi, dh                                        # 0049FD0B
.L49FD0E:
    movzx ebx, byte ptr [ebp]                            # 0049FD0E
    cmp bl, 0xff                                         # 0049FD12
    je .L49FD57                                          # 0049FD15
    mov esi, dword ptr [ebx*4 + 0x50c894]                # 0049FD17
    mov ax, word ptr [edi*2 + 0x4f7284]                  # 0049FD1E
    test word ptr [esi + 0x14], ax                       # 0049FD26
    je .L49FD2F                                          # 0049FD2A
    inc ebp                                              # 0049FD2C
    jmp .L49FD0E                                         # 0049FD2D
.L49FD2F:
    cmp bl, byte ptr [0x1136039]                         # 0049FD2F
    je .L49FD57                                          # 0049FD35
    ror edx, 0x18                                        # 0049FD37
    msvc_mov dl, bl                                      # 0049FD3A
    rol edx, 0x18                                        # 0049FD3C
    mov byte ptr [0x1136039], bl                         # 0049FD3F
    mov al, 0xd                                          # 0049FD45
    mov bx, 0                                            # 0049FD47
...
.L49FD57:
    ...
    pop eax                                              # 0049FD58
.L49FD59:
    mov byte ptr [0x113603a], 0                          # 0049FD59
    mov ebx, 0x80000000                                  # 0049FD60
    ret                                                  # 0049FD65

    .global _sub_49FD66
_sub_49FD66:
    cmp byte ptr [0x1136061], 0                          # 0049FD66
    je .L49FD70                                          # 0049FD6D
    ret                                                  # 0049FD6F
.L49FD70:
    test byte ptr [0x1136062], 0x80                      # 0049FD70
    jne .L49FE22                                         # 0049FD77
    push esi                                             # 0049FD7D
    test byte ptr [0x522096], 2                          # 0049FD7E
    jne .L49FDB6                                         # 0049FD85
    call _sub_4A04F8                                     # 0049FD87
    jb .L49FDB1                                          # 0049FD8C
    call _sub_49FB63                                     # 0049FD8E
    mov dword ptr [0x1135f3e], ebx                       # 0049FD93
    mov bl, byte ptr [0x1136073]                         # 0049FD99
    mov byte ptr [0x1136076], bl                         # 0049FD9F
...
.L49FDB6:
    pop esi                                              # 0049FDB6
    dec byte ptr [0x1136066]                             # 0049FDB7
    jns .L49FE21                                         # 0049FDBD
    mov byte ptr [0x1136066], 5                          # 0049FDBF
    xor byte ptr [0x522096], 1                           # 0049FDC6
    push esi                                             # 0049FDCD
    mov ax, word ptr [0x1135fb4]                         # 0049FDCE
    mov cx, word ptr [0x1135fb6]                         # 0049FDD4
    mov dx, word ptr [0x1135fb8]                         # 0049FDDB
    mov bl, byte ptr [0x1136064]                         # 0049FDE2
    mov word ptr [0xf24942], ax                          # 0049FDE8
    mov word ptr [0xf24944], cx                          # 0049FDEE
    mov word ptr [0xf24946], dx                          # 0049FDF5
    mov byte ptr [0xf24948], bl                          # 0049FDFC
    and word ptr [0xf24484], 0xfffb                      # 0049FE02
    test byte ptr [0x522096], 1                          # 0049FE0A
    je .L49FE1B                                          # 0049FE11
    or word ptr [0xf24484], 4                            # 0049FE13
.L49FE1B:
...
.L49FE22:
    push esi                                             # 0049FE22
    test byte ptr [0x522096], 2                          # 0049FE23
    jne .L49FE5B                                         # 0049FE2A
    call _sub_4A0832                                     # 0049FE2C
    jb .L49FE56                                          # 0049FE31
    call _sub_49FC60                                     # 0049FE33
    mov dword ptr [0x1135f3e], ebx                       # 0049FE38
    mov bl, byte ptr [0x1136073]                         # 0049FE3E
    mov byte ptr [0x1136076], bl                         # 0049FE44
...
.L49FE5B:
    pop esi                                              # 0049FE5B
    dec byte ptr [0x1136066]                             # 0049FE5C
    jns .L49FEC6                                         # 0049FE62
    mov byte ptr [0x1136066], 5                          # 0049FE64
    xor byte ptr [0x522096], 1                           # 0049FE6B
    push esi                                             # 0049FE72
    mov ax, word ptr [0x1135fb4]                         # 0049FE73
    mov cx, word ptr [0x1135fb6]                         # 0049FE79
    mov dx, word ptr [0x1135fb8]                         # 0049FE80
    mov bl, byte ptr [0x1136064]                         # 0049FE87
    mov word ptr [0xf24942], ax                          # 0049FE8D
    mov word ptr [0xf24944], cx                          # 0049FE93
    mov word ptr [0xf24946], dx                          # 0049FE9A
    mov byte ptr [0xf24948], bl                          # 0049FEA1
    and word ptr [0xf24484], 0xfffb                      # 0049FEA7
    test byte ptr [0x522096], 1                          # 0049FEAF
    je .L49FEC0                                          # 0049FEB6
    or word ptr [0xf24484], 4                            # 0049FEB8
.L49FEC0:
...
.L49FEC6:
    ...
    .global _sub_49FEC7
_sub_49FEC7:
    test byte ptr [0x522096], 1                          # 0049FEC7
    je .L49FEF1                                          # 0049FECE
    mov ax, word ptr [0x1135fb4]                         # 0049FED0
    mov cx, word ptr [0x1135fb6]                         # 0049FED6
    call _sub_4CBE5F                                     # 0049FEDD
    and word ptr [0xf24484], 0xfffb                      # 0049FEE2
    and byte ptr [0x522096], 0xfe                        # 0049FEEA
.L49FEF1:
    call _sub_4A006C                                     # 0049FEF1
    test byte ptr [0x522096], 4                          # 0049FEF6
    je .L49FF4B                                          # 0049FEFD
    push esi                                             # 0049FEFF
    mov di, word ptr [0x1136002]                         # 0049FF00
    shl edi, 0x10                                        # 0049FF07
    mov ax, word ptr [0x1136004]                         # 0049FF0A
    mov cx, word ptr [0x1136006]                         # 0049FF10
    mov di, word ptr [0x1136008]                         # 0049FF17
    mov bh, byte ptr [0x113604d]                         # 0049FF1E
    mov dl, byte ptr [0x113604e]                         # 0049FF24
    mov dh, byte ptr [0x113604f]                         # 0049FF2A
    mov bp, word ptr [0x113600a]                         # 0049FF30
    mov bl, 0x69                                         # 0049FF37
    mov esi, 0xe                                         # 0049FF39
    call _sub_431315                                     # 0049FF3E
    pop esi                                              # 0049FF43
    and byte ptr [0x522096], 0xfb                        # 0049FF44
.L49FF4B:
    test byte ptr [0x522096], 8                          # 0049FF4B
    je .L49FFF0                                          # 0049FF52
    test word ptr [0xf24484], 0x20                       # 0049FF58
    je .L49FF70                                          # 0049FF61
    call _sub_491BC6                                     # 0049FF63
    and word ptr [0xf24484], 0xffdf                      # 0049FF68
.L49FF70:
    push esi                                             # 0049FF70
    mov ax, word ptr [0x1135fe6]                         # 0049FF71
    mov cx, word ptr [0x1135fe8]                         # 0049FF77
    mov di, word ptr [0x1135fea]                         # 0049FF7E
    mov bl, 0x69                                         # 0049FF85
    mov bh, byte ptr [0x113606b]                         # 0049FF87
    mov dl, byte ptr [0x113606c]                         # 0049FF8D
    mov dh, byte ptr [0x113606d]                         # 0049FF93
    mov bp, word ptr [0x1135fee]                         # 0049FF99
...
.L49FFE8:
    pop esi                                              # 0049FFE8
    and byte ptr [0x522096], 0xf7                        # 0049FFE9
.L49FFF0:
    test byte ptr [0x522096], 0x10                       # 0049FFF0
    je .L4A006B                                          # 0049FFF7
    push esi                                             # 0049FFF9
    mov ax, word ptr [0x1135ff8]                         # 0049FFFA
    mov cx, word ptr [0x1135ffa]                         # 004A0000
    mov di, word ptr [0x1135fe4]                         # 004A0007
    shl edi, 0x10                                        # 004A000E
    mov di, word ptr [0x1135ffc]                         # 004A0011
    mov bh, byte ptr [0x1136058]                         # 004A0018
    mov dl, byte ptr [0x1136059]                         # 004A001E
    mov dh, byte ptr [0x113605a]                         # 004A0024
    mov bp, word ptr [0x1136010]                         # 004A002A
    ror ebp, 0x10                                        # 004A0031
    movzx bp, byte ptr [0x113606e]                       # 004A0034
...
.L4A0063:
    pop esi                                              # 004A0063
    and byte ptr [0x522096], 0xef                        # 004A0064
.L4A006B:
    ret                                                  # 004A006B

    .global _sub_4A006C
_sub_4A006C:
    test byte ptr [0x522096], 2                          # 004A006C
    je .L4A00CD                                          # 004A0073
    test word ptr [0x522093], 0x80                       # 004A0075
    jne .L4A00CE                                         # 004A007E
    push esi                                             # 004A0080
    mov ax, word ptr [0x1135fc0]                         # 004A0081
    mov cx, word ptr [0x1135fc2]                         # 004A0087
    mov di, word ptr [0x1135fc4]                         # 004A008E
    movzx edx, byte ptr [0x113606a]                      # 004A0095
    mov ebx, dword ptr [edx*4 + 0x4f73d8]                # 004A009C
    add di, word ptr [ebx + 5]                           # 004A00A3
    mov bh, byte ptr [0x1136069]                         # 004A00A7
    and bh, 3                                            # 004A00AD
    mov bp, word ptr [0x522093]                          # 004A00B0
    msvc_xor dh, dh                                      # 004A00B7
    mov bl, 0x69                                         # 004A00B9
    mov esi, 8                                           # 004A00BB
    call _sub_431315                                     # 004A00C0
    and byte ptr [0x522096], 0xfd                        # 004A00C5
    pop esi                                              # 004A00CC
.L4A00CD:
    ret                                                  # 004A00CD
.L4A00CE:
    push esi                                             # 004A00CE
    mov ax, word ptr [0x1135fc0]                         # 004A00CF
    mov cx, word ptr [0x1135fc2]                         # 004A00D5
    mov di, word ptr [0x1135fc4]                         # 004A00DC
    movzx edx, byte ptr [0x113606a]                      # 004A00E3
    mov ebx, dword ptr [edx*4 + 0x4f6d1c]                # 004A00EA
    add di, word ptr [ebx + 5]                           # 004A00F1
    mov bh, byte ptr [0x1136069]                         # 004A00F5
    and bh, 3                                            # 004A00FB
    mov bp, word ptr [0x522093]                          # 004A00FE
    and bp, 0xff7f                                       # 004A0105
    msvc_xor dh, dh                                      # 004A010A
    mov bl, 0x69                                         # 004A010C
    mov esi, 0x27                                        # 004A010E
    call _sub_431315                                     # 004A0113
    and byte ptr [0x522096], 0xfd                        # 004A0118
    pop esi                                              # 004A011F
    ret                                                  # 004A0120

    .global _sub_4A0121
_sub_4A0121:
    test byte ptr [0x1136062], 0x80                      # 004A0121
    jne .L4A02F2                                         # 004A0128
    push esi                                             # 004A012E
    mov dword ptr [0x1135f3e], 0x80000000                # 004A012F
    mov byte ptr [0x1136076], 0                          # 004A0139
    call _sub_49FEC7                                     # 004A0140
    cmp byte ptr [0x1136061], 0                          # 004A0145
    jne .L4A02F0                                         # 004A014C
    mov ax, word ptr [0x1135fb4]                         # 004A0152
    mov cx, word ptr [0x1135fb6]                         # 004A0158
    mov dx, word ptr [0x1135fb8]                         # 004A015F
    movzx ebx, byte ptr [0x1136064]                      # 004A0166
    mov ebp, 0                                           # 004A016D
    cmp bl, 4                                            # 004A0172
    jb .L4A01A0                                          # 004A0175
    ...
    jb .L4A01A0                                          # 004A0189
    mov ebp, 8                                           # 004A018B
    add ax, word ptr [ebx*4 + 0x503c6c]                  # 004A0190
    add cx, word ptr [ebx*4 + 0x503c6e]                  # 004A0198
.L4A01A0:
    and ebx, 3                                           # 004A01A0
    or ebx, 4                                            # 004A01A3
    msvc_or ebp, ebx                                     # 004A01A6
    mov bl, byte ptr [0x525e3c]                          # 004A01A8
    mov bh, byte ptr [0x1136062]                         # 004A01AE
    mov word ptr [0x113601a], 0                          # 004A01B4
    mov edi, 0x11360a0                                   # 004A01BD
    call _sub_4A2604                                     # 004A01C2
    cmp dword ptr [0x113609c], 0                         # 004A01C7
    je .L4A02F0                                          # 004A01CE
    mov ebp, dword ptr [0x113609c]                       # 004A01D4
    dec ebp                                              # 004A01DA
    mov bp, word ptr [ebp*2 + 0x11360a0]                 # 004A01DB
    and ebp, 0x1ff                                       # 004A01E3
    xor ebp, 4                                           # 004A01E9
    mov ax, word ptr [0x1135fb4]                         # 004A01EC
    mov cx, word ptr [0x1135fb6]                         # 004A01F2
    mov dx, word ptr [0x1135fb8]                         # 004A01F9
    sub ax, word ptr [ebp*8 + 0x4f7b5e]                  # 004A0200
    sub cx, word ptr [ebp*8 + 0x4f7b60]                  # 004A0208
    test ebp, 4                                          # 004A0210
    jne .L4A0220                                         # 004A0216
    sub dx, word ptr [ebp*8 + 0x4f7b62]                  # 004A0218
.L4A0220:
    msvc_mov esi, ebp                                    # 004A0220
    shr esi, 3                                           # 004A0222
    mov esi, dword ptr [esi*4 + 0x4f73d8]                # 004A0225
    test ebp, 4                                          # 004A022C
    je .L4A023F                                          # 004A0232
.L4A0234:
...
.L4A023F:
    ...
    push ebp                                             # 004A0257
    movzx ebp, byte ptr [0x1136062]                      # 004A0258
    mov esi, dword ptr [ebp*4 + 0x50c914]                # 004A025F
    mov si, word ptr [esi]                               # 004A0266
    mov word ptr [0x112c82c], si                         # 004A0269
    mov bl, 1                                            # 004A0270
    mov word ptr [0x9c68e8], 0x8e                        # 004A0272
    mov esi, 8                                           # 004A027B
    call _sub_431315                                     # 004A0280
    pop ebp                                              # 004A0285
    cmp ebx, 0x80000000                                  # 004A0286
    je .L4A02F0                                          # 004A028C
    mov ax, word ptr [0x1135fb4]                         # 004A028E
    mov cx, word ptr [0x1135fb6]                         # 004A0294
    mov dx, word ptr [0x1135fb8]                         # 004A029B
    sub ax, word ptr [ebp*8 + 0x4f7b5e]                  # 004A02A2
    sub cx, word ptr [ebp*8 + 0x4f7b60]                  # 004A02AA
    sub dx, word ptr [ebp*8 + 0x4f7b62]                  # 004A02B2
    mov word ptr [0x1135fb4], ax                         # 004A02BA
    mov word ptr [0x1135fb6], cx                         # 004A02C0
    mov word ptr [0x1135fb8], dx                         # 004A02C7
    mov bl, byte ptr [ebp*8 + 0x4f7b5c]                  # 004A02CE
    mov byte ptr [0x1136064], bl                         # 004A02D5
    mov byte ptr [0x1136067], 0                          # 004A02DB
    mov byte ptr [0x1136068], 0                          # 004A02E2
...
.L4A02F2:
    push esi                                             # 004A02F2
    mov dword ptr [0x1135f3e], 0x80000000                # 004A02F3
    mov byte ptr [0x1136076], 0                          # 004A02FD
    call _sub_49FEC7                                     # 004A0304
    cmp byte ptr [0x1136061], 0                          # 004A0309
    jne .L4A04F6                                         # 004A0310
    mov ax, word ptr [0x1135fb4]                         # 004A0316
    mov cx, word ptr [0x1135fb6]                         # 004A031C
    mov dx, word ptr [0x1135fb8]                         # 004A0323
    movzx ebx, byte ptr [0x1136064]                      # 004A032A
    mov ebp, 0                                           # 004A0331
    and ebx, 3                                           # 004A0336
    or ebx, 4                                            # 004A0339
    msvc_or ebp, ebx                                     # 004A033C
    mov bl, byte ptr [0x525e3c]                          # 004A033E
    mov bh, byte ptr [0x1136062]                         # 004A0344
    and bh, 0x7f                                         # 004A034A
    mov word ptr [0x113601a], 0                          # 004A034D
    mov edi, 0x11360a0                                   # 004A0356
    call _sub_478895                                     # 004A035B
    cmp dword ptr [0x113609c], 0                         # 004A0360
    je .L4A04F6                                          # 004A0367
    msvc_xor ebp, ebp                                    # 004A036D
.L4A036F:
    mov ax, word ptr [ebp*2 + 0x11360a0]                 # 004A036F
    and ax, 0x1f8                                        # 004A0377
    cmp ax, 0                                            # 004A037B
    je .L4A038C                                          # 004A037F
    inc ebp                                              # 004A0381
    cmp ebp, dword ptr [0x113609c]                       # 004A0382
    jb .L4A036F                                          # 004A0388
    jmp .L4A03A3                                         # 004A038A
.L4A038C:
    mov ax, word ptr [ebp*2 + 0x11360a0]                 # 004A038C
    xchg word ptr [0x11360a0], ax                        # 004A0394
    mov word ptr [ebp*2 + 0x11360a0], ax                 # 004A039B
.L4A03A3:
    movzx ebx, byte ptr [0x1136062]                      # 004A03A3
    and ebx, 0xffffff7f                                  # 004A03AA
    mov ebx, dword ptr [ebx*4 + 0x50c984]                # 004A03B0
    test word ptr [ebx + 0x12], 4                        # 004A03B7
    jne .L4A03C9                                         # 004A03BD
    mov dword ptr [0x113609c], 1                         # 004A03BF
.L4A03C9:
    mov ebp, dword ptr [0x113609c]                       # 004A03C9
    dec ebp                                              # 004A03CF
    mov bp, word ptr [ebp*2 + 0x11360a0]                 # 004A03D0
    and ebp, 0x1ff                                       # 004A03D8
    xor ebp, 4                                           # 004A03DE
    mov ax, word ptr [0x1135fb4]                         # 004A03E1
    mov cx, word ptr [0x1135fb6]                         # 004A03E7
    mov dx, word ptr [0x1135fb8]                         # 004A03EE
    sub ax, word ptr [ebp*8 + 0x4f6f8e]                  # 004A03F5
    sub cx, word ptr [ebp*8 + 0x4f6f90]                  # 004A03FD
    test ebp, 4                                          # 004A0405
    jne .L4A0415                                         # 004A040B
    sub dx, word ptr [ebp*8 + 0x4f6f92]                  # 004A040D
.L4A0415:
    msvc_mov esi, ebp                                    # 004A0415
    shr esi, 3                                           # 004A0417
    mov esi, dword ptr [esi*4 + 0x4f6d1c]                # 004A041A
    test ebp, 4                                          # 004A0421
    je .L4A0434                                          # 004A0427
.L4A0429:
...
.L4A0434:
    ...
    push ebp                                             # 004A044C
    movzx ebp, byte ptr [0x1136062]                      # 004A044D
    and bp, 0xff7f                                       # 004A0454
    mov esi, dword ptr [ebp*4 + 0x50c984]                # 004A0459
    mov si, word ptr [esi]                               # 004A0460
    mov word ptr [0x112c82c], si                         # 004A0463
    mov bl, 1                                            # 004A046A
    mov word ptr [0x9c68e8], 0x8e                        # 004A046C
    mov esi, 0x27                                        # 004A0475
    call _sub_431315                                     # 004A047A
    pop ebp                                              # 004A047F
    cmp ebx, 0x80000000                                  # 004A0480
    je .L4A04F6                                          # 004A0486
    dec dword ptr [0x113609c]                            # 004A0488
    jne .L4A03C9                                         # 004A048E
    mov ax, word ptr [0x1135fb4]                         # 004A0494
    mov cx, word ptr [0x1135fb6]                         # 004A049A
    mov dx, word ptr [0x1135fb8]                         # 004A04A1
    sub ax, word ptr [ebp*8 + 0x4f6f8e]                  # 004A04A8
    sub cx, word ptr [ebp*8 + 0x4f6f90]                  # 004A04B0
    sub dx, word ptr [ebp*8 + 0x4f6f92]                  # 004A04B8
    mov word ptr [0x1135fb4], ax                         # 004A04C0
    mov word ptr [0x1135fb6], cx                         # 004A04C6
    mov word ptr [0x1135fb8], dx                         # 004A04CD
    mov bl, byte ptr [ebp*8 + 0x4f6f8c]                  # 004A04D4
    mov byte ptr [0x1136064], bl                         # 004A04DB
    mov byte ptr [0x1136067], 0                          # 004A04E1
    mov byte ptr [0x1136068], 0                          # 004A04E8
...
_sub_4A04F8:
    push esi                                             # 004A04F8
    push ebp                                             # 004A04F9
    movzx eax, byte ptr [0x1136067]                      # 004A04FA
    mov bl, byte ptr [0x1136068]                         # 004A0501
    mov bh, byte ptr [0x1136064]                         # 004A0507
    cmp al, 0xff                                         # 004A050D
    je _sub_4A082E                                       # 004A050F
    jmp dword ptr [eax*4 + 0x4ffe68]                     # 004A0515
...
_sub_4A07DA:
    ...
    and bh, 3                                            # 004A07DF
.L4A07E2:
    mov ax, word ptr [0x1135fb4]                         # 004A07E2
    mov cx, word ptr [0x1135fb6]                         # 004A07E8
    mov di, word ptr [0x1135fb8]                         # 004A07EF
    mov dl, byte ptr [0x1136062]                         # 004A07F6
    push eax                                             # 004A07FC
    movzx edx, dx                                        # 004A07FD
    movsx eax, byte ptr [0x1136039]                      # 004A0800
    shl eax, 0x18                                        # 004A0807
    msvc_or edx, eax                                     # 004A080A
    pop eax                                              # 004A080C
    ror edi, 0x10                                        # 004A080D
    mov di, word ptr [0x1135fe4]                         # 004A0810
    ror edi, 0x10                                        # 004A0817
    test byte ptr [0x113607e], 1                         # 004A081A
    je .L4A0829                                          # 004A0821
...
_sub_4A0832:
    push esi                                             # 004A0832
    push ebp                                             # 004A0833
    movzx eax, byte ptr [0x1136067]                      # 004A0834
    mov bl, byte ptr [0x1136068]                         # 004A083B
    mov bh, byte ptr [0x1136064]                         # 004A0841
    cmp al, 0xff                                         # 004A0847
    je _sub_4A095F                                       # 004A0849
    jmp dword ptr [eax*4 + 0x4ffea0]                     # 004A084F
...
_sub_4A0917:
    ...
    and bh, 3                                            # 004A091C
.L4A091F:
    mov ax, word ptr [0x1135fb4]                         # 004A091F
    mov cx, word ptr [0x1135fb6]                         # 004A0925
    mov di, word ptr [0x1135fb8]                         # 004A092C
    mov dl, byte ptr [0x1136062]                         # 004A0933
    and dl, 0x7f                                         # 004A0939
    push eax                                             # 004A093C
    movzx edx, dx                                        # 004A093D
    movsx eax, byte ptr [0x1136039]                      # 004A0940
    shl eax, 0x18                                        # 004A0947
    msvc_or edx, eax                                     # 004A094A
    pop eax                                              # 004A094C
    ror edi, 0x10                                        # 004A094D
    mov di, word ptr [0x1135fe4]                         # 004A0950
...
_sub_4A0AB0:
    ...
    mov byte ptr [0x522096], 0                           # 004A0AC4
    popal                                                # 004A0ACB
    ret                                                  # 004A0ACC

    .global _sub_4A0ACD
_sub_4A0ACD:
    mov byte ptr [0x9c68ea], 0x40                        # 004A0ACD
    test bl, 1                                           # 004A0AD4
    je .L4A0AE2                                          # 004A0AD7
    bts word ptr [0x508f10], 0                           # 004A0AD9
.L4A0AE2:
    ...
    .global _sub_4A0AE5
_sub_4A0AE5:
    push word ptr [0xe3f0bc]                             # 004A0AE5
    mov word ptr [0xe3f0bc], 0                           # 004A0AEC
    pushal                                               # 004A0AF5
    mov edi, dword ptr [0xe0c3e0]                        # 004A0AF6
    mov eax, 0xe0c410                                    # 004A0AFC
    add eax, 0x32c40                                     # 004A0B01
    mov dword ptr [0xe0c404], eax                        # 004A0B06
    mov ebp, 0xe0c410                                    # 004A0B0B
    call _sub_45A6CA                                     # 004A0B10
    popal                                                # 004A0B15
    mov si, word ptr [0xf24484]                          # 004A0B16
    push esi                                             # 004A0B1D
    mov si, word ptr [0xf24942]                          # 004A0B1E
    push esi                                             # 004A0B25
    mov si, word ptr [0xf24944]                          # 004A0B26
    push esi                                             # 004A0B2D
    mov si, word ptr [0xf24946]                          # 004A0B2E
    push esi                                             # 004A0B35
    movzx si, byte ptr [0xf24948]                        # 004A0B36
    push esi                                             # 004A0B3E
    and word ptr [0xf24484], 0xfffb                      # 004A0B3F
    test byte ptr [0x522095], 2                          # 004A0B47
    je .L4A0B72                                          # 004A0B4E
    or word ptr [0xf24484], 4                            # 004A0B50
    mov word ptr [0xf24942], ax                          # 004A0B58
    mov word ptr [0xf24944], cx                          # 004A0B5E
    mov word ptr [0xf24946], di                          # 004A0B65
    mov byte ptr [0xf24948], bh                          # 004A0B6C
.L4A0B72:
    and bh, 3                                            # 004A0B72
    push eax                                             # 004A0B75
    push edx                                             # 004A0B76
    ...
    mov ebp, dword ptr [ebp*4 + 0x50c914]                # 004A0B7E
...
.L4A0B87:
    ...
    mov ebp, dword ptr [ebp*4 + 0x50c8f4]                # 004A0B93
    movzx edx, dh                                        # 004A0B9A
    mov ax, word ptr [edx*2 + 0x4f891c]                  # 004A0B9D
    and ax, word ptr [ebp + 2]                           # 004A0BA5
    cmp ax, word ptr [edx*2 + 0x4f891c]                  # 004A0BA9
    je .L4A0BB7                                          # 004A0BB1
    btr di, si                                           # 004A0BB3
.L4A0BB7:
    pop ebp                                              # 004A0BB7
.L4A0BB8:
    ...
    mov ebp, dword ptr [ebp*4 + 0x4f73d8]                # 004A0BCF
...
_sub_4A0BD6:
    ...
    jmp dword ptr [edi*4 + 0x4ffed8]                     # 004A0BF0
...
_sub_4A0C37:
    ...
    shr ebp, 3                                           # 004A0C66
    add ebp, 0xe40134                                    # 004A0C69
    mov esi, 0x522098                                    # 004A0C6F
    xchg dword ptr [ebp], esi                            # 004A0C74
    mov dword ptr [0x5220a8], esi                        # 004A0C77
    ...
    shr ebp, 3                                           # 004A0C91
    add ebp, 0xe40134                                    # 004A0C94
    mov esi, 0x5220a0                                    # 004A0C9A
    xchg dword ptr [ebp], esi                            # 004A0C9F
    mov dword ptr [0x5220ac], esi                        # 004A0CA2
    ...
    shr ebp, 3                                           # 004A0CBC
    add ebp, 0xe40134                                    # 004A0CBF
    mov esi, 0x5220a0                                    # 004A0CC5
    xchg dword ptr [ebp], esi                            # 004A0CCA
    mov dword ptr [0x5220b0], esi                        # 004A0CCD
    ...
    shr ebp, 3                                           # 004A0CF0
    add ebp, 0xe40134                                    # 004A0CF3
    mov esi, 0x5220a0                                    # 004A0CF9
    xchg dword ptr [ebp], esi                            # 004A0CFE
    mov dword ptr [0x5220b4], esi                        # 004A0D01
    ...
    shr ebp, 3                                           # 004A0D1C
    add ebp, 0xe40134                                    # 004A0D1F
    mov esi, 0x5220a0                                    # 004A0D25
    xchg dword ptr [ebp], esi                            # 004A0D2A
    mov dword ptr [0x5220b8], esi                        # 004A0D2D
    pop ebp                                              # 004A0D33
    msvc_mov bh, bl                                      # 004A0D34
    and bh, 0xf                                          # 004A0D36
    or bh, 0x80                                          # 004A0D39
    mov byte ptr [0x522099], bh                          # 004A0D3C
    mov byte ptr [0x52209a], dl                          # 004A0D42
    mov byte ptr [0x52209b], dh                          # 004A0D48
    mov bl, byte ptr [esp + 0x15]                        # 004A0D4E
    or bl, 4                                             # 004A0D52
    mov byte ptr [0x522098], bl                          # 004A0D55
    mov bl, byte ptr [ebp]                               # 004A0D5B
    mov byte ptr [0x52209d], bl                          # 004A0D5E
    mov bl, byte ptr [esp + 0xc]                         # 004A0D64
    shl bl, 4                                            # 004A0D68
    or byte ptr [0x52209d], bl                           # 004A0D6B
    mov bl, byte ptr [esp + 0xd]                         # 004A0D71
    mov byte ptr [0x52209c], bl                          # 004A0D75
    mov byte ptr [0x52209e], 0                           # 004A0D7B
    mov bl, byte ptr [0x525e3c]                          # 004A0D82
    mov byte ptr [0x52209f], bl                          # 004A0D88
    mov bl, byte ptr [esp + 0xa]                         # 004A0D8E
    shl bl, 4                                            # 004A0D92
    or byte ptr [0x52209f], bl                           # 004A0D95
    push ebp                                             # 004A0D9B
    ...
    shr ebp, 3                                           # 004A0DB3
    add ebp, 0xe40134                                    # 004A0DB6
    mov esi, dword ptr [0x5220a8]                        # 004A0DBC
    ...
    shr ebp, 3                                           # 004A0DD9
    add ebp, 0xe40134                                    # 004A0DDC
    mov esi, dword ptr [0x5220ac]                        # 004A0DE2
    ...
    shr ebp, 3                                           # 004A0DFF
    add ebp, 0xe40134                                    # 004A0E02
    mov esi, dword ptr [0x5220b0]                        # 004A0E08
    ...
    shr ebp, 3                                           # 004A0E2E
    add ebp, 0xe40134                                    # 004A0E31
    mov esi, dword ptr [0x5220b4]                        # 004A0E37
    ...
    shr ebp, 3                                           # 004A0E55
    add ebp, 0xe40134                                    # 004A0E58
    mov esi, dword ptr [0x5220b8]                        # 004A0E5E
...
_sub_4A0E70:
    ...
    popal                                                # 004A0E82
    pop eax                                              # 004A0E83
    mov byte ptr [0xf24948], al                          # 004A0E84
    pop eax                                              # 004A0E89
    mov word ptr [0xf24946], ax                          # 004A0E8A
    pop eax                                              # 004A0E90
    mov word ptr [0xf24944], ax                          # 004A0E91
    pop eax                                              # 004A0E97
    mov word ptr [0xf24942], ax                          # 004A0E98
    pop eax                                              # 004A0E9E
    mov word ptr [0xf24484], ax                          # 004A0E9F
    pop word ptr [0xe3f0bc]                              # 004A0EA5
    ret                                                  # 004A0EAC
...
_sub_4A0EAD:
    ...
    mov dword ptr [0x1136090], ebx                       # 004A0EB2
    mov ebx, dword ptr [edx + 4]                         # 004A0EB8
    mov dword ptr [0x1136094], ebx                       # 004A0EBB
    mov edx, 0x1136090                                   # 004A0EC1
    mov bl, byte ptr [edx + 7]                           # 004A0EC6
    and bl, 0xf                                          # 004A0EC9
    cmp bl, byte ptr [0x525e3c]                          # 004A0ECC
...
.L4A0EF4:
    ...
    mov eax, dword ptr [0x4ffad8]                        # 004A0EFD
    mov dword ptr [esi + 0xc], eax                       # 004A0F02
    mov eax, dword ptr [0x4ffac8]                        # 004A0F05
    mov dword ptr [esi], eax                             # 004A0F0A
    mov dword ptr [esi + 0x1c], 0                        # 004A0F0C
    mov eax, dword ptr [0x4ffab8]                        # 004A0F13
...
.L4A0F2C:
    ...
    shr bl, 4                                            # 004A0F30
    mov byte ptr [0x1136062], bl                         # 004A0F33
    mov byte ptr [0x1136063], 0                          # 004A0F39
    push ecx                                             # 004A0F40
    msvc_mov cl, bl                                      # 004A0F41
    call _sub_4A3A06                                     # 004A0F43
    pop ecx                                              # 004A0F48
    mov byte ptr [0x1136061], 0                          # 004A0F49
    mov byte ptr [0x113607e], 1                          # 004A0F50
    mov dword ptr [0x1135f3e], 0x80000000                # 004A0F57
    mov byte ptr [0x1136076], 0                          # 004A0F61
    mov dword ptr [0x1135f4a], edx                       # 004A0F68
    mov byte ptr [0x113606e], 0                          # 004A0F6E
    movzx ebp, byte ptr [edx + 4]                        # 004A0F75
    and ebp, 0x3f                                        # 004A0F79
    mov ebp, dword ptr [ebp*4 + 0x4f73d8]                # 004A0F7C
    ...
    shl di, 2                                            # 004A0F99
    jmp dword ptr [ebx*4 + 0x4ffee8]                     # 004A0F9D
...
_sub_4A0FCA:
    ...
    push edx                                             # 004A0FE0
    push edi                                             # 004A0FE1
    add ax, word ptr [ebx*8 + 0x4f7b5e]                  # 004A0FE2
    add cx, word ptr [ebx*8 + 0x4f7b60]                  # 004A0FEA
    add di, word ptr [ebx*8 + 0x4f7b62]                  # 004A0FF2
    mov dl, byte ptr [ebx*8 + 0x4f7b5d]                  # 004A0FFA
    mov word ptr [0x1135fc6], ax                         # 004A1001
    mov word ptr [0x1135fc8], cx                         # 004A1007
    mov word ptr [0x1135fca], di                         # 004A100E
    mov word ptr [0x1135fcc], dx                         # 004A1015
    pop edi                                              # 004A101C
    pop edx                                              # 004A101D
    pop ecx                                              # 004A101E
    pop eax                                              # 004A101F
    movzx edx, byte ptr [ebx*8 + 0x4f7b5c]               # 004A1020
    movzx edx, byte ptr [edx + 0x503cac]                 # 004A1028
    mov word ptr [0x1135fd4], dx                         # 004A102F
    cmp dl, 0xc                                          # 004A1036
    jae .L4A104B                                         # 004A1039
    add ax, word ptr [edx*4 + 0x503c6c]                  # 004A103B
    add cx, word ptr [edx*4 + 0x503c6e]                  # 004A1043
.L4A104B:
    mov word ptr [0x1135fce], ax                         # 004A104B
    mov word ptr [0x1135fd0], cx                         # 004A1051
    mov word ptr [0x1135fd2], di                         # 004A1058
    mov ax, word ptr [0x1135fc6]                         # 004A105F
    mov cx, word ptr [0x1135fc8]                         # 004A1065
    add ax, 0x10                                         # 004A106C
    add cx, 0x10                                         # 004A1070
    mov dx, word ptr [0x1135fca]                         # 004A1074
    mov ebx, dword ptr [0xe3f0b8]                        # 004A107B
    jmp dword ptr [ebx*4 + 0x4ffef8]                     # 004A1081
...
_sub_4A10D6:
    ...
    sub ax, word ptr [0x523378]                          # 004A10F5
    jns .L4A1101                                         # 004A10FC
    neg ax                                               # 004A10FE
.L4A1101:
    sub bx, word ptr [0x52337a]                          # 004A1101
    jns .L4A110D                                         # 004A1108
    neg bx                                               # 004A110A
.L4A110D:
    msvc_add ax, bx                                      # 004A110D
    msvc_mov bp, ax                                      # 004A1110
    mov ax, word ptr [0x1135fce]                         # 004A1113
    mov cx, word ptr [0x1135fd0]                         # 004A1119
    add ax, 0x10                                         # 004A1120
    add cx, 0x10                                         # 004A1124
    mov dx, word ptr [0x1135fd2]                         # 004A1128
    mov ebx, dword ptr [0xe3f0b8]                        # 004A112F
    jmp dword ptr [ebx*4 + 0x4fff08]                     # 004A1135
...
_sub_4A118A:
    ...
    sub ax, word ptr [0x523378]                          # 004A11A9
    jns .L4A11B5                                         # 004A11B0
    neg ax                                               # 004A11B2
.L4A11B5:
    sub bx, word ptr [0x52337a]                          # 004A11B5
    jns .L4A11C1                                         # 004A11BC
    neg bx                                               # 004A11BE
.L4A11C1:
    msvc_add ax, bx                                      # 004A11C1
    msvc_mov di, ax                                      # 004A11C4
    mov ax, word ptr [0x1135fc6]                         # 004A11C7
    mov cx, word ptr [0x1135fc8]                         # 004A11CD
    mov dx, word ptr [0x1135fca]                         # 004A11D4
    mov bx, word ptr [0x1135fcc]                         # 004A11DB
    msvc_cmp bp, di                                      # 004A11E2
    jbe .L4A1202                                         # 004A11E5
    mov ax, word ptr [0x1135fce]                         # 004A11E7
    mov cx, word ptr [0x1135fd0]                         # 004A11ED
    mov dx, word ptr [0x1135fd2]                         # 004A11F4
    mov bx, word ptr [0x1135fd4]                         # 004A11FB
.L4A1202:
    mov word ptr [0x1135fb4], ax                         # 004A1202
    mov word ptr [0x1135fb6], cx                         # 004A1208
    mov word ptr [0x1135fb8], dx                         # 004A120F
    mov byte ptr [0x1136064], bl                         # 004A1216
    mov byte ptr [0x1136067], 0                          # 004A121C
    mov byte ptr [0x1136068], 0                          # 004A1223
    pop edi                                              # 004A122A
    mov al, byte ptr [0x1136062]                         # 004A122B
    mov edi, 0x113601d                                   # 004A1230
    call _sub_488B4D                                     # 004A1235
    movzx edi, byte ptr [0x1136062]                      # 004A123A
    mov al, byte ptr [edi + 0x525f72]                    # 004A1241
    cmp al, 0xff                                         # 004A1247
    jne .L4A1250                                         # 004A1249
    mov al, byte ptr [0x113601d]                         # 004A124B
.L4A1250:
    mov byte ptr [0x113602e], al                         # 004A1250
    mov al, byte ptr [0x1136062]                         # 004A1255
    mov edi, 0x113603b                                   # 004A125A
    call _sub_48D5E4                                     # 004A125F
    movzx edi, byte ptr [0x1136062]                      # 004A1264
    mov al, byte ptr [edi + 0x525f82]                    # 004A126B
    cmp al, 0xff                                         # 004A1271
    jne .L4A127A                                         # 004A1273
    mov al, byte ptr [0x113603b]                         # 004A1275
.L4A127A:
    mov byte ptr [0x113604c], al                         # 004A127A
    mov al, byte ptr [0x1136062]                         # 004A127F
    mov edi, 0x1136030                                   # 004A1284
    call _sub_42C490                                     # 004A1289
    movzx edi, byte ptr [0x1136062]                      # 004A128E
    mov al, byte ptr [edi + 0x525f7a]                    # 004A1295
    cmp al, 0xff                                         # 004A129B
    jne .L4A12A4                                         # 004A129D
    mov al, byte ptr [0x1136030]                         # 004A129F
.L4A12A4:
    mov byte ptr [0x1136039], al                         # 004A12A4
    mov edx, dword ptr [0x1135f4a]                       # 004A12A9
    test byte ptr [edx + 4], 0x80                        # 004A12AF
    je .L4A12C0                                          # 004A12B3
    mov al, byte ptr [edx + 6]                           # 004A12B5
    shr al, 5                                            # 004A12B8
    mov byte ptr [0x1136039], al                         # 004A12BB
.L4A12C0:
    mov al, byte ptr [0x1136062]                         # 004A12C0
    mov edi, 0x1136054                                   # 004A12C5
    call _sub_4A693D                                     # 004A12CA
    mov edx, dword ptr [0x1135f4a]                       # 004A12CF
    movzx ax, byte ptr [edx + 7]                         # 004A12D5
    shr ax, 4                                            # 004A12DA
    mov word ptr [0x1135fe4], ax                         # 004A12DE
    mov byte ptr [0x113603a], 0                          # 004A12E4
...
.L4A1344:
    ...
    mov esi, dword ptr [esi*4 + 0x50c914]                # 004A134A
    msvc_mov ebp, edi                                    # 004A1351
    shr ebp, 0x10                                        # 004A1353
    bsf ebp, ebp                                         # 004A1356
    movzx ebp, byte ptr [ebp + esi + 0xa]                # 004A1359
    mov ebp, dword ptr [ebp*4 + 0x50c8f4]                # 004A135E
    mov ax, word ptr [ebp]                               # 004A1365
    mov word ptr [0x112c82c], ax                         # 004A1369
    pop ebp                                              # 004A136F
    pop eax                                              # 004A1370
    mov word ptr [0x9c68e8], 0x8e                        # 004A1371
    mov bl, 1                                            # 004A137A
    ...
    push ecx                                             # 004A1391
    push edx                                             # 004A1392
    mov cx, word ptr [0x9c68e0]                          # 004A1393
    mov dx, word ptr [0x9c68e2]                          # 004A139A
    mov bp, word ptr [0x9c68e4]                          # 004A13A1
...
.L4A1402:
    ...
    mov esi, dword ptr [esi*4 + 0x50c984]                # 004A1408
    msvc_mov ebp, edi                                    # 004A140F
    shr ebp, 0x10                                        # 004A1411
    bsf ebp, ebp                                         # 004A1414
    movzx ebp, byte ptr [ebp + esi + 0x26]               # 004A1417
    mov ebp, dword ptr [ebp*4 + 0x50c974]                # 004A141C
    mov ax, word ptr [ebp]                               # 004A1423
    mov word ptr [0x112c82c], ax                         # 004A1427
    pop ebp                                              # 004A142D
    pop eax                                              # 004A142E
    mov word ptr [0x9c68e8], 0x8e                        # 004A142F
    mov bl, 1                                            # 004A1438
    ...
    push ecx                                             # 004A144F
    push edx                                             # 004A1450
    mov cx, word ptr [0x9c68e0]                          # 004A1451
    mov dx, word ptr [0x9c68e2]                          # 004A1458
    mov bp, word ptr [0x9c68e4]                          # 004A145F
...
_sub_4A147F:
    ...
    mov dword ptr [0x1136090], ebx                       # 004A1484
    mov ebx, dword ptr [edx + 4]                         # 004A148A
    mov dword ptr [0x1136094], ebx                       # 004A148D
    mov edx, 0x1136090                                   # 004A1493
    push edi                                             # 004A1498
    pushal                                               # 004A1499
...
.L4A14B4:
    ...
    mov eax, dword ptr [0x4ffad8]                        # 004A14BD
    mov dword ptr [esi + 0xc], eax                       # 004A14C2
    mov eax, dword ptr [0x4ffac8]                        # 004A14C5
    mov dword ptr [esi], eax                             # 004A14CA
    mov dword ptr [esi + 0x1c], 0                        # 004A14CC
    mov eax, dword ptr [0x4ffab8]                        # 004A14D3
...
.L4A14EC:
    ...
    shr bl, 4                                            # 004A14F0
    or bl, 0x80                                          # 004A14F3
    mov byte ptr [0x1136062], bl                         # 004A14F6
    mov byte ptr [0x1136063], 0                          # 004A14FC
    push ecx                                             # 004A1503
    msvc_mov cl, bl                                      # 004A1504
    call _sub_4A3A06                                     # 004A1506
    pop ecx                                              # 004A150B
    mov byte ptr [0x1136061], 0                          # 004A150C
    mov byte ptr [0x113607e], 1                          # 004A1513
    mov dword ptr [0x1135f3e], 0x80000000                # 004A151A
    mov byte ptr [0x1136076], 0                          # 004A1524
    mov dword ptr [0x1135f4a], edx                       # 004A152B
    mov byte ptr [0x113606e], 0                          # 004A1531
    movzx ebp, byte ptr [edx + 4]                        # 004A1538
    and ebp, 0xf                                         # 004A153C
    mov ebp, dword ptr [ebp*4 + 0x4f6d1c]                # 004A153F
    ...
    shl di, 2                                            # 004A155C
    jmp dword ptr [ebx*4 + 0x4fff18]                     # 004A1560
...
_sub_4A158D:
    ...
    push edx                                             # 004A15A3
    push edi                                             # 004A15A4
    add ax, word ptr [ebx*8 + 0x4f6f8e]                  # 004A15A5
    add cx, word ptr [ebx*8 + 0x4f6f90]                  # 004A15AD
    add di, word ptr [ebx*8 + 0x4f6f92]                  # 004A15B5
    mov dl, byte ptr [ebx*8 + 0x4f6f8d]                  # 004A15BD
    mov word ptr [0x1135fc6], ax                         # 004A15C4
    mov word ptr [0x1135fc8], cx                         # 004A15CA
    mov word ptr [0x1135fca], di                         # 004A15D1
    mov word ptr [0x1135fcc], dx                         # 004A15D8
    pop edi                                              # 004A15DF
    pop edx                                              # 004A15E0
    pop ecx                                              # 004A15E1
    pop eax                                              # 004A15E2
    movzx edx, byte ptr [ebx*8 + 0x4f6f8c]               # 004A15E3
    movzx edx, byte ptr [edx + 0x503cac]                 # 004A15EB
    mov word ptr [0x1135fd4], dx                         # 004A15F2
    cmp dl, 0xc                                          # 004A15F9
    jae .L4A160E                                         # 004A15FC
    add ax, word ptr [edx*4 + 0x503c6c]                  # 004A15FE
    add cx, word ptr [edx*4 + 0x503c6e]                  # 004A1606
.L4A160E:
    mov word ptr [0x1135fce], ax                         # 004A160E
    mov word ptr [0x1135fd0], cx                         # 004A1614
    mov word ptr [0x1135fd2], di                         # 004A161B
    mov ax, word ptr [0x1135fc6]                         # 004A1622
    mov cx, word ptr [0x1135fc8]                         # 004A1628
    add ax, 0x10                                         # 004A162F
    add cx, 0x10                                         # 004A1633
    mov dx, word ptr [0x1135fca]                         # 004A1637
    mov ebx, dword ptr [0xe3f0b8]                        # 004A163E
    jmp dword ptr [ebx*4 + 0x4fff28]                     # 004A1644
...
_sub_4A1699:
    ...
    sub ax, word ptr [0x523378]                          # 004A16B8
    jns .L4A16C4                                         # 004A16BF
    neg ax                                               # 004A16C1
.L4A16C4:
    sub bx, word ptr [0x52337a]                          # 004A16C4
    jns .L4A16D0                                         # 004A16CB
    neg bx                                               # 004A16CD
.L4A16D0:
    msvc_add ax, bx                                      # 004A16D0
    msvc_mov bp, ax                                      # 004A16D3
    mov ax, word ptr [0x1135fce]                         # 004A16D6
    mov cx, word ptr [0x1135fd0]                         # 004A16DC
    add ax, 0x10                                         # 004A16E3
    add cx, 0x10                                         # 004A16E7
    mov dx, word ptr [0x1135fd2]                         # 004A16EB
    mov ebx, dword ptr [0xe3f0b8]                        # 004A16F2
    jmp dword ptr [ebx*4 + 0x4fff38]                     # 004A16F8
...
_sub_4A174D:
    ...
    sub ax, word ptr [0x523378]                          # 004A176C
    jns .L4A1778                                         # 004A1773
    neg ax                                               # 004A1775
.L4A1778:
    sub bx, word ptr [0x52337a]                          # 004A1778
    jns .L4A1784                                         # 004A177F
    neg bx                                               # 004A1781
.L4A1784:
    msvc_add ax, bx                                      # 004A1784
    msvc_mov di, ax                                      # 004A1787
    mov ax, word ptr [0x1135fc6]                         # 004A178A
    mov cx, word ptr [0x1135fc8]                         # 004A1790
    mov dx, word ptr [0x1135fca]                         # 004A1797
    mov bx, word ptr [0x1135fcc]                         # 004A179E
    msvc_cmp bp, di                                      # 004A17A5
    jbe .L4A17C5                                         # 004A17A8
    mov ax, word ptr [0x1135fce]                         # 004A17AA
    mov cx, word ptr [0x1135fd0]                         # 004A17B0
    mov dx, word ptr [0x1135fd2]                         # 004A17B7
    mov bx, word ptr [0x1135fd4]                         # 004A17BE
.L4A17C5:
    mov word ptr [0x1135fb4], ax                         # 004A17C5
    mov word ptr [0x1135fb6], cx                         # 004A17CB
    mov word ptr [0x1135fb8], dx                         # 004A17D2
    mov byte ptr [0x1136064], bl                         # 004A17D9
    mov byte ptr [0x1136067], 0                          # 004A17DF
    mov byte ptr [0x1136068], 0                          # 004A17E6
    pop edi                                              # 004A17ED
    mov byte ptr [0x113602e], 0xff                       # 004A17EE
    mov al, byte ptr [0x1136062]                         # 004A17F5
    and al, 0x7f                                         # 004A17FA
    mov edi, 0x113603b                                   # 004A17FC
    call _sub_48D678                                     # 004A1801
    movzx edi, byte ptr [0x1136062]                      # 004A1806
    and edi, 0xffffff7f                                  # 004A180D
    mov al, byte ptr [edi + 0x525f9a]                    # 004A1813
    cmp al, 0xff                                         # 004A1819
    jne .L4A1822                                         # 004A181B
    mov al, byte ptr [0x113603b]                         # 004A181D
.L4A1822:
    mov byte ptr [0x113604c], al                         # 004A1822
    mov al, byte ptr [0x1136062]                         # 004A1827
    and al, 0x7f                                         # 004A182C
    mov edi, 0x1136030                                   # 004A182E
    call _sub_42C518                                     # 004A1833
    movzx edi, byte ptr [0x1136062]                      # 004A1838
    and di, 0xff7f                                       # 004A183F
    mov al, byte ptr [edi + 0x525f92]                    # 004A1844
    cmp al, 0xff                                         # 004A184A
    jne .L4A1853                                         # 004A184C
    mov al, byte ptr [0x1136030]                         # 004A184E
.L4A1853:
    mov byte ptr [0x1136039], al                         # 004A1853
    mov edx, dword ptr [0x1135f4a]                       # 004A1858
    test byte ptr [edx + 4], 0x80                        # 004A185E
    je .L4A186F                                          # 004A1862
    mov al, byte ptr [edx + 6]                           # 004A1864
    shr al, 5                                            # 004A1867
    mov byte ptr [0x1136039], al                         # 004A186A
.L4A186F:
    mov al, byte ptr [0x1136062]                         # 004A186F
    and al, 0x7f                                         # 004A1874
    mov edi, 0x1136054                                   # 004A1876
    call _sub_4781C5                                     # 004A187B
    mov word ptr [0x1135fe4], 0                          # 004A1880
    movzx edx, byte ptr [0x1136062]                      # 004A1889
    and dl, 0x7f                                         # 004A1890
    mov edx, dword ptr [edx*4 + 0x50c984]                # 004A1893
    test word ptr [edx + 0x12], 8                        # 004A189A
    jne .L4A18B7                                         # 004A18A0
    mov edx, dword ptr [0x1135f4a]                       # 004A18A2
    movzx ax, byte ptr [edx + 7]                         # 004A18A8
    shr ax, 6                                            # 004A18AD
    mov word ptr [0x1135fe4], ax                         # 004A18B1
.L4A18B7:
    mov byte ptr [0x113603a], 0                          # 004A18B7
...
.L4A18CC:
    ...
    .global _sub_4A18D4
_sub_4A18D4:
    movzx ebx, byte ptr [0x112c2e9]                      # 004A18D4
    cmp bl, 0xff                                         # 004A18DB
    je .L4A193A                                          # 004A18DE
    or bl, 0x80                                          # 004A18E0
    cmp bl, byte ptr [0x1136062]                         # 004A18E3
    je .L4A193A                                          # 004A18E9
    and bl, 0x7f                                         # 004A18EB
    mov ebp, dword ptr [ebx*4 + 0x50c984]                # 004A18EE
    test word ptr [ebp + 0x12], 8                        # 004A18F5
    je .L4A193A                                          # 004A18FB
    or bl, 0x80                                          # 004A18FD
    mov ebp, 0x50a006                                    # 004A1900
.L4A1905:
...
.L4A1913:
    movzx ebp, byte ptr [0x1136062]                      # 004A1913
    and ebp, 0xffffff7f                                  # 004A191A
    mov ebp, dword ptr [ebp*4 + 0x50c984]                # 004A1920
    test word ptr [ebp + 0x12], 8                        # 004A1927
    je .L4A193A                                          # 004A192D
    mov byte ptr [0x1136062], bl                         # 004A192F
...
.L4A193A:
    ...
    .global _sub_4A193B
_sub_4A193B:
    mov bl, byte ptr [0x1136075]                         # 004A193B
    mov ebp, 0x1136030                                   # 004A1941
.L4A1946:
...
.L4A1954:
    mov byte ptr [0x1136039], bl                         # 004A1954
.L4A195A:
    ret                                                  # 004A195A

    .global _sub_4A195B
_sub_4A195B:
    test byte ptr [0x1136062], 0x80                      # 004A195B
    jne _sub_4A1CEE                                      # 004A1962
    call _sub_46112C                                     # 004A1968
    and word ptr [0xf24484], 0xfff8                      # 004A196D
    push eax                                             # 004A1975
    push ebx                                             # 004A1976
    ...
    shl ebp, 3                                           # 004A1981
    cmp word ptr [ebp*8 + 0x4f7b62], 0                   # 004A1984
    ...
    add esp, 8                                           # 004A19AC
    mov byte ptr [0x113605d], 1                          # 004A19AF
...
.L4A19B8:
    ...
    shr edi, 3                                           # 004A19D5
    mov edi, dword ptr [edi + 0xe40134]                  # 004A19D8
...
.L4A1A1B:
    mov byte ptr [0x113605d], 0                          # 004A1A1B
.L4A1A22:
    or word ptr [0xf24484], 2                            # 004A1A22
    and word ptr [0xf24484], 0xfff7                      # 004A1A2A
    or word ptr [0xf24484], 4                            # 004A1A32
    mov cl, byte ptr [0x1136064]                         # 004A1A3A
    mov byte ptr [0xf24948], cl                          # 004A1A40
    mov word ptr [0xf24942], ax                          # 004A1A46
    mov word ptr [0xf24944], bx                          # 004A1A4C
    mov word ptr [0xf24946], dx                          # 004A1A53
    mov word ptr [0xf24490], ax                          # 004A1A5A
    mov word ptr [0xf24492], bx                          # 004A1A60
    mov word ptr [0xf24494], 0xffff                      # 004A1A67
    push eax                                             # 004A1A70
    push ebx                                             # 004A1A71
    ...
    mov byte ptr [0x1136065], dh                         # 004A1A7F
    movzx ebp, dh                                        # 004A1A85
    mov ebp, dword ptr [ebp*4 + 0x4f73d8]                # 004A1A88
    mov edi, 0xf24490                                    # 004A1A8F
    push eax                                             # 004A1A94
    push ebx                                             # 004A1A95
    movzx ebx, byte ptr [0x1136064]                      # 004A1A96
...
_sub_4A1A9D:
    ...
    jmp dword ptr [ebx*4 + 0x4fff48]                     # 004A1AB1
...
_sub_4A1AE4:
    ...
    pop ebx                                              # 004A1AE9
    pop eax                                              # 004A1AEA
    mov dx, word ptr [0xf24946]                          # 004A1AEB
    cmp byte ptr [0x113605d], 1                          # 004A1AF2
    je .L4A1BF1                                          # 004A1AF9
    msvc_xor bp, bp                                      # 004A1AFF
    test word ptr [0xf24484], 2                          # 004A1B02
    je .L4A1B95                                          # 004A1B0B
    mov edi, 0xf24490                                    # 004A1B11
.L4A1B16:
    ...
    shr esi, 3                                           # 004A1B3B
    mov esi, dword ptr [esi + 0xe40134]                  # 004A1B3E
...
.L4A1B95:
    ...
    shr edi, 3                                           # 004A1BA1
    mov edi, dword ptr [edi + 0xe40134]                  # 004A1BA4
...
.L4A1BF1:
    ...
    movzx edi, byte ptr [0x1136065]                      # 004A1BF4
    mov edi, dword ptr [edi*4 + 0x4f73d8]                # 004A1BFB
...
.L4A1C0F:
    ...
    mov word ptr [0xf24946], dx                          # 004A1C1A
    sub dx, 0x10                                         # 004A1C21
    mov ebx, 2                                           # 004A1C25
    test byte ptr [0x508f18], 1                          # 004A1C2A
    je .L4A1C43                                          # 004A1C31
    mov ebx, 0x80000008                                  # 004A1C33
    sub dx, 0x10                                         # 004A1C38
    mov word ptr [0xf24946], dx                          # 004A1C3C
.L4A1C43:
    mov word ptr [0x1135fb4], ax                         # 004A1C43
    mov word ptr [0x1135fb6], cx                         # 004A1C49
    mov word ptr [0x1135fb8], dx                         # 004A1C50
    test byte ptr [0x522096], 2                          # 004A1C57
    je .L4A1C7B                                          # 004A1C5E
    cmp ax, word ptr [0x1135fba]                         # 004A1C60
    jne .L4A1C7B                                         # 004A1C67
    cmp cx, word ptr [0x1135fbc]                         # 004A1C69
    jne .L4A1C7B                                         # 004A1C70
    cmp dx, word ptr [0x1135fbe]                         # 004A1C72
    je _sub_4A1CE8                                       # 004A1C79
.L4A1C7B:
    mov word ptr [0x1135fba], ax                         # 004A1C7B
    mov word ptr [0x1135fbc], cx                         # 004A1C81
    mov word ptr [0x1135fbe], dx                         # 004A1C88
    push esi                                             # 004A1C8F
.L4A1C90:
    push ebx                                             # 004A1C90
    call _sub_4A04F8                                     # 004A1C91
    call _sub_49FB63                                     # 004A1C96
    mov dword ptr [0x1135f3e], ebx                       # 004A1C9B
    mov bl, byte ptr [0x1136073]                         # 004A1CA1
    mov byte ptr [0x1136076], bl                         # 004A1CA7
    call _sub_4A193B                                     # 004A1CAD
    pop ebx                                              # 004A1CB2
    cmp dword ptr [0x1135f3e], 0x80000000                # 004A1CB3
    jne .L4A1CDB                                         # 004A1CBD
    dec bx                                               # 004A1CBF
    je .L4A1CDB                                          # 004A1CC1
    sub word ptr [0x1135fb8], 0x10                       # 004A1CC3
    js .L4A1CDB                                          # 004A1CCB
    msvc_or ebx, ebx                                     # 004A1CCD
    js .L4A1C90                                          # 004A1CCF
    add word ptr [0x1135fb8], 0x20                       # 004A1CD1
...
_sub_4A1CEE:
    ...
    and word ptr [0xf24484], 0xfff8                      # 004A1CF3
    push eax                                             # 004A1CFB
    push ebx                                             # 004A1CFC
    ...
    add esp, 8                                           # 004A1D27
    mov byte ptr [0x113605d], 1                          # 004A1D2A
...
.L4A1D33:
    ...
    shr edi, 3                                           # 004A1D50
    mov edi, dword ptr [edi + 0xe40134]                  # 004A1D53
...
.L4A1D96:
    mov byte ptr [0x113605d], 0                          # 004A1D96
.L4A1D9D:
    or word ptr [0xf24484], 2                            # 004A1D9D
    and word ptr [0xf24484], 0xfff7                      # 004A1DA5
    or word ptr [0xf24484], 4                            # 004A1DAD
    mov cl, byte ptr [0x1136064]                         # 004A1DB5
    mov byte ptr [0xf24948], cl                          # 004A1DBB
    mov word ptr [0xf24942], ax                          # 004A1DC1
    mov word ptr [0xf24944], bx                          # 004A1DC7
    mov word ptr [0xf24946], dx                          # 004A1DCE
    mov word ptr [0xf24490], ax                          # 004A1DD5
    mov word ptr [0xf24492], bx                          # 004A1DDB
    mov word ptr [0xf24494], 0xffff                      # 004A1DE2
    push eax                                             # 004A1DEB
    push ebx                                             # 004A1DEC
    ...
    mov byte ptr [0x1136065], dh                         # 004A1DFA
    movzx ebp, dh                                        # 004A1E00
    mov ebp, dword ptr [ebp*4 + 0x4f6d1c]                # 004A1E03
    mov edi, 0xf24490                                    # 004A1E0A
    push eax                                             # 004A1E0F
    push ebx                                             # 004A1E10
    movzx ebx, byte ptr [0x1136064]                      # 004A1E11
...
_sub_4A1E18:
    ...
    jmp dword ptr [ebx*4 + 0x4fff58]                     # 004A1E2C
...
_sub_4A1E5F:
    ...
    pop ebx                                              # 004A1E64
    pop eax                                              # 004A1E65
    mov dx, word ptr [0xf24946]                          # 004A1E66
    cmp byte ptr [0x113605d], 1                          # 004A1E6D
    je .L4A1F6C                                          # 004A1E74
    msvc_xor bp, bp                                      # 004A1E7A
    test word ptr [0xf24484], 2                          # 004A1E7D
    je .L4A1F10                                          # 004A1E86
    mov edi, 0xf24490                                    # 004A1E8C
.L4A1E91:
    ...
    shr esi, 3                                           # 004A1EB6
    mov esi, dword ptr [esi + 0xe40134]                  # 004A1EB9
...
.L4A1F10:
    ...
    shr edi, 3                                           # 004A1F1C
    mov edi, dword ptr [edi + 0xe40134]                  # 004A1F1F
...
.L4A1F6C:
    ...
    movzx edi, byte ptr [0x1136065]                      # 004A1F6F
    mov edi, dword ptr [edi*4 + 0x4f6d1c]                # 004A1F76
...
.L4A1F8A:
    ...
    mov word ptr [0xf24946], dx                          # 004A1F95
    sub dx, 0x10                                         # 004A1F9C
    mov ebx, 2                                           # 004A1FA0
    test byte ptr [0x508f18], 1                          # 004A1FA5
    je .L4A1FBE                                          # 004A1FAC
    mov ebx, 0x80000008                                  # 004A1FAE
    sub dx, 0x10                                         # 004A1FB3
    mov word ptr [0xf24946], dx                          # 004A1FB7
.L4A1FBE:
    mov word ptr [0x1135fb4], ax                         # 004A1FBE
    mov word ptr [0x1135fb6], cx                         # 004A1FC4
    mov word ptr [0x1135fb8], dx                         # 004A1FCB
    test byte ptr [0x522096], 2                          # 004A1FD2
    je .L4A1FF6                                          # 004A1FD9
    cmp ax, word ptr [0x1135fba]                         # 004A1FDB
    jne .L4A1FF6                                         # 004A1FE2
    cmp cx, word ptr [0x1135fbc]                         # 004A1FE4
    jne .L4A1FF6                                         # 004A1FEB
    cmp dx, word ptr [0x1135fbe]                         # 004A1FED
    je _sub_4A2063                                       # 004A1FF4
.L4A1FF6:
    mov word ptr [0x1135fba], ax                         # 004A1FF6
    mov word ptr [0x1135fbc], cx                         # 004A1FFC
    mov word ptr [0x1135fbe], dx                         # 004A2003
    push esi                                             # 004A200A
.L4A200B:
    push ebx                                             # 004A200B
    call _sub_4A0832                                     # 004A200C
    call _sub_49FC60                                     # 004A2011
    mov dword ptr [0x1135f3e], ebx                       # 004A2016
    mov bl, byte ptr [0x1136073]                         # 004A201C
    mov byte ptr [0x1136076], bl                         # 004A2022
    call _sub_4A193B                                     # 004A2028
    pop ebx                                              # 004A202D
    cmp dword ptr [0x1135f3e], 0x80000000                # 004A202E
    jne .L4A2056                                         # 004A2038
    dec bx                                               # 004A203A
    je .L4A2056                                          # 004A203C
    sub word ptr [0x1135fb8], 0x10                       # 004A203E
    js .L4A2056                                          # 004A2046
    msvc_or ebx, ebx                                     # 004A2048
    js .L4A200B                                          # 004A204A
    add word ptr [0x1135fb8], 0x20                       # 004A204C
...
_sub_4A2063:
    ...
    .global _sub_4A2069
_sub_4A2069:
    test byte ptr [0x1136062], 0x80                      # 004A2069
    ...
    pop eax                                              # 004A208A
    jb .L4A2340                                          # 004A208B
    mov byte ptr [0x1136065], dh                         # 004A2091
    msvc_xor bp, bp                                      # 004A2097
    test word ptr [0xf24484], 2                          # 004A209A
    je .L4A212D                                          # 004A20A3
    mov edi, 0xf24490                                    # 004A20A9
.L4A20AE:
    ...
    shr esi, 3                                           # 004A20D3
    mov esi, dword ptr [esi + 0xe40134]                  # 004A20D6
...
.L4A212D:
    mov word ptr [0x1136000], bp                         # 004A212D
    and word ptr [0xf24484], 0xfff8                      # 004A2134
    push eax                                             # 004A213C
    push ebx                                             # 004A213D
    ...
    shl ebp, 3                                           # 004A2148
    cmp word ptr [ebp*8 + 0x4f7b62], 0                   # 004A214B
    ...
    add esp, 8                                           # 004A2173
    mov byte ptr [0x113605d], 1                          # 004A2176
    mov word ptr [0x1135ffe], dx                         # 004A217D
...
.L4A2186:
    ...
    shr edi, 3                                           # 004A21A3
    mov edi, dword ptr [edi + 0xe40134]                  # 004A21A6
...
.L4A21D6:
    cmp dx, word ptr [0x1136000]                         # 004A21D6
    jae .L4A21E6                                         # 004A21DD
    mov dx, word ptr [0x1136000]                         # 004A21DF
.L4A21E6:
...
.L4A21FB:
    mov byte ptr [0x113605d], 0                          # 004A21FB
.L4A2202:
    msvc_mov cx, bx                                      # 004A2202
    call _sub_4CE3D6                                     # 004A2205
    push esi                                             # 004A220A
    test byte ptr [0x508f18], 1                          # 004A220B
    jne .L4A222B                                         # 004A2212
    cmp byte ptr [0x113605d], 1                          # 004A2214
    jne .L4A222B                                         # 004A221B
    mov ebx, 1                                           # 004A221D
    mov dx, word ptr [0x1135ffe]                         # 004A2222
    jmp .L4A226C                                         # 004A2229
.L4A222B:
    movzx edi, byte ptr [0x1136065]                      # 004A222B
    mov edi, dword ptr [edi*4 + 0x4f73d8]                # 004A2232
...
.L4A2246:
    ...
    mov ebx, 2                                           # 004A2255
    test byte ptr [0x508f18], 1                          # 004A225A
    je .L4A226C                                          # 004A2261
...
.L4A226C:
    ...
    push ecx                                             # 004A226E
    push edx                                             # 004A226F
    mov byte ptr [0x1136061], 0                          # 004A2270
    mov byte ptr [0x113607e], 0                          # 004A2277
    mov word ptr [0x1135fb4], ax                         # 004A227E
    mov word ptr [0x1135fb6], cx                         # 004A2284
    mov word ptr [0x1135fb8], dx                         # 004A228B
    mov byte ptr [0x522096], 0                           # 004A2292
    mov byte ptr [0x1136066], 0                          # 004A2299
    ...
    pop eax                                              # 004A22AF
    je .L4A233F                                          # 004A22B0
    or byte ptr [0x508f09], 1                            # 004A22B6
    push eax                                             # 004A22BD
    push ebx                                             # 004A22BE
    push ecx                                             # 004A22BF
    push edx                                             # 004A22C0
    ...
    pop ebx                                              # 004A22CD
    pop eax                                              # 004A22CE
    and byte ptr [0x508f09], 0xfe                        # 004A22CF
    cmp dword ptr [0x1135f42], 0x80000000                # 004A22D6
    jne .L4A232C                                         # 004A22E0
    cmp word ptr [0x9c68e6], 0x168                       # 004A22E2
    je .L4A2308                                          # 004A22EB
    dec bx                                               # 004A22ED
    je .L4A2308                                          # 004A22EF
...
.L4A2308:
    ...
    pushal                                               # 004A2312
    mov ebp, dword ptr [0x113e72c]                       # 004A2313
    push eax                                             # 004A2319
    push ebx                                             # 004A231A
...
.L4A232C:
    mov byte ptr [0x113607e], 1                          # 004A232C
    pushal                                               # 004A2333
    mov cl, 0xc                                          # 004A2334
...
.L4A2341:
    ...
    pop eax                                              # 004A2355
    jb .L4A2600                                          # 004A2356
    mov byte ptr [0x1136065], dh                         # 004A235C
    msvc_xor bp, bp                                      # 004A2362
    test word ptr [0xf24484], 2                          # 004A2365
    je .L4A23F8                                          # 004A236E
    mov edi, 0xf24490                                    # 004A2374
.L4A2379:
    ...
    shr esi, 3                                           # 004A239E
    mov esi, dword ptr [esi + 0xe40134]                  # 004A23A1
...
.L4A23F8:
    mov word ptr [0x1136000], bp                         # 004A23F8
    and word ptr [0xf24484], 0xfff8                      # 004A23FF
    push eax                                             # 004A2407
    push ebx                                             # 004A2408
    ...
    add esp, 8                                           # 004A2433
    mov byte ptr [0x113605d], 1                          # 004A2436
    mov word ptr [0x1135ffe], dx                         # 004A243D
...
.L4A2446:
    ...
    shr edi, 3                                           # 004A2463
    mov edi, dword ptr [edi + 0xe40134]                  # 004A2466
...
.L4A2496:
    cmp dx, word ptr [0x1136000]                         # 004A2496
    jae .L4A24A6                                         # 004A249D
    mov dx, word ptr [0x1136000]                         # 004A249F
.L4A24A6:
...
.L4A24BB:
    mov byte ptr [0x113605d], 0                          # 004A24BB
.L4A24C2:
    msvc_mov cx, bx                                      # 004A24C2
    call _sub_4CE3D6                                     # 004A24C5
    push esi                                             # 004A24CA
    test byte ptr [0x508f18], 1                          # 004A24CB
    jne .L4A24EB                                         # 004A24D2
    cmp byte ptr [0x113605d], 1                          # 004A24D4
    jne .L4A24EB                                         # 004A24DB
    mov ebx, 1                                           # 004A24DD
    mov dx, word ptr [0x1135ffe]                         # 004A24E2
    jmp .L4A252C                                         # 004A24E9
.L4A24EB:
    movzx edi, byte ptr [0x1136065]                      # 004A24EB
    mov edi, dword ptr [edi*4 + 0x4f6d1c]                # 004A24F2
...
.L4A2506:
    ...
    mov ebx, 2                                           # 004A2515
    test byte ptr [0x508f18], 1                          # 004A251A
    je .L4A252C                                          # 004A2521
...
.L4A252C:
    ...
    push ecx                                             # 004A252E
    push edx                                             # 004A252F
    mov byte ptr [0x1136061], 0                          # 004A2530
    mov byte ptr [0x113607e], 0                          # 004A2537
    mov word ptr [0x1135fb4], ax                         # 004A253E
    mov word ptr [0x1135fb6], cx                         # 004A2544
    mov word ptr [0x1135fb8], dx                         # 004A254B
    mov byte ptr [0x522096], 0                           # 004A2552
    mov byte ptr [0x1136066], 0                          # 004A2559
    ...
    pop eax                                              # 004A256F
    je .L4A25FF                                          # 004A2570
    or byte ptr [0x508f09], 1                            # 004A2576
    push eax                                             # 004A257D
    push ebx                                             # 004A257E
    push ecx                                             # 004A257F
    push edx                                             # 004A2580
    ...
    pop ebx                                              # 004A258D
    pop eax                                              # 004A258E
    and byte ptr [0x508f09], 0xfe                        # 004A258F
    cmp dword ptr [0x1135f42], 0x80000000                # 004A2596
    jne .L4A25EC                                         # 004A25A0
    cmp word ptr [0x9c68e6], 0x168                       # 004A25A2
    je .L4A25C8                                          # 004A25AB
    dec bx                                               # 004A25AD
    je .L4A25C8                                          # 004A25AF
...
.L4A25C8:
    ...
    pushal                                               # 004A25D2
    mov ebp, dword ptr [0x113e72c]                       # 004A25D3
    push eax                                             # 004A25D9
    push ebx                                             # 004A25DA
...
.L4A25EC:
    mov byte ptr [0x113607e], 1                          # 004A25EC
    pushal                                               # 004A25F3
    mov cl, 0xc                                          # 004A25F4
...
_sub_4A2601:
    ...
    .global _sub_4A2604
_sub_4A2604:
    add ax, word ptr [ebp*8 + 0x4f7b5e]                  # 004A2604
    add cx, word ptr [ebp*8 + 0x4f7b60]                  # 004A260C
    add dx, word ptr [ebp*8 + 0x4f7b62]                  # 004A2614
    mov word ptr [0x1135fae], 0xffff                     # 004A261C
    mov byte ptr [0x113607d], 0                          # 004A2625
    pushal                                               # 004A262C
    shr dx, 2                                            # 004A262D
    mov dh, byte ptr [ebp*8 + 0x4f7b5d]                  # 004A2631
.L4A2638:
    mov dword ptr [0x1135ee6], edi                       # 004A2638
    movzx esi, cx                                        # 004A263E
    shl esi, 9                                           # 004A2641
    msvc_or si, ax                                       # 004A2644
    shr esi, 3                                           # 004A2647
    mov esi, dword ptr [esi + 0xe40134]                  # 004A264A
.L4A2650:
    ...
    shr al, 4                                            # 004A267A
    and al, byte ptr [0x113601a]                         # 004A267D
    cmp al, byte ptr [0x113601a]                         # 004A2683
    ...
    cmp dh, byte ptr [ecx*8 + 0x4f7b5c]                  # 004A26B2
    jne .L4A274A                                         # 004A26B9
    msvc_mov ebp, ecx                                    # 004A26BF
    shr ebp, 3                                           # 004A26C1
    mov ebp, dword ptr [ebp*4 + 0x4f73d8]                # 004A26C4
...
.L4A26F5:
    ...
    shr al, 4                                            # 004A26F8
    test byte ptr [0x113601b], al                        # 004A26FB
    je .L4A2708                                          # 004A2701
...
.L4A2708:
    ...
    mov word ptr [0x1135fae], ax                         # 004A271B
.L4A2721:
    test byte ptr [esi + 6], 0x10                        # 004A2721
    je .L4A272E                                          # 004A2725
    or byte ptr [0x113607d], 1                           # 004A2727
.L4A272E:
...
.L4A274A:
    ...
    je .L4A27FC                                          # 004A274E
    or ecx, 4                                            # 004A2754
    cmp dh, byte ptr [ecx*8 + 0x4f7b5c]                  # 004A2757
    jne .L4A27FC                                         # 004A275E
    msvc_mov ebp, ecx                                    # 004A2764
    shr ebp, 3                                           # 004A2766
    mov ebp, dword ptr [ebp*4 + 0x4f73d8]                # 004A2769
    ...
    add ax, word ptr [ecx*8 + 0x4f7b62]                  # 004A277F
    sar ax, 2                                            # 004A2787
    neg al                                               # 004A278B
...
.L4A27AD:
    ...
    shr al, 4                                            # 004A27B0
    test byte ptr [0x113601b], al                        # 004A27B3
    je .L4A27C0                                          # 004A27B9
...
.L4A27C0:
    ...
    mov word ptr [0x1135fae], ax                         # 004A27D3
.L4A27D9:
    test byte ptr [esi + 6], 0x10                        # 004A27D9
    je .L4A27E6                                          # 004A27DD
    or byte ptr [0x113607d], 1                           # 004A27DF
.L4A27E6:
...
.L4A27FC:
    ...
    mov esi, dword ptr [0x1135ee6]                       # 004A280E
...
_sub_4A281D:
    ...
    .global _sub_4A2820
_sub_4A2820:
    add ax, word ptr [ebp*8 + 0x4f7b5e]                  # 004A2820
    add cx, word ptr [ebp*8 + 0x4f7b60]                  # 004A2828
    add dx, word ptr [ebp*8 + 0x4f7b62]                  # 004A2830
    mov word ptr [0x1135fae], 0xffff                     # 004A2838
    mov byte ptr [0x113607d], 0                          # 004A2841
    pushal                                               # 004A2848
    shr dx, 2                                            # 004A2849
    mov dh, byte ptr [ebp*8 + 0x4f7b5d]                  # 004A284D
.L4A2854:
    mov dword ptr [0x1135ee6], edi                       # 004A2854
    movzx esi, cx                                        # 004A285A
    shl esi, 9                                           # 004A285D
    msvc_or si, ax                                       # 004A2860
    shr esi, 3                                           # 004A2863
    mov esi, dword ptr [esi + 0xe40134]                  # 004A2866
.L4A286C:
    ...
    shr al, 4                                            # 004A2896
    and al, byte ptr [0x113601a]                         # 004A2899
    cmp al, byte ptr [0x113601a]                         # 004A289F
    ...
    cmp dh, byte ptr [ecx*8 + 0x4f7b5c]                  # 004A28CE
    jne .L4A2966                                         # 004A28D5
    msvc_mov ebp, ecx                                    # 004A28DB
    shr ebp, 3                                           # 004A28DD
    mov ebp, dword ptr [ebp*4 + 0x4f73d8]                # 004A28E0
...
.L4A2911:
    ...
    shr al, 4                                            # 004A2914
    test byte ptr [0x113601b], al                        # 004A2917
    je .L4A2924                                          # 004A291D
...
.L4A2924:
    ...
    mov word ptr [0x1135fae], ax                         # 004A2937
.L4A293D:
    test byte ptr [esi + 6], 0x10                        # 004A293D
    je .L4A294A                                          # 004A2941
    or byte ptr [0x113607d], 1                           # 004A2943
.L4A294A:
...
.L4A2966:
    ...
    je .L4A2A18                                          # 004A296A
    or ecx, 4                                            # 004A2970
    cmp dh, byte ptr [ecx*8 + 0x4f7b5c]                  # 004A2973
    jne .L4A2A18                                         # 004A297A
    msvc_mov ebp, ecx                                    # 004A2980
    shr ebp, 3                                           # 004A2982
    mov ebp, dword ptr [ebp*4 + 0x4f73d8]                # 004A2985
    ...
    add ax, word ptr [ecx*8 + 0x4f7b62]                  # 004A299B
    sar ax, 2                                            # 004A29A3
    neg al                                               # 004A29A7
...
.L4A29C9:
    ...
    shr al, 4                                            # 004A29CC
    test byte ptr [0x113601b], al                        # 004A29CF
    je .L4A29DC                                          # 004A29D5
...
.L4A29DC:
    ...
    mov word ptr [0x1135fae], ax                         # 004A29EF
.L4A29F5:
    test byte ptr [esi + 6], 0x10                        # 004A29F5
    je .L4A2A02                                          # 004A29F9
    or byte ptr [0x113607d], 1                           # 004A29FB
.L4A2A02:
...
.L4A2A18:
    ...
    mov esi, dword ptr [0x1135ee6]                       # 004A2A2A
    ...
    .global _sub_4A2A39
_sub_4A2A39:
    mov word ptr [0x1135f88], 0                          # 004A2A39
    mov esi, 0x4a2af0                                    # 004A2A42
    mov edi, 0xffffffff                                  # 004A2A47
    call _sub_4A2E46                                     # 004A2A4C
    mov ax, word ptr [0x1135f88]                         # 004A2A51
    ret                                                  # 004A2A57

    .global _sub_4A2A58
_sub_4A2A58:
    mov word ptr [0x1135f88], 0                          # 004A2A58
    mov esi, 0x4a2d4c                                    # 004A2A61
    mov edi, 0xffffffff                                  # 004A2A66
    call _sub_4A2E46                                     # 004A2A6B
    mov ax, word ptr [0x1135f88]                         # 004A2A70
    ret                                                  # 004A2A76

    .global _sub_4A2A77
_sub_4A2A77:
    mov word ptr [0x1135f88], 0                          # 004A2A77
    mov esi, 0x4a2aa1                                    # 004A2A80
    mov edi, 0xffffffff                                  # 004A2A85
    call _sub_4A2F0A                                     # 004A2A8A
    msvc_mov bl, al                                      # 004A2A8F
    mov ax, word ptr [0x1135f88]                         # 004A2A91
    test bl, 1                                           # 004A2A97
    je .L4A2AA0                                          # 004A2A9A
    or ax, 2                                             # 004A2A9C
.L4A2AA0:
    ret                                                  # 004A2AA0
# 0x4A2AA1
    .byte 0xF7, 0xC5, 0x00, 0x80, 0x00, 0x00, 0x74, 0x2B #        0 ......t+
    .byte 0x50, 0x81, 0xE5, 0xFF, 0x01, 0x00, 0x00, 0xBF #        8 P.......
    .byte 0x0A, 0x00, 0x00, 0x00, 0xE8, 0x85, 0x6B, 0xFE #       10 ......k.
    .byte 0xFF, 0xA8, 0x04, 0x75, 0x0B, 0xA8, 0x02, 0x75 #       18 ...u...u
    .byte 0x04, 0xA8, 0x01, 0x74, 0x03, 0x58, 0xF9, 0xC3 #       20 ...t.X..
    .byte 0x66, 0x83, 0x0D, 0x88, 0x5F, 0x13, 0x01, 0x01 #       28 f..._...
    .byte 0x58, 0xF9, 0xC3, 0x23, 0xC0, 0xC3             #       30 X..#..


    .global _sub_4A2AD7
_sub_4A2AD7:
    mov word ptr [0x1135f88], 0                          # 004A2AD7
    mov esi, 0x4a2af0                                    # 004A2AE0
    mov edi, 0x4a2ce7                                    # 004A2AE5
    call _sub_4A2E46                                     # 004A2AEA
    ret                                                  # 004A2AEF
# 0x4A2AF0
    .byte 0x60, 0x81, 0xE5, 0xFF, 0x01, 0x00, 0x00, 0x66 #        0 `......f
    .byte 0xA3, 0x8A, 0x5F, 0x13, 0x01, 0x66, 0x89, 0x0D #        8 .._..f..
    .byte 0x8C, 0x5F, 0x13, 0x01, 0x66, 0x89, 0x15, 0x8E #       10 ._..f...
    .byte 0x5F, 0x13, 0x01, 0x89, 0x2D, 0xF2, 0x5E, 0x13 #       18 _...-.^.
    .byte 0x01, 0xF7, 0xC5, 0x04, 0x00, 0x00, 0x00, 0x74 #       20 .......t
    .byte 0x56, 0x53, 0x66, 0x03, 0x04, 0xED, 0x5E, 0x7B #       28 VSf...^{
    .byte 0x4F, 0x00, 0x66, 0x03, 0x0C, 0xED, 0x60, 0x7B #       30 O.f...`{
    .byte 0x4F, 0x00, 0x66, 0x03, 0x14, 0xED, 0x62, 0x7B #       38 O.f...b{
    .byte 0x4F, 0x00, 0x0F, 0xB6, 0x1C, 0xED, 0x5D, 0x7B #       40 O.....]{
    .byte 0x4F, 0x00, 0x80, 0xFB, 0x0C, 0x73, 0x10, 0x66 #       48 O....s.f
    .byte 0x2B, 0x04, 0x9D, 0x6C, 0x3C, 0x50, 0x00, 0x66 #       50 +..l<P.f
    .byte 0x2B, 0x0C, 0x9D, 0x6E, 0x3C, 0x50, 0x00, 0x5B #       58 +..n<P.[
    .byte 0x83, 0xE5, 0xFB, 0x66, 0xA3, 0x90, 0x5F, 0x13 #       60 ...f.._.
    .byte 0x01, 0x66, 0x89, 0x0D, 0x92, 0x5F, 0x13, 0x01 #       68 .f..._..
    .byte 0x66, 0x89, 0x15, 0x94, 0x5F, 0x13, 0x01, 0x89 #       70 f..._...
    .byte 0x2D, 0xF6, 0x5E, 0x13, 0x01, 0xEB, 0x6E, 0x53 #       78 -.^...nS
    .byte 0x66, 0x03, 0x04, 0xED, 0x5E, 0x7B, 0x4F, 0x00 #       80 f...^{O.
    .byte 0x66, 0x03, 0x0C, 0xED, 0x60, 0x7B, 0x4F, 0x00 #       88 f...`{O.
    .byte 0x66, 0x03, 0x14, 0xED, 0x62, 0x7B, 0x4F, 0x00 #       90 f...b{O.
    .byte 0x0F, 0xB6, 0x1C, 0xED, 0x5D, 0x7B, 0x4F, 0x00 #       98 ....]{O.
    .byte 0x80, 0xFB, 0x0C, 0x73, 0x10, 0x66, 0x2B, 0x04 #       A0 ...s.f+.
    .byte 0x9D, 0x6C, 0x3C, 0x50, 0x00, 0x66, 0x2B, 0x0C #       A8 .l<P.f+.
    .byte 0x9D, 0x6E, 0x3C, 0x50, 0x00, 0x5B, 0x83, 0xCD #       B0 .n<P.[..
    .byte 0x04, 0x66, 0xA3, 0x90, 0x5F, 0x13, 0x01, 0x66 #       B8 .f.._..f
    .byte 0x89, 0x0D, 0x92, 0x5F, 0x13, 0x01, 0x66, 0x89 #       C0 ..._..f.
    .byte 0x15, 0x94, 0x5F, 0x13, 0x01, 0x89, 0x2D, 0xF6 #       C8 .._...-.
    .byte 0x5E, 0x13, 0x01, 0x66, 0xA1, 0x8A, 0x5F, 0x13 #       D0 ^..f.._.
    .byte 0x01, 0x66, 0x8B, 0x0D, 0x8C, 0x5F, 0x13, 0x01 #       D8 .f..._..
    .byte 0x66, 0x8B, 0x15, 0x8E, 0x5F, 0x13, 0x01, 0x8B #       E0 f..._...
    .byte 0x2D, 0xF2, 0x5E, 0x13, 0x01, 0x8B, 0xF5, 0x83 #       E8 -.^.....
    .byte 0xE6, 0x03, 0xC1, 0xED, 0x03, 0x8B, 0x2C, 0xAD #       F0 ......,.
    .byte 0xD8, 0x73, 0x4F, 0x00                         #       F8 .sO.
...
_sub_4A2BEC:
    ...
    push edi                                             # 004A2BEF
    push esi                                             # 004A2BF0
    jmp dword ptr [esi*4 + 0x4fff68]                     # 004A2BF1
...
_sub_4A2C1E:
    ...
    mov ax, word ptr [eax*2 + 0x1025a8c]                 # 004A2C2D
    cmp ax, -1                                           # 004A2C35
    je .L4A2CC7                                          # 004A2C39
.L4A2C3F:
    movzx esi, ax                                        # 004A2C3F
    shl esi, 7                                           # 004A2C42
    add esi, 0x6db6dc                                    # 004A2C45
    ...
    cmp ax, word ptr [0x1135f8a]                         # 004A2C6B
    jne .L4A2C8F                                         # 004A2C72
    cmp cx, word ptr [0x1135f8c]                         # 004A2C74
    jne .L4A2C8F                                         # 004A2C7B
    cmp dx, word ptr [0x1135f8e]                         # 004A2C7D
    jne .L4A2C8F                                         # 004A2C84
    cmp di, word ptr [0x1135ef2]                         # 004A2C86
    je .L4A2CBF                                          # 004A2C8D
.L4A2C8F:
    cmp ax, word ptr [0x1135f90]                         # 004A2C8F
    jne .L4A2CB3                                         # 004A2C96
    cmp cx, word ptr [0x1135f92]                         # 004A2C98
    jne .L4A2CB3                                         # 004A2C9F
    cmp dx, word ptr [0x1135f94]                         # 004A2CA1
    jne .L4A2CB3                                         # 004A2CA8
    cmp di, word ptr [0x1135ef6]                         # 004A2CAA
    je .L4A2CBF                                          # 004A2CB1
.L4A2CB3:
...
.L4A2CBF:
    or word ptr [0x1135f88], 1                           # 004A2CBF
.L4A2CC7:
    pop esi                                              # 004A2CC7
    pop edi                                              # 004A2CC8
    pop edx                                              # 004A2CC9
...
.L4A2CE4:
    ...
    ret                                                  # 004A2CE6
# 0x4A2CE7
    .byte 0x33, 0xFF, 0x83, 0x7C, 0xBD, 0x00, 0xFF, 0x74 #        0 3..|...t
    .byte 0x52, 0x66, 0xF7, 0x84, 0xBD, 0x02, 0x10, 0x00 #        8 Rf......
    .byte 0x00, 0x00, 0x80, 0x74, 0x46, 0x57, 0x55, 0x66 #       10 ...tFWUf
    .byte 0x8B, 0x44, 0xBD, 0x00, 0x66, 0x8B, 0x4C, 0xBD #       18 .D..f.L.
    .byte 0x02, 0x66, 0x8B, 0x94, 0xBD, 0x00, 0x10, 0x00 #       20 .f......
    .byte 0x00, 0x66, 0x8B, 0x9C, 0xBD, 0x00, 0x20, 0x00 #       28 .f.... .
    .byte 0x00, 0x0F, 0xB7, 0xAC, 0xBD, 0x02, 0x10, 0x00 #       30 ........
    .byte 0x00, 0x81, 0xE5, 0xFF, 0x01, 0x00, 0x00, 0xBF #       38 ........
    .byte 0x09, 0x00, 0x00, 0x80, 0x66, 0xF7, 0x05, 0x88 #       40 ....f...
    .byte 0x5F, 0x13, 0x01, 0x01, 0x00, 0x74, 0x05, 0xBF #       48 _....t..
    .byte 0x08, 0x00, 0x00, 0x80, 0xE8, 0xFF, 0x68, 0xFE #       50 ......h.
    .byte 0xFF, 0x5D, 0x5F, 0x47, 0x81, 0xFF, 0x00, 0x04 #       58 .]_G....
    .byte 0x00, 0x00, 0x72, 0x9E, 0xC3, 0xF7, 0xC5, 0x00 #       60 ..r.....
    .byte 0x80, 0x00, 0x00, 0x74, 0x2B, 0x50, 0x81, 0xE5 #       68 ...t+P..
    .byte 0xFF, 0x01, 0x00, 0x00, 0xBF, 0x0A, 0x00, 0x00 #       70 ........
    .byte 0x80, 0xE8, 0xDA, 0x68, 0xFE, 0xFF, 0xA8, 0x01 #       78 ...h....
    .byte 0x74, 0x0B, 0x66, 0x83, 0x0D, 0x88, 0x5F, 0x13 #       80 t.f..._.
    .byte 0x01, 0x01, 0x58, 0xF9, 0xC3, 0x66, 0x83, 0x0D #       88 ..X..f..
    .byte 0x88, 0x5F, 0x13, 0x01, 0x02, 0x58, 0xF9, 0xC3 #       90 ._...X..
    .byte 0x23, 0xC0, 0xC3, 0x89, 0x35, 0x0E, 0x5F, 0x13 #       98 #...5._.
    .byte 0x01, 0x89, 0x3D, 0x12, 0x5F, 0x13, 0x01, 0x81 #       A0 ..=._...
    .byte 0xEC, 0x00, 0x30, 0x00, 0x00, 0x89, 0x25, 0x06 #       A8 ..0...%.
    .byte 0x5F, 0x13, 0x01, 0x50, 0x51, 0x8B, 0x3D, 0x06 #       B0 _..PQ.=.
    .byte 0x5F, 0x13, 0x01, 0xB9, 0x00, 0x04, 0x00, 0x00 #       B8 _.......
    .byte 0xB8, 0xFF, 0xFF, 0xFF, 0xFF, 0xF3, 0xAB, 0x59 #       C0 .......Y
    .byte 0x58, 0xC7, 0x05, 0x0A, 0x5F, 0x13, 0x01, 0x00 #       C8 X..._...
    .byte 0x00, 0x00, 0x00, 0x66, 0xC7, 0x05, 0xA6, 0x5F #       D0 ...f..._
    .byte 0x13, 0x01, 0x01, 0x00, 0xE8, 0x1E, 0x02, 0x00 #       D8 ........
    .byte 0x00, 0x83, 0x3D, 0x12, 0x5F, 0x13, 0x01, 0xFF #       E0 ..=._...
    .byte 0x74, 0x0C, 0x8B, 0x2D, 0x06, 0x5F, 0x13, 0x01 #       E8 t..-._..
    .byte 0xFF, 0x15, 0x12, 0x5F, 0x13, 0x01, 0x81, 0xC4 #       F0 ..._....
    .byte 0x00, 0x30, 0x00, 0x00, 0xC3                   #       F8 .0...


    .global _sub_4A2DE4
_sub_4A2DE4:
    mov dword ptr [0x1135f0e], esi                       # 004A2DE4
    mov dword ptr [0x1135f12], edi                       # 004A2DEA
    sub esp, 0xc000                                      # 004A2DF0
    mov dword ptr [0x1135f06], esp                       # 004A2DF6
    push eax                                             # 004A2DFC
    push ecx                                             # 004A2DFD
    mov edi, dword ptr [0x1135f06]                       # 004A2DFE
    mov ecx, 0x1000                                      # 004A2E04
    mov eax, 0xffffffff                                  # 004A2E09
    rep stosd dword ptr es:[edi], eax                    # 004A2E0E
    pop ecx                                              # 004A2E10
    pop eax                                              # 004A2E11
    mov dword ptr [0x1135f0a], 0                         # 004A2E12
    mov word ptr [0x1135fa6], 1                          # 004A2E1C
    call _sub_4A3462                                     # 004A2E25
    cmp dword ptr [0x1135f12], -1                        # 004A2E2A
    je .L4A2E3F                                          # 004A2E31
    mov ebp, dword ptr [0x1135f06]                       # 004A2E33
    msvc_abscall 0x1135F12                               # 004A2E39
.L4A2E3F:
    ...
    .global _sub_4A2E46
_sub_4A2E46:
    mov dword ptr [0x1135f0e], esi                       # 004A2E46
    mov dword ptr [0x1135f12], edi                       # 004A2E4C
    sub esp, 0x3000                                      # 004A2E52
    mov dword ptr [0x1135f06], esp                       # 004A2E58
    push eax                                             # 004A2E5E
    push ecx                                             # 004A2E5F
    mov edi, dword ptr [0x1135f06]                       # 004A2E60
    mov ecx, 0x400                                       # 004A2E66
    mov eax, 0xffffffff                                  # 004A2E6B
    rep stosd dword ptr es:[edi], eax                    # 004A2E70
    pop ecx                                              # 004A2E72
    pop eax                                              # 004A2E73
    mov dword ptr [0x1135f0a], 0                         # 004A2E74
    mov word ptr [0x1135fa6], 5                          # 004A2E7E
    call _sub_4A2FE6                                     # 004A2E87
    cmp dword ptr [0x1135f12], -1                        # 004A2E8C
    je .L4A2EA1                                          # 004A2E93
    mov ebp, dword ptr [0x1135f06]                       # 004A2E95
    msvc_abscall 0x1135F12                               # 004A2E9B
.L4A2EA1:
    add esp, 0x3000                                      # 004A2EA1
    ret                                                  # 004A2EA7
# 0x4A2EA8
    .byte 0x89, 0x35, 0x0E, 0x5F, 0x13, 0x01, 0x89, 0x3D #        0 .5._...=
    .byte 0x12, 0x5F, 0x13, 0x01, 0x81, 0xEC, 0x00, 0xC0 #        8 ._......
    .byte 0x00, 0x00, 0x89, 0x25, 0x06, 0x5F, 0x13, 0x01 #       10 ...%._..
    .byte 0x50, 0x51, 0x8B, 0x3D, 0x06, 0x5F, 0x13, 0x01 #       18 PQ.=._..
    .byte 0xB9, 0x00, 0x10, 0x00, 0x00, 0xB8, 0xFF, 0xFF #       20 ........
    .byte 0xFF, 0xFF, 0xF3, 0xAB, 0x59, 0x58, 0xC7, 0x05 #       28 ....YX..
    .byte 0x0A, 0x5F, 0x13, 0x01, 0x00, 0x00, 0x00, 0x00 #       30 ._......
    .byte 0x66, 0xC7, 0x05, 0xA6, 0x5F, 0x13, 0x01, 0x05 #       38 f..._...
    .byte 0x00, 0xE8, 0x74, 0x05, 0x00, 0x00, 0x83, 0x3D #       40 ..t....=
    .byte 0x12, 0x5F, 0x13, 0x01, 0xFF, 0x74, 0x0C, 0x8B #       48 ._...t..
    .byte 0x2D, 0x06, 0x5F, 0x13, 0x01, 0xFF, 0x15, 0x12 #       50 -._.....
    .byte 0x5F, 0x13, 0x01, 0x81, 0xC4, 0x00, 0xC0, 0x00 #       58 _.......
    .byte 0x00, 0xC3                                     #       60 ..


    .global _sub_4A2F0A
_sub_4A2F0A:
    mov dword ptr [0x1135f0e], esi                       # 004A2F0A
    mov dword ptr [0x1135f12], edi                       # 004A2F10
    mov byte ptr [0x1136085], 0                          # 004A2F16
    sub esp, 0x3000                                      # 004A2F1D
    mov dword ptr [0x1135f06], esp                       # 004A2F23
    push eax                                             # 004A2F29
    push ecx                                             # 004A2F2A
    mov edi, dword ptr [0x1135f06]                       # 004A2F2B
    mov ecx, 0x400                                       # 004A2F31
    mov eax, 0xffffffff                                  # 004A2F36
    rep stosd dword ptr es:[edi], eax                    # 004A2F3B
    pop ecx                                              # 004A2F3D
    pop eax                                              # 004A2F3E
    mov dword ptr [0x1135f0a], 0                         # 004A2F3F
    mov word ptr [0x1135fa6], 3                          # 004A2F49
    call _sub_4A2FE6                                     # 004A2F52
    cmp dword ptr [0x1135f12], -1                        # 004A2F57
    je .L4A2F6C                                          # 004A2F5E
    mov ebp, dword ptr [0x1135f06]                       # 004A2F60
    msvc_abscall 0x1135F12                               # 004A2F66
.L4A2F6C:
    add esp, 0x3000                                      # 004A2F6C
    mov al, byte ptr [0x1136085]                         # 004A2F72
    ret                                                  # 004A2F77
# 0x4A2F78
    .byte 0x89, 0x35, 0x0E, 0x5F, 0x13, 0x01, 0x89, 0x3D #        0 .5._...=
    .byte 0x12, 0x5F, 0x13, 0x01, 0xC6, 0x05, 0x85, 0x60 #        8 ._.....`
    .byte 0x13, 0x01, 0x00, 0x81, 0xEC, 0x00, 0xC0, 0x00 #       10 ........
    .byte 0x00, 0x89, 0x25, 0x06, 0x5F, 0x13, 0x01, 0x50 #       18 ..%._..P
    .byte 0x51, 0x8B, 0x3D, 0x06, 0x5F, 0x13, 0x01, 0xB9 #       20 Q.=._...
    .byte 0x00, 0x10, 0x00, 0x00, 0xB8, 0xFF, 0xFF, 0xFF #       28 ........
    .byte 0xFF, 0xF3, 0xAB, 0x59, 0x58, 0xC7, 0x05, 0x0A #       30 ...YX...
    .byte 0x5F, 0x13, 0x01, 0x00, 0x00, 0x00, 0x00, 0x66 #       38 _......f
    .byte 0xC7, 0x05, 0xA6, 0x5F, 0x13, 0x01, 0x03, 0x00 #       40 ..._....
    .byte 0xE8, 0x9D, 0x04, 0x00, 0x00, 0x83, 0x3D, 0x12 #       48 ......=.
    .byte 0x5F, 0x13, 0x01, 0xFF, 0x74, 0x0C, 0x8B, 0x2D #       50 _...t..-
    .byte 0x06, 0x5F, 0x13, 0x01, 0xFF, 0x15, 0x12, 0x5F #       58 ._....._
    .byte 0x13, 0x01, 0x81, 0xC4, 0x00, 0xC0, 0x00, 0x00 #       60 ........
    .byte 0xA0, 0x85, 0x60, 0x13, 0x01, 0xC3             #       68 ..`...


    .global _sub_4A2FE6
_sub_4A2FE6:
    mov word ptr [0x1135f96], ax                         # 004A2FE6
    mov word ptr [0x1135f98], cx                         # 004A2FEC
    mov word ptr [0x1135f9a], dx                         # 004A2FF3
    and ebp, 0x1ff                                       # 004A2FFA
    mov dword ptr [0x1135efe], ebp                       # 004A3000
    mov word ptr [0x113601a], 0                          # 004A3006
    mov edi, 0x11360a0                                   # 004A300F
    call _sub_4A2604                                     # 004A3014
    cmp dword ptr [0x113609c], 1                         # 004A3019
    jb .L4A305F                                          # 004A3020
    msvc_xor esi, esi                                    # 004A3022
.L4A3024:
    mov bp, word ptr [esi*2 + 0x11360a0]                 # 004A3024
    push esi                                             # 004A302C
    ...
    jb .L4A3054                                          # 004A3039
    push esi                                             # 004A303B
    msvc_abscall 0x1135F0E                               # 004A303C
    pop esi                                              # 004A3042
    jb .L4A3054                                          # 004A3043
    push ax                                              # 004A3045
    push bx                                              # 004A3047
    ...
    push dx                                              # 004A304B
    push bp                                              # 004A304D
    push 0x4a313b                                        # 004A304F
.L4A3054:
    inc esi                                              # 004A3054
    cmp esi, dword ptr [0x113609c]                       # 004A3055
    jb .L4A3024                                          # 004A305B
    jmp .L4A3066                                         # 004A305D
.L4A305F:
    or byte ptr [0x1136085], 1                           # 004A305F
.L4A3066:
    test word ptr [0x1135fa6], 2                         # 004A3066
    jne .L4A313A                                         # 004A306F
    btr word ptr [0x1135fa6], 1                          # 004A3075
    jb .L4A313A                                          # 004A307E
    mov ax, word ptr [0x1135f96]                         # 004A3084
    mov cx, word ptr [0x1135f98]                         # 004A308A
    mov dx, word ptr [0x1135f9a]                         # 004A3091
    mov ebp, dword ptr [0x1135efe]                       # 004A3098
    add ax, word ptr [ebp*8 + 0x4f7b5e]                  # 004A309E
    add cx, word ptr [ebp*8 + 0x4f7b60]                  # 004A30A6
    add dx, word ptr [ebp*8 + 0x4f7b62]                  # 004A30AE
    shr dx, 2                                            # 004A30B6
    movzx ebp, byte ptr [ebp*8 + 0x4f7b5d]               # 004A30BA
    cmp ebp, 0xc                                         # 004A30C2
    jae .L4A30D7                                         # 004A30C5
    sub ax, word ptr [ebp*4 + 0x503c6c]                  # 004A30C7
    sub cx, word ptr [ebp*4 + 0x503c6e]                  # 004A30CF
.L4A30D7:
    mov dh, byte ptr [ebp + 0x503cac]                    # 004A30D7
    mov word ptr [0x113601a], 0                          # 004A30DD
    mov edi, 0x11360a0                                   # 004A30E6
    call _sub_4A2601                                     # 004A30EB
    cmp dword ptr [0x113609c], 1                         # 004A30F0
    jb .L4A313A                                          # 004A30F7
    msvc_xor dh, dh                                      # 004A30F9
    shl dx, 2                                            # 004A30FB
    msvc_xor esi, esi                                    # 004A30FF
.L4A3101:
    mov bp, word ptr [esi*2 + 0x11360a0]                 # 004A3101
    push esi                                             # 004A3109
    ...
    jb .L4A3131                                          # 004A3116
    push esi                                             # 004A3118
    msvc_abscall 0x1135F0E                               # 004A3119
    pop esi                                              # 004A311F
    jb .L4A3131                                          # 004A3120
    push ax                                              # 004A3122
    push bx                                              # 004A3124
    ...
    push dx                                              # 004A3128
    push bp                                              # 004A312A
    push 0x4a313b                                        # 004A312C
.L4A3131:
    inc esi                                              # 004A3131
    cmp esi, dword ptr [0x113609c]                       # 004A3132
    jb .L4A3101                                          # 004A3138
.L4A313A:
    ret                                                  # 004A313A
# 0x4A313B
    .byte 0x33, 0xED, 0x66, 0x5D, 0x66, 0x5A, 0x66, 0x59 #        0 3.f]fZfY
    .byte 0x66, 0x5B, 0x66, 0x58, 0x66, 0xF7, 0x05, 0xA6 #        8 f[fXf...
    .byte 0x5F, 0x13, 0x01, 0x04, 0x00, 0x0F, 0x84, 0x90 #       10 _.......
    .byte 0xFE, 0xFF, 0xFF, 0x89, 0x2D, 0xFE, 0x5E, 0x13 #       18 ....-.^.
    .byte 0x01, 0x66, 0xA3, 0x9C, 0x5F, 0x13, 0x01, 0x66 #       20 .f.._..f
    .byte 0x89, 0x0D, 0x9E, 0x5F, 0x13, 0x01, 0x66, 0x89 #       28 ..._..f.
    .byte 0x15, 0xA0, 0x5F, 0x13, 0x01, 0x81, 0xE5, 0xFF #       30 .._.....
    .byte 0x01, 0x00, 0x00, 0xF7, 0xC5, 0x04, 0x00, 0x00 #       38 ........
    .byte 0x00, 0x74, 0x37, 0x53, 0x66, 0x03, 0x04, 0xED #       40 .t7Sf...
    .byte 0x5E, 0x7B, 0x4F, 0x00, 0x66, 0x03, 0x0C, 0xED #       48 ^{O.f...
    .byte 0x60, 0x7B, 0x4F, 0x00, 0x66, 0x03, 0x14, 0xED #       50 `{O.f...
    .byte 0x62, 0x7B, 0x4F, 0x00, 0x0F, 0xB6, 0x1C, 0xED #       58 b{O.....
    .byte 0x5D, 0x7B, 0x4F, 0x00, 0x80, 0xFB, 0x0C, 0x73 #       60 ]{O....s
    .byte 0x10, 0x66, 0x2B, 0x04, 0x9D, 0x6C, 0x3C, 0x50 #       68 .f+..l<P
    .byte 0x00, 0x66, 0x2B, 0x0C, 0x9D, 0x6E, 0x3C, 0x50 #       70 .f+..n<P
    .byte 0x00, 0x5B, 0x66, 0xA3, 0x96, 0x5F, 0x13, 0x01 #       78 .[f.._..
    .byte 0x66, 0x89, 0x0D, 0x98, 0x5F, 0x13, 0x01, 0x66 #       80 f..._..f
    .byte 0x89, 0x15, 0x9A, 0x5F, 0x13, 0x01, 0x88, 0x1D #       88 ..._....
    .byte 0x50, 0x60, 0x13, 0x01, 0x88, 0x3D, 0x51, 0x60 #       90 P`...=Q`
    .byte 0x13, 0x01, 0x8B, 0xF5, 0x83, 0xE6, 0x03, 0x89 #       98 ........
    .byte 0x35, 0xFA, 0x5E, 0x13, 0x01, 0xC1, 0xED, 0x03 #       A0 5.^.....
    .byte 0x89, 0x2D, 0x02, 0x5F, 0x13, 0x01, 0x8B, 0x2C #       A8 .-._...,
    .byte 0xAD, 0xD8, 0x73, 0x4F, 0x00                   #       B0 ..sO.


    .global _sub_4A31F0
_sub_4A31F0:
    mov esi, dword ptr [0x1135f02]                       # 004A31F0
    movzx ebx, byte ptr [ebp]                            # 004A31F6
    mov esi, dword ptr [esi*4 + 0x4f78f8]                # 004A31FA
    shl ebx, 2                                           # 004A3201
    add ebx, dword ptr [0x1135efa]                       # 004A3204
    mov bl, byte ptr [esi + ebx]                         # 004A320A
    mov byte ptr [0x1136052], bl                         # 004A320D
    mov ax, word ptr [0x1135f96]                         # 004A3213
    mov cx, word ptr [0x1135f98]                         # 004A3219
    mov dx, word ptr [0x1135f9a]                         # 004A3220
    mov esi, dword ptr [0x1135efa]                       # 004A3227
    jmp dword ptr [esi*4 + 0x4fff78]                     # 004A322D
...
_sub_4A325A:
    ...
    shr dx, 2                                            # 004A325E
    mov word ptr [0x1135fa2], ax                         # 004A3262
    mov word ptr [0x1135fa4], cx                         # 004A3268
    mov byte ptr [0x1136053], dl                         # 004A326F
    movzx esi, cx                                        # 004A3275
    shl esi, 9                                           # 004A3278
    msvc_or si, ax                                       # 004A327B
    shr esi, 3                                           # 004A327E
    mov esi, dword ptr [esi + 0xe40134]                  # 004A3281
...
_sub_4A3287:
    ...
    mov ebx, dword ptr [ebx*4 + 0x4f78f8]                # 004A32AC
    ...
    test byte ptr [0x1136052], al                        # 004A32C7
    je _sub_4A341D                                       # 004A32CD
    mov al, byte ptr [esi]                               # 004A32D3
    and al, 3                                            # 004A32D5
    cmp al, byte ptr [0x1135efa]                         # 004A32D7
    ...
    shr al, 4                                            # 004A32EC
    cmp al, byte ptr [0x1136051]                         # 004A32EF
    jne .L4A3308                                         # 004A32F5
    mov al, byte ptr [esi + 4]                           # 004A32F7
    and al, 0x3f                                         # 004A32FA
    cmp al, byte ptr [0x1135f02]                         # 004A32FC
    je _sub_4A341D                                       # 004A3302
.L4A3308:
    mov dword ptr [0x1135eea], ebp                       # 004A3308
    mov dword ptr [0x1135eee], esi                       # 004A330E
    movzx ebp, byte ptr [esi + 4]                        # 004A3314
    and ebp, 0x3f                                        # 004A3318
    mov ebp, dword ptr [ebp*4 + 0x4f73d8]                # 004A331B
    ...
    mov ax, word ptr [0x1135fa2]                         # 004A3338
    mov cx, word ptr [0x1135fa4]                         # 004A333E
    shl dx, 2                                            # 004A3345
    jmp dword ptr [ebx*4 + 0x4fff88]                     # 004A3349
...
_sub_4A3376:
    ...
    jb .L4A33B5                                          # 004A339C
    msvc_abscall 0x1135F0E                               # 004A339E
    jb .L4A33B5                                          # 004A33A4
    push ax                                              # 004A33A6
    push bx                                              # 004A33A8
    push cx                                              # 004A33AA
    push dx                                              # 004A33AC
    push bp                                              # 004A33AE
    push 0x4a313b                                        # 004A33B0
.L4A33B5:
    add ax, word ptr [ebp*8 + 0x4f7b5e]                  # 004A33B5
    add cx, word ptr [ebp*8 + 0x4f7b60]                  # 004A33BD
    add dx, word ptr [ebp*8 + 0x4f7b62]                  # 004A33C5
    movzx edi, byte ptr [ebp*8 + 0x4f7b5d]               # 004A33CD
    cmp edi, 0xc                                         # 004A33D5
    jae .L4A33EA                                         # 004A33D8
    sub ax, word ptr [edi*4 + 0x503c6c]                  # 004A33DA
    sub cx, word ptr [edi*4 + 0x503c6e]                  # 004A33E2
.L4A33EA:
    xor ebp, 4                                           # 004A33EA
    call _sub_4A38DE                                     # 004A33ED
    jb .L4A340B                                          # 004A33F2
    msvc_abscall 0x1135F0E                               # 004A33F4
    jb .L4A340B                                          # 004A33FA
    push ax                                              # 004A33FC
    push bx                                              # 004A33FE
    push cx                                              # 004A3400
    push dx                                              # 004A3402
    push bp                                              # 004A3404
    push 0x4a313b                                        # 004A3406
.L4A340B:
    mov ebp, dword ptr [0x1135eea]                       # 004A340B
    mov esi, dword ptr [0x1135eee]                       # 004A3411
    mov dl, byte ptr [0x1136053]                         # 004A3417
...
_sub_4A341D:
    ...
    mov bl, byte ptr [0x1136050]                         # 004A3437
    mov bh, byte ptr [0x1136051]                         # 004A343D
    mov ax, word ptr [0x1135f9c]                         # 004A3443
    mov cx, word ptr [0x1135f9e]                         # 004A3449
    mov dx, word ptr [0x1135fa0]                         # 004A3450
    mov ebp, dword ptr [0x1135efe]                       # 004A3457
    msvc_jmp _sub_4A2FE6                                 # 004A345D

    .global _sub_4A3462
_sub_4A3462:
    mov word ptr [0x1135f96], ax                         # 004A3462
    mov word ptr [0x1135f98], cx                         # 004A3468
    mov word ptr [0x1135f9a], dx                         # 004A346F
    and ebp, 0x1ff                                       # 004A3476
    mov dword ptr [0x1135efe], ebp                       # 004A347C
    mov word ptr [0x113601a], 0                          # 004A3482
    mov edi, 0x11360a0                                   # 004A348B
    call _sub_4A2604                                     # 004A3490
    cmp dword ptr [0x113609c], 1                         # 004A3495
    jb .L4A34DB                                          # 004A349C
    msvc_xor esi, esi                                    # 004A349E
.L4A34A0:
    mov bp, word ptr [esi*2 + 0x11360a0]                 # 004A34A0
    push esi                                             # 004A34A8
    ...
    jb .L4A34D0                                          # 004A34B5
    push esi                                             # 004A34B7
    msvc_abscall 0x1135F0E                               # 004A34B8
    pop esi                                              # 004A34BE
    jb .L4A34D0                                          # 004A34BF
    push ax                                              # 004A34C1
    push bx                                              # 004A34C3
    ...
    push dx                                              # 004A34C7
    push bp                                              # 004A34C9
    push 0x4a35b7                                        # 004A34CB
.L4A34D0:
    inc esi                                              # 004A34D0
    cmp esi, dword ptr [0x113609c]                       # 004A34D1
    jb .L4A34A0                                          # 004A34D7
    jmp .L4A34E2                                         # 004A34D9
.L4A34DB:
    or byte ptr [0x1136085], 1                           # 004A34DB
.L4A34E2:
    test word ptr [0x1135fa6], 2                         # 004A34E2
    jne .L4A35B6                                         # 004A34EB
    btr word ptr [0x1135fa6], 1                          # 004A34F1
    jb .L4A35B6                                          # 004A34FA
    mov ax, word ptr [0x1135f96]                         # 004A3500
    mov cx, word ptr [0x1135f98]                         # 004A3506
    mov dx, word ptr [0x1135f9a]                         # 004A350D
    mov ebp, dword ptr [0x1135efe]                       # 004A3514
    add ax, word ptr [ebp*8 + 0x4f7b5e]                  # 004A351A
    add cx, word ptr [ebp*8 + 0x4f7b60]                  # 004A3522
    add dx, word ptr [ebp*8 + 0x4f7b62]                  # 004A352A
    shr dx, 2                                            # 004A3532
    movzx ebp, byte ptr [ebp*8 + 0x4f7b5d]               # 004A3536
    cmp ebp, 0xc                                         # 004A353E
    jae .L4A3553                                         # 004A3541
    sub ax, word ptr [ebp*4 + 0x503c6c]                  # 004A3543
    sub cx, word ptr [ebp*4 + 0x503c6e]                  # 004A354B
.L4A3553:
    mov dh, byte ptr [ebp + 0x503cac]                    # 004A3553
    mov word ptr [0x113601a], 0                          # 004A3559
    mov edi, 0x11360a0                                   # 004A3562
    call _sub_4A2601                                     # 004A3567
    cmp dword ptr [0x113609c], 1                         # 004A356C
    jb .L4A35B6                                          # 004A3573
    msvc_xor dh, dh                                      # 004A3575
    shl dx, 2                                            # 004A3577
    msvc_xor esi, esi                                    # 004A357B
.L4A357D:
    mov bp, word ptr [esi*2 + 0x11360a0]                 # 004A357D
    push esi                                             # 004A3585
    ...
    jb .L4A35AD                                          # 004A3592
    push esi                                             # 004A3594
    msvc_abscall 0x1135F0E                               # 004A3595
    pop esi                                              # 004A359B
    jb .L4A35AD                                          # 004A359C
    push ax                                              # 004A359E
    push bx                                              # 004A35A0
    ...
    push dx                                              # 004A35A4
    push bp                                              # 004A35A6
    push 0x4a35b7                                        # 004A35A8
.L4A35AD:
    inc esi                                              # 004A35AD
    cmp esi, dword ptr [0x113609c]                       # 004A35AE
    jb .L4A357D                                          # 004A35B4
.L4A35B6:
    ret                                                  # 004A35B6
# 0x4A35B7
    ...
    .global _sub_4A366C
_sub_4A366C:
    mov esi, dword ptr [0x1135f02]                       # 004A366C
    movzx ebx, byte ptr [ebp]                            # 004A3672
    mov esi, dword ptr [esi*4 + 0x4f78f8]                # 004A3676
    shl ebx, 2                                           # 004A367D
    add ebx, dword ptr [0x1135efa]                       # 004A3680
    mov bl, byte ptr [esi + ebx]                         # 004A3686
    mov byte ptr [0x1136052], bl                         # 004A3689
    mov ax, word ptr [0x1135f96]                         # 004A368F
    mov cx, word ptr [0x1135f98]                         # 004A3695
    mov dx, word ptr [0x1135f9a]                         # 004A369C
    mov esi, dword ptr [0x1135efa]                       # 004A36A3
    jmp dword ptr [esi*4 + 0x4fff98]                     # 004A36A9
...
_sub_4A36D6:
    ...
    shr dx, 2                                            # 004A36DA
    mov word ptr [0x1135fa2], ax                         # 004A36DE
    mov word ptr [0x1135fa4], cx                         # 004A36E4
    mov byte ptr [0x1136053], dl                         # 004A36EB
    movzx esi, cx                                        # 004A36F1
    shl esi, 9                                           # 004A36F4
    msvc_or si, ax                                       # 004A36F7
    shr esi, 3                                           # 004A36FA
    mov esi, dword ptr [esi + 0xe40134]                  # 004A36FD
...
_sub_4A3703:
    ...
    mov ebx, dword ptr [ebx*4 + 0x4f78f8]                # 004A3728
    ...
    test byte ptr [0x1136052], al                        # 004A3743
    je _sub_4A3899                                       # 004A3749
    mov al, byte ptr [esi]                               # 004A374F
    and al, 3                                            # 004A3751
    cmp al, byte ptr [0x1135efa]                         # 004A3753
    ...
    shr al, 4                                            # 004A3768
    cmp al, byte ptr [0x1136051]                         # 004A376B
    jne .L4A3784                                         # 004A3771
    mov al, byte ptr [esi + 4]                           # 004A3773
    and al, 0x3f                                         # 004A3776
    cmp al, byte ptr [0x1135f02]                         # 004A3778
    je _sub_4A3899                                       # 004A377E
.L4A3784:
    mov dword ptr [0x1135eea], ebp                       # 004A3784
    mov dword ptr [0x1135eee], esi                       # 004A378A
    movzx ebp, byte ptr [esi + 4]                        # 004A3790
    and ebp, 0x3f                                        # 004A3794
    mov ebp, dword ptr [ebp*4 + 0x4f73d8]                # 004A3797
    ...
    mov ax, word ptr [0x1135fa2]                         # 004A37B4
    mov cx, word ptr [0x1135fa4]                         # 004A37BA
    shl dx, 2                                            # 004A37C1
    jmp dword ptr [ebx*4 + 0x4fffa8]                     # 004A37C5
...
_sub_4A37F2:
    ...
    jb .L4A3831                                          # 004A3818
    msvc_abscall 0x1135F0E                               # 004A381A
    jb .L4A3831                                          # 004A3820
    push ax                                              # 004A3822
    push bx                                              # 004A3824
    push cx                                              # 004A3826
    push dx                                              # 004A3828
    push bp                                              # 004A382A
    push 0x4a35b7                                        # 004A382C
.L4A3831:
    add ax, word ptr [ebp*8 + 0x4f7b5e]                  # 004A3831
    add cx, word ptr [ebp*8 + 0x4f7b60]                  # 004A3839
    add dx, word ptr [ebp*8 + 0x4f7b62]                  # 004A3841
    movzx edi, byte ptr [ebp*8 + 0x4f7b5d]               # 004A3849
    cmp edi, 0xc                                         # 004A3851
    jae .L4A3866                                         # 004A3854
    sub ax, word ptr [edi*4 + 0x503c6c]                  # 004A3856
    sub cx, word ptr [edi*4 + 0x503c6e]                  # 004A385E
.L4A3866:
    xor ebp, 4                                           # 004A3866
    call _sub_4A3972                                     # 004A3869
    jb .L4A3887                                          # 004A386E
    msvc_abscall 0x1135F0E                               # 004A3870
    jb .L4A3887                                          # 004A3876
    push ax                                              # 004A3878
    push bx                                              # 004A387A
    push cx                                              # 004A387C
    push dx                                              # 004A387E
    push bp                                              # 004A3880
    push 0x4a35b7                                        # 004A3882
.L4A3887:
    mov ebp, dword ptr [0x1135eea]                       # 004A3887
    mov esi, dword ptr [0x1135eee]                       # 004A388D
    mov dl, byte ptr [0x1136053]                         # 004A3893
...
_sub_4A3899:
    ...
    mov bl, byte ptr [0x1136050]                         # 004A38B3
    mov bh, byte ptr [0x1136051]                         # 004A38B9
    mov ax, word ptr [0x1135f9c]                         # 004A38BF
    mov cx, word ptr [0x1135f9e]                         # 004A38C5
    mov dx, word ptr [0x1135fa0]                         # 004A38CC
    mov ebp, dword ptr [0x1135efe]                       # 004A38D3
...
_sub_4A38DE:
    ...
    mov edi, dword ptr [0x1135f06]                       # 004A38F8
.L4A38FE:
...
.L4A3938:
    cmp dword ptr [0x1135f0a], 0x39c                     # 004A3938
    ...
    inc dword ptr [0x1135f0a]                            # 004A3965
...
_sub_4A3972:
    ...
    mov edi, dword ptr [0x1135f06]                       # 004A398C
.L4A3992:
...
.L4A39CC:
    cmp dword ptr [0x1135f0a], 0xf9c                     # 004A39CC
    ...
    inc dword ptr [0x1135f0a]                            # 004A39F9
...
_sub_4A3A50:
    ...
    mov cl, byte ptr [0x1136062]                         # 004A3A56
    call _sub_4A3A06                                     # 004A3A5C
    mov al, byte ptr [0x1136062]                         # 004A3A61
    and al, 0x7f                                         # 004A3A66
    mov edi, 0x113603b                                   # 004A3A68
    call _sub_48D678                                     # 004A3A6D
    movzx edi, byte ptr [0x1136062]                      # 004A3A72
    and edi, 0xffffff7f                                  # 004A3A79
    mov al, byte ptr [edi + 0x525f9a]                    # 004A3A7F
    cmp al, 0xff                                         # 004A3A85
    jne .L4A3A8E                                         # 004A3A87
    mov al, byte ptr [0x113603b]                         # 004A3A89
.L4A3A8E:
    mov byte ptr [0x113604c], al                         # 004A3A8E
    mov al, byte ptr [0x1136062]                         # 004A3A93
    and al, 0x7f                                         # 004A3A98
    mov edi, 0x1136030                                   # 004A3A9A
    call _sub_42C518                                     # 004A3A9F
    movzx edi, byte ptr [0x1136062]                      # 004A3AA4
    and edi, 0xffffff7f                                  # 004A3AAB
    mov al, byte ptr [edi + 0x525f7a]                    # 004A3AB1
    cmp al, 0xff                                         # 004A3AB7
    jne .L4A3AC0                                         # 004A3AB9
    mov al, byte ptr [0x1136030]                         # 004A3ABB
.L4A3AC0:
    mov byte ptr [0x1136039], al                         # 004A3AC0
    mov al, byte ptr [0x1136062]                         # 004A3AC5
    and al, 0x7f                                         # 004A3ACA
    mov edi, 0x1136054                                   # 004A3ACC
    call _sub_4781C5                                     # 004A3AD1
    movzx edi, byte ptr [0x1136062]                      # 004A3AD6
    and edi, 0xffffff7f                                  # 004A3ADD
    movzx ax, byte ptr [edi + 0x525fa2]                  # 004A3AE3
    cmp al, 0xff                                         # 004A3AEB
    jne .L4A3AF2                                         # 004A3AED
    msvc_xor ax, ax                                      # 004A3AEF
.L4A3AF2:
    mov word ptr [0x1135fe4], ax                         # 004A3AF2
...
_sub_4A3B0D:
    ...
    mov word ptr [0x1135f86], ax                         # 004A3B1B
.L4A3B21:
    push ecx                                             # 004A3B21
    ...
    mov eax, dword ptr [eax*4 + 0x50c984]                # 004A3B36
    test word ptr [eax + 0x12], 8                        # 004A3B3D
    je .L4A3B7F                                          # 004A3B43
    test byte ptr [0x1136062], 0x80                      # 004A3B45
    je .L4A3B7F                                          # 004A3B4C
    mov al, byte ptr [0x1136062]                         # 004A3B4E
    and eax, 0x7f                                        # 004A3B53
    mov eax, dword ptr [eax*4 + 0x50c984]                # 004A3B56
    test word ptr [eax + 0x12], 8                        # 004A3B5D
    je .L4A3B7F                                          # 004A3B63
    mov byte ptr [0x1136062], cl                         # 004A3B65
    call _sub_4A3A50                                     # 004A3B6B
    mov byte ptr [0x1136067], 0                          # 004A3B70
    mov byte ptr [0x1136068], 0                          # 004A3B77
    ret                                                  # 004A3B7E
.L4A3B7F:
    ...
    mov ax, word ptr [0x1135f86]                         # 004A3B93
    mov word ptr [edi + 0x12], ax                        # 004A3B99
.L4A3B9D:
    mov byte ptr [0x1136062], cl                         # 004A3B9D
    ror ecx, 0x18                                        # 004A3BA3
    mov byte ptr [0x1136063], cl                         # 004A3BA6
    rol ecx, 0x18                                        # 004A3BAC
    mov word ptr [0x1135fb4], 0x1800                     # 004A3BAF
    mov word ptr [0x1135fb6], 0x1800                     # 004A3BB8
    mov word ptr [0x1135fb8], 0x100                      # 004A3BC1
    mov byte ptr [0x1136064], 0                          # 004A3BCA
    mov byte ptr [0x1136061], 0                          # 004A3BD1
    mov byte ptr [0x113607e], 1                          # 004A3BD8
    mov dword ptr [0x1135f3e], 0x80000000                # 004A3BDF
    mov byte ptr [0x1136076], 0                          # 004A3BE9
    mov byte ptr [0x1136067], 0                          # 004A3BF0
    mov byte ptr [0x1136068], 0                          # 004A3BF7
    mov byte ptr [0x113606e], 0                          # 004A3BFE
    ...
    mov al, byte ptr [0x1136062]                         # 004A3C30
    mov edi, 0x113601d                                   # 004A3C35
    call _sub_488B4D                                     # 004A3C3A
    movzx edi, byte ptr [0x1136062]                      # 004A3C3F
    mov al, byte ptr [edi + 0x525f72]                    # 004A3C46
    cmp al, 0xff                                         # 004A3C4C
    jne .L4A3C55                                         # 004A3C4E
    mov al, byte ptr [0x113601d]                         # 004A3C50
.L4A3C55:
    mov byte ptr [0x113602e], al                         # 004A3C55
    mov al, byte ptr [0x1136062]                         # 004A3C5A
    mov edi, 0x113603b                                   # 004A3C5F
    call _sub_48D5E4                                     # 004A3C64
    movzx edi, byte ptr [0x1136062]                      # 004A3C69
    mov al, byte ptr [edi + 0x525f82]                    # 004A3C70
    cmp al, 0xff                                         # 004A3C76
    jne .L4A3C7F                                         # 004A3C78
    mov al, byte ptr [0x113603b]                         # 004A3C7A
.L4A3C7F:
    mov byte ptr [0x113604c], al                         # 004A3C7F
    mov al, byte ptr [0x1136062]                         # 004A3C84
    mov edi, 0x1136030                                   # 004A3C89
    call _sub_42C490                                     # 004A3C8E
    movzx edi, byte ptr [0x1136062]                      # 004A3C93
    mov al, byte ptr [edi + 0x525f7a]                    # 004A3C9A
    cmp al, 0xff                                         # 004A3CA0
    jne .L4A3CA9                                         # 004A3CA2
    mov al, byte ptr [0x1136030]                         # 004A3CA4
.L4A3CA9:
    mov byte ptr [0x1136039], al                         # 004A3CA9
    mov al, byte ptr [0x1136062]                         # 004A3CAE
    mov edi, 0x1136054                                   # 004A3CB3
    call _sub_4A693D                                     # 004A3CB8
    movzx edi, byte ptr [0x1136062]                      # 004A3CBD
    movzx ax, byte ptr [edi + 0x525f8a]                  # 004A3CC4
    cmp al, 0xff                                         # 004A3CCC
    jne .L4A3CD3                                         # 004A3CCE
    msvc_xor ax, ax                                      # 004A3CD0
.L4A3CD3:
    mov word ptr [0x1135fe4], ax                         # 004A3CD3
    mov byte ptr [0x113603a], 0                          # 004A3CD9
...
.L4A3D07:
    ...
    mov byte ptr [0x113602e], 0xff                       # 004A3D0C
    mov al, byte ptr [0x1136062]                         # 004A3D13
    and al, 0x7f                                         # 004A3D18
    mov edi, 0x113603b                                   # 004A3D1A
    call _sub_48D678                                     # 004A3D1F
    movzx edi, byte ptr [0x1136062]                      # 004A3D24
    and edi, 0xffffff7f                                  # 004A3D2B
    mov al, byte ptr [edi + 0x525f9a]                    # 004A3D31
    cmp al, 0xff                                         # 004A3D37
    jne .L4A3D40                                         # 004A3D39
    mov al, byte ptr [0x113603b]                         # 004A3D3B
.L4A3D40:
    mov byte ptr [0x113604c], al                         # 004A3D40
    mov al, byte ptr [0x1136062]                         # 004A3D45
    and al, 0x7f                                         # 004A3D4A
    mov edi, 0x1136030                                   # 004A3D4C
    call _sub_42C518                                     # 004A3D51
    movzx edi, byte ptr [0x1136062]                      # 004A3D56
    and edi, 0xffffff7f                                  # 004A3D5D
    mov al, byte ptr [edi + 0x525f7a]                    # 004A3D63
    cmp al, 0xff                                         # 004A3D69
    jne .L4A3D72                                         # 004A3D6B
    mov al, byte ptr [0x1136030]                         # 004A3D6D
.L4A3D72:
    mov byte ptr [0x1136039], al                         # 004A3D72
    mov al, byte ptr [0x1136062]                         # 004A3D77
    and al, 0x7f                                         # 004A3D7C
    mov edi, 0x1136054                                   # 004A3D7E
    call _sub_4781C5                                     # 004A3D83
    movzx edi, byte ptr [0x1136062]                      # 004A3D88
    and edi, 0xffffff7f                                  # 004A3D8F
    movzx ax, byte ptr [edi + 0x525fa2]                  # 004A3D95
    cmp al, 0xff                                         # 004A3D9D
    jne .L4A3DA4                                         # 004A3D9F
    msvc_xor ax, ax                                      # 004A3DA1
.L4A3DA4:
    mov word ptr [0x1135fe4], ax                         # 004A3DA4
    mov byte ptr [0x113603a], 0                          # 004A3DAA
...
.L4A3DD8:
    ...
    mov byte ptr [0x113602e], 0xff                       # 004A3DDD
    mov dword ptr [0x1136054], 0xffffffff                # 004A3DE4
    mov word ptr [0x1135fe4], 0                          # 004A3DEE
    mov byte ptr [0x1136039], 0xff                       # 004A3DF7
    mov edi, 0x113603b                                   # 004A3DFE
    call _sub_48D70C                                     # 004A3E03
    mov al, byte ptr [0x525fac]                          # 004A3E08
    cmp al, 0xff                                         # 004A3E0D
    jne .L4A3E16                                         # 004A3E0F
    mov al, byte ptr [0x113603b]                         # 004A3E11
.L4A3E16:
    mov byte ptr [0x113604c], al                         # 004A3E16
...
.L4A3E3D:
    ...
    mov byte ptr [0x113602e], 0xff                       # 004A3E42
    mov dword ptr [0x1136054], 0xffffffff                # 004A3E49
    mov word ptr [0x1135fe4], 0                          # 004A3E53
    mov byte ptr [0x1136039], 0xff                       # 004A3E5C
    mov edi, 0x113603b                                   # 004A3E63
    call _sub_48D753                                     # 004A3E68
    mov al, byte ptr [0x525fad]                          # 004A3E6D
    cmp al, 0xff                                         # 004A3E72
    jne .L4A3E7B                                         # 004A3E74
    mov al, byte ptr [0x113603b]                         # 004A3E76
.L4A3E7B:
    mov byte ptr [0x113604c], al                         # 004A3E7B
...
_sub_4A3EA2:
    test ebp, 4                                          # 004A3EA2
    je .L4A3EDF                                          # 004A3EA8
    add ax, word ptr [ebp*8 + 0x4f7b5e]                  # 004A3EAA
    add cx, word ptr [ebp*8 + 0x4f7b60]                  # 004A3EB2
    add dx, word ptr [ebp*8 + 0x4f7b62]                  # 004A3EBA
    movzx esi, byte ptr [ebp*8 + 0x4f7b5d]               # 004A3EC2
    cmp esi, 0xc                                         # 004A3ECA
    jae .L4A3EDF                                         # 004A3ECD
    sub ax, word ptr [esi*4 + 0x503c6c]                  # 004A3ECF
    sub cx, word ptr [esi*4 + 0x503c6e]                  # 004A3ED7
.L4A3EDF:
...
_sub_4A3EF6:
    ...
    mov edi, dword ptr [ebp*4 + 0x4f73d8]                # 004A3F06
...
_sub_4A3F0F:
    ...
    push edx                                             # 004A3F1C
    push esi                                             # 004A3F1D
    jmp dword ptr [esi*4 + 0x4fffb8]                     # 004A3F1E
...
_sub_4A3F53:
    ...
    shr esi, 3                                           # 004A3F76
    mov esi, dword ptr [esi + 0xe40134]                  # 004A3F79
    mov dword ptr [0x1135f1a], esi                       # 004A3F7F
.L4A3F85:
...
.L4A3FC8:
    sub esi, 8                                           # 004A3FC8
    cmp esi, dword ptr [0x1135f1a]                       # 004A3FCB
    jb .L4A4002                                          # 004A3FD1
...
_sub_4A400E:
    ...
    .global _sub_4A4011
_sub_4A4011:
    mov word ptr [0x113600c], ax                         # 004A4011
    mov word ptr [0x113600e], bx                         # 004A4017
    push esi                                             # 004A401E
    mov edx, 0xfffffffb                                  # 004A401F
    call _sub_459E54                                     # 004A4024
    mov dword ptr [0x1135f52], edi                       # 004A4029
    cmp bl, 4                                            # 004A402F
    ...
    mov esi, dword ptr [0x1135f52]                       # 004A405B
...
_sub_4A40C2:
    ...
    .global _sub_4A40C5
_sub_4A40C5:
    mov word ptr [0x113600c], ax                         # 004A40C5
    mov word ptr [0x113600e], bx                         # 004A40CB
    push esi                                             # 004A40D2
    mov edx, 0xfffffffb                                  # 004A40D3
    call _sub_459E54                                     # 004A40D8
    mov dword ptr [0x1135f52], edi                       # 004A40DD
    cmp bl, 4                                            # 004A40E3
    ...
    mov esi, dword ptr [0x1135f52]                       # 004A410F
...
_sub_4A417A:
    ...
    mov ebp, dword ptr [ebp*4 + 0x4f73d8]                # 004A4187
    ...
    shl di, 2                                            # 004A41A4
    jmp dword ptr [ebx*4 + 0x4fffe8]                     # 004A41A8
...
_sub_4A41D5:
    ...
    push edx                                             # 004A41EB
    push edi                                             # 004A41EC
    add ax, word ptr [ebx*8 + 0x4f7b5e]                  # 004A41ED
    add cx, word ptr [ebx*8 + 0x4f7b60]                  # 004A41F5
    add di, word ptr [ebx*8 + 0x4f7b62]                  # 004A41FD
    mov dl, byte ptr [ebx*8 + 0x4f7b5d]                  # 004A4205
    mov word ptr [0x1135fc6], ax                         # 004A420C
    mov word ptr [0x1135fc8], cx                         # 004A4212
    mov word ptr [0x1135fca], di                         # 004A4219
    mov word ptr [0x1135fcc], dx                         # 004A4220
    pop edi                                              # 004A4227
    pop edx                                              # 004A4228
    pop ecx                                              # 004A4229
    pop eax                                              # 004A422A
    movzx edx, byte ptr [ebx*8 + 0x4f7b5c]               # 004A422B
    movzx edx, byte ptr [edx + 0x503cac]                 # 004A4233
    mov word ptr [0x1135fd4], dx                         # 004A423A
    cmp dl, 0xc                                          # 004A4241
    jae .L4A4256                                         # 004A4244
    add ax, word ptr [edx*4 + 0x503c6c]                  # 004A4246
    add cx, word ptr [edx*4 + 0x503c6e]                  # 004A424E
.L4A4256:
    mov word ptr [0x1135fce], ax                         # 004A4256
    mov word ptr [0x1135fd0], cx                         # 004A425C
    mov word ptr [0x1135fd2], di                         # 004A4263
    mov ax, word ptr [0x1135fc6]                         # 004A426A
    mov cx, word ptr [0x1135fc8]                         # 004A4270
    add ax, 0x10                                         # 004A4277
    add cx, 0x10                                         # 004A427B
    mov dx, word ptr [0x1135fca]                         # 004A427F
    mov ebx, dword ptr [0xe3f0b8]                        # 004A4286
    jmp dword ptr [ebx*4 + 0x4ffff8]                     # 004A428C
...
_sub_4A42E1:
    ...
    sub ax, word ptr [0x113600c]                         # 004A4301
    jns .L4A430D                                         # 004A4308
    neg ax                                               # 004A430A
.L4A430D:
    sub bx, word ptr [0x113600e]                         # 004A430D
    jns .L4A4319                                         # 004A4314
    neg bx                                               # 004A4316
.L4A4319:
    msvc_add ax, bx                                      # 004A4319
    msvc_mov bp, ax                                      # 004A431C
    mov ax, word ptr [0x1135fce]                         # 004A431F
    mov cx, word ptr [0x1135fd0]                         # 004A4325
    add ax, 0x10                                         # 004A432C
    add cx, 0x10                                         # 004A4330
    mov dx, word ptr [0x1135fd2]                         # 004A4334
    mov ebx, dword ptr [0xe3f0b8]                        # 004A433B
    jmp dword ptr [ebx*4 + 0x500008]                     # 004A4341
...
_sub_4A4396:
    ...
    sub ax, word ptr [0x113600c]                         # 004A43B6
    jns .L4A43C2                                         # 004A43BD
    neg ax                                               # 004A43BF
.L4A43C2:
    sub bx, word ptr [0x113600e]                         # 004A43C2
...
_sub_4A43E4:
    ...
    mov ebp, dword ptr [ebp*4 + 0x4f73d8]                # 004A43F1
    ...
    shl di, 2                                            # 004A440E
    jmp dword ptr [ebx*4 + 0x500018]                     # 004A4412
...
_sub_4A443F:
    ...
    mov ebp, dword ptr [ebx*4 + 0x4d9724]                # 004A4453
    movzx edx, word ptr [ebp - 2]                        # 004A445A
    mov word ptr [0x1135fc6], 0xffff                     # 004A445E
...
_sub_4A4467:
    ...
    mov ebx, dword ptr [0xe3f0b8]                        # 004A4480
    jmp dword ptr [ebx*4 + 0x500028]                     # 004A4486
...
_sub_4A44DB:
    ...
    sub ax, word ptr [0x113600c]                         # 004A44FB
    jns .L4A4507                                         # 004A4502
    neg ax                                               # 004A4504
.L4A4507:
    sub bx, word ptr [0x113600e]                         # 004A4507
    jns .L4A4513                                         # 004A450E
    neg bx                                               # 004A4510
.L4A4513:
    msvc_add ax, bx                                      # 004A4513
    cmp ax, word ptr [0x1135fc6]                         # 004A4516
    jae .L4A452C                                         # 004A451D
    mov word ptr [0x1135fc6], ax                         # 004A451F
    mov word ptr [0x1135fc8], dx                         # 004A4525
.L4A452C:
    pop edi                                              # 004A452C
    pop ecx                                              # 004A452D
    pop eax                                              # 004A452E
    ...
    .global _sub_4A4534
_sub_4A4534:
    movzx edx, word ptr [0x1135fc8]                      # 004A4534
    pop ebp                                              # 004A453B
    pop esi                                              # 004A453C
    pop edi                                              # 004A453D
    pop ecx                                              # 004A453E
    ...
    .global _sub_4A4542
_sub_4A4542:
    mov word ptr [0x113600c], ax                         # 004A4542
    mov word ptr [0x113600e], bx                         # 004A4548
    push esi                                             # 004A454F
    mov edx, 0xfffffffb                                  # 004A4550
    call _sub_459E54                                     # 004A4555
    mov dword ptr [0x1135f52], edi                       # 004A455A
    cmp bl, 4                                            # 004A4560
    jne .L4A46AD                                         # 004A4563
    mov bh, byte ptr [edx + 5]                           # 004A4569
    shr bh, 4                                            # 004A456C
    cmp bh, byte ptr [0x1136062]                         # 004A456F
    jne .L4A46AD                                         # 004A4575
    msvc_mov esi, edx                                    # 004A457B
    movzx di, byte ptr [0x113602e]                       # 004A457D
    ...
    cmp word ptr [0x523394], 0xa                         # 004A45B1
    je .L4A45DA                                          # 004A45B9
    push edx                                             # 004A45BB
    msvc_mov edx, esi                                    # 004A45BC
    mov esi, dword ptr [0x1135f52]                       # 004A45BE
...
.L4A45D9:
    pop edx                                              # 004A45D9
.L4A45DA:
    test byte ptr [0x522096], 4                          # 004A45DA
    je .L4A4639                                          # 004A45E1
    cmp ax, word ptr [0x1136004]                         # 004A45E3
    jne .L4A4632                                         # 004A45EA
    cmp cx, word ptr [0x1136006]                         # 004A45EC
    jne .L4A4632                                         # 004A45F3
    cmp di, word ptr [0x1136008]                         # 004A45F5
    jne .L4A4632                                         # 004A45FC
    cmp bh, byte ptr [0x113604d]                         # 004A45FE
    jne .L4A4632                                         # 004A4604
    cmp dl, byte ptr [0x113604e]                         # 004A4606
    jne .L4A4632                                         # 004A460C
    cmp dh, byte ptr [0x113604f]                         # 004A460E
    jne .L4A4632                                         # 004A4614
    cmp bp, word ptr [0x113600a]                         # 004A4616
    jne .L4A4632                                         # 004A461D
    msvc_mov esi, edi                                    # 004A461F
    shr esi, 0x10                                        # 004A4621
    and si, 0xc000                                       # 004A4624
    cmp si, word ptr [0x1136002]                         # 004A4629
    je .L4A46AB                                          # 004A4630
.L4A4632:
    pushal                                               # 004A4632
    ...
    popal                                                # 004A4638
.L4A4639:
    mov word ptr [0x1136004], ax                         # 004A4639
    mov word ptr [0x1136006], cx                         # 004A463F
    mov word ptr [0x1136008], di                         # 004A4646
    mov byte ptr [0x113604d], bh                         # 004A464D
    mov byte ptr [0x113604e], dl                         # 004A4653
    mov byte ptr [0x113604f], dh                         # 004A4659
    mov word ptr [0x113600a], bp                         # 004A465F
    msvc_mov esi, edi                                    # 004A4666
    shr esi, 0x10                                        # 004A4668
    and si, 0xc000                                       # 004A466B
    mov word ptr [0x1136002], si                         # 004A4670
    mov bl, 0x69                                         # 004A4677
    mov esi, 0xd                                         # 004A4679
    call _sub_431315                                     # 004A467E
    cmp ebx, dword ptr [0x1135f4e]                       # 004A4683
    je .L4A469C                                          # 004A4689
    mov dword ptr [0x1135f4e], ebx                       # 004A468B
    mov al, 0xd                                          # 004A4691
    mov bx, 0                                            # 004A4693
...
.L4A469C:
    ...
    je .L4A46AB                                          # 004A46A2
    or byte ptr [0x522096], 4                            # 004A46A4
.L4A46AB:
    pop esi                                              # 004A46AB
    ret                                                  # 004A46AC
.L4A46AD:
    call _sub_49FEC7                                     # 004A46AD
    cmp dword ptr [0x1135f4e], 0x80000000                # 004A46B2
    je .L4A46D3                                          # 004A46BC
    mov dword ptr [0x1135f4e], 0x80000000                # 004A46BE
    mov al, 0xd                                          # 004A46C8
    mov bx, 0                                            # 004A46CA
...
.L4A46D3:
    ...
    .global _sub_4A46D5
_sub_4A46D5:
    mov word ptr [0x113600c], ax                         # 004A46D5
    mov word ptr [0x113600e], bx                         # 004A46DB
    pushal                                               # 004A46E2
    ...
    mov dword ptr [0x1135f52], edi                       # 004A46F4
    cmp bl, 4                                            # 004A46FA
    jne .L4A47C8                                         # 004A46FD
    mov bh, byte ptr [edx + 5]                           # 004A4703
    shr bh, 4                                            # 004A4706
    cmp bh, byte ptr [0x1136062]                         # 004A4709
    jne .L4A47CA                                         # 004A470F
    msvc_mov esi, edx                                    # 004A4715
    movzx di, byte ptr [0x113602e]                       # 004A4717
    ...
    mov word ptr [0x9c68e8], 0x8c                        # 004A474B
    cmp word ptr [0x523394], 0xa                         # 004A4754
    je .L4A4786                                          # 004A475C
    mov word ptr [0x9c68e8], 0x8b                        # 004A475E
    push edx                                             # 004A4767
    msvc_mov edx, esi                                    # 004A4768
    mov esi, dword ptr [0x1135f52]                       # 004A476A
...
.L4A4786:
    ...
    push ecx                                             # 004A479D
    push edx                                             # 004A479E
    mov cx, word ptr [0x9c68e0]                          # 004A479F
    mov dx, word ptr [0x9c68e2]                          # 004A47A6
    mov bp, word ptr [0x9c68e4]                          # 004A47AD
...
_sub_4A47D9:
    ...
    push eax                                             # 004A47EB
    push ecx                                             # 004A47EC
    movzx edi, byte ptr [0x113604c]                      # 004A47ED
    mov edi, dword ptr [edi*4 + 0x50c9a4]                # 004A47F4
    ...
    movzx edx, byte ptr [0x1136064]                      # 004A481B
    shl ax, 5                                            # 004A4822
    shl cx, 5                                            # 004A4826
    shl bp, 5                                            # 004A482A
    shl bx, 5                                            # 004A482E
    jmp dword ptr [edx*4 + 0x500038]                     # 004A4832
...
.L4A4880:
    ...
    mov word ptr [0x1135f80], bp                         # 004A488D
    mov word ptr [0x1135f82], bx                         # 004A4894
...
.L4A489E:
    ...
    shr esi, 3                                           # 004A48B7
    mov esi, dword ptr [esi + 0xe40134]                  # 004A48BA
...
_sub_4A4903:
    ...
    mov dword ptr [0x113608b], 0                         # 004A4915
    mov byte ptr [0x113608f], 0xff                       # 004A491F
    push eax                                             # 004A4926
    push ecx                                             # 004A4927
    mov word ptr [0x1135f7c], ax                         # 004A4928
    mov word ptr [0x1135f7e], cx                         # 004A492E
    msvc_mov bp, ax                                      # 004A4935
    msvc_mov bx, cx                                      # 004A4938
    add bp, 0x20                                         # 004A493B
    add bx, 0x20                                         # 004A493F
    mov word ptr [0x1135f80], bp                         # 004A4943
    mov word ptr [0x1135f82], bx                         # 004A494A
...
.L4A4964:
    ...
    shr esi, 3                                           # 004A4985
    mov esi, dword ptr [esi + 0xe40134]                  # 004A4988
...
.L4A49C6:
    cmp ax, word ptr [0x1135f7c]                         # 004A49C6
    jb .L4A49D8                                          # 004A49CD
    cmp ax, word ptr [0x1135f80]                         # 004A49CF
    jbe .L4A49EA                                         # 004A49D6
.L4A49D8:
    cmp cx, word ptr [0x1135f7e]                         # 004A49D8
    jb .L4A4A15                                          # 004A49DF
    cmp cx, word ptr [0x1135f82]                         # 004A49E1
    ja .L4A4A15                                          # 004A49E8
.L4A49EA:
    push eax                                             # 004A49EA
    push ecx                                             # 004A49EB
    sub ax, word ptr [0x1135f7c]                         # 004A49EC
    sub cx, word ptr [0x1135f7e]                         # 004A49F3
    sub ax, 0x10                                         # 004A49FA
    sub cx, 0x10                                         # 004A49FE
    call _sub_4BF52B                                     # 004A4A02
    shr eax, 4                                           # 004A4A07
    xor eax, 2                                           # 004A4A0A
    inc byte ptr [eax + 0x113608b]                       # 004A4A0D
    pop ecx                                              # 004A4A13
    pop eax                                              # 004A4A14
.L4A4A15:
    ...
    movzx ebp, byte ptr [ebp + 0x5c456c]                 # 004A4A2F
    mov ebp, dword ptr [ebp*4 + 0x50d074]                # 004A4A36
...
.L4A4A54:
    cmp ax, word ptr [0x1135f7c]                         # 004A4A54
    jb .L4A4A66                                          # 004A4A5B
    cmp ax, word ptr [0x1135f80]                         # 004A4A5D
    jbe .L4A4A78                                         # 004A4A64
.L4A4A66:
    cmp cx, word ptr [0x1135f7e]                         # 004A4A66
    jb .L4A4A9F                                          # 004A4A6D
    cmp cx, word ptr [0x1135f82]                         # 004A4A6F
    ja .L4A4A9F                                          # 004A4A76
.L4A4A78:
    push eax                                             # 004A4A78
    push ecx                                             # 004A4A79
    sub ax, word ptr [0x1135f7c]                         # 004A4A7A
    sub cx, word ptr [0x1135f7e]                         # 004A4A81
    sub ax, 0x10                                         # 004A4A88
    sub cx, 0x10                                         # 004A4A8C
    call _sub_4BF52B                                     # 004A4A90
    shr eax, 4                                           # 004A4A95
    mov byte ptr [0x113608f], al                         # 004A4A98
    pop ecx                                              # 004A4A9D
    pop eax                                              # 004A4A9E
.L4A4A9F:
    ...
    je .L4A4B00                                          # 004A4ABC
    movzx ecx, byte ptr [0x113608f]                      # 004A4ABE
    cmp cl, 0xff                                         # 004A4AC5
    jne .L4A4AF3                                         # 004A4AC8
    msvc_xor ecx, ecx                                    # 004A4ACA
.L4A4ACC:
    cmp byte ptr [ecx + 0x113608b], 2                    # 004A4ACC
    jae .L4A4AF3                                         # 004A4AD3
    inc ecx                                              # 004A4AD5
    cmp ecx, 4                                           # 004A4AD6
    jb .L4A4ACC                                          # 004A4AD9
    msvc_xor ecx, ecx                                    # 004A4ADB
.L4A4ADD:
    cmp byte ptr [ecx + 0x113608b], 1                    # 004A4ADD
    jae .L4A4AF3                                         # 004A4AE4
    inc ecx                                              # 004A4AE6
    cmp ecx, 4                                           # 004A4AE7
    jb .L4A4ADD                                          # 004A4AEA
    movzx ecx, byte ptr [0x113608a]                      # 004A4AEC
.L4A4AF3:
    msvc_mov bh, cl                                      # 004A4AF3
    pop ecx                                              # 004A4AF5
    pop eax                                              # 004A4AF6
...
.L4A4B00:
    ...
    .global _sub_4A4B07
_sub_4A4B07:
    test byte ptr [0x1136063], 0x80                      # 004A4B07
    jne .L4A4F3B                                         # 004A4B0E
    test byte ptr [0x1136063], 0x40                      # 004A4B14
    jne .L4A5158                                         # 004A4B1B
    test byte ptr [0x1136062], 0x80                      # 004A4B21
    jne .L4A4D21                                         # 004A4B28
    mov word ptr [0x113600c], ax                         # 004A4B2E
    mov word ptr [0x113600e], bx                         # 004A4B34
    push esi                                             # 004A4B3B
    mov edx, 0xfffffffb                                  # 004A4B3C
    call _sub_459E54                                     # 004A4B41
    mov dword ptr [0x1135f52], edi                       # 004A4B46
    cmp bl, 4                                            # 004A4B4C
    jne .L4A4CF9                                         # 004A4B4F
    mov bh, byte ptr [edx + 5]                           # 004A4B55
    shr bh, 4                                            # 004A4B58
    cmp bh, byte ptr [0x1136062]                         # 004A4B5B
    jne .L4A4CF9                                         # 004A4B61
    msvc_mov esi, edx                                    # 004A4B67
    movzx di, byte ptr [0x113604c]                       # 004A4B69
    ...
    shr bp, 4                                            # 004A4B93
    test byte ptr [0x522096], 8                          # 004A4B97
    je .L4A4BE7                                          # 004A4B9E
    cmp ax, word ptr [0x1135fe6]                         # 004A4BA0
    jne .L4A4BE0                                         # 004A4BA7
    cmp cx, word ptr [0x1135fe8]                         # 004A4BA9
    jne .L4A4BE0                                         # 004A4BB0
    cmp di, word ptr [0x1135fea]                         # 004A4BB2
    jne .L4A4BE0                                         # 004A4BB9
    cmp bh, byte ptr [0x113606b]                         # 004A4BBB
    jne .L4A4BE0                                         # 004A4BC1
    cmp dl, byte ptr [0x113606c]                         # 004A4BC3
    jne .L4A4BE0                                         # 004A4BC9
    cmp dh, byte ptr [0x113606d]                         # 004A4BCB
    jne .L4A4BE0                                         # 004A4BD1
    cmp bp, word ptr [0x1135fee]                         # 004A4BD3
    je .L4A4CF7                                          # 004A4BDA
.L4A4BE0:
    pushal                                               # 004A4BE0
    ...
    popal                                                # 004A4BE6
.L4A4BE7:
    mov word ptr [0x1135fe6], ax                         # 004A4BE7
    mov word ptr [0x1135fe8], cx                         # 004A4BED
    mov word ptr [0x1135fea], di                         # 004A4BF4
    mov byte ptr [0x113606b], bh                         # 004A4BFB
    mov byte ptr [0x113606c], dl                         # 004A4C01
    mov byte ptr [0x113606d], dh                         # 004A4C07
    mov word ptr [0x1135fee], bp                         # 004A4C0D
    mov bl, 0x69                                         # 004A4C14
    mov esi, 0xf                                         # 004A4C16
    call _sub_431315                                     # 004A4C1B
    mov dword ptr [0x1135f6c], ebx                       # 004A4C20
    mov al, 0xd                                          # 004A4C26
    mov bx, 0                                            # 004A4C28
    call _sub_4CB966                                     # 004A4C2C
    cmp ebx, 0x80000000                                  # 004A4C31
    je .L4A4CF7                                          # 004A4C37
    or byte ptr [0x522096], 8                            # 004A4C3D
    or word ptr [0xf24484], 0x20                         # 004A4C44
    mov ebp, dword ptr [0x112c734]                       # 004A4C4C
    mov dword ptr [0x1135f70], ebp                       # 004A4C52
    cmp ebp, -1                                          # 004A4C58
    je .L4A4C69                                          # 004A4C5B
    imul ebp, ebp, 0x3d2                                 # 004A4C5D
    add ebp, 0x5e6edc                                    # 004A4C63
.L4A4C69:
    mov dx, 0                                            # 004A4C69
    call _sub_491D70                                     # 004A4C6D
    mov ax, word ptr [0x112c792]                         # 004A4C72
    mov cx, word ptr [0x112c794]                         # 004A4C78
    cmp ax, -1                                           # 004A4C7F
    jne .L4A4C92                                         # 004A4C83
    mov ax, word ptr [0x1135fe6]                         # 004A4C85
    mov cx, word ptr [0x1135fe8]                         # 004A4C8B
.L4A4C92:
    mov dx, 0                                            # 004A4C92
    call _sub_491BF5                                     # 004A4C96
    call _sub_491BC6                                     # 004A4C9B
    mov ebp, dword ptr [0x112c734]                       # 004A4CA0
    mov dword ptr [0x1135f70], ebp                       # 004A4CA6
    cmp ebp, -1                                          # 004A4CAC
    je .L4A4CBD                                          # 004A4CAF
    imul ebp, ebp, 0x3d2                                 # 004A4CB1
    add ebp, 0x5e6edc                                    # 004A4CB7
.L4A4CBD:
    mov ebx, 0xffffffff                                  # 004A4CBD
    mov ax, word ptr [0x112c792]                         # 004A4CC2
    mov cx, word ptr [0x112c794]                         # 004A4CC8
    cmp ax, -1                                           # 004A4CCF
    jne .L4A4CE2                                         # 004A4CD3
    mov ax, word ptr [0x1135fe6]                         # 004A4CD5
    mov cx, word ptr [0x1135fe8]                         # 004A4CDB
.L4A4CE2:
    call _sub_491FE0                                     # 004A4CE2
    mov dword ptr [0x1135f74], ebx                       # 004A4CE7
    mov eax, dword ptr [0x112c710]                       # 004A4CED
    mov dword ptr [0x1135f78], eax                       # 004A4CF2
.L4A4CF7:
    pop esi                                              # 004A4CF7
    ret                                                  # 004A4CF8
.L4A4CF9:
    call _sub_49FEC7                                     # 004A4CF9
    cmp dword ptr [0x1135f6c], 0x80000000                # 004A4CFE
    je .L4A4D1F                                          # 004A4D08
    mov dword ptr [0x1135f6c], 0x80000000                # 004A4D0A
    mov al, 0xd                                          # 004A4D14
    mov bx, 0                                            # 004A4D16
...
.L4A4D1F:
    ...
    ret                                                  # 004A4D20
.L4A4D21:
    mov word ptr [0x113600c], ax                         # 004A4D21
    mov word ptr [0x113600e], bx                         # 004A4D27
    push esi                                             # 004A4D2E
    mov edx, 0xffffffdf                                  # 004A4D2F
    call _sub_459E54                                     # 004A4D34
    mov dword ptr [0x1135f52], edi                       # 004A4D39
    cmp bl, 0x10                                         # 004A4D3F
    jne .L4A4F13                                         # 004A4D42
    msvc_mov esi, edx                                    # 004A4D48
    movzx di, byte ptr [0x113604c]                       # 004A4D4A
    ...
    shr bp, 4                                            # 004A4D74
    or bp, 0x80                                          # 004A4D78
    test byte ptr [0x522096], 8                          # 004A4D7D
    je .L4A4DCD                                          # 004A4D84
    cmp ax, word ptr [0x1135fe6]                         # 004A4D86
    jne .L4A4DC6                                         # 004A4D8D
    cmp cx, word ptr [0x1135fe8]                         # 004A4D8F
    jne .L4A4DC6                                         # 004A4D96
    cmp di, word ptr [0x1135fea]                         # 004A4D98
    jne .L4A4DC6                                         # 004A4D9F
    cmp bh, byte ptr [0x113606b]                         # 004A4DA1
    jne .L4A4DC6                                         # 004A4DA7
    cmp dl, byte ptr [0x113606c]                         # 004A4DA9
    jne .L4A4DC6                                         # 004A4DAF
    cmp dh, byte ptr [0x113606d]                         # 004A4DB1
    jne .L4A4DC6                                         # 004A4DB7
    cmp bp, word ptr [0x1135fee]                         # 004A4DB9
    je .L4A4F11                                          # 004A4DC0
.L4A4DC6:
    pushal                                               # 004A4DC6
    ...
    popal                                                # 004A4DCC
.L4A4DCD:
    mov word ptr [0x1135fe6], ax                         # 004A4DCD
    mov word ptr [0x1135fe8], cx                         # 004A4DD3
    mov word ptr [0x1135fea], di                         # 004A4DDA
    mov byte ptr [0x113606b], bh                         # 004A4DE1
    mov byte ptr [0x113606c], dl                         # 004A4DE7
    mov byte ptr [0x113606d], dh                         # 004A4DED
    mov word ptr [0x1135fee], bp                         # 004A4DF3
    mov bl, 0x69                                         # 004A4DFA
    and bp, 0xff7f                                       # 004A4DFC
    mov esi, 0x2a                                        # 004A4E01
    call _sub_431315                                     # 004A4E06
    mov dword ptr [0x1135f6c], ebx                       # 004A4E0B
    mov al, 0xd                                          # 004A4E11
    mov bx, 0                                            # 004A4E13
    call _sub_4CB966                                     # 004A4E17
    cmp ebx, 0x80000000                                  # 004A4E1C
    je .L4A4F11                                          # 004A4E22
    or byte ptr [0x522096], 8                            # 004A4E28
    or word ptr [0xf24484], 0x20                         # 004A4E2F
    mov ebp, dword ptr [0x112c734]                       # 004A4E37
    mov dword ptr [0x1135f70], ebp                       # 004A4E3D
    cmp ebp, -1                                          # 004A4E43
    je .L4A4E54                                          # 004A4E46
    imul ebp, ebp, 0x3d2                                 # 004A4E48
    add ebp, 0x5e6edc                                    # 004A4E4E
.L4A4E54:
    mov dx, 0                                            # 004A4E54
    call _sub_491D70                                     # 004A4E58
    mov ax, word ptr [0x112c792]                         # 004A4E5D
    mov cx, word ptr [0x112c794]                         # 004A4E63
    cmp ax, -1                                           # 004A4E6A
    jne .L4A4E7D                                         # 004A4E6E
    mov ax, word ptr [0x1135fe6]                         # 004A4E70
    mov cx, word ptr [0x1135fe8]                         # 004A4E76
.L4A4E7D:
    mov dx, 0                                            # 004A4E7D
    call _sub_491BF5                                     # 004A4E81
    call _sub_491BC6                                     # 004A4E86
    mov ebp, dword ptr [0x112c734]                       # 004A4E8B
    mov dword ptr [0x1135f70], ebp                       # 004A4E91
    cmp ebp, -1                                          # 004A4E97
    je .L4A4EA8                                          # 004A4E9A
    imul ebp, ebp, 0x3d2                                 # 004A4E9C
    add ebp, 0x5e6edc                                    # 004A4EA2
.L4A4EA8:
    mov ebx, 0xffffffff                                  # 004A4EA8
    movzx ecx, byte ptr [0x113604c]                      # 004A4EAD
    mov ecx, dword ptr [ecx*4 + 0x50c934]                # 004A4EB4
...
.L4A4EDC:
    mov ax, word ptr [0x112c792]                         # 004A4EDC
    mov cx, word ptr [0x112c794]                         # 004A4EE2
    cmp ax, -1                                           # 004A4EE9
    jne .L4A4EFC                                         # 004A4EED
    mov ax, word ptr [0x1135fe6]                         # 004A4EEF
    mov cx, word ptr [0x1135fe8]                         # 004A4EF5
.L4A4EFC:
    call _sub_491FE0                                     # 004A4EFC
    mov dword ptr [0x1135f74], ebx                       # 004A4F01
    mov eax, dword ptr [0x112c710]                       # 004A4F07
    mov dword ptr [0x1135f78], eax                       # 004A4F0C
.L4A4F11:
    pop esi                                              # 004A4F11
    ret                                                  # 004A4F12
.L4A4F13:
    call _sub_49FEC7                                     # 004A4F13
    cmp dword ptr [0x1135f6c], 0x80000000                # 004A4F18
    je .L4A4F39                                          # 004A4F22
    mov dword ptr [0x1135f6c], 0x80000000                # 004A4F24
    mov al, 0xd                                          # 004A4F2E
    mov bx, 0                                            # 004A4F30
...
.L4A4F39:
    ...
    ret                                                  # 004A4F3A
.L4A4F3B:
    mov word ptr [0x113600c], ax                         # 004A4F3B
    mov word ptr [0x113600e], bx                         # 004A4F41
    push esi                                             # 004A4F48
    call _sub_46112C                                     # 004A4F49
    and word ptr [0xf24484], 0xfff8                      # 004A4F4E
    call _sub_4A47D9                                     # 004A4F56
    cmp ax, 0x8000                                       # 004A4F5B
    je .L4A4CF9                                          # 004A4F5F
    or word ptr [0xf24484], 2                            # 004A4F65
    and word ptr [0xf24484], 0xfff7                      # 004A4F6D
    or word ptr [0xf24484], 4                            # 004A4F75
    mov bl, byte ptr [0x1136064]                         # 004A4F7D
    mov byte ptr [0xf24948], bl                          # 004A4F83
    mov word ptr [0xf24942], ax                          # 004A4F89
    mov word ptr [0xf24944], cx                          # 004A4F8F
    mov word ptr [0xf24946], di                          # 004A4F96
    push eax                                             # 004A4F9D
    push ecx                                             # 004A4F9E
    mov esi, 0xf24490                                    # 004A4F9F
    mov ax, word ptr [0x1135f7c]                         # 004A4FA4
    mov cx, word ptr [0x1135f7e]                         # 004A4FAA
.L4A4FB1:
    mov word ptr [esi], ax                               # 004A4FB1
    mov word ptr [esi + 2], cx                           # 004A4FB4
    add esi, 4                                           # 004A4FB8
    add ax, 0x20                                         # 004A4FBB
    cmp ax, word ptr [0x1135f80]                         # 004A4FBF
    jle .L4A4FB1                                         # 004A4FC6
    mov ax, word ptr [0x1135f7c]                         # 004A4FC8
    add cx, 0x20                                         # 004A4FCE
    cmp cx, word ptr [0x1135f82]                         # 004A4FD2
    jle .L4A4FB1                                         # 004A4FD9
    mov word ptr [esi], 0xffff                           # 004A4FDB
    pop ecx                                              # 004A4FE0
    pop eax                                              # 004A4FE1
    call _sub_46112C                                     # 004A4FE2
    mov bh, byte ptr [0x1136064]                         # 004A4FE7
    mov dl, byte ptr [0x113604c]                         # 004A4FED
    test byte ptr [0x522096], 8                          # 004A4FF3
    je .L4A5032                                          # 004A4FFA
    cmp ax, word ptr [0x1135fe6]                         # 004A4FFC
    jne .L4A502B                                         # 004A5003
    cmp cx, word ptr [0x1135fe8]                         # 004A5005
    jne .L4A502B                                         # 004A500C
    cmp di, word ptr [0x1135fea]                         # 004A500E
    jne .L4A502B                                         # 004A5015
    cmp bh, byte ptr [0x113606b]                         # 004A5017
    jne .L4A502B                                         # 004A501D
    cmp dl, byte ptr [0x1136089]                         # 004A501F
    je .L4A5156                                          # 004A5025
.L4A502B:
    pushal                                               # 004A502B
    ...
    popal                                                # 004A5031
.L4A5032:
    mov word ptr [0x1135fe6], ax                         # 004A5032
    mov word ptr [0x1135fe8], cx                         # 004A5038
    mov word ptr [0x1135fea], di                         # 004A503F
    mov byte ptr [0x113606b], bh                         # 004A5046
    mov byte ptr [0x1136089], dl                         # 004A504C
    mov word ptr [0x1135fee], 0x8000                     # 004A5052
    mov bl, 0x69                                         # 004A505B
    mov esi, 0x38                                        # 004A505D
    call _sub_431315                                     # 004A5062
    mov dword ptr [0x1135f6c], ebx                       # 004A5067
    mov al, 0xd                                          # 004A506D
    mov bx, 0                                            # 004A506F
    call _sub_4CB966                                     # 004A5073
    cmp ebx, 0x80000000                                  # 004A5078
    je .L4A5156                                          # 004A507E
    or byte ptr [0x522096], 8                            # 004A5084
    or word ptr [0xf24484], 0x20                         # 004A508B
    mov ebp, dword ptr [0x112c734]                       # 004A5093
    mov dword ptr [0x1135f70], ebp                       # 004A5099
    cmp ebp, -1                                          # 004A509F
    je .L4A50B0                                          # 004A50A2
    imul ebp, ebp, 0x3d2                                 # 004A50A4
    add ebp, 0x5e6edc                                    # 004A50AA
.L4A50B0:
    mov dx, 0                                            # 004A50B0
    call _sub_491D70                                     # 004A50B4
    mov ax, word ptr [0x112c792]                         # 004A50B9
    mov cx, word ptr [0x112c794]                         # 004A50BF
    cmp ax, -1                                           # 004A50C6
    jne .L4A50D9                                         # 004A50CA
    mov ax, word ptr [0x1135fe6]                         # 004A50CC
    mov cx, word ptr [0x1135fe8]                         # 004A50D2
.L4A50D9:
    mov dx, 0                                            # 004A50D9
    mov bl, byte ptr [0x1136089]                         # 004A50DD
    mov bh, byte ptr [0x113606b]                         # 004A50E3
    call _sub_491C6F                                     # 004A50E9
    call _sub_491BC6                                     # 004A50EE
    mov ebp, dword ptr [0x112c734]                       # 004A50F3
    mov dword ptr [0x1135f70], ebp                       # 004A50F9
    cmp ebp, -1                                          # 004A50FF
    je .L4A5110                                          # 004A5102
    imul ebp, ebp, 0x3d2                                 # 004A5104
    add ebp, 0x5e6edc                                    # 004A510A
.L4A5110:
    mov ebx, 0xffffffff                                  # 004A5110
    mov ax, word ptr [0x112c792]                         # 004A5115
    mov cx, word ptr [0x112c794]                         # 004A511B
    cmp ax, -1                                           # 004A5122
    jne .L4A5135                                         # 004A5126
    mov ax, word ptr [0x1135fe6]                         # 004A5128
    mov cx, word ptr [0x1135fe8]                         # 004A512E
.L4A5135:
    mov dh, byte ptr [0x113606b]                         # 004A5135
    mov dl, byte ptr [0x1136089]                         # 004A513B
    call _sub_491F43                                     # 004A5141
    mov dword ptr [0x1135f74], ebx                       # 004A5146
    mov eax, dword ptr [0x112c710]                       # 004A514C
    mov dword ptr [0x1135f78], eax                       # 004A5151
.L4A5156:
    pop esi                                              # 004A5156
    ret                                                  # 004A5157
.L4A5158:
    mov word ptr [0x113600c], ax                         # 004A5158
    mov word ptr [0x113600e], bx                         # 004A515E
    push esi                                             # 004A5165
    call _sub_46112C                                     # 004A5166
    and word ptr [0xf24484], 0xfff8                      # 004A516B
    call _sub_4A4903                                     # 004A5173
    cmp ax, 0x8000                                       # 004A5178
    je .L4A4CF9                                          # 004A517C
    or word ptr [0xf24484], 2                            # 004A5182
    and word ptr [0xf24484], 0xfff7                      # 004A518A
    or word ptr [0xf24484], 4                            # 004A5192
    mov byte ptr [0xf24948], bh                          # 004A519A
    mov word ptr [0xf24942], ax                          # 004A51A0
    mov word ptr [0xf24944], cx                          # 004A51A6
    mov word ptr [0xf24946], di                          # 004A51AD
    push eax                                             # 004A51B4
    push ecx                                             # 004A51B5
    mov esi, 0xf24490                                    # 004A51B6
    mov ax, word ptr [0x1135f7c]                         # 004A51BB
    mov cx, word ptr [0x1135f7e]                         # 004A51C1
.L4A51C8:
    mov word ptr [esi], ax                               # 004A51C8
    mov word ptr [esi + 2], cx                           # 004A51CB
    add esi, 4                                           # 004A51CF
    add ax, 0x20                                         # 004A51D2
    cmp ax, word ptr [0x1135f80]                         # 004A51D6
    jle .L4A51C8                                         # 004A51DD
    mov ax, word ptr [0x1135f7c]                         # 004A51DF
    add cx, 0x20                                         # 004A51E5
    cmp cx, word ptr [0x1135f82]                         # 004A51E9
    jle .L4A51C8                                         # 004A51F0
    mov word ptr [esi], 0xffff                           # 004A51F2
    pop ecx                                              # 004A51F7
    pop eax                                              # 004A51F8
    call _sub_46112C                                     # 004A51F9
    mov dl, byte ptr [0x113604c]                         # 004A51FE
    test byte ptr [0x522096], 8                          # 004A5204
    je .L4A5243                                          # 004A520B
    cmp ax, word ptr [0x1135fe6]                         # 004A520D
    jne .L4A523C                                         # 004A5214
    cmp cx, word ptr [0x1135fe8]                         # 004A5216
    jne .L4A523C                                         # 004A521D
    cmp di, word ptr [0x1135fea]                         # 004A521F
    jne .L4A523C                                         # 004A5226
    cmp bh, byte ptr [0x113606b]                         # 004A5228
    jne .L4A523C                                         # 004A522E
    cmp dl, byte ptr [0x1136089]                         # 004A5230
    je .L4A5367                                          # 004A5236
.L4A523C:
    pushal                                               # 004A523C
    ...
    popal                                                # 004A5242
.L4A5243:
    mov word ptr [0x1135fe6], ax                         # 004A5243
    mov word ptr [0x1135fe8], cx                         # 004A5249
    mov word ptr [0x1135fea], di                         # 004A5250
    mov byte ptr [0x113606b], bh                         # 004A5257
    mov byte ptr [0x1136089], dl                         # 004A525D
    mov word ptr [0x1135fee], 0x4000                     # 004A5263
    mov bl, 0x69                                         # 004A526C
    mov esi, 0x3c                                        # 004A526E
    call _sub_431315                                     # 004A5273
    mov dword ptr [0x1135f6c], ebx                       # 004A5278
    mov al, 0xd                                          # 004A527E
    mov bx, 0                                            # 004A5280
    call _sub_4CB966                                     # 004A5284
    cmp ebx, 0x80000000                                  # 004A5289
    je .L4A5367                                          # 004A528F
    or byte ptr [0x522096], 8                            # 004A5295
    or word ptr [0xf24484], 0x20                         # 004A529C
    mov ebp, dword ptr [0x112c734]                       # 004A52A4
    mov dword ptr [0x1135f70], ebp                       # 004A52AA
    cmp ebp, -1                                          # 004A52B0
    je .L4A52C1                                          # 004A52B3
    imul ebp, ebp, 0x3d2                                 # 004A52B5
    add ebp, 0x5e6edc                                    # 004A52BB
.L4A52C1:
    mov dx, 0                                            # 004A52C1
    call _sub_491D70                                     # 004A52C5
    mov ax, word ptr [0x112c792]                         # 004A52CA
    mov cx, word ptr [0x112c794]                         # 004A52D0
    cmp ax, -1                                           # 004A52D7
    jne .L4A52EA                                         # 004A52DB
    mov ax, word ptr [0x1135fe6]                         # 004A52DD
    mov cx, word ptr [0x1135fe8]                         # 004A52E3
.L4A52EA:
    mov dx, 0                                            # 004A52EA
    mov bl, byte ptr [0x1136089]                         # 004A52EE
    mov bh, byte ptr [0x113606b]                         # 004A52F4
    call _sub_491D20                                     # 004A52FA
    call _sub_491BC6                                     # 004A52FF
    mov ebp, dword ptr [0x112c734]                       # 004A5304
    mov dword ptr [0x1135f70], ebp                       # 004A530A
    cmp ebp, -1                                          # 004A5310
    je .L4A5321                                          # 004A5313
    imul ebp, ebp, 0x3d2                                 # 004A5315
    add ebp, 0x5e6edc                                    # 004A531B
.L4A5321:
    mov ebx, 0xffffffff                                  # 004A5321
    mov ax, word ptr [0x112c792]                         # 004A5326
    mov cx, word ptr [0x112c794]                         # 004A532C
    cmp ax, -1                                           # 004A5333
    jne .L4A5346                                         # 004A5337
    mov ax, word ptr [0x1135fe6]                         # 004A5339
    mov cx, word ptr [0x1135fe8]                         # 004A533F
.L4A5346:
    mov dh, byte ptr [0x113606b]                         # 004A5346
    mov dl, byte ptr [0x1136089]                         # 004A534C
    call _sub_491F93                                     # 004A5352
    mov dword ptr [0x1135f74], ebx                       # 004A5357
    mov eax, dword ptr [0x112c710]                       # 004A535D
    mov dword ptr [0x1135f78], eax                       # 004A5362
.L4A5367:
    pop esi                                              # 004A5367
    ret                                                  # 004A5368
    ...
    .global _sub_4A5369
_sub_4A5369:
    test byte ptr [0x1136063], 0x80                      # 004A5369
    jne .L4A5550                                         # 004A5370
    test byte ptr [0x1136063], 0x40                      # 004A5376
    jne .L4A55AB                                         # 004A537D
    test byte ptr [0x1136062], 0x80                      # 004A5383
    jne .L4A548F                                         # 004A538A
    mov word ptr [0x113600c], ax                         # 004A5390
    mov word ptr [0x113600e], bx                         # 004A5396
    pushal                                               # 004A539D
    ...
    mov dword ptr [0x1135f52], edi                       # 004A53AF
    cmp bl, 4                                            # 004A53B5
    jne .L4A5461                                         # 004A53B8
    mov bh, byte ptr [edx + 5]                           # 004A53BE
    shr bh, 4                                            # 004A53C1
    cmp bh, byte ptr [0x1136062]                         # 004A53C4
    jne .L4A5463                                         # 004A53CA
    msvc_mov esi, edx                                    # 004A53D0
    movzx di, byte ptr [0x113604c]                       # 004A53D2
    ...
    mov esi, dword ptr [esi*4 + 0x50c8b4]                # 004A5405
    mov si, word ptr [esi]                               # 004A540C
    mov word ptr [0x112c82c], si                         # 004A540F
    mov word ptr [0x9c68e8], 0x8f                        # 004A5416
    mov bl, 1                                            # 004A541F
    ...
    push ecx                                             # 004A5436
    push edx                                             # 004A5437
    mov cx, word ptr [0x9c68e0]                          # 004A5438
    mov dx, word ptr [0x9c68e2]                          # 004A543F
    mov bp, word ptr [0x9c68e4]                          # 004A5446
...
.L4A5461:
    ...
    ret                                                  # 004A5462
.L4A5463:
    movzx esi, byte ptr [0x113604c]                      # 004A5463
    mov esi, dword ptr [esi*4 + 0x50c8b4]                # 004A546A
    mov si, word ptr [esi]                               # 004A5471
    mov word ptr [0x112c82c], si                         # 004A5474
    mov word ptr [0x9c68e8], 0x8f                        # 004A547B
    mov dx, 0xa7                                         # 004A5484
    call _sub_431A8A                                     # 004A5488
    pop esi                                              # 004A548D
    ret                                                  # 004A548E
.L4A548F:
    mov word ptr [0x113600c], ax                         # 004A548F
    mov word ptr [0x113600e], bx                         # 004A5495
    pushal                                               # 004A549C
    ...
    mov dword ptr [0x1135f52], edi                       # 004A54AE
    cmp bl, 0x10                                         # 004A54B4
    jne .L4A554E                                         # 004A54B7
    msvc_mov esi, edx                                    # 004A54BD
    movzx di, byte ptr [0x113604c]                       # 004A54BF
    ...
    mov esi, dword ptr [esi*4 + 0x50c934]                # 004A54F2
    mov si, word ptr [esi]                               # 004A54F9
    mov word ptr [0x112c82c], si                         # 004A54FC
    mov word ptr [0x9c68e8], 0x8f                        # 004A5503
    mov bl, 1                                            # 004A550C
    ...
    push ecx                                             # 004A5523
    push edx                                             # 004A5524
    mov cx, word ptr [0x9c68e0]                          # 004A5525
    mov dx, word ptr [0x9c68e2]                          # 004A552C
    mov bp, word ptr [0x9c68e4]                          # 004A5533
...
.L4A554E:
    ...
    ret                                                  # 004A554F
.L4A5550:
    mov word ptr [0x113600c], ax                         # 004A5550
    mov word ptr [0x113600e], bx                         # 004A5556
    pushal                                               # 004A555D
    ...
    je .L4A55A9                                          # 004A556E
    movzx esi, byte ptr [0x113604c]                      # 004A5570
    mov esi, dword ptr [esi*4 + 0x50c9a4]                # 004A5577
    mov si, word ptr [esi]                               # 004A557E
    mov word ptr [0x112c82c], si                         # 004A5581
    mov word ptr [0x9c68e8], 0x8f                        # 004A5588
    mov bh, byte ptr [0x1136064]                         # 004A5591
    mov dl, byte ptr [0x113604c]                         # 004A5597
    mov bl, 1                                            # 004A559D
...
.L4A55A9:
    ...
    ret                                                  # 004A55AA
.L4A55AB:
    mov word ptr [0x113600c], ax                         # 004A55AB
    mov word ptr [0x113600e], bx                         # 004A55B1
    pushal                                               # 004A55B8
    ...
    je .L4A55FE                                          # 004A55C9
    movzx esi, byte ptr [0x113604c]                      # 004A55CB
    mov esi, dword ptr [esi*4 + 0x50c9c4]                # 004A55D2
    mov si, word ptr [esi]                               # 004A55D9
    mov word ptr [0x112c82c], si                         # 004A55DC
    mov word ptr [0x9c68e8], 0x8f                        # 004A55E3
    mov dl, byte ptr [0x113604c]                         # 004A55EC
    mov bl, 1                                            # 004A55F2
...
.L4A55FE:
    ...
    .global _sub_4A5600
_sub_4A5600:
    test byte ptr [0x1136062], 0x80                      # 004A5600
    jne .L4A576C                                         # 004A5607
    mov word ptr [0x113600c], ax                         # 004A560D
    mov word ptr [0x113600e], bx                         # 004A5613
    push esi                                             # 004A561A
    mov edx, 0xfffffffb                                  # 004A561B
    call _sub_459E54                                     # 004A5620
    mov dword ptr [0x1135f52], edi                       # 004A5625
    cmp bl, 4                                            # 004A562B
    jne .L4A5744                                         # 004A562E
    mov bh, byte ptr [edx + 5]                           # 004A5634
    shr bh, 4                                            # 004A5637
    cmp bh, byte ptr [0x1136062]                         # 004A563A
    jne .L4A5744                                         # 004A5640
    msvc_mov esi, edx                                    # 004A5646
    movzx di, byte ptr [0x113604c]                       # 004A5648
    ...
    shr bp, 4                                            # 004A5672
    test byte ptr [0x522096], 0x10                       # 004A5676
    je .L4A56C6                                          # 004A567D
    cmp ax, word ptr [0x1135ff8]                         # 004A567F
    jne .L4A56BF                                         # 004A5686
    cmp cx, word ptr [0x1135ffa]                         # 004A5688
    jne .L4A56BF                                         # 004A568F
    cmp di, word ptr [0x1135ffc]                         # 004A5691
    jne .L4A56BF                                         # 004A5698
    cmp bh, byte ptr [0x1136058]                         # 004A569A
    jne .L4A56BF                                         # 004A56A0
    cmp dl, byte ptr [0x1136059]                         # 004A56A2
    jne .L4A56BF                                         # 004A56A8
    cmp dh, byte ptr [0x113605a]                         # 004A56AA
    jne .L4A56BF                                         # 004A56B0
    cmp bp, word ptr [0x1136010]                         # 004A56B2
    je .L4A5742                                          # 004A56B9
.L4A56BF:
    pushal                                               # 004A56BF
    ...
    popal                                                # 004A56C5
.L4A56C6:
    mov word ptr [0x1135ff8], ax                         # 004A56C6
    mov word ptr [0x1135ffa], cx                         # 004A56CC
    mov word ptr [0x1135ffc], di                         # 004A56D3
    mov byte ptr [0x1136058], bh                         # 004A56DA
    mov byte ptr [0x1136059], dl                         # 004A56E0
    mov byte ptr [0x113605a], dh                         # 004A56E6
    mov word ptr [0x1136010], bp                         # 004A56EC
    ror edi, 0x10                                        # 004A56F3
    mov di, word ptr [0x1135fe4]                         # 004A56F6
    ror edi, 0x10                                        # 004A56FD
    ror ebp, 0x10                                        # 004A5700
    movzx bp, byte ptr [0x113606e]                       # 004A5703
    ror ebp, 0x10                                        # 004A570B
    mov bl, 0x69                                         # 004A570E
    mov esi, 0x11                                        # 004A5710
    call _sub_431315                                     # 004A5715
    cmp ebx, dword ptr [0x1135f46]                       # 004A571A
    je .L4A5733                                          # 004A5720
    mov dword ptr [0x1135f46], ebx                       # 004A5722
    mov al, 0xd                                          # 004A5728
    mov bx, 0                                            # 004A572A
...
.L4A5733:
    ...
    je .L4A5742                                          # 004A5739
    or byte ptr [0x522096], 0x10                         # 004A573B
.L4A5742:
    pop esi                                              # 004A5742
    ret                                                  # 004A5743
.L4A5744:
    call _sub_49FEC7                                     # 004A5744
    cmp dword ptr [0x1135f46], 0x80000000                # 004A5749
    je .L4A576A                                          # 004A5753
    mov dword ptr [0x1135f46], 0x80000000                # 004A5755
    mov al, 0xd                                          # 004A575F
    mov bx, 0                                            # 004A5761
...
.L4A576A:
    ...
    ret                                                  # 004A576B
.L4A576C:
    mov word ptr [0x113600c], ax                         # 004A576C
    mov word ptr [0x113600e], bx                         # 004A5772
    push esi                                             # 004A5779
    mov edx, 0xffffffdf                                  # 004A577A
    call _sub_459E54                                     # 004A577F
    mov dword ptr [0x1135f52], edi                       # 004A5784
    cmp bl, 0x10                                         # 004A578A
    jne .L4A58AF                                         # 004A578D
    mov bh, byte ptr [edx + 5]                           # 004A5793
    shr bh, 4                                            # 004A5796
    or bh, 0x80                                          # 004A5799
    cmp bh, byte ptr [0x1136062]                         # 004A579C
    jne .L4A58AF                                         # 004A57A2
    msvc_mov esi, edx                                    # 004A57A8
    movzx di, byte ptr [0x113604c]                       # 004A57AA
    ...
    shr bp, 4                                            # 004A57D4
    test byte ptr [0x522096], 0x10                       # 004A57D8
    je .L4A5828                                          # 004A57DF
    cmp ax, word ptr [0x1135ff8]                         # 004A57E1
    jne .L4A5821                                         # 004A57E8
    cmp cx, word ptr [0x1135ffa]                         # 004A57EA
    jne .L4A5821                                         # 004A57F1
    cmp di, word ptr [0x1135ffc]                         # 004A57F3
    jne .L4A5821                                         # 004A57FA
    cmp bh, byte ptr [0x1136058]                         # 004A57FC
    jne .L4A5821                                         # 004A5802
    cmp dl, byte ptr [0x1136059]                         # 004A5804
    jne .L4A5821                                         # 004A580A
    cmp dh, byte ptr [0x113605a]                         # 004A580C
    jne .L4A5821                                         # 004A5812
    cmp bp, word ptr [0x1136010]                         # 004A5814
    je .L4A58AD                                          # 004A581B
.L4A5821:
    pushal                                               # 004A5821
    ...
    popal                                                # 004A5827
.L4A5828:
    mov word ptr [0x1135ff8], ax                         # 004A5828
    mov word ptr [0x1135ffa], cx                         # 004A582E
    mov word ptr [0x1135ffc], di                         # 004A5835
    mov byte ptr [0x1136058], bh                         # 004A583C
    mov byte ptr [0x1136059], dl                         # 004A5842
    mov byte ptr [0x113605a], dh                         # 004A5848
    mov word ptr [0x1136010], bp                         # 004A584E
    or word ptr [0x1136010], 0x80                        # 004A5855
    ror edi, 0x10                                        # 004A585E
    mov di, word ptr [0x1135fe4]                         # 004A5861
    ror edi, 0x10                                        # 004A5868
    ror ebp, 0x10                                        # 004A586B
    movzx bp, byte ptr [0x113606e]                       # 004A586E
    ror ebp, 0x10                                        # 004A5876
    mov bl, 0x69                                         # 004A5879
    mov esi, 0x28                                        # 004A587B
    call _sub_431315                                     # 004A5880
    cmp ebx, dword ptr [0x1135f46]                       # 004A5885
    je .L4A589E                                          # 004A588B
    mov dword ptr [0x1135f46], ebx                       # 004A588D
    mov al, 0xd                                          # 004A5893
    mov bx, 0                                            # 004A5895
...
.L4A589E:
    ...
    je .L4A58AD                                          # 004A58A4
    or byte ptr [0x522096], 0x10                         # 004A58A6
.L4A58AD:
    pop esi                                              # 004A58AD
    ret                                                  # 004A58AE
.L4A58AF:
    call _sub_49FEC7                                     # 004A58AF
    cmp dword ptr [0x1135f46], 0x80000000                # 004A58B4
    je .L4A58D5                                          # 004A58BE
    mov dword ptr [0x1135f46], 0x80000000                # 004A58C0
    mov al, 0xd                                          # 004A58CA
    mov bx, 0                                            # 004A58CC
...
.L4A58D5:
    ...
    .global _sub_4A58D7
_sub_4A58D7:
    test byte ptr [0x1136062], 0x80                      # 004A58D7
    jne .L4A59C1                                         # 004A58DE
    mov word ptr [0x113600c], ax                         # 004A58E4
    mov word ptr [0x113600e], bx                         # 004A58EA
    pushal                                               # 004A58F1
    ...
    mov dword ptr [0x1135f52], edi                       # 004A5903
    cmp bl, 4                                            # 004A5909
    jne .L4A59B0                                         # 004A590C
    mov bh, byte ptr [edx + 5]                           # 004A5912
    shr bh, 4                                            # 004A5915
    cmp bh, byte ptr [0x1136062]                         # 004A5918
    jne .L4A59B2                                         # 004A591E
    msvc_mov esi, edx                                    # 004A5924
    mov di, word ptr [0x1135fe4]                         # 004A5926
    ...
    movzx bp, byte ptr [0x113606e]                       # 004A5956
    ror ebp, 0x10                                        # 004A595E
    mov word ptr [0x9c68e8], 0x247                       # 004A5961
    mov bl, 1                                            # 004A596A
    ...
    push ecx                                             # 004A5985
    push edx                                             # 004A5986
    mov cx, word ptr [0x9c68e0]                          # 004A5987
    mov dx, word ptr [0x9c68e2]                          # 004A598E
    mov bp, word ptr [0x9c68e4]                          # 004A5995
...
.L4A59B2:
    ...
    ret                                                  # 004A59C0
.L4A59C1:
    mov word ptr [0x113600c], ax                         # 004A59C1
    mov word ptr [0x113600e], bx                         # 004A59C7
    pushal                                               # 004A59CE
    ...
    movzx bp, byte ptr [0x113606e]                       # 004A5A36
    ror ebp, 0x10                                        # 004A5A3E
    mov word ptr [0x9c68e8], 0x247                       # 004A5A41
    mov bl, 1                                            # 004A5A4A
    ...
    push ecx                                             # 004A5A65
    push edx                                             # 004A5A66
    mov cx, word ptr [0x9c68e0]                          # 004A5A67
    mov dx, word ptr [0x9c68e2]                          # 004A5A6E
    mov bp, word ptr [0x9c68e4]                          # 004A5A75
...
.L4A5AB2:
    bt dword ptr [0x523368], 3                           # 004A5AB2
    jae .L4A5ACF                                         # 004A5ABA
    cmp byte ptr [0x523392], 0xd                         # 004A5ABC
    jne .L4A5ACF                                         # 004A5AC3
    cmp word ptr [0x523394], 0xb                         # 004A5AC5
    je .L4A5AE0                                          # 004A5ACD
.L4A5ACF:
...
.L4A5B15:
    popal                                                # 004A5B15
    mov word ptr [0x9c68e8], 0x8d                        # 004A5B16
    mov bl, 1                                            # 004A5B1F
    ...
    push ecx                                             # 004A5B36
    push edx                                             # 004A5B37
    mov cx, word ptr [0x9c68e0]                          # 004A5B38
    mov dx, word ptr [0x9c68e2]                          # 004A5B3F
    mov bp, word ptr [0x9c68e4]                          # 004A5B46
...
_sub_4A5B66:
    ...
    shl di, 2                                            # 004A5B8B
    mov word ptr [0x9c68e8], 0xa6                        # 004A5B8F
    mov bl, 1                                            # 004A5B98
    ...
    push ecx                                             # 004A5BAF
    push edx                                             # 004A5BB0
    mov cx, word ptr [0x9c68e0]                          # 004A5BB1
    mov dx, word ptr [0x9c68e2]                          # 004A5BB8
    mov bp, word ptr [0x9c68e4]                          # 004A5BBF
...
_sub_4A5BDF:
    ...
    shl di, 2                                            # 004A5C04
    mov word ptr [0x9c68e8], 0xa6                        # 004A5C08
    mov bl, 1                                            # 004A5C11
    ...
    push ecx                                             # 004A5C28
    push edx                                             # 004A5C29
    mov cx, word ptr [0x9c68e0]                          # 004A5C2A
    mov dx, word ptr [0x9c68e2]                          # 004A5C31
    mov bp, word ptr [0x9c68e4]                          # 004A5C38
...
_sub_4A5C58:
    ...
    shl di, 2                                            # 004A5C64
    mov word ptr [0x9c68e8], 0xa4                        # 004A5C68
    mov bl, 1                                            # 004A5C71
    ...
    push ecx                                             # 004A5C88
    push edx                                             # 004A5C89
    mov cx, word ptr [0x9c68e0]                          # 004A5C8A
    mov dx, word ptr [0x9c68e2]                          # 004A5C91
    mov bp, word ptr [0x9c68e4]                          # 004A5C98
...
_sub_4A5CC5:
    ...
    shr ebx, 6                                           # 004A5CCF
    sub ax, word ptr [ebx*4 + 0x4f9296]                  # 004A5CD2
    sub cx, word ptr [ebx*4 + 0x4f9298]                  # 004A5CDA
    movzx di, byte ptr [edx + 2]                         # 004A5CE2
    shl di, 2                                            # 004A5CE7
    mov word ptr [0x9c68e8], 0xa5                        # 004A5CEB
    mov bl, 1                                            # 004A5CF4
    ...
    push ecx                                             # 004A5D0B
    push edx                                             # 004A5D0C
    mov cx, word ptr [0x9c68e0]                          # 004A5D0D
    mov dx, word ptr [0x9c68e2]                          # 004A5D14
    mov bp, word ptr [0x9c68e4]                          # 004A5D1B
...
_sub_4A5D48:
    ...
    cmp byte ptr [0x1136061], 1                          # 004A5D5B
...
.L4A5D74:
    ...
    cmp byte ptr [0x521ebc], 0                           # 004A5D7E
    je .L4A5D91                                          # 004A5D85
...
_sub_4A5D94:
    ...
    push edx                                             # 004A5D97
    push ebp                                             # 004A5D98
    cmp dword ptr [0x1135f06], -1                        # 004A5D99
    je .L4A5DF9                                          # 004A5DA0
    and ebp, 0x1ff                                       # 004A5DA2
    push ebx                                             # 004A5DA8
    add ax, word ptr [ebp*8 + 0x4f7b5e]                  # 004A5DA9
    add cx, word ptr [ebp*8 + 0x4f7b60]                  # 004A5DB1
    add dx, word ptr [ebp*8 + 0x4f7b62]                  # 004A5DB9
    movzx ebx, byte ptr [ebp*8 + 0x4f7b5d]               # 004A5DC1
    cmp bl, 0xc                                          # 004A5DC9
    jae .L4A5DDE                                         # 004A5DCC
    sub ax, word ptr [ebx*4 + 0x503c6c]                  # 004A5DCE
    sub cx, word ptr [ebx*4 + 0x503c6e]                  # 004A5DD6
.L4A5DDE:
    pop ebx                                              # 004A5DDE
...
.L4A5DF9:
    ...
    shr edx, 3                                           # 004A5E01
    movzx edi, word ptr [0x1135ff0]                      # 004A5E04
    mov edi, dword ptr [edi*4 + 0x50c914]                # 004A5E0B
    msvc_xor esi, esi                                    # 004A5E12
.L4A5E14:
    bt word ptr [0x1135ff2], si                          # 004A5E14
    jae .L4A5E44                                         # 004A5E1C
    movzx ebx, byte ptr [esi + edi + 0xa]                # 004A5E1E
    mov ebx, dword ptr [ebx*4 + 0x50c8f4]                # 004A5E23
    mov ax, word ptr [edx*2 + 0x4f891c]                  # 004A5E2A
    and ax, word ptr [ebx + 2]                           # 004A5E32
    cmp ax, word ptr [edx*2 + 0x4f891c]                  # 004A5E36
...
.L4A5E44:
    ...
    je .L4A5E95                                          # 004A5E5C
    push ebx                                             # 004A5E5E
    add ax, word ptr [ebp*8 + 0x4f7b5e]                  # 004A5E5F
    add cx, word ptr [ebp*8 + 0x4f7b60]                  # 004A5E67
    add dx, word ptr [ebp*8 + 0x4f7b62]                  # 004A5E6F
    movzx ebx, byte ptr [ebp*8 + 0x4f7b5d]               # 004A5E77
    cmp bl, 0xc                                          # 004A5E7F
    jae .L4A5E94                                         # 004A5E82
    sub ax, word ptr [ebx*4 + 0x503c6c]                  # 004A5E84
    sub cx, word ptr [ebx*4 + 0x503c6e]                  # 004A5E8C
.L4A5E94:
    pop ebx                                              # 004A5E94
.L4A5E95:
    msvc_mov esi, ebp                                    # 004A5E95
    and esi, 3                                           # 004A5E97
    mov dword ptr [0x1135ede], esi                       # 004A5E9A
    shr ebp, 3                                           # 004A5EA0
    mov dword ptr [0x1135ee2], ebp                       # 004A5EA3
    mov ebp, dword ptr [ebp*4 + 0x4f73d8]                # 004A5EA9
    mov byte ptr [0x1136060], 0                          # 004A5EB0
...
_sub_4A5EB7:
    ...
    push edi                                             # 004A5EBA
    push esi                                             # 004A5EBB
    jmp dword ptr [esi*4 + 0x500048]                     # 004A5EBC
...
_sub_4A5EE9:
    ...
    mov word ptr [0x1135f66], ax                         # 004A5EED
    mov word ptr [0x1135f68], cx                         # 004A5EF3
    mov word ptr [0x1135f6a], dx                         # 004A5EFA
    shr dx, 2                                            # 004A5F01
    movzx esi, cx                                        # 004A5F05
    shl esi, 9                                           # 004A5F08
    msvc_or si, ax                                       # 004A5F0B
    shr esi, 3                                           # 004A5F0E
    mov esi, dword ptr [esi + 0xe40134]                  # 004A5F11
.L4A5F17:
    ...
    and al, 3                                            # 004A5F26
    cmp al, byte ptr [0x1135ede]                         # 004A5F28
    ...
    cmp al, byte ptr [0x1135ee2]                         # 004A5F49
    je .L4A5F56                                          # 004A5F4F
.L4A5F51:
    add esi, 8                                           # 004A5F51
    jmp .L4A5F17                                         # 004A5F54
.L4A5F56:
    cmp byte ptr [0x1136060], 0                          # 004A5F56
    jne .L4A609C                                         # 004A5F5D
    inc word ptr [0x1135f62]                             # 004A5F63
    movzx edi, word ptr [0x1135ff0]                      # 004A5F6A
    mov edi, dword ptr [edi*4 + 0x50c914]                # 004A5F71
    test word ptr [0x1135ff2], 1                         # 004A5F78
    je .L4A5FC1                                          # 004A5F81
    test byte ptr [esi + 7], 0x10                        # 004A5F83
    jne .L4A5FC1                                         # 004A5F87
    movzx ecx, byte ptr [edi + 0xa]                      # 004A5F89
    mov ecx, dword ptr [ecx*4 + 0x50c8f4]                # 004A5F8D
    movsx eax, word ptr [ecx + 6]                        # 004A5F94
    movzx ecx, byte ptr [ecx + 5]                        # 004A5F98
    imul eax, dword ptr [ecx*4 + 0x525e5e]               # 004A5F9C
    sar eax, 0xa                                         # 004A5FA4
    mov ecx, dword ptr [0x1135ee2]                       # 004A5FA7
    movzx ecx, word ptr [ecx*2 + 0x4f870c]               # 004A5FAD
    imul eax, ecx                                        # 004A5FB5
    sar eax, 8                                           # 004A5FB8
    add dword ptr [0x1135eda], eax                       # 004A5FBB
.L4A5FC1:
    test word ptr [0x1135ff2], 2                         # 004A5FC1
    je .L4A600A                                          # 004A5FCA
    test byte ptr [esi + 7], 0x20                        # 004A5FCC
    jne .L4A600A                                         # 004A5FD0
    movzx ecx, byte ptr [edi + 0xb]                      # 004A5FD2
    mov ecx, dword ptr [ecx*4 + 0x50c8f4]                # 004A5FD6
    movsx eax, word ptr [ecx + 6]                        # 004A5FDD
    movzx ecx, byte ptr [ecx + 5]                        # 004A5FE1
    imul eax, dword ptr [ecx*4 + 0x525e5e]               # 004A5FE5
    sar eax, 0xa                                         # 004A5FED
    mov ecx, dword ptr [0x1135ee2]                       # 004A5FF0
    movzx ecx, word ptr [ecx*2 + 0x4f870c]               # 004A5FF6
    imul eax, ecx                                        # 004A5FFE
    sar eax, 8                                           # 004A6001
    add dword ptr [0x1135eda], eax                       # 004A6004
.L4A600A:
    test word ptr [0x1135ff2], 4                         # 004A600A
    je .L4A6053                                          # 004A6013
    test byte ptr [esi + 7], 0x40                        # 004A6015
    jne .L4A6053                                         # 004A6019
    movzx ecx, byte ptr [edi + 0xc]                      # 004A601B
    mov ecx, dword ptr [ecx*4 + 0x50c8f4]                # 004A601F
    movsx eax, word ptr [ecx + 6]                        # 004A6026
    movzx ecx, byte ptr [ecx + 5]                        # 004A602A
    imul eax, dword ptr [ecx*4 + 0x525e5e]               # 004A602E
    sar eax, 0xa                                         # 004A6036
    mov ecx, dword ptr [0x1135ee2]                       # 004A6039
    movzx ecx, word ptr [ecx*2 + 0x4f870c]               # 004A603F
    imul eax, ecx                                        # 004A6047
    sar eax, 8                                           # 004A604A
    add dword ptr [0x1135eda], eax                       # 004A604D
.L4A6053:
    test word ptr [0x1135ff2], 8                         # 004A6053
    je .L4A609C                                          # 004A605C
    test byte ptr [esi + 7], 0x80                        # 004A605E
    jne .L4A609C                                         # 004A6062
    movzx ecx, byte ptr [edi + 0xd]                      # 004A6064
    mov ecx, dword ptr [ecx*4 + 0x50c8f4]                # 004A6068
    movsx eax, word ptr [ecx + 6]                        # 004A606F
    movzx ecx, byte ptr [ecx + 5]                        # 004A6073
    imul eax, dword ptr [ecx*4 + 0x525e5e]               # 004A6077
    sar eax, 0xa                                         # 004A607F
    mov ecx, dword ptr [0x1135ee2]                       # 004A6082
    movzx ecx, word ptr [ecx*2 + 0x4f870c]               # 004A6088
    imul eax, ecx                                        # 004A6090
    sar eax, 8                                           # 004A6093
    add dword ptr [0x1135eda], eax                       # 004A6096
.L4A609C:
    test byte ptr [0x113605f], 1                         # 004A609C
    je .L4A60EE                                          # 004A60A3
    test byte ptr [0x113605f], 0x40                      # 004A60A5
    je .L4A60BF                                          # 004A60AC
    mov al, byte ptr [0x525e3c]                          # 004A60AE
    cmp al, byte ptr [esp + 0x20]                        # 004A60B3
    jne .L4A60EE                                         # 004A60B7
    or byte ptr [esi + 4], 0x40                          # 004A60B9
    jmp .L4A60CA                                         # 004A60BD
.L4A60BF:
    mov al, byte ptr [0x1135ff2]                         # 004A60BF
    shl al, 4                                            # 004A60C4
    or byte ptr [esi + 7], al                            # 004A60C7
.L4A60CA:
    mov ax, word ptr [0x1135f66]                         # 004A60CA
    mov cx, word ptr [0x1135f68]                         # 004A60D0
...
.L4A60EE:
    ...
    pop ecx                                              # 004A60F1
    pop eax                                              # 004A60F2
    test byte ptr [0x113605f], 1                         # 004A60F3
    je _sub_4A610F                                       # 004A60FA
    add ebp, 0xa                                         # 004A60FC
    inc byte ptr [0x1136060]                             # 004A60FF
...
_sub_4A610F:
    ...
    pop ebx                                              # 004A6112
    pop eax                                              # 004A6113
    test word ptr [0x1135f64], 0x8000                    # 004A6114
    je .L4A6127                                          # 004A611D
...
.L4A612A:
    ...
    .global _sub_4A612C
_sub_4A612C:
    or word ptr [0x1135f64], 1                           # 004A612C
...
_sub_4A6136:
    ...
    push edx                                             # 004A6139
    push ebp                                             # 004A613A
    cmp dword ptr [0x1135f06], -1                        # 004A613B
    je .L4A619B                                          # 004A6142
    and ebp, 0x1ff                                       # 004A6144
    push ebx                                             # 004A614A
    add ax, word ptr [ebp*8 + 0x4f7b5e]                  # 004A614B
    add cx, word ptr [ebp*8 + 0x4f7b60]                  # 004A6153
    add dx, word ptr [ebp*8 + 0x4f7b62]                  # 004A615B
    movzx ebx, byte ptr [ebp*8 + 0x4f7b5d]               # 004A6163
    cmp bl, 0xc                                          # 004A616B
    jae .L4A6180                                         # 004A616E
    sub ax, word ptr [ebx*4 + 0x503c6c]                  # 004A6170
    sub cx, word ptr [ebx*4 + 0x503c6e]                  # 004A6178
.L4A6180:
    pop ebx                                              # 004A6180
...
.L4A619B:
    ...
    je .L4A61E0                                          # 004A61A7
    push ebx                                             # 004A61A9
    add ax, word ptr [ebp*8 + 0x4f7b5e]                  # 004A61AA
    add cx, word ptr [ebp*8 + 0x4f7b60]                  # 004A61B2
    add dx, word ptr [ebp*8 + 0x4f7b62]                  # 004A61BA
    movzx ebx, byte ptr [ebp*8 + 0x4f7b5d]               # 004A61C2
    cmp bl, 0xc                                          # 004A61CA
    jae .L4A61DF                                         # 004A61CD
    sub ax, word ptr [ebx*4 + 0x503c6c]                  # 004A61CF
    sub cx, word ptr [ebx*4 + 0x503c6e]                  # 004A61D7
.L4A61DF:
    pop ebx                                              # 004A61DF
.L4A61E0:
    msvc_mov esi, ebp                                    # 004A61E0
    and esi, 3                                           # 004A61E2
    mov dword ptr [0x1135ede], esi                       # 004A61E5
    shr ebp, 3                                           # 004A61EB
    mov dword ptr [0x1135ee2], ebp                       # 004A61EE
    mov ebp, dword ptr [ebp*4 + 0x4f73d8]                # 004A61F4
    mov byte ptr [0x1136060], 0                          # 004A61FB
...
_sub_4A6202:
    ...
    push edi                                             # 004A6205
    push esi                                             # 004A6206
    jmp dword ptr [esi*4 + 0x500058]                     # 004A6207
...
_sub_4A6234:
    ...
    mov word ptr [0x1135f66], ax                         # 004A6238
    mov word ptr [0x1135f68], cx                         # 004A623E
    mov word ptr [0x1135f6a], dx                         # 004A6245
    shr dx, 2                                            # 004A624C
    movzx esi, cx                                        # 004A6250
    shl esi, 9                                           # 004A6253
    msvc_or si, ax                                       # 004A6256
    shr esi, 3                                           # 004A6259
    mov esi, dword ptr [esi + 0xe40134]                  # 004A625C
.L4A6262:
    ...
    and al, 3                                            # 004A6271
    cmp al, byte ptr [0x1135ede]                         # 004A6273
    ...
    cmp al, byte ptr [0x1135ee2]                         # 004A6294
    je .L4A62A1                                          # 004A629A
.L4A629C:
    add esi, 8                                           # 004A629C
    jmp .L4A6262                                         # 004A629F
.L4A62A1:
    cmp byte ptr [0x1136060], 0                          # 004A62A1
    jne .L4A63E7                                         # 004A62A8
    inc word ptr [0x1135f62]                             # 004A62AE
    movzx edi, word ptr [0x1135ff0]                      # 004A62B5
    mov edi, dword ptr [edi*4 + 0x50c914]                # 004A62BC
    test word ptr [0x1135ff2], 1                         # 004A62C3
    je .L4A630C                                          # 004A62CC
    test byte ptr [esi + 7], 0x10                        # 004A62CE
    je .L4A630C                                          # 004A62D2
    movzx ecx, byte ptr [edi + 0xa]                      # 004A62D4
    mov ecx, dword ptr [ecx*4 + 0x50c8f4]                # 004A62D8
    movsx eax, word ptr [ecx + 8]                        # 004A62DF
    movzx ecx, byte ptr [ecx + 5]                        # 004A62E3
    imul eax, dword ptr [ecx*4 + 0x525e5e]               # 004A62E7
    sar eax, 0xa                                         # 004A62EF
    mov ecx, dword ptr [0x1135ee2]                       # 004A62F2
    movzx ecx, word ptr [ecx*2 + 0x4f870c]               # 004A62F8
    imul eax, ecx                                        # 004A6300
    sar eax, 8                                           # 004A6303
    add dword ptr [0x1135eda], eax                       # 004A6306
.L4A630C:
    test word ptr [0x1135ff2], 2                         # 004A630C
    je .L4A6355                                          # 004A6315
    test byte ptr [esi + 7], 0x20                        # 004A6317
    je .L4A6355                                          # 004A631B
    movzx ecx, byte ptr [edi + 0xb]                      # 004A631D
    mov ecx, dword ptr [ecx*4 + 0x50c8f4]                # 004A6321
    movsx eax, word ptr [ecx + 8]                        # 004A6328
    movzx ecx, byte ptr [ecx + 5]                        # 004A632C
    imul eax, dword ptr [ecx*4 + 0x525e5e]               # 004A6330
    sar eax, 0xa                                         # 004A6338
    mov ecx, dword ptr [0x1135ee2]                       # 004A633B
    movzx ecx, word ptr [ecx*2 + 0x4f870c]               # 004A6341
    imul eax, ecx                                        # 004A6349
    sar eax, 8                                           # 004A634C
    add dword ptr [0x1135eda], eax                       # 004A634F
.L4A6355:
    test word ptr [0x1135ff2], 4                         # 004A6355
    je .L4A639E                                          # 004A635E
    test byte ptr [esi + 7], 0x40                        # 004A6360
    je .L4A639E                                          # 004A6364
    movzx ecx, byte ptr [edi + 0xc]                      # 004A6366
    mov ecx, dword ptr [ecx*4 + 0x50c8f4]                # 004A636A
    movsx eax, word ptr [ecx + 8]                        # 004A6371
    movzx ecx, byte ptr [ecx + 5]                        # 004A6375
    imul eax, dword ptr [ecx*4 + 0x525e5e]               # 004A6379
    sar eax, 0xa                                         # 004A6381
    mov ecx, dword ptr [0x1135ee2]                       # 004A6384
    movzx ecx, word ptr [ecx*2 + 0x4f870c]               # 004A638A
    imul eax, ecx                                        # 004A6392
    sar eax, 8                                           # 004A6395
    add dword ptr [0x1135eda], eax                       # 004A6398
.L4A639E:
    test word ptr [0x1135ff2], 8                         # 004A639E
    je .L4A63E7                                          # 004A63A7
    test byte ptr [esi + 7], 0x80                        # 004A63A9
    je .L4A63E7                                          # 004A63AD
    movzx ecx, byte ptr [edi + 0xd]                      # 004A63AF
    mov ecx, dword ptr [ecx*4 + 0x50c8f4]                # 004A63B3
    movsx eax, word ptr [ecx + 8]                        # 004A63BA
    movzx ecx, byte ptr [ecx + 5]                        # 004A63BE
    imul eax, dword ptr [ecx*4 + 0x525e5e]               # 004A63C2
    sar eax, 0xa                                         # 004A63CA
    mov ecx, dword ptr [0x1135ee2]                       # 004A63CD
    movzx ecx, word ptr [ecx*2 + 0x4f870c]               # 004A63D3
    imul eax, ecx                                        # 004A63DB
    sar eax, 8                                           # 004A63DE
    add dword ptr [0x1135eda], eax                       # 004A63E1
.L4A63E7:
    test byte ptr [0x113605f], 1                         # 004A63E7
    je .L4A643B                                          # 004A63EE
    test byte ptr [0x113605f], 0x40                      # 004A63F0
    je .L4A640A                                          # 004A63F7
    mov al, byte ptr [0x525e3c]                          # 004A63F9
    cmp al, byte ptr [esp + 0x20]                        # 004A63FE
    jne .L4A643B                                         # 004A6402
    and byte ptr [esi + 4], 0xbf                         # 004A6404
    jmp .L4A6417                                         # 004A6408
.L4A640A:
    mov al, byte ptr [0x1135ff2]                         # 004A640A
    shl al, 4                                            # 004A640F
    not al                                               # 004A6412
    and byte ptr [esi + 7], al                           # 004A6414
.L4A6417:
    mov ax, word ptr [0x1135f66]                         # 004A6417
    mov cx, word ptr [0x1135f68]                         # 004A641D
...
.L4A643B:
    ...
    pop ecx                                              # 004A643E
    pop eax                                              # 004A643F
    test byte ptr [0x113605f], 1                         # 004A6440
    je .L4A645C                                          # 004A6447
    add ebp, 0xa                                         # 004A6449
    inc byte ptr [0x1136060]                             # 004A644C
...
.L4A645C:
    ...
    pop ebx                                              # 004A645F
    pop eax                                              # 004A6460
    test word ptr [0x1135f64], 0x8000                    # 004A6461
    je .L4A6474                                          # 004A646A
...
.L4A6477:
    ...
    .global _sub_4A6479
_sub_4A6479:
    mov byte ptr [0x9c68ea], 0x30                        # 004A6479
    mov word ptr [0x9c68e0], ax                          # 004A6480
    mov word ptr [0x9c68e2], cx                          # 004A6486
    add word ptr [0x9c68e0], 0x10                        # 004A648D
    add word ptr [0x9c68e2], 0x10                        # 004A6495
    mov word ptr [0x9c68e4], di                          # 004A649D
    mov byte ptr [0x113606f], dh                         # 004A64A4
    mov byte ptr [0x1136070], dl                         # 004A64AA
    mov word ptr [0x1135ff0], bp                         # 004A64B0
    ror edi, 0x10                                        # 004A64B7
    ror ebp, 0x10                                        # 004A64BA
    mov word ptr [0x1135ff2], di                         # 004A64BD
    mov word ptr [0x1135fec], bp                         # 004A64C4
    ...
    shr esi, 3                                           # 004A64DE
    mov esi, dword ptr [esi + 0xe40134]                  # 004A64E1
.L4A64E7:
    ...
    and dh, 0xf                                          # 004A650B
    cmp dh, byte ptr [0x113606f]                         # 004A650E
    jne .L4A652E                                         # 004A6514
    mov dh, byte ptr [esi + 5]                           # 004A6516
    shr dh, 4                                            # 004A6519
    cmp dh, byte ptr [0x1135ff0]                         # 004A651C
...
.L4A6533:
    ...
    and al, 0xf                                          # 004A6537
    mov byte ptr [0x1136071], al                         # 004A6539
    ...
    and esi, 3                                           # 004A6569
    jmp dword ptr [esi*4 + 0x500068]                     # 004A656C
...
_sub_4A65A1:
    ...
    pop ebx                                              # 004A65A6
    mov byte ptr [0x113605f], bl                         # 004A65A7
    shr bx, 8                                            # 004A65AD
    movzx ebp, byte ptr [0x1136070]                      # 004A65B1
    shl ebp, 3                                           # 004A65B8
    msvc_or bp, bx                                       # 004A65BB
    mov bl, byte ptr [0x1136071]                         # 004A65BE
    mov bh, byte ptr [0x1135ff0]                         # 004A65C4
    mov dword ptr [0x1135eda], 0                         # 004A65CA
    mov word ptr [0x1135f62], 0                          # 004A65D4
    mov word ptr [0x1135f64], 0                          # 004A65DD
    movzx esi, word ptr [0x1135fec]                      # 004A65E6
    jmp dword ptr [esi*4 + 0x500078]                     # 004A65ED

    .global _sub_4A65F4
_sub_4A65F4:
    or word ptr [0x1135f64], 0x8000                      # 004A65F4

    .global _sub_4A65FD
_sub_4A65FD:
    mov esi, 0x4a5d94                                    # 004A65FD
    mov edi, 0xffffffff                                  # 004A6602
    call _sub_4A2DE4                                     # 004A6607
    cmp word ptr [0x1135f62], 0                          # 004A660C
    jne .L4A6621                                         # 004A6614
    test word ptr [0x1135f64], 1                         # 004A6616
    jne _sub_4A6674                                      # 004A661F
.L4A6621:
    test byte ptr [0x113605f], 1                         # 004A6621
    je .L4A664C                                          # 004A6628
    test byte ptr [0x113605f], 0x40                      # 004A662A
    jne .L4A664C                                         # 004A6631
    cmp dword ptr [0x1135f0a], 0xf9c                     # 004A6633
    jb .L4A664C                                          # 004A663D
    mov bx, 0x15f                                        # 004A663F
    mov dx, 0xffff                                       # 004A6643
    call _sub_431A8A                                     # 004A6647
.L4A664C:
    mov ebx, dword ptr [0x1135eda]                       # 004A664C
    ret                                                  # 004A6652

    .global _sub_4A6653
_sub_4A6653:
    mov dword ptr [0x1135f06], 0xffffffff                # 004A6653
    call _sub_4A5D94                                     # 004A665D
    test word ptr [0x1135f64], 1                         # 004A6662
    jne _sub_4A6674                                      # 004A666B
    mov ebx, dword ptr [0x1135eda]                       # 004A666D
    ret                                                  # 004A6673

    .global _sub_4A6674
_sub_4A6674:
    mov word ptr [0x9c68e6], 0x26e                       # 004A6674
...
_sub_4A6683:
    ...
    .global _sub_4A668A
_sub_4A668A:
    mov byte ptr [0x9c68ea], 0x30                        # 004A668A
    mov word ptr [0x9c68e0], ax                          # 004A6691
    mov word ptr [0x9c68e2], cx                          # 004A6697
    add word ptr [0x9c68e0], 0x10                        # 004A669E
    add word ptr [0x9c68e2], 0x10                        # 004A66A6
    mov word ptr [0x9c68e4], di                          # 004A66AE
    mov byte ptr [0x113606f], dh                         # 004A66B5
    mov byte ptr [0x1136070], dl                         # 004A66BB
    mov word ptr [0x1135ff0], bp                         # 004A66C1
    ror edi, 0x10                                        # 004A66C8
    ror ebp, 0x10                                        # 004A66CB
    mov word ptr [0x1135ff2], di                         # 004A66CE
    mov word ptr [0x1135fec], bp                         # 004A66D5
    ...
    shr esi, 3                                           # 004A66EF
    mov esi, dword ptr [esi + 0xe40134]                  # 004A66F2
.L4A66F8:
    ...
    and dh, 0xf                                          # 004A671C
    cmp dh, byte ptr [0x113606f]                         # 004A671F
    jne .L4A673F                                         # 004A6725
    mov dh, byte ptr [esi + 5]                           # 004A6727
    shr dh, 4                                            # 004A672A
    cmp dh, byte ptr [0x1135ff0]                         # 004A672D
...
.L4A6744:
    ...
    and al, 0xf                                          # 004A6748
    mov byte ptr [0x1136071], al                         # 004A674A
    ...
    and esi, 3                                           # 004A677A
    jmp dword ptr [esi*4 + 0x500084]                     # 004A677D
...
_sub_4A67B2:
    ...
    pop ebx                                              # 004A67B7
    mov byte ptr [0x113605f], bl                         # 004A67B8
    shr bx, 8                                            # 004A67BE
    movzx ebp, byte ptr [0x1136070]                      # 004A67C2
    shl ebp, 3                                           # 004A67C9
    msvc_or bp, bx                                       # 004A67CC
    mov bl, byte ptr [0x1136071]                         # 004A67CF
    mov bh, byte ptr [0x1135ff0]                         # 004A67D5
    mov dword ptr [0x1135eda], 0                         # 004A67DB
    mov word ptr [0x1135f62], 0                          # 004A67E5
    mov word ptr [0x1135f64], 0                          # 004A67EE
    movzx esi, word ptr [0x1135fec]                      # 004A67F7
    jmp dword ptr [esi*4 + 0x500094]                     # 004A67FE

    .global _sub_4A6805
_sub_4A6805:
    or word ptr [0x1135f64], 0x8000                      # 004A6805

    .global _sub_4A680E
_sub_4A680E:
    mov esi, 0x4a6136                                    # 004A680E
    mov edi, 0xffffffff                                  # 004A6813
    call _sub_4A2DE4                                     # 004A6818
    mov ebx, dword ptr [0x1135eda]                       # 004A681D
    ret                                                  # 004A6823

    .global _sub_4A6824
_sub_4A6824:
    mov dword ptr [0x1135f06], 0xffffffff                # 004A6824
    call _sub_4A6136                                     # 004A682E
    mov ebx, dword ptr [0x1135eda]                       # 004A6833
    ret                                                  # 004A6839
...
_sub_4A6841:
    ...
    movzx esi, byte ptr [0x9c68eb]                       # 004A6849
    imul esi, esi, 0x8fa8                                # 004A6850
    msvc_xor ecx, ecx                                    # 004A6856
.L4A6858:
    mov ebp, dword ptr [ecx*4 + 0x50c9e4]                # 004A6858
    cmp ebp, -1                                          # 004A685F
    je .L4A6885                                          # 004A6862
    ...
    shr eax, 5                                           # 004A686B
    bt dword ptr [esi + eax*4 + 0x5317b8], edx           # 004A686E
...
.L4A688E:
    ...
    mov ebp, dword ptr [eax*4 + 0x50c914]                # 004A6896
...
.L4A68AA:
    ...
    movzx esi, byte ptr [0x9c68eb]                       # 004A68AC
    imul esi, esi, 0x8fa8                                # 004A68B3
    msvc_xor ecx, ecx                                    # 004A68B9
.L4A68BB:
    mov ebp, dword ptr [ecx*4 + 0x50c9e4]                # 004A68BB
    cmp ebp, -1                                          # 004A68C2
    je .L4A68ED                                          # 004A68C5
    ...
    shr eax, 5                                           # 004A68CE
    bt dword ptr [esi + eax*4 + 0x5317b8], edx           # 004A68D1
...
.L4A68F8:
    mov ebp, dword ptr [ecx*4 + 0x50c984]                # 004A68F8
    cmp ebp, -1                                          # 004A68FF
    je .L4A690F                                          # 004A6902
...
.L4A6915:
    ...
    mov ebp, dword ptr [eax*4 + 0x50c984]                # 004A691D
...
_sub_4A693D:
    ...
    movzx esi, byte ptr [0x9c68eb]                       # 004A694B
    imul esi, esi, 0x8fa8                                # 004A6952
    msvc_xor ecx, ecx                                    # 004A6958
.L4A695A:
    mov ebp, dword ptr [ecx*4 + 0x50c9e4]                # 004A695A
    cmp ebp, -1                                          # 004A6961
    je .L4A69AC                                          # 004A6964
    ...
    shr edi, 5                                           # 004A6978
    bt dword ptr [esi + edi*4 + 0x5317b8], edx           # 004A697B
...
.L4A69AC:
    ...
    mov ebp, dword ptr [ebp*4 + 0x50c914]                # 004A69B9
...
_sub_4A6A49:
    ...
    mov edi, dword ptr [0x50d158]                        # 004A6A6C
    cmp edi, -1                                          # 004A6A72
    je .L4A6A7B                                          # 004A6A75
    mov byte ptr [edi], 0                                # 004A6A77
    inc edi                                              # 004A6A7A
.L4A6A7B:
    mov dword ptr [0x112c20d], edi                       # 004A6A7B
...
.L4A6B29:
    ...
    push edi                                             # 004A6B30
    push esi                                             # 004A6B31
    mov edi, dword ptr [0x112c20d]                       # 004A6B32
    cmp edi, -1                                          # 004A6B38
    je .L4A6B63                                          # 004A6B3B
    ...
    add dword ptr [0x112c20d], 0x10                      # 004A6B54
    mov edi, dword ptr [0x50d158]                        # 004A6B5B
...
.L4A6B88:
    ...
    push eax                                             # 004A6B94
    push esi                                             # 004A6B95
    mov edi, dword ptr [0x112c20d]                       # 004A6B96
    cmp edi, -1                                          # 004A6B9C
    je .L4A6BC7                                          # 004A6B9F
    ...
    add dword ptr [0x112c20d], 0x10                      # 004A6BB8
    mov edi, dword ptr [0x50d158]                        # 004A6BBF
...
.L4A6C16:
    ...
    mov edi, dword ptr [0x112c20d]                       # 004A6C1E
    cmp edi, -1                                          # 004A6C24
    je .L4A6C2C                                          # 004A6C27
...
_sub_4A6CEE:
    ...
    mov edi, dword ptr [0x50d158]                        # 004A6D13
    cmp edi, -1                                          # 004A6D19
    je .L4A6D23                                          # 004A6D1C
...
.L4A6DA7:
    ...
    .global _sub_4A6DA9
_sub_4A6DA9:
    mov al, byte ptr [0x525e3c]                          # 004A6DA9
    xchg byte ptr [0x9c68eb], al                         # 004A6DAE
    push eax                                             # 004A6DB4
    mov al, byte ptr [0x525fc5]                          # 004A6DB5
    cmp al, 0xff                                         # 004A6DBA
    je .L4A6DC2                                          # 004A6DBC
    or al, 0x80                                          # 004A6DBE
    jmp .L4A6DD1                                         # 004A6DC0
.L4A6DC2:
    mov edi, 0x50a006                                    # 004A6DC2
    call _sub_478265                                     # 004A6DC7
    mov al, byte ptr [0x50a006]                          # 004A6DCC
.L4A6DD1:
    mov byte ptr [0x525fab], al                          # 004A6DD1
    mov edi, 0x50a006                                    # 004A6DD6
    call _sub_4A6841                                     # 004A6DDB
    mov al, byte ptr [0x50a006]                          # 004A6DE0
    mov byte ptr [0x525faa], al                          # 004A6DE5
    movzx edi, byte ptr [0x525e3c]                       # 004A6DEA
    imul edi, edi, 0x8fa8                                # 004A6DF1
    mov dx, word ptr [edi + 0x5317d4]                    # 004A6DF7
    bsf ax, dx                                           # 004A6DFE
    jne .L4A6E07                                         # 004A6E02
    msvc_xor ax, ax                                      # 004A6E04
.L4A6E07:
    mov byte ptr [0x525faf], al                          # 004A6E07
    mov byte ptr [0x52622c], al                          # 004A6E0C
    mov byte ptr [0x525fac], 0xff                        # 004A6E11
    mov byte ptr [0x525fad], 0xff                        # 004A6E18
    call _sub_4A6E9B                                     # 004A6E1F
    pop eax                                              # 004A6E24
    mov byte ptr [0x9c68eb], al                          # 004A6E25
    ret                                                  # 004A6E2A

    .global _sub_4A6E2B
_sub_4A6E2B:
    mov al, byte ptr [0x525e3c]                          # 004A6E2B
    xchg byte ptr [0x9c68eb], al                         # 004A6E30
    push eax                                             # 004A6E36
    cmp byte ptr [0x525fab], 0xff                        # 004A6E37
    jne .L4A6E6C                                         # 004A6E3E
    mov al, byte ptr [0x525fc5]                          # 004A6E40
    cmp al, 0xff                                         # 004A6E45
    je .L4A6E4D                                          # 004A6E47
    or al, 0x80                                          # 004A6E49
    jmp .L4A6E5C                                         # 004A6E4B
.L4A6E4D:
    mov edi, 0x50a006                                    # 004A6E4D
    call _sub_478265                                     # 004A6E52
    mov al, byte ptr [0x50a006]                          # 004A6E57
.L4A6E5C:
    mov byte ptr [0x525fab], al                          # 004A6E5C
    mov al, 1                                            # 004A6E61
    mov bx, 0                                            # 004A6E63
    call _sub_4CB966                                     # 004A6E67
.L4A6E6C:
    cmp byte ptr [0x525faa], 0xff                        # 004A6E6C
    jne .L4A6E94                                         # 004A6E73
    mov edi, 0x50a006                                    # 004A6E75
    call _sub_4A6841                                     # 004A6E7A
    mov al, byte ptr [0x50a006]                          # 004A6E7F
    mov byte ptr [0x525faa], al                          # 004A6E84
    mov al, 1                                            # 004A6E89
    mov bx, 0                                            # 004A6E8B
    call _sub_4CB966                                     # 004A6E8F
.L4A6E94:
    pop eax                                              # 004A6E94
    mov byte ptr [0x9c68eb], al                          # 004A6E95
    ret                                                  # 004A6E9A

    .global _sub_4A6E9B
_sub_4A6E9B:
    mov al, byte ptr [0x525e3c]                          # 004A6E9B
    xchg byte ptr [0x9c68eb], al                         # 004A6EA0
    push eax                                             # 004A6EA6
    cmp byte ptr [0x525fac], 0xff                        # 004A6EA7
    je .L4A6ED4                                          # 004A6EAE
    movzx edi, byte ptr [0x525fac]                       # 004A6EB0
    mov edi, dword ptr [edi*4 + 0x50c9a4]                # 004A6EB7
    mov ax, word ptr [0x525e32]                          # 004A6EBE
    cmp ax, word ptr [edi + 0xaa]                        # 004A6EC4
    jbe .L4A6ED4                                         # 004A6ECB
    mov byte ptr [0x525fac], 0xff                        # 004A6ECD
.L4A6ED4:
    cmp byte ptr [0x525fac], 0xff                        # 004A6ED4
    jne .L4A6F37                                         # 004A6EDB
    mov edi, 0x50a006                                    # 004A6EDD
    call _sub_48D70C                                     # 004A6EE2
    mov al, byte ptr [edi]                               # 004A6EE7
    cmp al, 0xff                                         # 004A6EE9
    je .L4A6F37                                          # 004A6EEB
    mov byte ptr [0x525fac], al                          # 004A6EED
    msvc_xor ebp, ebp                                    # 004A6EF2
.L4A6EF4:
    mov esi, dword ptr [ebp*4 + 0x50c9e4]                # 004A6EF4
    cmp esi, -1                                          # 004A6EFB
    je .L4A6F27                                          # 004A6EFE
    cmp byte ptr [esi + 2], 2                            # 004A6F00
    jne .L4A6F27                                         # 004A6F04
    movzx ebx, byte ptr [0x9c68eb]                       # 004A6F06
    msvc_mov ecx, ebp                                    # 004A6F0D
    imul ebx, ebx, 0x8fa8                                # 004A6F0F
    msvc_mov eax, ebp                                    # 004A6F15
    shr ecx, 5                                           # 004A6F17
    and eax, 0x1f                                        # 004A6F1A
    bt dword ptr [ebx + ecx*4 + 0x5317b8], eax           # 004A6F1D
    jb .L4A6F37                                          # 004A6F25
.L4A6F27:
    inc ebp                                              # 004A6F27
    cmp ebp, 0xe0                                        # 004A6F28
    jb .L4A6EF4                                          # 004A6F2E
    mov byte ptr [0x525fac], 0xff                        # 004A6F30
.L4A6F37:
    cmp byte ptr [0x525fad], 0xff                        # 004A6F37
    jne .L4A6F9A                                         # 004A6F3E
    mov edi, 0x50a006                                    # 004A6F40
    call _sub_48D753                                     # 004A6F45
    mov al, byte ptr [edi]                               # 004A6F4A
    cmp al, 0xff                                         # 004A6F4C
    je .L4A6F9A                                          # 004A6F4E
    mov byte ptr [0x525fad], al                          # 004A6F50
    msvc_xor ebp, ebp                                    # 004A6F55
.L4A6F57:
    mov esi, dword ptr [ebp*4 + 0x50c9e4]                # 004A6F57
    cmp esi, -1                                          # 004A6F5E
    je .L4A6F8A                                          # 004A6F61
    cmp byte ptr [esi + 2], 3                            # 004A6F63
    jne .L4A6F8A                                         # 004A6F67
    movzx ebx, byte ptr [0x9c68eb]                       # 004A6F69
    msvc_mov ecx, ebp                                    # 004A6F70
    imul ebx, ebx, 0x8fa8                                # 004A6F72
    msvc_mov eax, ebp                                    # 004A6F78
    shr ecx, 5                                           # 004A6F7A
    and eax, 0x1f                                        # 004A6F7D
    bt dword ptr [ebx + ecx*4 + 0x5317b8], eax           # 004A6F80
    jb .L4A6F9A                                          # 004A6F88
.L4A6F8A:
    inc ebp                                              # 004A6F8A
    cmp ebp, 0xe0                                        # 004A6F8B
    jb .L4A6F57                                          # 004A6F91
    mov byte ptr [0x525fad], 0xff                        # 004A6F93
.L4A6F9A:
    mov al, 1                                            # 004A6F9A
    mov bx, 0                                            # 004A6F9C
    call _sub_4CB966                                     # 004A6FA0
    pop eax                                              # 004A6FA5
    mov byte ptr [0x9c68eb], al                          # 004A6FA6
    ret                                                  # 004A6FAB
...
_sub_4A6FAC:
    ...
    test byte ptr [0x1136063], 0xc0                      # 004A6FC0
...
.L4A6FDA:
    ...
    .global _sub_4A6FDC
_sub_4A6FDC:
    mov byte ptr [0x9c68ea], 0x30                        # 004A6FDC
    mov dword ptr [0x1135c74], 0                         # 004A6FE3
    mov word ptr [0x1136012], ax                         # 004A6FED
    mov word ptr [0x1136014], cx                         # 004A6FF3
    mov word ptr [0x1136016], di                         # 004A6FFA
    mov byte ptr [0x113607f], dl                         # 004A7001
    mov byte ptr [0x1136080], dh                         # 004A7007
    mov dword ptr [0x1135c70], edi                       # 004A700D
    shr edi, 0x10                                        # 004A7013
    and edi, 0xf                                         # 004A7016
    mov word ptr [0x1136018], di                         # 004A7019
    and edx, 0xff830000                                  # 004A7020
    and bh, 3                                            # 004A7026
    mov dword ptr [0x1135c6c], edx                       # 004A7029
    mov byte ptr [0x1136081], bl                         # 004A702F
    mov byte ptr [0x1136082], bh                         # 004A7035
    mov byte ptr [0x1136084], 0                          # 004A703B
    call _sub_461393                                     # 004A7042
    jb .L4A7322                                          # 004A7047
    mov ax, word ptr [0x1136012]                         # 004A704D
    mov cx, word ptr [0x1136014]                         # 004A7053
    msvc_xor dl, dl                                      # 004A705A
.L4A705C:
    test byte ptr [0x1136081], 1                         # 004A705C
    ...
    shr esi, 3                                           # 004A707E
    mov esi, dword ptr [esi + 0xe40134]                  # 004A7081
...
.L4A7094:
    mov dx, word ptr [0x1136016]                         # 004A7094
    shr dx, 2                                            # 004A709B
.L4A709F:
...
.L4A70BB:
    inc byte ptr [0x1136084]                             # 004A70BB
.L4A70C1:
    pop edx                                              # 004A70C1
    pop ecx                                              # 004A70C2
    pop eax                                              # 004A70C3
.L4A70C4:
    ...
    push ecx                                             # 004A70C5
    push edx                                             # 004A70C6
    mov bl, byte ptr [0x1136081]                         # 004A70C7
    movzx edx, byte ptr [0x113607f]                      # 004A70CD
    mov dh, 0                                            # 004A70D4
    mov bh, byte ptr [0x1136082]                         # 004A70D6
    mov di, word ptr [0x1136018]                         # 004A70DC
    shl edi, 0x10                                        # 004A70E3
    mov di, word ptr [0x1136016]                         # 004A70E6
    or edx, dword ptr [0x1135c6c]                        # 004A70ED
    and edx, 0xfffcffff                                  # 004A70F3
    call _sub_49BB98                                     # 004A70F9
    pop edx                                              # 004A70FE
    pop ecx                                              # 004A70FF
    pop eax                                              # 004A7100
    test byte ptr [0x1136081], 1                         # 004A7101
    jne .L4A7123                                         # 004A7108
    cmp ebx, 0x80000000                                  # 004A710A
    je .L4A7322                                          # 004A7110
    test byte ptr [0x1136073], 0xc                       # 004A7116
    jne .L4A7322                                         # 004A711D
.L4A7123:
    add dword ptr [0x1135c74], ebx                       # 004A7123
    push eax                                             # 004A7129
    push ecx                                             # 004A712A
    push edx                                             # 004A712B
    mov bl, byte ptr [0x1136081]                         # 004A712C
    mov bh, byte ptr [0x1136082]                         # 004A7132
    mov dl, 0                                            # 004A7138
    msvc_xor dh, dh                                      # 004A713A
    movzx bp, byte ptr [0x113607f]                       # 004A713C
    movzx edi, byte ptr [0x1136080]                      # 004A7144
    shl edi, 0x10                                        # 004A714B
    mov di, word ptr [0x1136016]                         # 004A714E
    call _sub_48BB20                                     # 004A7155
    pop edx                                              # 004A715A
    pop ecx                                              # 004A715B
    pop eax                                              # 004A715C
    test byte ptr [0x1136081], 1                         # 004A715D
    jne .L4A7172                                         # 004A7164
    cmp ebx, 0x80000000                                  # 004A7166
    je .L4A7322                                          # 004A716C
.L4A7172:
    add dword ptr [0x1135c74], ebx                       # 004A7172
    movzx ebx, byte ptr [0x1136082]                      # 004A7178
    add ax, word ptr [ebx*4 + 0x503c6c]                  # 004A717F
    add cx, word ptr [ebx*4 + 0x503c6e]                  # 004A7187
    inc dl                                               # 004A718F
    cmp dl, byte ptr [0x1135c73]                         # 004A7191
    jb .L4A705C                                          # 004A7197
    test dword ptr [0x1135c6c], 0x20000                  # 004A719D
    je .L4A7249                                          # 004A71A7
    mov ax, word ptr [0x1136012]                         # 004A71AD
    mov cx, word ptr [0x1136014]                         # 004A71B3
    movzx ebx, byte ptr [0x1136082]                      # 004A71BA
    mov dx, word ptr [0x1136016]                         # 004A71C1
    sub ax, word ptr [ebx*4 + 0x503c6c]                  # 004A71C8
    sub cx, word ptr [ebx*4 + 0x503c6e]                  # 004A71D0
    shr dx, 2                                            # 004A71D8
    msvc_mov dh, dl                                      # 004A71DC
    add dh, 0xc                                          # 004A71DE
    mov bl, 0xf                                          # 004A71E1
    mov ebp, 0x4a7328                                    # 004A71E3
    call _sub_462917                                     # 004A71E8
    jb .L4A7322                                          # 004A71ED
    mov ax, word ptr [0x1136012]                         # 004A71F3
    mov cx, word ptr [0x1136014]                         # 004A71F9
    movzx ebx, byte ptr [0x1136082]                      # 004A7200
    mov dx, word ptr [0x1136016]                         # 004A7207
    sub ax, word ptr [ebx*4 + 0x503c6c]                  # 004A720E
    sub cx, word ptr [ebx*4 + 0x503c6e]                  # 004A7216
    sub ax, word ptr [ebx*4 + 0x503c6c]                  # 004A721E
    sub cx, word ptr [ebx*4 + 0x503c6e]                  # 004A7226
    shr dx, 2                                            # 004A722E
    msvc_mov dh, dl                                      # 004A7232
    add dh, 0xc                                          # 004A7234
    mov bl, 0xf                                          # 004A7237
    mov ebp, 0x4a7328                                    # 004A7239
    call _sub_462917                                     # 004A723E
    jb .L4A7322                                          # 004A7243
.L4A7249:
    test dword ptr [0x1135c6c], 0x10000                  # 004A7249
    je .L4A7301                                          # 004A7253
    movzx ebx, byte ptr [0x1136082]                      # 004A7259
    mov ax, word ptr [ebx*4 + 0x503c6c]                  # 004A7260
    mov cx, word ptr [ebx*4 + 0x503c6e]                  # 004A7268
    movzx dx, byte ptr [0x1135c73]                       # 004A7270
    imul ax, dx                                          # 004A7278
    imul cx, dx                                          # 004A727C
    add ax, word ptr [0x1136012]                         # 004A7280
    add cx, word ptr [0x1136014]                         # 004A7287
    mov dx, word ptr [0x1136016]                         # 004A728E
    shr dx, 2                                            # 004A7295
    msvc_mov dh, dl                                      # 004A7299
    add dh, 0xc                                          # 004A729B
    mov bl, 0xf                                          # 004A729E
    mov ebp, 0x4a7328                                    # 004A72A0
    call _sub_462917                                     # 004A72A5
    jb .L4A7322                                          # 004A72AA
    movzx ebx, byte ptr [0x1136082]                      # 004A72AC
    mov ax, word ptr [ebx*4 + 0x503c6c]                  # 004A72B3
    mov cx, word ptr [ebx*4 + 0x503c6e]                  # 004A72BB
    movzx dx, byte ptr [0x1135c73]                       # 004A72C3
    inc dx                                               # 004A72CB
    imul ax, dx                                          # 004A72CD
    imul cx, dx                                          # 004A72D1
    add ax, word ptr [0x1136012]                         # 004A72D5
    add cx, word ptr [0x1136014]                         # 004A72DC
    mov dx, word ptr [0x1136016]                         # 004A72E3
    shr dx, 2                                            # 004A72EA
    msvc_mov dh, dl                                      # 004A72EE
    add dh, 0xc                                          # 004A72F0
    mov bl, 0xf                                          # 004A72F3
    mov ebp, 0x4a7328                                    # 004A72F5
    call _sub_462917                                     # 004A72FA
    jb .L4A7322                                          # 004A72FF
.L4A7301:
    test byte ptr [0x1136081], 1                         # 004A7301
    jne .L4A731B                                         # 004A7308
    mov bl, byte ptr [0x1135c73]                         # 004A730A
    sub bl, 2                                            # 004A7310
    cmp byte ptr [0x1136084], bl                         # 004A7313
    jae .L4A7322                                         # 004A7319
.L4A731B:
    mov ebx, dword ptr [0x1135c74]                       # 004A731B
    ret                                                  # 004A7321
.L4A7322:
...
# 0x4A7328
    ...
    .byte 0x1B, 0x3C, 0x10, 0x74, 0x03, 0x61, 0xF9, 0xC3 #        8 .<.t.a..
    .byte 0x0F, 0xB6, 0x6E, 0x04, 0x8B, 0x2C, 0xAD, 0x70 #       10 ..n..,.p
    .byte 0xCE, 0x50, 0x00, 0xF6, 0x85, 0x98, 0x00, 0x00 #       18 .P......
    .byte 0x00, 0x0C, 0x75, 0xE9, 0x61, 0xF8, 0xC3       #       20 ..u.a..


    .global _sub_4A734F
_sub_4A734F:
    mov byte ptr [0x9c68ea], 0x30                        # 004A734F
    mov dword ptr [0x1135f16], 0                         # 004A7356
    mov byte ptr [0x113605b], 0                          # 004A7360
    mov byte ptr [0x1136072], 0                          # 004A7367
    mov dword ptr [0x112c730], 0xffffffff                # 004A736E
    mov byte ptr [0x113607b], dh                         # 004A7378
    mov byte ptr [0x113607a], dl                         # 004A737E
    mov word ptr [0x1135fda], bp                         # 004A7384
    mov byte ptr [0x1136098], 0                          # 004A738B
    test bl, 1                                           # 004A7392
    je .L4A73B5                                          # 004A7395
    pushal                                               # 004A7397
    ...
    mov bh, byte ptr [0x9c68eb]                          # 004A73A7
    mov bl, 1                                            # 004A73AD
...
.L4A73B5:
    ...
    shr esi, 3                                           # 004A73C4
    mov esi, dword ptr [esi + 0xe40134]                  # 004A73C7
.L4A73CD:
    ...
    and dh, 0xf                                          # 004A73F1
    cmp dh, byte ptr [0x113607b]                         # 004A73F4
    jne .L4A7414                                         # 004A73FA
    mov dh, byte ptr [esi + 5]                           # 004A73FC
    shr dh, 4                                            # 004A73FF
    cmp dh, byte ptr [0x1135fda]                         # 004A7402
...
.L4A7422:
    ...
    and al, 0xf                                          # 004A7425
    cmp al, byte ptr [0x9c68eb]                          # 004A7427
...
.L4A75E2:
    ...
    mov edi, dword ptr [ecx*4 + 0x50c8b4]                # 004A75F6
    movzx ecx, byte ptr [edi + 0xa]                      # 004A75FD
    movsx eax, word ptr [edi + 6]                        # 004A7601
    imul eax, dword ptr [ecx*4 + 0x525e5e]               # 004A7605
    sar eax, 8                                           # 004A760D
    mov cl, byte ptr [esi + 4]                           # 004A7610
    and ecx, 0x3f                                        # 004A7613
    movzx ecx, word ptr [ecx*2 + 0x4f870c]               # 004A7616
    imul eax, ecx                                        # 004A761E
    sar eax, 8                                           # 004A7621
    add dword ptr [0x1135f16], eax                       # 004A7624
    pop edi                                              # 004A762A
    pop ecx                                              # 004A762B
    pop eax                                              # 004A762C
.L4A762D:
    ...
    and esi, 3                                           # 004A764F
    jmp dword ptr [esi*4 + 0x5000a0]                     # 004A7652
...
_sub_4A7687:
    ...
    push edx                                             # 004A768E
    push 0                                               # 004A768F
    mov word ptr [0x1135c7c], 0xffff                     # 004A7691
...
_sub_4A769C:
    ...
    push edx                                             # 004A76A9
    push esi                                             # 004A76AA
    jmp dword ptr [esi*4 + 0x5000b0]                     # 004A76AB
...
_sub_4A76E0:
    ...
    shr dx, 2                                            # 004A76E5
    mov word ptr [0x1135fe0], ax                         # 004A76E9
    mov word ptr [0x1135fe2], cx                         # 004A76EF
    mov byte ptr [0x113601c], dl                         # 004A76F6
    movzx esi, cx                                        # 004A76FC
    shl esi, 9                                           # 004A76FF
    msvc_or si, ax                                       # 004A7702
    shr esi, 3                                           # 004A7705
    mov esi, dword ptr [esi + 0xe40134]                  # 004A7708
.L4A770E:
    test byte ptr [esi], 0x3c                            # 004A770E
    jne .L4A7720                                         # 004A7711
    test byte ptr [esi + 5], 0x1f                        # 004A7713
    je .L4A7720                                          # 004A7717
    mov byte ptr [0x1136098], 1                          # 004A7719
.L4A7720:
...
.L4A7762:
    ...
    je .L4A777B                                          # 004A7766
    or byte ptr [0x113605b], 1                           # 004A7768
    mov cl, byte ptr [esi + 6]                           # 004A776F
    shr cl, 5                                            # 004A7772
    mov byte ptr [0x113605c], cl                         # 004A7775
.L4A777B:
    ...
    mov ax, word ptr [0x1135fe0]                         # 004A778C
    mov cx, word ptr [0x1135fe2]                         # 004A7792
...
.L4A779E:
    ...
    mov ax, word ptr [0x1135fe0]                         # 004A77B4
    mov cx, word ptr [0x1135fe2]                         # 004A77BA
...
.L4A77C6:
    ...
    mov ax, word ptr [0x1135fe0]                         # 004A77EB
    mov cx, word ptr [0x1135fe2]                         # 004A77F1
    call _sub_4CBE5F                                     # 004A77F8
    mov bx, word ptr [esi + 6]                           # 004A77FD
    and ebx, 0x3ff                                       # 004A7801
    mov dword ptr [0x112c730], ebx                       # 004A7807
    push esi                                             # 004A780D
    msvc_mov esi, ebx                                    # 004A780E
    imul esi, esi, 0x3d2                                 # 004A7810
    add esi, 0x5e6edc                                    # 004A7816
    ...
    inc word ptr [edx + 0x5b8402]                        # 004A7835
...
.L4A7849:
    ...
    sub esi, 8                                           # 004A7868
.L4A786B:
    mov ax, word ptr [0x1135fe0]                         # 004A786B
    mov cx, word ptr [0x1135fe2]                         # 004A7871
    mov dl, byte ptr [0x113601c]                         # 004A7878
    mov dh, byte ptr [esi + 3]                           # 004A787E
    mov bl, byte ptr [esi + 1]                           # 004A7881
    and bl, 0xf                                          # 004A7884
    mov dword ptr [0x1135f5a], esp                       # 004A7887
    mov dword ptr [0x1135f5e], ebp                       # 004A788D
    add dword ptr [0x1135f5e], edi                       # 004A7893
    mov byte ptr [0x113607c], 0                          # 004A7899
    push edi                                             # 004A78A0
    push ebp                                             # 004A78A1
    mov ebp, 0x4a7a7f                                    # 004A78A2
    call _sub_462917                                     # 004A78A7
    pop ebp                                              # 004A78AC
    pop edi                                              # 004A78AD
    jb _sub_4A7A6E                                       # 004A78AE
    mov bh, byte ptr [0xf00166]                          # 004A78B4
    and bh, 3                                            # 004A78BA
    mov byte ptr [0x1136072], bh                         # 004A78BD
    test byte ptr [0x113607c], 1                         # 004A78C3
    je .L4A793E                                          # 004A78CA
    test byte ptr [esp + 0x24], 1                        # 004A78CC
    je .L4A793E                                          # 004A78D1
    mov ax, word ptr [0x1135fe0]                         # 004A78D3
    mov cx, word ptr [0x1135fe2]                         # 004A78D9
    mov dl, byte ptr [0x113601c]                         # 004A78E0
    movzx esi, cx                                        # 004A78E6
    shl esi, 9                                           # 004A78E9
    msvc_or si, ax                                       # 004A78EC
    shr esi, 3                                           # 004A78EF
    mov esi, dword ptr [esi + 0xe40134]                  # 004A78F2
.L4A78F8:
...
.L4A793E:
    ...
    je .L4A7963                                          # 004A7943
    mov ax, word ptr [0x1135fe0]                         # 004A7945
    mov cx, word ptr [0x1135fe2]                         # 004A794B
    movzx dx, byte ptr [0x113601c]                       # 004A7952
    shl dx, 2                                            # 004A795A
    call _sub_4C4979                                     # 004A795E
.L4A7963:
    test byte ptr [esp + 0x24], 1                        # 004A7963
    je .L4A798D                                          # 004A7968
    mov ax, word ptr [0x1135fe0]                         # 004A796A
    mov cx, word ptr [0x1135fe2]                         # 004A7970
    movzx dx, byte ptr [0x113601c]                       # 004A7977
    shl dx, 2                                            # 004A797F
...
_sub_4A7999:
    pop ebp                                              # 004A7999
    add ebp, dword ptr [0x1135f16]                       # 004A799A
    test byte ptr [0x113605b], 1                         # 004A79A0
    je .L4A79FA                                          # 004A79A7
    movzx edi, byte ptr [0x113605c]                      # 004A79A9
    mov edi, dword ptr [edi*4 + 0x50c894]                # 004A79B0
    mov ecx, 1                                           # 004A79B7
    ...
    imul eax, dword ptr [ecx*4 + 0x525e5e]               # 004A79CD
    sar eax, 0xa                                         # 004A79D5
    movzx ecx, byte ptr [0x113607a]                      # 004A79D8
    movzx ecx, word ptr [ecx*2 + 0x4f870c]               # 004A79DF
    imul eax, ecx                                        # 004A79E7
    sar eax, 8                                           # 004A79EA
    cmp byte ptr [0x1136098], 0                          # 004A79ED
    je .L4A79F8                                          # 004A79F4
    shl eax, 1                                           # 004A79F6
.L4A79F8:
    msvc_add ebp, eax                                    # 004A79F8
.L4A79FA:
    test byte ptr [0x1136072], 2                         # 004A79FA
    je .L4A7A36                                          # 004A7A01
    movzx edi, word ptr [0x1135fda]                      # 004A7A03
    mov edi, dword ptr [edi*4 + 0x50c914]                # 004A7A0A
    movsx eax, word ptr [edi + 0x18]                     # 004A7A11
    imul eax, dword ptr [0x525e66]                       # 004A7A15
    sar eax, 8                                           # 004A7A1C
    movzx ecx, byte ptr [0x113607a]                      # 004A7A1F
    movzx ecx, word ptr [ecx*2 + 0x4f870c]               # 004A7A26
...
.L4A7A36:
    ...
    je .L4A7A62                                          # 004A7A3F
    pushal                                               # 004A7A41
    mov cx, word ptr [0x1135fe0]                         # 004A7A42
    mov dx, word ptr [0x1135fe2]                         # 004A7A49
    movzx bp, byte ptr [0x113601c]                       # 004A7A50
    shl bp, 2                                            # 004A7A58
...
# 0x4A7A7F
    .byte 0x60, 0x8A, 0x06, 0x24, 0x3C, 0x3C, 0x04, 0x0F #        0 `..$<<..
    .byte 0x84, 0xE8, 0x01, 0x00, 0x00, 0x3C, 0x1C, 0x0F #        8 .....<..
    .byte 0x84, 0x54, 0x01, 0x00, 0x00, 0x3C, 0x0C, 0x0F #       10 .T...<..
    .byte 0x84, 0xD8, 0x01, 0x00, 0x00, 0x3C, 0x08, 0x75 #       18 .....<.u
    .byte 0x0F, 0x8A, 0x66, 0x05, 0xC0, 0xEC, 0x05, 0x80 #       20 ..f.....
    .byte 0xFC, 0x00, 0x0F, 0x84, 0xC5, 0x01, 0x00, 0x00 #       28 ........
    .byte 0x3C, 0x14, 0x0F, 0x84, 0xD3, 0x00, 0x00, 0x00 #       30 <.......
    .byte 0x3C, 0x10, 0x74, 0x0C, 0x3C, 0x00, 0x74, 0x03 #       38 <.t.<.t.
    .byte 0x61, 0xF9, 0xC3, 0xE9, 0xAD, 0x01, 0x00, 0x00 #       40 a.......
    .byte 0x0F, 0xB6, 0x5E, 0x04, 0x8B, 0x1C, 0x9D, 0x70 #       48 ..^....p
    .byte 0xCE, 0x50, 0x00, 0xF6, 0x83, 0x98, 0x00, 0x00 #       50 .P......
    .byte 0x00, 0x08, 0x75, 0xE4, 0x66, 0xA1, 0xE0, 0x5F #       58 ..u.f.._
    .byte 0x13, 0x01, 0x66, 0x8B, 0x0D, 0xE2, 0x5F, 0x13 #       60 ..f..._.
    .byte 0x01, 0x8A, 0x5E, 0x05, 0x83, 0xE3, 0x03, 0x66 #       68 ..^....f
    .byte 0x2B, 0x04, 0x9D, 0x96, 0x92, 0x4F, 0x00, 0x66 #       70 +....O.f
    .byte 0x2B, 0x0C, 0x9D, 0x98, 0x92, 0x4F, 0x00, 0x8A #       78 +....O..
    .byte 0x56, 0x02, 0xBD, 0x7C, 0x5C, 0x13, 0x01, 0x66 #       80 V..|...f
    .byte 0x83, 0x7D, 0x00, 0xFF, 0x74, 0x1A, 0x66, 0x3B #       88 .}..t.f;
    .byte 0x45, 0x00, 0x75, 0x0F, 0x66, 0x3B, 0x4D, 0x02 #       90 E.u.f;M.
    .byte 0x75, 0x09, 0x3A, 0x55, 0x04, 0x0F, 0x84, 0x52 #       98 u.:U...R
    .byte 0x01, 0x00, 0x00, 0x83, 0xC5, 0x06, 0xEB, 0xDF #       A0 ........
    .byte 0x66, 0x89, 0x45, 0x00, 0x66, 0x89, 0x4D, 0x02 #       A8 f.E.f.M.
    .byte 0x88, 0x55, 0x04, 0x66, 0xC7, 0x45, 0x06, 0xFF #       B0 .U.f.E..
    .byte 0xFF, 0x89, 0x35, 0x58, 0x01, 0xF0, 0x00, 0x8B #       B8 ..5X....
    .byte 0x2D, 0x5A, 0x5F, 0x13, 0x01, 0x66, 0x0F, 0xB6 #       C0 -Z_..f..
    .byte 0x7E, 0x02, 0x66, 0xC1, 0xE7, 0x02, 0x8A, 0x5D #       C8 ~.f....]
    .byte 0x24, 0x80, 0xCB, 0x80, 0xE8, 0xF6, 0x5B, 0xF8 #       D0 $.....[.
    .byte 0xFF, 0x81, 0xFB, 0x00, 0x00, 0x00, 0x80, 0x0F #       D8 ........
    .byte 0x84, 0x5B, 0xFF, 0xFF, 0xFF, 0x8B, 0x2D, 0x5A #       E0 .[....-Z
    .byte 0x5F, 0x13, 0x01, 0x01, 0x1D, 0x16, 0x5F, 0x13 #       E8 _....._.
    .byte 0x01, 0xF6, 0x45, 0x24, 0x01, 0x0F, 0x84, 0xFA #       F0 ..E$....
    .byte 0x00, 0x00, 0x00, 0x8B, 0x35, 0x58, 0x01, 0xF0 #       F8 ....5X..
    .byte 0x00, 0x89, 0x35, 0x5C, 0x01, 0xF0, 0x00, 0x61 #      100 ..5....a
    .byte 0x23, 0xC0, 0xC3, 0x8B, 0x2D, 0x5A, 0x5F, 0x13 #      108 #...-Z_.
    .byte 0x01, 0x0F, 0xB6, 0x5E, 0x04, 0x8B, 0x1C, 0x9D #      110 ...^....
    .byte 0x64, 0xCD, 0x50, 0x00, 0x0F, 0xBF, 0x4B, 0x42 #      118 d.P...KB
    .byte 0x0F, 0xB6, 0x5B, 0x3F, 0x0F, 0xAF, 0x0C, 0x9D #      120 ..[?....
    .byte 0x5E, 0x5E, 0x52, 0x00, 0xC1, 0xF9, 0x0C, 0x01 #      128 ^^R.....
    .byte 0x0D, 0x16, 0x5F, 0x13, 0x01, 0xF6, 0x45, 0x24 #      130 .._...E$
    .byte 0x01, 0x0F, 0x84, 0xB6, 0x00, 0x00, 0x00, 0x89 #      138 ........
    .byte 0x35, 0x58, 0x01, 0xF0, 0x00, 0x66, 0xA1, 0xE0 #      140 5X...f..
    .byte 0x5F, 0x13, 0x01, 0x66, 0x8B, 0x0D, 0xE2, 0x5F #      148 _..f..._
    .byte 0x13, 0x01, 0xB3, 0x01, 0xE8, 0x5A, 0x38, 0x01 #      150 .....Z8.
    .byte 0x00, 0x8B, 0x35, 0x58, 0x01, 0xF0, 0x00, 0x89 #      158 ..5X....
    .byte 0x35, 0x5C, 0x01, 0xF0, 0x00, 0x61, 0x23, 0xC0 #      160 5....a#.
    .byte 0xC3, 0x8B, 0x2D, 0x5A, 0x5F, 0x13, 0x01, 0xF6 #      168 ..-Z_...
    .byte 0x46, 0x04, 0x80, 0x74, 0x1B, 0x0F, 0xB6, 0x46 #      170 F..t...F
    .byte 0x06, 0xC0, 0xE8, 0x05, 0xA2, 0x75, 0x60, 0x13 #      178 .....u`.
    .byte 0x01, 0x8B, 0x04, 0x85, 0x94, 0xC8, 0x50, 0x00 #      180 ......P.
    .byte 0x66, 0xF7, 0x40, 0x14, 0x00, 0x08, 0x75, 0x68 #      188 f.@...uh
    .byte 0x0F, 0xB6, 0x46, 0x05, 0xC0, 0xE8, 0x04, 0x8B #      190 ..F.....
    .byte 0x1C, 0x85, 0x84, 0xC9, 0x50, 0x00, 0x0F, 0xB7 #      198 ....P...
    .byte 0x05, 0xDA, 0x5F, 0x13, 0x01, 0x66, 0x0F, 0xA3 #      1A0 .._..f..
    .byte 0x43, 0x2C, 0x72, 0x15, 0x8B, 0x1C, 0x85, 0x14 #      1A8 C,r.....
    .byte 0xC9, 0x50, 0x00, 0x0F, 0xB6, 0x46, 0x05, 0xC0 #      1B0 .P...F..
    .byte 0xE8, 0x04, 0x66, 0x0F, 0xA3, 0x43, 0x12, 0x73 #      1B8 ..f..C.s
    .byte 0x6A, 0xF6, 0x06, 0x40, 0x75, 0x54, 0xF6, 0x06 #      1C0 j..@uT..
    .byte 0x80, 0x75, 0x3E, 0x80, 0x0D, 0x7C, 0x60, 0x13 #      1C8 .u>..|`.
    .byte 0x01, 0x01, 0xF6, 0x45, 0x24, 0x01, 0x74, 0x1D #      1D0 ...E$.t.
    .byte 0x80, 0x4E, 0x07, 0x20, 0x80, 0x66, 0x05, 0xF3 #      1D8 .N. .f..
    .byte 0xA0, 0xC4, 0x5F, 0x52, 0x00, 0xC0, 0xE0, 0x02 #      1E0 .._R....
    .byte 0x08, 0x46, 0x05, 0x80, 0x66, 0x07, 0xEF, 0x80 #      1E8 .F..f...
    .byte 0x66, 0x06, 0xF0, 0xEB, 0x00, 0x61, 0xF8, 0xC3 #      1F0 f....a..
    .byte 0x66, 0xC7, 0x05, 0xE6, 0x68, 0x9C, 0x00, 0xA9 #      1F8 f...h...
    .byte 0x00, 0x61, 0xBE, 0xFF, 0xFF, 0xFF, 0xFF, 0xF9 #      200 .a......
    .byte 0xC3, 0x66, 0xC7, 0x05, 0xE6, 0x68, 0x9C, 0x00 #      208 .f...h..
    .byte 0xA2, 0x00, 0x61, 0xBE, 0xFF, 0xFF, 0xFF, 0xFF #      210 ..a.....
    .byte 0xF9, 0xC3, 0x66, 0xC7, 0x05, 0xE6, 0x68, 0x9C #      218 ..f...h.
    .byte 0x00, 0xA3, 0x00, 0x61, 0xBE, 0xFF, 0xFF, 0xFF #      220 ...a....
    .byte 0xFF, 0xF9, 0xC3, 0x0F, 0xB6, 0x46, 0x05, 0xC1 #      228 .....F..
    .byte 0xE8, 0x04, 0x8B, 0x04, 0x85, 0x84, 0xC9, 0x50 #      230 .......P
    .byte 0x00, 0x66, 0x8B, 0x00, 0x66, 0xA3, 0x26, 0xC8 #      238 .f..f.&.
    .byte 0x12, 0x01, 0x66, 0xC7, 0x05, 0xE6, 0x68, 0x9C #      240 ..f...h.
    .byte 0x00, 0x9C, 0x00, 0x61, 0xBE, 0xFF, 0xFF, 0xFF #      248 ...a....
    .byte 0xFF, 0xF9, 0xC3                               #      250 ...


    .global _sub_4A7CD2
_sub_4A7CD2:
    mov byte ptr [0x1136086], dh                         # 004A7CD2
    mov word ptr [0x1136012], ax                         # 004A7CD8
    mov word ptr [0x1136014], cx                         # 004A7CDE
    mov word ptr [0x1136016], di                         # 004A7CE5
    mov byte ptr [0x113607f], dl                         # 004A7CEC
    mov byte ptr [0x1136082], bh                         # 004A7CF2
    mov ax, word ptr [0x1136012]                         # 004A7CF8
    mov cx, word ptr [0x1136014]                         # 004A7CFE
...
.L4A7D07:
    ...
    shr esi, 3                                           # 004A7D13
    mov esi, dword ptr [esi + 0xe40134]                  # 004A7D16
    msvc_xor al, al                                      # 004A7D1C
.L4A7D1E:
    movzx bp, byte ptr [esi + 2]                         # 004A7D1E
    shl bp, 2                                            # 004A7D23
    cmp bp, word ptr [0x1136016]                         # 004A7D27
    ...
    and dh, 3                                            # 004A7D3C
    cmp dh, byte ptr [0x1136082]                         # 004A7D3F
    ...
    shr dh, 4                                            # 004A7D52
    cmp dh, byte ptr [0x113607f]                         # 004A7D55
    ...
    and dh, 0xf                                          # 004A7D6B
    cmp dh, byte ptr [0x9c68eb]                          # 004A7D6E
...
.L4A7D7E:
    ...
    push ecx                                             # 004A7D8F
    push edx                                             # 004A7D90
    mov di, word ptr [0x1136016]                         # 004A7D91
    mov bl, 0x21                                         # 004A7D98
    mov bh, byte ptr [0x1136082]                         # 004A7D9A
    mov dl, 0                                            # 004A7DA0
    msvc_xor dh, dh                                      # 004A7DA2
    movzx bp, byte ptr [0x113607f]                       # 004A7DA4
...
.L4A7DB6:
    ...
    push ecx                                             # 004A7DBA
    push edx                                             # 004A7DBB
    mov di, word ptr [0x1136016]                         # 004A7DBC
    mov bl, 0x31                                         # 004A7DC3
    mov bh, byte ptr [0x1136082]                         # 004A7DC5
    mov dl, 0                                            # 004A7DCB
    msvc_xor dh, dh                                      # 004A7DCD
    movzx bp, byte ptr [0x113607f]                       # 004A7DCF
    call _sub_49C7F2                                     # 004A7DD7
    pop edx                                              # 004A7DDC
    pop ecx                                              # 004A7DDD
    pop eax                                              # 004A7DDE
.L4A7DDF:
    movzx ebx, byte ptr [0x1136082]                      # 004A7DDF
    add ax, word ptr [ebx*4 + 0x503c6c]                  # 004A7DE6
    add cx, word ptr [ebx*4 + 0x503c6e]                  # 004A7DEE
    inc dl                                               # 004A7DF6
    cmp dl, byte ptr [0x1136086]                         # 004A7DF8
    jb .L4A7D07                                          # 004A7DFE
    ...
    .global _sub_4A7E07
_sub_4A7E07:
    mov byte ptr [0x1136086], dh                         # 004A7E07
    mov word ptr [0x1136012], ax                         # 004A7E0D
    mov word ptr [0x1136014], cx                         # 004A7E13
    mov word ptr [0x1136016], di                         # 004A7E1A
    mov byte ptr [0x113607f], dl                         # 004A7E21
    mov byte ptr [0x1136082], bh                         # 004A7E27
    mov ax, word ptr [0x1136012]                         # 004A7E2D
    mov cx, word ptr [0x1136014]                         # 004A7E33
    msvc_xor dl, dl                                      # 004A7E3A
.L4A7E3C:
    push eax                                             # 004A7E3C
    push ecx                                             # 004A7E3D
    push edx                                             # 004A7E3E
    mov di, word ptr [0x1136016]                         # 004A7E3F
    mov bl, 1                                            # 004A7E46
    mov bh, byte ptr [0x1136082]                         # 004A7E48
    mov dl, 0                                            # 004A7E4E
    msvc_xor dh, dh                                      # 004A7E50
    movzx bp, byte ptr [0x113607f]                       # 004A7E52
    call _sub_49C7F2                                     # 004A7E5A
    pop edx                                              # 004A7E5F
    pop ecx                                              # 004A7E60
    pop eax                                              # 004A7E61
    movzx ebx, byte ptr [0x1136082]                      # 004A7E62
    add ax, word ptr [ebx*4 + 0x503c6c]                  # 004A7E69
    add cx, word ptr [ebx*4 + 0x503c6e]                  # 004A7E71
    inc dl                                               # 004A7E79
    cmp dl, byte ptr [0x1136086]                         # 004A7E7B
    jb .L4A7E3C                                          # 004A7E81
    ...
    .global _sub_4A7E86
_sub_4A7E86:
    mov byte ptr [0x113607b], dh                         # 004A7E86
    mov byte ptr [0x113607a], dl                         # 004A7E8C
    mov word ptr [0x1135fda], bp                         # 004A7E92
    mov byte ptr [0x1136083], 0                          # 004A7E99
    test bl, 0x10                                        # 004A7EA0
    je .L4A7EAC                                          # 004A7EA3
    or byte ptr [0x1136083], 0x20                        # 004A7EA5
.L4A7EAC:
    push eax                                             # 004A7EAC
    push ebx                                             # 004A7EAD
    push ecx                                             # 004A7EAE
    ...
    shr esi, 3                                           # 004A7EBB
    mov esi, dword ptr [esi + 0xe40134]                  # 004A7EBE
.L4A7EC4:
    ...
    and dh, 0xf                                          # 004A7EE8
    cmp dh, byte ptr [0x113607b]                         # 004A7EEB
    jne .L4A7F0B                                         # 004A7EF1
    mov dh, byte ptr [esi + 5]                           # 004A7EF3
    shr dh, 4                                            # 004A7EF6
    cmp dh, byte ptr [0x1135fda]                         # 004A7EF9
...
.L4A7F1A:
    ...
    and esi, 3                                           # 004A7F47
    jmp dword ptr [esi*4 + 0x5000c0]                     # 004A7F4A
...
_sub_4A7F89:
    ...
    push edx                                             # 004A7F96
    push esi                                             # 004A7F97
    jmp dword ptr [esi*4 + 0x5000d0]                     # 004A7F98
...
_sub_4A7FCD:
    ...
    shr esi, 3                                           # 004A7FE1
    mov esi, dword ptr [esi + 0xe40134]                  # 004A7FE4
.L4A7FEA:
    ...
    shr al, 4                                            # 004A800D
    cmp al, byte ptr [0x1135fda]                         # 004A8010
...
.L4A8031:
    ...
    shr esi, 3                                           # 004A803D
    mov esi, dword ptr [esi + 0xe40134]                  # 004A8040
.L4A8046:
    ...
    mov ebx, dword ptr [ebx*4 + 0x4f78f8]                # 004A8073
    ...
    mov ebx, dword ptr [ebx*4 + 0x4f78f8]                # 004A8093
...
_sub_4A80D1:
    ...
    .global _sub_4A80E1
_sub_4A80E1:
    mov byte ptr [0x113607b], dh                         # 004A80E1
    mov byte ptr [0x113607a], dl                         # 004A80E7
    mov word ptr [0x1135fda], bp                         # 004A80ED
    mov byte ptr [0x1136083], 0                          # 004A80F4
    test bl, 0x10                                        # 004A80FB
    je .L4A8107                                          # 004A80FE
    or byte ptr [0x1136083], 0x20                        # 004A8100
.L4A8107:
    mov byte ptr [0x1136088], 0                          # 004A8107
    movzx esi, dl                                        # 004A810E
    test word ptr [esi*2 + 0x4f8764], 0x13               # 004A8111
    je .L4A8124                                          # 004A811B
    or byte ptr [0x1136088], 1                           # 004A811D
.L4A8124:
    push eax                                             # 004A8124
    push ebx                                             # 004A8125
    push ecx                                             # 004A8126
    ...
    shr esi, 3                                           # 004A8133
    mov esi, dword ptr [esi + 0xe40134]                  # 004A8136
.L4A813C:
    ...
    and dh, 0xf                                          # 004A8160
    cmp dh, byte ptr [0x113607b]                         # 004A8163
    jne .L4A8183                                         # 004A8169
    mov dh, byte ptr [esi + 5]                           # 004A816B
    shr dh, 4                                            # 004A816E
    cmp dh, byte ptr [0x1135fda]                         # 004A8171
...
.L4A8192:
    ...
    cmp dh, byte ptr [0x1136083]                         # 004A8198
    ...
    and esi, 3                                           # 004A81C9
    jmp dword ptr [esi*4 + 0x5000e0]                     # 004A81CC
...
_sub_4A820B:
    ...
    push edx                                             # 004A8218
    push esi                                             # 004A8219
    jmp dword ptr [esi*4 + 0x5000f0]                     # 004A821A
...
_sub_4A824F:
    ...
    shr esi, 3                                           # 004A8263
    mov esi, dword ptr [esi + 0xe40134]                  # 004A8266
...
.L4A82AA:
    cmp byte ptr [0x113607a], 0                          # 004A82AA
...
.L4A82D8:
    cmp byte ptr [0x113607a], 0                          # 004A82D8
...
.L4A8326:
    test byte ptr [0x1136088], 1                         # 004A8326
    je .L4A8336                                          # 004A832D
    cmp ah, 0x10                                         # 004A832F
    ja .L4A8395                                          # 004A8332
    jmp _sub_4A83AB                                      # 004A8334
.L4A8336:
    cmp byte ptr [0x113607a], 0                          # 004A8336
...
_sub_4A83C0:
    ...
    mov word ptr [0x1135fda], bx                         # 004A83C8
    mov byte ptr [0x1136083], 0                          # 004A83CF
    test ebp, 4                                          # 004A83D6
    je .L4A8416                                          # 004A83DC
    add ax, word ptr [ebp*8 + 0x4f7b5e]                  # 004A83DE
    add cx, word ptr [ebp*8 + 0x4f7b60]                  # 004A83E6
    add dx, word ptr [ebp*8 + 0x4f7b62]                  # 004A83EE
    movzx ebx, byte ptr [ebp*8 + 0x4f7b5d]               # 004A83F6
    xor ebp, 4                                           # 004A83FE
    cmp bl, 0xc                                          # 004A8401
    jae .L4A8416                                         # 004A8404
    sub ax, word ptr [ebx*4 + 0x503c6c]                  # 004A8406
    sub cx, word ptr [ebx*4 + 0x503c6e]                  # 004A840E
.L4A8416:
    push eax                                             # 004A8416
    push ecx                                             # 004A8417
    push edx                                             # 004A8418
    push ebp                                             # 004A8419
    shr ebp, 3                                           # 004A841A
    mov edi, dword ptr [ebp*4 + 0x4f73d8]                # 004A841D
...
_sub_4A8426:
    ...
    and esi, 3                                           # 004A8443
    jmp dword ptr [esi*4 + 0x500100]                     # 004A8446
...
_sub_4A847B:
    ...
    shr esi, 3                                           # 004A848D
    mov esi, dword ptr [esi + 0xe40134]                  # 004A8490
.L4A8496:
    ...
    shr al, 4                                            # 004A84BF
    cmp al, byte ptr [0x1135fda]                         # 004A84C2
    jne .L4A84EE                                         # 004A84C8
    mov al, byte ptr [esi + 7]                           # 004A84CA
    and al, 0xf                                          # 004A84CD
    cmp al, byte ptr [0x9c68eb]                          # 004A84CF
...
.L4A84F9:
    ...
    je .L4A8505                                          # 004A84FC
    or byte ptr [0x1136083], 4                           # 004A84FE
.L4A8505:
...
_sub_4A850D:
    ...
    pop ecx                                              # 004A8515
    pop eax                                              # 004A8516
    mov bl, byte ptr [0x1136083]                         # 004A8517
    ret                                                  # 004A851D
...
_sub_4A852B:
    ...
    mov word ptr [0x1135fda], bx                         # 004A8533
    mov byte ptr [0x1136083], 0                          # 004A853A
    test ebp, 4                                          # 004A8541
    je .L4A8581                                          # 004A8547
    add ax, word ptr [ebp*8 + 0x4f7b5e]                  # 004A8549
    add cx, word ptr [ebp*8 + 0x4f7b60]                  # 004A8551
    add dx, word ptr [ebp*8 + 0x4f7b62]                  # 004A8559
    movzx ebx, byte ptr [ebp*8 + 0x4f7b5d]               # 004A8561
    xor ebp, 4                                           # 004A8569
    cmp bl, 0xc                                          # 004A856C
    jae .L4A8581                                         # 004A856F
    sub ax, word ptr [ebx*4 + 0x503c6c]                  # 004A8571
    sub cx, word ptr [ebx*4 + 0x503c6e]                  # 004A8579
.L4A8581:
    push eax                                             # 004A8581
    push ecx                                             # 004A8582
    push edx                                             # 004A8583
    push ebp                                             # 004A8584
    shr ebp, 3                                           # 004A8585
    mov edi, dword ptr [ebp*4 + 0x4f73d8]                # 004A8588
...
_sub_4A8591:
    ...
    and esi, 3                                           # 004A85AE
    jmp dword ptr [esi*4 + 0x500110]                     # 004A85B1
...
_sub_4A85E6:
    ...
    shr esi, 3                                           # 004A85F8
    mov esi, dword ptr [esi + 0xe40134]                  # 004A85FB
.L4A8601:
    ...
    shr al, 4                                            # 004A862A
    cmp al, byte ptr [0x1135fda]                         # 004A862D
    jne .L4A8659                                         # 004A8633
    mov al, byte ptr [esi + 7]                           # 004A8635
    and al, 0xf                                          # 004A8638
    cmp al, byte ptr [0x9c68eb]                          # 004A863A
...
_sub_4A866C:
    ...
    pop ecx                                              # 004A8674
    pop eax                                              # 004A8675
    mov bl, byte ptr [0x1136083]                         # 004A8676
    ret                                                  # 004A867C
...
_sub_4A867D:
    ...
    .global _sub_4A868A
_sub_4A868A:
    mov ebp, dword ptr [0x525e18]                        # 004A868A
    mov esi, dword ptr [0x525e1c]                        # 004A8690
    ror ebp, 3                                           # 004A8696
    xor esi, 0x1234567f                                  # 004A8699
    mov dword ptr [0x525e1c], ebp                        # 004A869F
    ror esi, 7                                           # 004A86A5
    add dword ptr [0x525e18], esi                        # 004A86A8
    ...
    shr esi, 3                                           # 004A86E3
    mov esi, dword ptr [esi + 0xe40134]                  # 004A86E6
.L4A86EC:
    ...
    and al, 0xf                                          # 004A8701
    cmp al, byte ptr [0x9c68eb]                          # 004A8703
...
.L4A871E:
    ...
    mov edi, dword ptr [eax*4 + 0x4f73d8]                # 004A8734
...
_sub_4A874D:
    ...
    push esi                                             # 004A874E
    push ebp                                             # 004A874F
    mov word ptr [0x1135fb0], 0                          # 004A8750
    mov word ptr [0x1135fb2], 0                          # 004A8759
...
.L4A876F:
    ...
    shr esi, 3                                           # 004A8788
    mov esi, dword ptr [esi + 0xe40134]                  # 004A878B
...
.L4A879E:
    ...
    and dl, 0xf                                          # 004A87BF
    cmp dl, byte ptr [0x9c68eb]                          # 004A87C2
    jne .L4A87D8                                         # 004A87C8
    inc word ptr [0x1135fb2]                             # 004A87CA
.L4A87D1:
    inc word ptr [0x1135fb0]                             # 004A87D1
.L4A87D8:
    add esi, 8                                           # 004A87D8
...
.L4A87E1:
    ...
    movzx ebx, word ptr [0x1135fb0]                      # 004A87FB
    movzx edx, word ptr [0x1135fb2]                      # 004A8802
    pop ebp                                              # 004A8809
    pop esi                                              # 004A880A
    pop edi                                              # 004A880B
    ret                                                  # 004A880C
