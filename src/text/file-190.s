...
_sub_46B779:
    ...
    add dx, 0xe                                         # 0046B7AB
    cmp dx, 0x62                                         # 0046B7AF
    jae .L46B7B9                                         # 0046B7B3
    mov dx, 0x62                                         # 0046B7B5
.L46B7B9:
...
.L46E3E3:
    ...
    mov_offset esi, __50B0CE                             # 0046E41F
...
.L46E429:
    ...
    mov_offset esi, __50B0CE                             # 0046E455
...
.L46E45F:
    ...
    mov_offset esi, __50B0CE                             # 0046E48B
...
.L46E67B:
    ...
    mov word ptr [esi + 0x36], 0xec                      # 0046E690
.L46E696:
...
.L46E897:
    ...
    mov_offset ebp, __F254D0                             # 0046E89C
.L46E8A1:
...
_sub_46EB52:
    ...
    mov word ptr [esi + 0x36], 0xec                      # 0046EB58
...
_sub_46EB69:
    ...
    mov word ptr [esi + 0x36], 0xec                      # 0046EB6F
...
_sub_46EBA0:
    push esi                                             # 0046EBA0
    mov_offset esi, __50AF88                             # 0046EBA1
...
_sub_46EBC8:
    ...
    mov_offset edi, __50AF88                             # 0046EBD6
...
.L46ED12:
    ...
    push esi                                             # 0046ED19
    mov_offset esi, __9D1B9A                             # 0046ED1A
...
.L46ED49:
    ...
    cmp word ptr [esi], 0x87a                            # 0046ED50
    je .L46ED5D                                          # 0046ED55
...
.L46EE21:
    ...
    mov_offset edi, __F2542E                             # 0046EE60
.L46EE65:
...
.L46EE92:
    ...
    mov_offset edi, __F2542E                             # 0046EE97
.L46EE9C:
...
.L46EEF1:
    ...
    mov_dword_ptr __F25424, __F254D0                     # 0046EF62
    push 0                                               # 0046EF6C
...
.L46EF76:
    ...
    cmp word ptr [esi], 0x87a                            # 0046EF87
    je .L46EF94                                          # 0046EF8C
...
.L46EF94:
    ...
    cmp word ptr [esi + 2], 0x87a                        # 0046EF9F
    jne .L46F023                                         # 0046EFA5
    add esi, 0x4c                                        # 0046EFA7
    mov_offset edi, __5060D0                             # 0046EFAA
.L46EFAF:
...
.L46F3E0:
    ...
    add_offset edi, __FA5984                             # 0046F3EC
...
.L46F4B6:
    ...
    add_offset edi, __F25780                             # 0046F4C4
...
.L46F5BD:
    ...
    add_offset ebp, __F25780                             # 0046F5CC
...
.L46F779:
    ...
    add_offset esi, __FA5984                             # 0046F788
...
_sub_46F7AA:
    pushal                                               # 0046F7AA
    mov word ptr [__F25572], 0x87a                       # 0046F7AB
    mov word ptr [__F25574], 0x87a                       # 0046F7B4
    ...
    mov_offset edi, __F2557E                             # 0046F7DF
.L46F7E4:
...
.L46F811:
    ...
    mov_offset edi, __F2557E                             # 0046F816
.L46F81B:
...
.L46F825:
    mov_offset esi, __5060D0                             # 0046F825
    mov_offset edi, __F255BE                             # 0046F82A
.L46F82F:
    mov al, byte ptr [esi]                               # 0046F82F
    mov byte ptr [edi], al                               # 0046F831
    inc esi                                              # 0046F833
    inc edi                                              # 0046F834
    cmp_offset edi, __F255DE                             # 0046F835
...
.L46F87B:
    ...
    add_offset esi, __FA5984                             # 0046F88A
...
_sub_46F976:
    ...
    mov dword ptr [esi + _str_1719+4], edx                  # 0046F98E
    mov dword ptr [esi + _str_1719+8], ebp                  # 0046F994
    mov dword ptr [esi + _str_1719+12], edi                  # 0046F99A
