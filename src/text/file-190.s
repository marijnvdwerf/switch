...
_sub_46E306:
    ...
    imul eax, dword ptr [_scenarioChunk3+70]                   # 0046E30F
    sar eax, 8                                           # 0046E319
    xor edx, edx
...
.L46E8A1:
    ...
    mov word ptr [__112C826], 0x7e6                      # 0046E8AC
.L46E8B5:
...
.L46ED49:
    ...
    cmp word ptr [esi], 0x7f7                            # 0046ED50
    je .L46ED5D                                          # 0046ED55
...
.L46EF76:
    ...
    cmp word ptr [esi], 0x7f7                            # 0046EF87
    je .L46EF94                                          # 0046EF8C
...
.L46EF94:
    ...
    cmp word ptr [esi + 2], 0x7f7                        # 0046EF9F
...
.L46F676:
    ...
    popal                                                # 0046F67C
    DebugStamp 0x5021117
    ret                                                  # 0046F67D

    .global _sub_46F67E
_sub_46F67E:
    DebugStamp 0x5021118
    push eax                                             # 0046F67E
    push ebx                                             # 0046F67F
    push edx                                             # 0046F680
    push edi                                             # 0046F681
...
_sub_46F7AA:
    pushal                                               # 0046F7AA
    mov word ptr [__F25572], 0x7f7                       # 0046F7AB
    mov word ptr [__F25574], 0x7f7                       # 0046F7B4
