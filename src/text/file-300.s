...
_sub_4C3D7C:
    ...
    mov ebp, dword ptr [ebp*4 + _wallObjects]            # 004C3D93
    mov dword ptr [__11364FC], ebp                       # 004C3D9A
    mov dword ptr [__11364F8], 0                         # 004C3DA0
    test byte ptr [ebp + 9], 0x10                        # 004C3DAA
    je .L4C3DBF                                          # 004C3DAE
    mov eax, dword ptr [_scenarioChunk3+326]             # 004C3DB0
    and eax, 7                                           # 004C3DB5
    shl eax, 1                                           # 004C3DB8
    mov dword ptr [__11364F8], eax                       # 004C3DBA
.L4C3DBF:
    mov al, byte ptr [esi + 6]                           # 004C3DBF
    and eax, 0x1f                                        # 004C3DC2
    shl eax, 0x13                                        # 004C3DC5
    or eax, 0x20000000                                   # 004C3DC8
    mov dword ptr [__1136504], eax                       # 004C3DCD
    add eax, 0x23a00006                                  # 004C3DD2
    mov dword ptr [__1136508], eax                       # 004C3DD7
    ...
    or dword ptr [__1136504], eax                        # 004C3E00
.L4C3E06:
    test byte ptr [ebp + 7], 0x80                        # 004C3E06
    je .L4C3E1F                                          # 004C3E0A
    movzx eax, byte ptr [esi + 5]                        # 004C3E0C
    mov dword ptr [__113650C], eax                       # 004C3E10
    and dword ptr [__1136504], 0xdfffffff                # 004C3E15
.L4C3E1F:
    mov dword ptr [__1136500], 0                         # 004C3E1F
    test byte ptr [esi + 1], 0x10                        # 004C3E29
    je .L4C3E49                                          # 004C3E2D
    mov byte ptr [__E3F0AC], 0                           # 004C3E2F
    movzx eax, byte ptr [__50AED8]                       # 004C3E36
    mov eax, dword ptr [eax*4 + __4FFAE8]                # 004C3E3D
    mov dword ptr [__1136500], eax                       # 004C3E44
.L4C3E49:
    push esi                                             # 004C3E49
    ...
    jmp dword ptr [ecx*4 + __5045DC]                     # 004C3E55
    .global _loc_4C3E5C
_loc_4C3E5C:
    mov ebx, 3                                           # 004C3E5C
...
.L4C3E73:
    ...
    add ebx, dword ptr [__11364F8]                       # 004C3E76
    test byte ptr [ebp + 7], 2                           # 004C3E7C
    jne .L4C3EEF                                         # 004C3E80
    test byte ptr [ebp + 7], 1                           # 004C3E82
    je .L4C3E8E                                          # 004C3E86
    or ebx, dword ptr [__1136504]                        # 004C3E88
.L4C3E8E:
    cmp dword ptr [__1136500], 0                         # 004C3E8E
    je .L4C3EA3                                          # 004C3E95
    and ebx, 0x7ffff                                     # 004C3E97
    or ebx, dword ptr [__1136500]                        # 004C3E9D
.L4C3EA3:
    push ecx                                             # 004C3EA3
    mov word ptr [__E3F0A0], 1                           # 004C3EA4
    mov word ptr [__E3F0A2], 1                           # 004C3EAD
    mov al, 0                                            # 004C3EB6
    mov cl, 0                                            # 004C3EB8
    mov di, 1                                            # 004C3EBA
    mov si, 0x1c                                         # 004C3EBE
    add dx, 1                                            # 004C3EC2
    mov word ptr [__E3F0A4], dx                          # 004C3EC6
    sub dx, 1                                            # 004C3ECD
    mov ebp, dword ptr [__E3F0B8]                        # 004C3ED1
    call dword ptr [ebp*4 + __4FD140]                    # 004C3ED7
    jb .L4C3EE9                                          # 004C3EDE
    mov ecx, dword ptr [__113650C]                       # 004C3EE0
    mov dword ptr [ebp + 4], ecx                         # 004C3EE6
.L4C3EE9:
    pop ecx                                              # 004C3EE9
    msvc_jmp .L4C436A                                    # 004C3EEA
.L4C3EEF:
    push eax                                             # 004C3EEF
    push ebx                                             # 004C3EF0
    test byte ptr [ebp + 7], 1                           # 004C3EF1
    je .L4C3EFD                                          # 004C3EF5
    or ebx, dword ptr [__1136504]                        # 004C3EF7
.L4C3EFD:
    cmp dword ptr [__1136500], 0                         # 004C3EFD
    je .L4C3F12                                          # 004C3F04
    and ebx, 0x7ffff                                     # 004C3F06
    or ebx, dword ptr [__1136500]                        # 004C3F0C
.L4C3F12:
    mov word ptr [__E3F0A0], 1                           # 004C3F12
    mov word ptr [__E3F0A2], 1                           # 004C3F1B
    mov al, 0                                            # 004C3F24
    mov cl, 0                                            # 004C3F26
    mov di, 1                                            # 004C3F28
    mov si, 0x1c                                         # 004C3F2C
    add dx, 1                                            # 004C3F30
    mov word ptr [__E3F0A4], dx                          # 004C3F34
    sub dx, 1                                            # 004C3F3B
    mov ebp, dword ptr [__E3F0B8]                        # 004C3F3F
    call dword ptr [ebp*4 + __4FD140]                    # 004C3F45
    pop ebx                                              # 004C3F4C
    pop eax                                              # 004C3F4D
    add ebx, dword ptr [__1136508]                       # 004C3F4E
    cmp dword ptr [__1136500], 0                         # 004C3F54
    jne .L4C3F97                                         # 004C3F5B
    mov word ptr [__E3F0A0], 1                           # 004C3F5D
    mov word ptr [__E3F0A2], 1                           # 004C3F66
    mov al, 0                                            # 004C3F6F
    mov cl, 0                                            # 004C3F71
    mov di, 1                                            # 004C3F73
    mov si, 0x1c                                         # 004C3F77
    add dx, 1                                            # 004C3F7B
    mov word ptr [__E3F0A4], dx                          # 004C3F7F
    sub dx, 1                                            # 004C3F86
    mov ebp, dword ptr [__E3F0B8]                        # 004C3F8A
    call dword ptr [ebp*4 + __4FD1E0]                    # 004C3F90
.L4C3F97:
    pop esi                                              # 004C3F97
    ret                                                  # 004C3F98
    .global _loc_4C3F99
...
.L4C3FBC:
    ...
    add ebx, dword ptr [__11364F8]                       # 004C3FBF
    test byte ptr [ebp + 7], 1                           # 004C3FC5
    je .L4C3FD1                                          # 004C3FC9
    or ebx, dword ptr [__1136504]                        # 004C3FCB
.L4C3FD1:
    cmp dword ptr [__1136500], 0                         # 004C3FD1
    je .L4C3FE6                                          # 004C3FD8
    and ebx, 0x7ffff                                     # 004C3FDA
    or ebx, dword ptr [__1136500]                        # 004C3FE0
.L4C3FE6:
    mov word ptr [__E3F0A0], 2                           # 004C3FE6
    mov word ptr [__E3F0A2], 0x1e                        # 004C3FEF
    mov al, 1                                            # 004C3FF8
    mov cl, 0x1f                                         # 004C3FFA
    mov di, 0x1d                                         # 004C3FFC
    mov si, 1                                            # 004C4000
    add dx, 1                                            # 004C4004
    mov word ptr [__E3F0A4], dx                          # 004C4008
    sub dx, 1                                            # 004C400F
    mov ebp, dword ptr [__E3F0B8]                        # 004C4013
    call dword ptr [ebp*4 + __4FD140]                    # 004C4019
    jb .L4C402B                                          # 004C4020
    mov ecx, dword ptr [__113650C]                       # 004C4022
...
.L4C4036:
    ...
    je .L4C4047                                          # 004C403F
    or ebx, dword ptr [__1136504]                        # 004C4041
.L4C4047:
    cmp dword ptr [__1136500], 0                         # 004C4047
    je .L4C405C                                          # 004C404E
    and ebx, 0x7ffff                                     # 004C4050
    or ebx, dword ptr [__1136500]                        # 004C4056
.L4C405C:
    mov word ptr [__E3F0A0], 2                           # 004C405C
    mov word ptr [__E3F0A2], 0x1e                        # 004C4065
    mov al, 1                                            # 004C406E
    mov cl, 0x1f                                         # 004C4070
    mov di, 0x1d                                         # 004C4072
    mov si, 1                                            # 004C4076
    add dx, 1                                            # 004C407A
    mov word ptr [__E3F0A4], dx                          # 004C407E
    sub dx, 1                                            # 004C4085
    mov ebp, dword ptr [__E3F0B8]                        # 004C4089
    call dword ptr [ebp*4 + __4FD140]                    # 004C408F
    pop ebx                                              # 004C4096
    pop eax                                              # 004C4097
    add ebx, dword ptr [__1136508]                       # 004C4098
    cmp dword ptr [__1136500], 0                         # 004C409E
    jne .L4C40E1                                         # 004C40A5
    mov word ptr [__E3F0A0], 2                           # 004C40A7
    mov word ptr [__E3F0A2], 0x1e                        # 004C40B0
    mov al, 1                                            # 004C40B9
    mov cl, 0x1f                                         # 004C40BB
    mov di, 0x1d                                         # 004C40BD
    mov si, 1                                            # 004C40C1
    add dx, 1                                            # 004C40C5
    mov word ptr [__E3F0A4], dx                          # 004C40C9
    sub dx, 1                                            # 004C40D0
    mov ebp, dword ptr [__E3F0B8]                        # 004C40D4
    call dword ptr [ebp*4 + __4FD1E0]                    # 004C40DA
.L4C40E1:
    pop esi                                              # 004C40E1
    ret                                                  # 004C40E2
    .global _loc_4C40E3
...
.L4C4109:
    ...
    add ebx, dword ptr [__11364F8]                       # 004C410C
    test byte ptr [ebp + 7], 1                           # 004C4112
    je .L4C411E                                          # 004C4116
    or ebx, dword ptr [__1136504]                        # 004C4118
.L4C411E:
    cmp dword ptr [__1136500], 0                         # 004C411E
    je .L4C4133                                          # 004C4125
    and ebx, 0x7ffff                                     # 004C4127
    or ebx, dword ptr [__1136500]                        # 004C412D
.L4C4133:
    mov word ptr [__E3F0A0], 0x1e                        # 004C4133
    mov word ptr [__E3F0A2], 2                           # 004C413C
    mov al, 0x1f                                         # 004C4145
    mov cl, 0                                            # 004C4147
    mov di, 1                                            # 004C4149
    mov si, 0x1d                                         # 004C414D
    add dx, 1                                            # 004C4151
    mov word ptr [__E3F0A4], dx                          # 004C4155
    sub dx, 1                                            # 004C415C
    mov ebp, dword ptr [__E3F0B8]                        # 004C4160
    call dword ptr [ebp*4 + __4FD140]                    # 004C4166
    jb .L4C4178                                          # 004C416D
    mov ecx, dword ptr [__113650C]                       # 004C416F
...
.L4C4183:
    ...
    je .L4C4194                                          # 004C418C
    or ebx, dword ptr [__1136504]                        # 004C418E
.L4C4194:
    cmp dword ptr [__1136500], 0                         # 004C4194
    je .L4C41A9                                          # 004C419B
    and ebx, 0x7ffff                                     # 004C419D
    or ebx, dword ptr [__1136500]                        # 004C41A3
.L4C41A9:
    mov word ptr [__E3F0A0], 0x1e                        # 004C41A9
    mov word ptr [__E3F0A2], 2                           # 004C41B2
    mov al, 0x1f                                         # 004C41BB
    mov cl, 0                                            # 004C41BD
    mov di, 1                                            # 004C41BF
    mov si, 0x1d                                         # 004C41C3
    add dx, 1                                            # 004C41C7
    mov word ptr [__E3F0A4], dx                          # 004C41CB
    sub dx, 1                                            # 004C41D2
    mov ebp, dword ptr [__E3F0B8]                        # 004C41D6
    call dword ptr [ebp*4 + __4FD140]                    # 004C41DC
    pop ebx                                              # 004C41E3
    pop eax                                              # 004C41E4
    add ebx, dword ptr [__1136508]                       # 004C41E5
    cmp dword ptr [__1136500], 0                         # 004C41EB
    jne .L4C422E                                         # 004C41F2
    mov word ptr [__E3F0A0], 0x1e                        # 004C41F4
    mov word ptr [__E3F0A2], 2                           # 004C41FD
    mov al, 0x1f                                         # 004C4206
    mov cl, 0                                            # 004C4208
    mov di, 1                                            # 004C420A
    mov si, 0x1d                                         # 004C420E
    add dx, 1                                            # 004C4212
    mov word ptr [__E3F0A4], dx                          # 004C4216
    sub dx, 1                                            # 004C421D
    mov ebp, dword ptr [__E3F0B8]                        # 004C4221
    call dword ptr [ebp*4 + __4FD1E0]                    # 004C4227
.L4C422E:
    pop esi                                              # 004C422E
    ret                                                  # 004C422F
    .global _loc_4C4230
...
.L4C4244:
    ...
    add ebx, dword ptr [__11364F8]                       # 004C4247
    test byte ptr [ebp + 7], 2                           # 004C424D
    jne .L4C42C0                                         # 004C4251
    test byte ptr [ebp + 7], 1                           # 004C4253
    je .L4C425F                                          # 004C4257
    or ebx, dword ptr [__1136504]                        # 004C4259
.L4C425F:
    cmp dword ptr [__1136500], 0                         # 004C425F
    je .L4C4274                                          # 004C4266
    and ebx, 0x7ffff                                     # 004C4268
    or ebx, dword ptr [__1136500]                        # 004C426E
.L4C4274:
    push ecx                                             # 004C4274
    mov word ptr [__E3F0A0], 1                           # 004C4275
    mov word ptr [__E3F0A2], 1                           # 004C427E
    mov al, 2                                            # 004C4287
    mov cl, 1                                            # 004C4289
    mov di, 0x1c                                         # 004C428B
    mov si, 1                                            # 004C428F
    add dx, 1                                            # 004C4293
    mov word ptr [__E3F0A4], dx                          # 004C4297
    sub dx, 1                                            # 004C429E
    mov ebp, dword ptr [__E3F0B8]                        # 004C42A2
    call dword ptr [ebp*4 + __4FD140]                    # 004C42A8
    jb .L4C42BA                                          # 004C42AF
    mov ecx, dword ptr [__113650C]                       # 004C42B1
    mov dword ptr [ebp + 4], ecx                         # 004C42B7
.L4C42BA:
    pop ecx                                              # 004C42BA
    msvc_jmp .L4C436A                                    # 004C42BB
.L4C42C0:
    push eax                                             # 004C42C0
    push ebx                                             # 004C42C1
    test byte ptr [ebp + 7], 1                           # 004C42C2
    je .L4C42CE                                          # 004C42C6
    or ebx, dword ptr [__1136504]                        # 004C42C8
.L4C42CE:
    cmp dword ptr [__1136500], 0                         # 004C42CE
    je .L4C42E3                                          # 004C42D5
    and ebx, 0x7ffff                                     # 004C42D7
    or ebx, dword ptr [__1136500]                        # 004C42DD
.L4C42E3:
    mov word ptr [__E3F0A0], 1                           # 004C42E3
    mov word ptr [__E3F0A2], 1                           # 004C42EC
    mov al, 2                                            # 004C42F5
    mov cl, 1                                            # 004C42F7
    mov di, 0x1c                                         # 004C42F9
    mov si, 1                                            # 004C42FD
    add dx, 1                                            # 004C4301
    mov word ptr [__E3F0A4], dx                          # 004C4305
    sub dx, 1                                            # 004C430C
    mov ebp, dword ptr [__E3F0B8]                        # 004C4310
    call dword ptr [ebp*4 + __4FD140]                    # 004C4316
    pop ebx                                              # 004C431D
    pop eax                                              # 004C431E
    add ebx, dword ptr [__1136508]                       # 004C431F
    cmp dword ptr [__1136500], 0                         # 004C4325
    jne .L4C4368                                         # 004C432C
    mov word ptr [__E3F0A0], 1                           # 004C432E
    mov word ptr [__E3F0A2], 1                           # 004C4337
    mov al, 2                                            # 004C4340
    mov cl, 1                                            # 004C4342
    mov di, 0x1c                                         # 004C4344
    mov si, 1                                            # 004C4348
    add dx, 1                                            # 004C434C
    mov word ptr [__E3F0A4], dx                          # 004C4350
    sub dx, 1                                            # 004C4357
    mov ebp, dword ptr [__E3F0B8]                        # 004C435B
    call dword ptr [ebp*4 + __4FD1E0]                    # 004C4361
.L4C4368:
    pop esi                                              # 004C4368
    ret                                                  # 004C4369
.L4C436A:
    ...
    .global _sub_4C436C
_sub_4C436C:
    mov word ptr [__113651A], bp                         # 004C436C
    mov byte ptr [__9C68EA], 0x30                        # 004C4373
    mov word ptr [__9C68E0], ax                          # 004C437A
    mov word ptr [__9C68E2], cx                          # 004C4380
    add word ptr [__9C68E0], 0x10                        # 004C4387
    add word ptr [__9C68E2], 0x10                        # 004C438F
    mov word ptr [__9C68E4], di                          # 004C4397
    msvc_or di, di                                       # 004C439E
    jne .L4C43B1                                         # 004C43A1
    push edx                                             # 004C43A3
    call _sub_467297                                     # 004C43A4
    mov word ptr [__9C68E4], dx                          # 004C43A9
    pop edx                                              # 004C43B0
.L4C43B1:
    ...
    shr ecx, 3                                           # 004C43D9
    mov ecx, dword ptr [ecx + __E40134]                  # 004C43DC
...
.L4C43EF:
    ...
    shl edx, 5                                           # 004C4401
    mov al, byte ptr [eax + edx + __50455C]              # 004C4404
    test al, 1                                           # 004C440B
    je .L4C4415                                          # 004C440D
...
.L4C441B:
    shr di, 2                                            # 004C441B
    mov word ptr [__1136515], di                         # 004C441F
    mov byte ptr [__1136514], dh                         # 004C4426
    mov word ptr [__1136517], bp                         # 004C442C
    msvc_mov si, cx                                      # 004C4433
    movzx esi, si                                        # 004C4436
    shl esi, 9                                           # 004C4439
    msvc_or si, ax                                       # 004C443C
    shr esi, 3                                           # 004C443F
    mov esi, dword ptr [esi + __E40134]                  # 004C4442
...
.L4C4455:
    ...
    movzx di, byte ptr [__1136515]                       # 004C4463
    shl bp, 4                                            # 004C446B
    shl di, 2                                            # 004C446F
...
.L4C447C:
    ...
    movzx di, byte ptr [__1136515]                       # 004C4481
    msvc_cmp di, bp                                      # 004C4489
    jb .L4C463F                                          # 004C448C
    test word ptr [__1136517], 0xc0                      # 004C4492
...
.L4C4537:
    push ebx                                             # 004C4537
    push edx                                             # 004C4538
    mov dl, byte ptr [__1136515]                         # 004C4539
    movzx edi, byte ptr [esp + 5]                        # 004C453F
    msvc_mov dh, dl                                      # 004C4544
    mov edi, dword ptr [edi*4 + _wallObjects]            # 004C4546
    test word ptr [__1136517], 0xc0                      # 004C454D
    je .L4C4565                                          # 004C4556
...
.L4C4565:
    ...
    mov byte ptr [__1136516], dh                         # 004C4568
    ...
    je .L4C463B                                          # 004C458E
    push ebx                                             # 004C4594
    mov bl, byte ptr [__1136515]                         # 004C4595
    msvc_xor bh, bh                                      # 004C459B
    call _sub_4616D6                                     # 004C459D
    mov bl, byte ptr [__1136516]                         # 004C45A2
    mov byte ptr [esi + 3], bl                           # 004C45A8
    mov bl, byte ptr [__1136517]                         # 004C45AB
    msvc_or bl, dl                                       # 004C45B1
    or bl, 0x18                                          # 004C45B3
    mov byte ptr [esi], bl                               # 004C45B6
    mov bl, byte ptr [__1136514]                         # 004C45B8
    mov byte ptr [esi + 6], bl                           # 004C45BE
    mov bl, byte ptr [__113651A]                         # 004C45C1
    and bl, 7                                            # 004C45C7
    shl bl, 5                                            # 004C45CA
    or byte ptr [esi + 6], bl                            # 004C45CD
    mov bl, byte ptr [__113651A]                         # 004C45D0
    and bl, 0x18                                         # 004C45D6
    shl bl, 2                                            # 004C45D9
    or byte ptr [esi + 1], bl                            # 004C45DC
    test byte ptr [__1136519], 1                         # 004C45DF
    je .L4C45EC                                          # 004C45E6
...
.L4C45EC:
    ...
    mov ebx, dword ptr [ebx*4 + _wallObjects]            # 004C45F4
    test byte ptr [ebx + 7], 0x80                        # 004C45FB
    je .L4C460B                                          # 004C45FF
    mov bx, word ptr [__113651A]                         # 004C4601
...
.L4C4615:
    mov dword ptr [__1136470], esi                       # 004C4615
    push edi                                             # 004C461B
    push esi                                             # 004C461C
    ...
    pop esi                                              # 004C4632
    pop edi                                              # 004C4633
    mov byte ptr [_scenarioChunk1+8], 1                  # 004C4634
.L4C463B:
...
.L4C463E:
    pop ecx                                              # 004C463E
.L4C463F:
    mov word ptr [__9C68E6], 0x168                       # 004C463F
    jmp .L4C4666                                         # 004C4648
.L4C464A:
    mov word ptr [__9C68E6], 0x169                       # 004C464A
.L4C4653:
    pop edx                                              # 004C4653
    pop ebx                                              # 004C4654
...
.L4C465D:
    mov word ptr [__9C68E6], 0x1e4                       # 004C465D
.L4C4666:
    ...
    .global _sub_4C466C
_sub_4C466C:
    mov byte ptr [__9C68EA], 0x30                        # 004C466C
    push edx                                             # 004C4673
    movzx dx, dh                                         # 004C4674
    shl dx, 2                                            # 004C4678
    mov word ptr [__9C68E0], ax                          # 004C467C
    mov word ptr [__9C68E2], cx                          # 004C4682
    mov word ptr [__9C68E4], dx                          # 004C4689
    add word ptr [__9C68E0], 0x10                        # 004C4690
    add word ptr [__9C68E2], 0x10                        # 004C4698
    pop edx                                              # 004C46A0
    ...
    shr esi, 3                                           # 004C46AD
    mov esi, dword ptr [esi + __E40134]                  # 004C46B0
.L4C46B6:
...
.L4C46E4:
    ...
    mov byte ptr [_scenarioChunk1+8], 1                  # 004C4707
.L4C470E:
...
.L4C4711:
    ...
    .global _sub_4C4717
_sub_4C4717:
    mov byte ptr [__9C68EA], 0x30                        # 004C4717
    push edx                                             # 004C471E
    movzx dx, dh                                         # 004C471F
    shl dx, 2                                            # 004C4723
    mov word ptr [__9C68E0], ax                          # 004C4727
    mov word ptr [__9C68E2], cx                          # 004C472D
    mov word ptr [__9C68E4], dx                          # 004C4734
    add word ptr [__9C68E0], 0x10                        # 004C473B
    add word ptr [__9C68E2], 0x10                        # 004C4743
    pop edx                                              # 004C474B
    test word ptr [__508F14], 2                          # 004C474C
...
.L4C4757:
    ...
    shr esi, 3                                           # 004C4764
    mov esi, dword ptr [esi + __E40134]                  # 004C4767
.L4C476D:
...
.L4C479D:
    ...
    mov edi, dword ptr [edi*4 + _wallObjects]            # 004C47A7
...
.L4C47DF:
    ...
    pop esi                                              # 004C47F7
    pop edi                                              # 004C47F8
    mov byte ptr [_scenarioChunk1+8], 1                  # 004C47F9
.L4C4800:
...
_sub_4C4809:
    ...
    mov bl, 1                                            # 004C4814
    mov word ptr [__9C68E8], 0x1bd                       # 004C4816
...
_sub_4C482B:
    ...
    shr esi, 3                                           # 004C4838
    mov esi, dword ptr [esi + __E40134]                  # 004C483B
.L4C4841:
    ...
    mov dword ptr [__F00158], esi                        # 004C485F
    push edi                                             # 004C4865
    push esi                                             # 004C4866
    ...
    mov esi, dword ptr [__F00158]                        # 004C4883
    cmp esi, -1                                          # 004C4889
...
_sub_4C489B:
    ...
    shr esi, 3                                           # 004C48A8
    mov esi, dword ptr [esi + __E40134]                  # 004C48AB
    shr dx, 2                                            # 004C48B1
    shr bh, 2                                            # 004C48B5
...
.L4C48BA:
    ...
    mov dword ptr [__F00158], esi                        # 004C48CE
    push edi                                             # 004C48D4
    push esi                                             # 004C48D5
    ...
    mov esi, dword ptr [__F00158]                        # 004C48F2
    cmp esi, -1                                          # 004C48F8
...
_sub_4C490A:
    ...
    shr esi, 3                                           # 004C4917
    mov esi, dword ptr [esi + __E40134]                  # 004C491A
.L4C4920:
    ...
    mov dword ptr [__F00158], esi                        # 004C493D
    push edi                                             # 004C4943
    push esi                                             # 004C4944
    ...
    mov esi, dword ptr [__F00158]                        # 004C4961
    cmp esi, -1                                          # 004C4967
...
_sub_4C4979:
    ...
    shr esi, 3                                           # 004C4986
    mov esi, dword ptr [esi + __E40134]                  # 004C4989
.L4C498F:
...
.L4C49AD:
    mov dword ptr [__F00158], esi                        # 004C49AD
    push edi                                             # 004C49B3
    push esi                                             # 004C49B4
    ...
    mov esi, dword ptr [__F00158]                        # 004C49D1
    cmp esi, -1                                          # 004C49D7
...
_sub_4C49E9:
    ...
    shr esi, 3                                           # 004C49F7
    mov esi, dword ptr [esi + __E40134]                  # 004C49FA
.L4C4A00:
...
.L4C4A23:
    ...
    ret                                                  # 004C4A30
.L4C4A31:
    mov dword ptr [__1136510], esi                       # 004C4A31
    pop esi                                              # 004C4A37
    pop ebx                                              # 004C4A38
    stc                                                  # 004C4A39
    ret                                                  # 004C4A3A
...
_sub_4C4A3B:
    pushal                                               # 004C4A3B
    mov byte ptr [__1136519], 0                          # 004C4A3C
    mov byte ptr [__F00166], 1                           # 004C4A43
    ...
    shr esi, 3                                           # 004C4A6C
    mov esi, dword ptr [esi + __E40134]                  # 004C4A6F
.L4C4A75:
...
.L4C4AAC:
    ...
    ret                                                  # 004C4AB3
.L4C4AB4:
    mov word ptr [__9C68E6], 0x164                       # 004C4AB4
    popal                                                # 004C4ABD
    stc                                                  # 004C4ABE
    ret                                                  # 004C4ABF
...
_sub_4C4AC0:
    ...
    mov edi, dword ptr [__50D158]                        # 004C4ADF
    cmp edi, -1                                          # 004C4AE5
    je .L4C4AEF                                          # 004C4AE8
